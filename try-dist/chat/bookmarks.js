...
function _findBookmarkDocument() {
  _findBookmarkDocument = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee(userContext) {
    var klass, fileTail, isPublic, newBookmarkFile;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            isPublic = true;
            _context.next = 5;
            return UI.authn.findAppInstances(userContext, klass, isPublic);
          ...
          case 22:
            _context.next = 24;
            return UI.authn.registerInTypeIndex(userContext, newBookmarkFile, klass, true);
...
function _addBookmark() {
  _addBookmark = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee2(context, target) {
...
function _toggleBookmark() {
  _toggleBookmark = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee3(userContext, target, bookmarkButton) {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 15:
            ...
            console.error('Cant delete bookmark:' + _context3.t0);
...
function _renderBookmarksButton() {
  _renderBookmarksButton = (0, _asyncToGenerator2["default"])(
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee5(userContext, target) {
    ...
    return _regenerator["default"].wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _setBookmarkButtonColor = function _ref2() {
              _setBookmarkButtonColor = (0, _asyncToGenerator2["default"])(
              /*#__PURE__*/
              _regenerator["default"].mark(function _callee4(bookmarkButton) {
                var bookmarked;
            ...
            setBookmarkButtonColor = function _ref(_x9) {
              return _setBookmarkButtonColor.apply(this, arguments);
            };
