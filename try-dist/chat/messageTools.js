...
function messageToolbar(message, messageRow, userContext) {
  ...
  function _deleteThingThen() {
    _deleteThingThen = (0, _asyncToGenerator2["default"])(
    /*#__PURE__*/
  ...
  if (me && kb.holds(message, ns.foaf('maker'), me)) {
    ...
    var deleteButton = UI.widgets.deleteButtonWithCheck(dom, div, 'message',
    /*#__PURE__*/
  ...
  */
  ...
  function sentimentButton(context, target, icon, actionClass, doc, mutuallyExclusive) {
    ...
    var button = UI.widgets.button(dom, icon, UI.utils.label(actionClass),
    /*#__PURE__*/
    function () {
      var _ref2 = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee2(_event) {
