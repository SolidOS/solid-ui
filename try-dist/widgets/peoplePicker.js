...
exports.findAddressBook = findAddressBook;
  ...
  (0, _createClass2["default"])(PeoplePicker, [{
    ...
    value: function render() {
      ...
      if (this.selectedgroup) {
        ...
        findAddressBook(this.typeIndex).then(function (_ref) {
          var book = _ref.book;
          ...
          createNewGroupButton.addEventListener('click', function (_event) {
            createNewGroup(book, _this.options.defaultNewGroupName).then(function (_ref2) {
  ...
  (0, _createClass2["default"])(GroupPicker, [{
    ...
    value: function loadGroups() {
      ...
      return new Promise(function (resolve, reject) {
        var _indexes = indexes(_this3.book),
...
function () {
  ...
  (0, _createClass2["default"])(GroupBuilder, [{
    ...
    value: function setGroupName(name) {
      ...
      var _indexes2 = indexes(this.book),
...
function findAddressBook(typeIndex) {
  return new Promise(function (resolve, reject) {
...
function createNewGroup(book, defaultNewGroupName) {
  var _indexes3 = indexes(book),
      groupIndex = _indexes3.groupIndex,
      groupContainer = _indexes3.groupContainer;

  var group = rdf.sym("".concat(groupContainer.uri).concat(_nodeUuid["default"].v4().slice(0, 8), ".ttl#this"));
