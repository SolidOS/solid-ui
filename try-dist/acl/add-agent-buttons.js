...
function () {
  ...
  (0, _createClass2["default"])(AddAgentButtons, [{
    ...
    value: function renderAddButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, "".concat(_iconBase["default"].iconBase, "noun_34653_green.svg"), 'Add ...', function () {
        _this.toggleBar();
    ...
    value: function renderPersonButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, _iconBase["default"].iconBase + _widgets["default"].iconForClass['vcard:Individual'], 'Add Person', function (event) {
        _this3.renderSimplifiedBar(event.target);

        _this3.renderNameForm(_ns["default"].vcard('Individual'), 'person').then(function (name) {
    ...
    value: function renderGroupButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, _iconBase["default"].iconBase + _widgets["default"].iconForClass['vcard:Group'], 'Add Group', function (event) {
        _this4.renderSimplifiedBar(event.target);

        _this4.renderNameForm(_ns["default"].vcard('Group'), 'group').then(function (name) {
    ...
    value: function renderNameForm(type, noun) {
      return _widgets["default"].askName(this.groupList.controller.dom, this.groupList.store, this.barElement, _ns["default"].vcard('URI'), type, noun);
    }
  }, {
    ...
    value: function renderPublicButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, _iconBase["default"].iconBase + _widgets["default"].iconForClass['foaf:Agent'], 'Add Everyone', function () {
        return _this5.addAgent(_ns["default"].foaf('Agent').uri).then(function () {
    ...
    value: function renderAuthenticatedAgentButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, "".concat(_iconBase["default"].iconBase, "noun_99101.svg"), 'Anyone logged In', function () {
        return _this6.addAgent(_ns["default"].acl('AuthenticatedAgent').uri).then(function () {
    ...
    value: function renderBotButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, _iconBase["default"].iconBase + 'noun_Robot_849764.svg', 'A Software Agent (bot)', function (event) {
        _this7.renderSimplifiedBar(event.target);

        _this7.renderNameForm(_ns["default"].schema('Application'), 'bot').then(function (name) {
    ...
    value: function renderAppsButton() {
      ...
      return _widgets["default"].button(this.groupList.controller.dom, "".concat(_iconBase["default"].iconBase, "noun_15177.svg"), 'A Web App (origin)', function (event) {
        ...
        var newApp = _this8.renderNameForm(_ns["default"].schema('WebApplication'), 'webapp domain').then(function (name) {
    ...
    value: function renderAppsView() {
      ...
      if (trustedApplications) {
        ...
        var cancelButton = _widgets["default"].cancelButton(this.groupList.controller.dom, function () {
    ...
    key: "renderAppsTable",
    value: function () {
      var _renderAppsTable = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(eventContext) {
        var _this10 = this;
        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                trustedApps = this.groupList.store.each(eventContext.me, _ns["default"].acl('trustedApp'));
                trustedOrigins = trustedApps.flatMap(function (app) {
                  return _this10.groupList.store.each(app, _ns["default"].acl('origin'));
                });
                ...
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  trustedApps.forEach(function (app) {
                    var origin = _this10.groupList.store.any(app, _ns["default"].acl('origin'));

                    if (!origin) {
                      reject(new Error("Unable to pick app: ".concat(app.value)));
                    }

                    var thingTR = _widgets["default"].personTR(_this10.groupList.controller.dom, _ns["default"].acl('origin'), origin, {});
                    ...
                    innerMiddleColumn.textContent = "Give access to ".concat(_this10.groupList.controller.noun, " ").concat(_utils["default"].label(_this10.groupList.controller.subject), "?");
                    var innerRightColumn = innerRow.appendChild(_this10.groupList.controller.dom.createElement('td'));
                    innerRightColumn.appendChild(_widgets["default"].continueButton(_this10.groupList.controller.dom, function () {
    ...
    key: "addPerson",
    value: function () {
      var _addPerson = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 5:
                ...
                console.log("Adding to ACL person: ".concat(name));
                _context2.next = 8;
    ...
    key: "addGroup",
    value: function () {
      var _addGroup = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    key: "addAgent",
    value: function () {
      var _addAgent = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee4(agentUri) {
    ...
    key: "addBot",
    value: function () {
      var _addBot = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function () {
      var _getOriginFromName = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
