    ...
    */
        ...
        var possibleTimes = kb.each(invitation, SCHED('option'))
         ...
         var displayTheMatrix = function() {
            var matrix = div.appendChild(UI.panes.utils.matrixForQuery(
        ...
        options.cellFunction = function(cell, x, y, value) {
            ...
            if (y.sameTerm(me)) {
                ...
                var selector = UI.panes.utils.makeSelectForOptions(dom, kb, cellSubject, predicate,
