    ...
    value: function findAddressBook(typeIndex) {
      return new Promise(function (resolve, reject) {
        kb.fetcher.nowOrWhenFetched(typeIndex, function (ok, err) {
          ...
          var bookRegistration = kb.any(null, _ns["default"].solid('forClass'), _ns["default"].vcard('AddressBook'));

          if (!bookRegistration) {
            return reject(new Error('no address book registered in the solid type index ' + typeIndex));
          }

          var book = kb.any(bookRegistration, _ns["default"].solid('instance'));
    ...
    value: function loadGroups() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        kb.fetcher.nowOrWhenFetched(groupIndex, function (ok, err) {
          ...
          var groups = kb.each(_this3.book, _ns["default"].vcard('includesGroup'));
...
var GroupBuilder = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(GroupBuilder, [{
    ...
    value: function render() {
      ...
      if (kb.any(this.group, _ns["default"].vcard('hasMember'))) {
        kb.match(this.group, _ns["default"].vcard('hasMember')).forEach(function (statement) {
    ...
    value: function add(webId) {
      ...
      return new Promise(function (resolve, reject) {
        kb.fetcher.nowOrWhenFetched(webId, function (ok, err) {
          ...
          var rdfClass = kb.any(webIdNode, _ns["default"].rdf('type'));
    ...
    value: function handleRemove(webIdNode) {
      ...
      return function (_event) {
        ...
        return patch(_this7.group.doc().uri, {
          ...
          var name = kb.any(webIdNode, _ns["default"].foaf('name'));
    ...
    value: function setGroupName(name) {
      ...
      var updatePromises = [this.group.doc(), groupIndex].map(function (namedGraph) {
        var oldNameStatements = kb.match(_this8.group, _ns["default"].vcard('fn'), null, namedGraph);
...
function indexes(book) {
  return {
    // bookIndex: book,
    groupIndex: kb.any(book, _ns["default"].vcard('groupIndex')),
