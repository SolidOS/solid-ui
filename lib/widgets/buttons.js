...
var iconBase = _iconBase.icons.iconBase,
    originalIconBase = _iconBase.icons.originalIconBase;
...
function deleteButtonWithCheck(dom, _container, // Used to interfere with style of this
noun, deleteFunction) {
  function setStyle() {
  ...
  deleteButtonElt.addEventListener('click', function (_event) {
    ...
    cancelButtonElt = dom.createElement('button'); // cancelButton.textContent = 'cancel'
    ...
    buttonDiv.appendChild(cancelButtonElt).addEventListener('click', function (_event) {
    ...
    buttonDiv.appendChild(sureButtonElt).addEventListener('click', function (_event) {
      buttonDiv.removeChild(sureButtonElt);
      buttonDiv.removeChild(cancelButtonElt);
      setStyle();
      deleteFunction();
