...
function _queryESCODataByName() {
  _queryESCODataByName = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(filter, theClass, queryTarget) {
    var queryURI, response, text, json;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            queryURI = queryTarget.searchByNameURI.replace('$(name)', filter).replace('$(limit)', '' + AUTOCOMPLETE_LIMIT).replace('$(targetClass)', theClass.toNT());
...
function _queryPublicDataByName() {
  _queryPublicDataByName = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(filter, theClass, languages, queryTarget) {
    var substituteStrings, languagePrefs, language, sparql, queryURI, response, text, json, bindings;
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            substituteStrings = function _substituteStrings(template) {
              var u1 = template.replace('$(name)', filter).replace('$(limit)', '' + AUTOCOMPLETE_LIMIT).replace('$(language)', language);
...
function _queryPublicDataSelect() {
  _queryPublicDataSelect = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(sparql, queryTarget) {
    var myUrlWithParams, queryURI, headers, options, response, text, json, bindings;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 11:
            ...
            text = response.responseText || 'wot no response text'; // debug.log('    Query result  text' + text.slice(0,100) + '...')
