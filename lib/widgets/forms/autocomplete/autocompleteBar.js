      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            cancelButton = widgets.cancelButton(dom); // @@ not in edit case only in temporary case cancelButtonHandler
            ...
            decoratedAutocomplete = undefined; // const { dom } = dataBrowserContext
