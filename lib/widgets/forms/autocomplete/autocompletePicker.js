          ...
          case 0:
            ...
            _refreshList = function _refreshList3() {
              _refreshList = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7() {
                var rowForBinding, languagePrefs, filter, slimmed, _iterator, _step, binding;
                  ...
                  while (1) {
                    switch (_context7.prev = _context7.next) {
                      ...
                      case 15:
                        ...
                        debug.log("   Querying database at \"$(filter}\" cf last \"".concat(lastFilter, "\"."));
                        _context7.next = 19;
                      ...
                      case 20:
                        ...
                        clearList();
                        _iterator = _createForOfIteratorHelper(slimmed);
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      case 0:
                        ...
                        } else {// (decoration.acceptButton as any).disabled = true
                        }
