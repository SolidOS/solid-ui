...
function logInLoadProfile(context) {
  ...
  return new Promise(function (resolve, reject) {
    return logIn(context).then(function (context) {
      ...
      _logic.solidLogicSingleton.loadDoc(profileDocument).then(function (_response) {
...
function logInLoadPreferences(context) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    return logInLoadProfile(context).then(function (context) {
      return _logic.solidLogicSingleton.loadPreferences(context.me).then(function (preferencesFile) {
        if (progressDisplay) {
      ...
      if (err instanceof _solidLogicMoveMe.UnauthorizedError) {
        m2 = 'Strange - you are not authenticated (properly logged in) to read preference file.';
        (0, _log.alert)(m2);
      } else if (err instanceof _solidLogicMoveMe.CrossOriginForbiddenError) {
        m2 = "Unauthorized: Assuming preference file blocked for origin ".concat(window.location.origin);
        context.preferencesFileError = m2;
        return resolve(context);
      } else if (err instanceof _solidLogicMoveMe.SameOriginForbiddenError) {
        m2 = 'You are not authorized to read your preference file. This may be because you are using an untrusted web app.';
        debug.warn(m2);
      } else if (err instanceof _solidLogicMoveMe.NotFoundError) {
        if (confirm("You do not currently have a preference file. OK for me to create an empty one? ".concat(err.preferencesFile))) {
          // @@@ code me  ... weird to have a name of the file but no file
          (0, _log.alert)("Sorry; I am not prepared to do this. Please create an empty file at ".concat(err.preferencesFile));
          return complain(new Error('Sorry; no code yet to create a preference file at '));
        } else {
          reject(new Error("User declined to create a preference file at ".concat(err.preferencesFile)));
        }
      } else if (err instanceof _solidLogicMoveMe.FetchError) {
        m2 = "Strange: Error ".concat(err.status, " trying to read your preference file.").concat(err.message);
        (0, _log.alert)(m2);
      } else {
    ...
    return _regenerator["default"].wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return loadIndex(context, true);

          case 2:
            _context2.next = 4;
            return loadIndex(context, false);
...
function _loadIndex() {
  _loadIndex = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(context, isPublic) {
    var me, ixs;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            ixs = _logic.solidLogicSingleton.getTypeIndex(me, context.publicProfile, isPublic);
          ...
          case 7:
            ...
            ixs = _logic.solidLogicSingleton.getTypeIndex(me, context.preferencesFile, isPublic);
          ...
          case 21:
            ...
            _widgets["default"].complain(context, "loadIndex: loading public type index ".concat(_context3.t0));
...
function ensureTypeIndexes(_x5) {
...
function _ensureTypeIndexes() {
  _ensureTypeIndexes = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(context) {
...
function ensureOneTypeIndex(_x6, _x7) {
...
function _ensureOneTypeIndex() {
  _ensureOneTypeIndex = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7(context, isPublic) {
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            _makeIndexIfNecessary = function _makeIndexIfNecessary3() {
              _makeIndexIfNecessary = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(context, isPublic) {
                    ...
                    switch (_context6.prev = _context6.next) {
                      case 0:
                        _putIndex = function _putIndex3() {
                          _putIndex = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(newIndex) {
                            var _msg;
                              ...
                              while (1) {
                                switch (_context5.prev = _context5.next) {
                                  ...
                                  case 6:
                                    ...
                                    _msg = "Error creating new index ".concat(_context5.t0);
                        ...
                        putIndex = function _putIndex2(_x19) {
                          return _putIndex.apply(this, arguments);
                        };
                      ...
                      case 18:
                        ...
                        msg = "Error saving type index link saving back ".concat(newIndex, ": ").concat(_context6.t0);
                      ...
                      case 35:
                        ...
                        _widgets["default"].complain(context, "ensureOneTypeIndex: loading indexes ".concat(_context6.t1));
                ...
                }, _callee6, null, [[13, 18], [30, 35]]);
              }));
              return _makeIndexIfNecessary.apply(this, arguments);
            };

            makeIndexIfNecessary = function _makeIndexIfNecessary2(_x17, _x18) {
              return _makeIndexIfNecessary.apply(this, arguments);
            };
...
function findAppInstances(_x8, _x9, _x10) {
...
function _findAppInstances() {
  _findAppInstances = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee8(context, theClass, isPublic) {
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          ...
          case 12:
            ...
            _widgets["default"].complain(context, "loadIndex: login and load problem ".concat(_context8.t0));
          ...
          case 23:
            ...
            registrations = thisIndex.map(function (ix) {
              return _logic.solidLogicSingleton.store.each(undefined, _ns["default"].solid('forClass'), theClass, ix);
            }).flat();
            instances = registrations.map(function (reg) {
              return _logic.solidLogicSingleton.store.each(reg, _ns["default"].solid('instance'));
            }).flat();
            containers = registrations.map(function (reg) {
              return _logic.solidLogicSingleton.store.each(reg, _ns["default"].solid('instanceContainer'));
            }).flat();
          ...
          case 39:
            ...
            e = new Error("[FAI] Unable to load containers".concat(_context8.t2));
            debug.log(e); // complain

            _widgets["default"].complain(context, "Error looking for ".concat(_utils["default"].label(theClass), ":  ").concat(_context8.t2)); // but then ignore it
            // throw new Error(e)
          ...
          case 44:
            for (i = 0; i < containers.length; i++) {
              cont = containers[i];
              context.instances = context.instances.concat(_logic.solidLogicSingleton.getContainerElements(cont));
            }
    ...
    }, _callee8, null, [[7, 12], [16, 21], [34, 39]]);
  }));
  return _findAppInstances.apply(this, arguments);
}

function registerInTypeIndex(_x11, _x12, _x13, _x14) {
...
function _registerInTypeIndex() {
  _registerInTypeIndex = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(context, instance, theClass, isPublic) {
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 15:
            ...
            debug.log(_context9.t0);
            (0, _log.alert)(_context9.t0);
...
function registrationControl(context, instance, theClass) {
  ...
  return ensureTypeIndexes(context).then(function () {
    ...
    var form = (0, _rdflib.bnode)(); // @@ say for now
    ...
    if (context.index && context.index["public"] && context.index["public"].length > 0) {
      ...
      tbody.children[0].appendChild(_widgets["default"].buildChecsolidLogicSingleton.storeoxForm(context.dom, _logic.solidLogicSingleton.store, "Public link to this ".concat(context.noun), null, statements, form, index));
    }

    if (context.index && context.index["private"] && context.index["private"].length > 0) {
      index = context.index["private"][0];
      statements = registrationStatements(index);
      tbody.children[1].appendChild(_widgets["default"].buildChecsolidLogicSingleton.storeoxForm(context.dom, _logic.solidLogicSingleton.store, "Personal note of this ".concat(context.noun), null, statements, form, index));
    }
  ...
  return ensureTypeIndexes(context).then(function (_indexes) {
    ...
    vs.forEach(function (visibility) {
      if (context.index && options[visibility]) {
        ...
        sts = sts.concat(_logic.solidLogicSingleton.store.statementsMatching(undefined, _ns["default"].solid('instance'), undefined, context.index[visibility][0]));
      }
    });
    ...
    var _loop = function _loop(i) {
      ...
      if (options.type) {
        ...
        if (!_logic.solidLogicSingleton.store.holds(statement.subject, _ns["default"].solid('forClass'), options.type, statement.why)) {
...
function setACLUserPublic(docURI, me, options) {
  var aclDoc = _logic.solidLogicSingleton.store.any(_logic.solidLogicSingleton.store.sym(docURI), _logic.solidLogicSingleton.store.sym(_solidLogic.ACL_LINK));
...
function loginStatusBox(dom) {
  ...
  function logoutButton(me, options) {
    ...
    if (me) {
      var nick = _logic.solidLogicSingleton.store.any(me, _ns["default"].foaf('nick')) || _logic.solidLogicSingleton.store.any(me, _ns["default"].foaf('name'));
...
function selectWorkspace(dom, appDetails, callbackWS) {
  ...
  function figureOutBase(ws) {
    var newBase = _logic.solidLogicSingleton.store.any(ws, _ns["default"].space('uriPrefix'));
  ...
  function displayOptions(context) {
    function makeNewWorkspace(_x15) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return _widgets["default"].askName(dom, _logic.solidLogicSingleton.store, cell, _ns["default"].solid('URL'), _ns["default"].space('Workspace'), 'Workspace');
    ...
    var w = _logic.solidLogicSingleton.store.each(id, _ns["default"].space('workspace'), undefined, preferencesFile); // Only trust preference file here
    // A workspace in a storage in the public profile:


    var storages = _logic.solidLogicSingleton.store.each(id, _ns["default"].space('storage')); // @@ No provenance requirement at the moment


    if (w.length === 0 && storages) {
      say("You don't seem to have any workspaces. You have ".concat(storages.length, " storage spaces."));
      storages.map(function (s) {
        w = w.concat(_logic.solidLogicSingleton.store.each(s, _ns["default"].ldp('contains')));
    ...
    w = w.filter(function (x) {
      return !_logic.solidLogicSingleton.store.holds(x, _ns["default"].rdf('type'), // Ignore master workspaces
    ...
    for (var i = 0; i < w.length; i++) {
      ...
      style = _logic.solidLogicSingleton.store.anyValue(ws, _ns["default"].ui('style'));
      ...
      var label = _logic.solidLogicSingleton.store.any(ws, _ns["default"].rdfs('label'));
      ...
      comment = _logic.solidLogicSingleton.store.any(ws, _ns["default"].rdfs('comment'));
    ...
    return _regenerator["default"].wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 3:
            _yield$logInLoadPrefe = _context10.sent;
          ...
          case 9:
            return _context10.abrupt("return", _logic.solidLogicSingleton.store.each(me, _ns["default"].rdf('type'), null, preferencesFile.doc()));
...
function filterAvailablePanes(_x16) {
