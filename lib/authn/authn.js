...
function _findAppInstances() {
  ...
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee10(context, theClass, isPublic) {
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 31:
            ...
            _widgets["default"].complain(context, "Error looking for ".concat(_utils["default"].label(theClass), ":  ").concat(_context10.t1)); // but then ignore it
            // throw new Error(e)
...
function _registerInTypeIndex() {
  ...
  /*#__PURE__*/
  _regenerator["default"].mark(function _callee11(context, instance, theClass, isPublic) {
      ...
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 7:
            ...
            $rdf.st(registration, _ns["default"].rdf('type'), _ns["default"].solid('TypeRegistration'), index), $rdf.st(registration, _ns["default"].solid('forClass'), theClass, index), $rdf.st(registration, _ns["default"].solid('instance'), instance, index)];
            _context11.prev = 10;
            _context11.next = 13;
          ...
          case 15:
            ...
            debug.log(_context11.t0);
            (0, _log.alert)(_context11.t0);
...
function registrationControl(context, instance, theClass) {
  ...
  return ensureTypeIndexes(context).then(function () {
    ...
    var registrationStatements = function registrationStatements(index) {
      ...
      return [$rdf.st(reg, _ns["default"].solid('instance'), instance, index), $rdf.st(reg, _ns["default"].solid('forClass'), theClass, index)];
    };
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          ...
          case 12:
            ...
            debug.warn('Unable to fetch your preferences - this was the error: ', _context12.t0);
