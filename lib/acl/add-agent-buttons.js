        ...
        return _regenerator["default"].wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                trustedApps = this.groupList.store.each(eventContext.me, _ns["default"].acl('trustedApp')); // @@ TODO fix as
                ...
                return _context.abrupt("return", new Promise(function (resolve, reject) {
                  ...
                  trustedApps.forEach(function (app) {
                    var origin = _this10.groupList.store.any(app, _ns["default"].acl('origin')); // @@ TODO fix as
