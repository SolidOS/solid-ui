...
function () {
  ...
  (0, _createClass2["default"])(AccessGroups, [{
    ...
    key: "deleteAgent",
    value: function () {
      var _deleteAgent = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee(combo, pred, obj) {
    ...
    key: "addNewURI",
    value: function () {
      var _addNewURI = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
    ...
    value: function () {
      var _handleDroppedUris = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee3(uris, combo) {
        var _this5 = this;
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regenerator["default"].mark(function _callee4(uri, combo) {
        var secondAttempt,
            agent,
            thing,
            message,
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                console.log("   Not obvious: looking up dropped thing ".concat(thing));
                _context4.prev = 5;
                _context4.next = 8;
                return this.store.fetcher.load(thing.doc());
    ...
    value: function setACLCombo(combo, uri, res, subject) {
      ...
      console.log("ACL: setting access to ".concat(subject, " by ").concat(res.pred, ": ").concat(res.obj));
    }
  }, {
