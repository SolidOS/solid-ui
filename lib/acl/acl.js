...
function adoptACLDefault(doc, aclDoc, defaultResource, defaultACLDoc) {
  ...
  var proposed = defaults.reduce(function (accumulatedStatements, da) {
    return accumulatedStatements.concat(_store["default"].statementsMatching(da, _ns["default"].rdf('type'), ACL('Authorization'), defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('agent'), undefined, defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('agentClass'), undefined, defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('agentGroup'), undefined, defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('origin'), undefined, defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('originClass'), undefined, defaultACLDoc)).concat(_store["default"].statementsMatching(da, ACL('mode'), undefined, defaultACLDoc)).concat((0, _rdflib.st)(da, ACL('accessTo'), doc, defaultACLDoc)).concat(isContainer ? (0, _rdflib.st)(da, ACL('default'), doc, defaultACLDoc) : []);
  }, []);
...
function readACL(doc, aclDoc) {
  ...
  var auths = getDefaults ? getDefaultsFallback(kb2, _ns["default"]) : kb2.each(undefined, _ns["default"].acl('accessTo'), doc);
  var ACL = _ns["default"].acl;
  var ac = {
    agent: {},
    agentClass: {},
...
function setACL(docURI, aclText, callbackFunction) {
  var aclDoc = _store["default"].any(_store["default"].sym(docURI), _store["default"].sym(_solidLogic.ACL_LINK)); // @@ check that this get set by web.js
...
function getACL(doc, callbackFunction) {
  _store["default"].fetcher.nowOrWhenFetched(doc, undefined, function (ok, body) {
    ...
    var aclDoc = _store["default"].any(doc, _store["default"].sym(_solidLogic.ACL_LINK)); // @@ check that this get set by web.js
