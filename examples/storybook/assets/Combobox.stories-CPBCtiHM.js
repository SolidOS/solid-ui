import{i as e}from"./preload-helper-BdFrVu1K.js";import{H as t,Kt as n,U as r,V as i,Yt as a}from"./iframe-CMAmzkTh.js";var o,s,c,l,u,d;e((()=>{n(),r(),i(),o=t(async e=>{let{data:t}=await(await fetch(`https://beta.pokeapi.co/graphql/v1beta`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({query:`
