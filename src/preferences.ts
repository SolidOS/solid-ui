...
export class Preferences {
  ...
  recordSharedPreferences (subject, context) {
  ...
  //
  recordPersonalDefaults (theClass, context) {
    return new Promise(function (resolve, reject) {
  ...
  renderPreferencesForm (subject, theClass, preferencesForm, context) {
    ...
    participationObject(subject, subject.doc(), context.me).then(
      participation => {
        ...
        this.recordSharedPreferences(subject, context).then(context => {
          ...
          this.recordPersonalDefaults(theClass, context).then(
            context => {
              widgets.appendForm(
                dom,
                prefContainer,
  ...
  getPreferencesForClass (subject, theClass, predicates, context: any) {
      ...
      this.recordSharedPreferences(subject, context).then(context => {
        ...
        if ((context as any).me) {
          participationObject(subject, subject.doc(), (context as any).me)
            .then(participation => {
              this.recordPersonalDefaults(theClass, context).then(context => {
                const results: any = []
