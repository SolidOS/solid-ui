...
/* harmony import */ var _shared_listboxTemplate__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(3337);
/* harmony import */ var _shared_listboxStyles__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6457);
/* harmony import */ var _shared_keyboard__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9757);
...
class Select extends lit__WEBPACK_IMPORTED_MODULE_0__/* .LitElement */ .WF {
  ...
  static styles = [_shared_listboxStyles__WEBPACK_IMPORTED_MODULE_4__/* .listboxStyles */ .S, (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .css */ .AH)`
      :host {
        /* default theme */
        display: block;
        width: 100%;
  ...
  _getSelectedIndex() {
    return (0,_shared_keyboard__WEBPACK_IMPORTED_MODULE_5__/* .findOptionIndexByValue */ .Dh)(this.options, this.value);
  }
  _getSelectedOption() {
    ...
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .html */ .qy)`
      <div class="popup-box" part="popup-box" style="pointer-events: auto; max-height: inherit; overflow: auto;">
        <div class="select-options-section">
          ${(0,_shared_listboxTemplate__WEBPACK_IMPORTED_MODULE_3__/* .renderListbox */ .M)({
      selectedOption,
      activeOption,
        ...
        >
          ...
          <span class="select-trigger-toggle" part="trigger-toggle">
            <span class="select-trigger-icon" part="trigger-icon" aria-hidden="true"
              >${_shared_downArrow__WEBPACK_IMPORTED_MODULE_2__/* .downArrowIcon */ .n}</span
            >
          </span>
        </button>
      </div>
...
/* harmony export */ });
/* harmony import */ var _Select__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6451);
...
const __webpack_exports__Select = __webpack_exports__.l;
export { __webpack_exports__Select as Select };
