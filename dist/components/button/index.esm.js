...
class Button extends lit__WEBPACK_IMPORTED_MODULE_0__/* .LitElement */ .WF {
  static properties = {
    label: {
      type: String,
      reflect: true
  ...
  _renderIcon() {
    ...
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .html */ .qy)`
      <span class="button__icon" part="icon">
        ...
        ${!this._hasSlottedIcon && this.icon ? (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .html */ .qy)`<img class="button__icon-image" src=${this.icon} alt="" aria-hidden="true" />` : lit__WEBPACK_IMPORTED_MODULE_0__/* .nothing */ .s6}
      </span>
    `;
  }
  render() {
    return (0,lit__WEBPACK_IMPORTED_MODULE_0__/* .html */ .qy)`
      <button
        ...
        aria-label=${this.ariaLabel || lit__WEBPACK_IMPORTED_MODULE_0__/* .nothing */ .s6}
        name=${this.name || lit__WEBPACK_IMPORTED_MODULE_0__/* .nothing */ .s6}
        value=${this.value || lit__WEBPACK_IMPORTED_MODULE_0__/* .nothing */ .s6}
        part="button"
...
/* harmony export */ });
/* harmony import */ var _Button__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8415);
...
const __webpack_exports__Button = __webpack_exports__.$;
