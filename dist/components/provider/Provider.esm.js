import { authContext as e } from "../../lib/auth/context.esm.js";
...
import r from "../../lib/auth/SolidAuth.esm.js";
...
u = [t("solid-ui-provider")];
var E, D = /*#__PURE__*/ new WeakMap(), O = /*#__PURE__*/ new WeakMap();
h = (d = o({
	type: String,
	reflect: !0
}), p = i({ context: e }), "signupUrl"), s = class extends n {
	constructor(...e) {
		super(...e), g(this, D, (c(this), f(this))), g(this, O, m(this, new r()));
	}
	get [h]() {
		return y(D, this);
	}
