import e from "./styleConstants.esm.js";
//#region src/lib/style.js
var t = {
	...
	formGroupStyle: [
		`padding-left: 0em; border: 0.0em solid ${e.formBorderColor}; border-radius: 0.2em;`,
		`padding-left: 2em; border: 0.05em solid ${e.formBorderColor}; border-radius: 0.2em;`,
		`padding-left: 2em; border: 0.1em solid ${e.formBorderColor}; border-radius: 0.2em;`,
		`padding-left: 2em; border: 0.2em solid ${e.formBorderColor}; border-radius: 0.2em;`
	],
	formFieldLabelStyle: `color: ${e.lowProfileLinkColor}; text-decoration: none;`,
	formFieldNameBoxStyle: `padding: 0.3em; vertical-align: middle; width:${e.formFieldNameBoxWidth};`,
	...
	controlStyle: `border-radius: 0.5em; margin: 0.8em; width:${e.mediaModuleCanvasWidth}; height:${e.mediaModuleCanvasHeight};`,
