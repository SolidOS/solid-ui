...
import { log_exports as t } from "./log.esm.js";
import { label as n } from "../utils/label.esm.js";
import { getTarget as r, utils_exports as i } from "../utils/index.esm.js";
import { log as a } from "./debug.esm.js";
import { icons as o } from "./iconBase.esm.js";
import { widgets_exports as s } from "../widgets/index.esm.js";
...
function d(e, t) {
	let i = t.sourceDocument, o = t.tableClass, s = t.query, d = u.ns, f = l, p = {}, ee = {
	...
	}, h = t.keyVariable || "?_row", g = 0, _, v, y, b, x = null, S = null, C = e.createElement("div");
	C.className = "tableViewPane", C.appendChild(re());
	let w = e.createElement("div");
	C.appendChild(w), C.refresh = function() {
		Z(T.query, T.logicalRows, T.columns, T);
	};
	let T;
	if (s) T = $(s), w.appendChild(T);
	else {
		let e = I();
		_ = e[0], v = e[1], o || y.appendChild(le(_, v)), S = Ce(v), E(S || _);
	}
	return C;
	function re() {
		...
		return y = e.createElement("td"), n.appendChild(y), b = e.createElement("td"), n.appendChild(b), t.appendChild(n), t;
	}
	function ie(e, t) {
		let n = t.getColumns();
		for (let t = 0; t < n.length; ++t) {
			let r = f.variable("_col" + t);
			e.vars.push(r), n[t].setVariable(r);
		}
	}
	function ae(e, t, n) {
		let r = n.type;
		r ||= f.variable("_any"), e.pat.add(t, u.ns.rdf("type"), r);
	}
	function oe(e, t, n) {
		let r = n.getColumns();
		for (let n = 0; n < r.length; ++n) {
			let i = r[n], a = f.formula();
			a.add(t, i.predicate, i.getVariable()), e.pat.optional.push(a);
		}
	}
	function se(e) {
		let t = new c.Query(), n = f.variable(h.slice(1));
		return ie(t, e), ae(t, n, e), oe(t, n, e), t;
	}
	function E(e) {
		D(b), b.appendChild(de(e)), ce(se(e), e);
	}
	function ce(e, t) {
		x && (x.running = !1);
		let n = $(e, t);
		D(w), w.appendChild(n), x = e;
	}
	function D(e) {
	...
	function k() {
		this.useCount = 0, this.checkedAnyValues = !1, this.possiblyLiteral = !0, this.possiblyNumber = !0, this.constraints = [], this.checkValue = function(e) {
			...
			return this.getHints().label ? this.getHints().label : this.predicate ? this.predicate.sameTerm(d.rdf("type")) && this.superClass ? n(this.superClass, !0) : n(this.predicate) : this.variable ? this.variable.toString() : "unlabeled column?";
		}, this.setPredicate = function(e, t, n) {
			t ? (this.inverse = e, this.constraints = this.constraints.concat(f.each(e, u.ns.rdfs("domain"))), e.sameTerm(d.rdfs("subClassOf")) && n.termType === "NamedNode" && (this.superClass = n, this.alternatives = f.each(void 0, d.rdfs("subClassOf"), n))) : (this.predicate = e, this.constraints = this.constraints.concat(f.each(e, u.ns.rdfs("range"))));
			...
			for (let e = 0; e < this.constraints.length; e++) if (this.constraints[e].uri in ne) return !0;
			return !1;
		};
	}
	function A(e, t) {
	...
	function le(t, n) {
		...
		i.appendChild(j("All types", "null"));
		for (let e in n) i.appendChild(j(n[e].getLabel(), e));
		return i.addEventListener("click", function() {
			let e;
			e = i.value === "null" ? t : n[i.value], ue(e);
		}, !1), r.appendChild(i), r;
	}
	function ue(e) {
		E(e);
	...
	function pe(e, t) {
		let n;
		return t.uri in e ? n = e[t.uri] : (n = new k(), n.setPredicate(t), e[t.uri] = n), n;
	}
	function M(e, t) {
		let n;
		return t.uri in e ? n = e[t.uri] : (n = new O(t), e[t.uri] = n), n;
	}
	function N() {
		let e = {}, t = f.statementsMatching(void 0, u.ns.rdf("type"), o, i), n = {};
		for (let r = 0; r < t.length; ++r) {
			let i = t[r].object;
			if (i.termType !== "NamedNode") continue;
			let a = M(e, i);
			i.uri in n || (n[i.uri] = []), n[i.uri].push(t[r].subject), a.addUse();
		}
		return [n, e];
	}
	function P(e, t) {
		let n = f.statementsMatching(e, void 0, void 0, i), r = {};
		for (let e = 0; e < n.length; ++e) {
			let i = n[e].predicate;
			if (i.uri in ee) continue;
			let a = pe(t, i);
			a.checkValue(n[e].object), r[i.uri] = a;
		}
		return r;
	}
	function F(e, t) {
	...
	function z(t, n) {
		...
		for (let i = 0; i < t.length; ++i) {
			...
			a.appendChild(e.createTextNode(o.getLabel())), n && a.appendChild(R(n, o)), r.appendChild(a);
		}
		return r;
	}
	function me(e, t, n, r) {
	...
	function U(t, r, i) {
		let a = e.createElement("div"), o = e.createElement("input");
		o.setAttribute("type", "text"), o.style.width = "70%", a.appendChild(o);
		let s = e.createElement("span");
		s.appendChild(e.createTextNode("▼")), s.addEventListener("click", function() {
			H(t, i, !1);
		}, !1), a.appendChild(s);
		let c = e.createElement("span");
		c.appendChild(e.createTextNode("▲")), c.addEventListener("click", function() {
			H(t, i, !0);
		}, !1), a.appendChild(c);
		let l = null;
		return i.filterFunction = function(e) {
			if (!l) return !0;
			if (e) {
				let t;
	...
	function W(t, r, i, a) {
		let o = e.createElement("div"), s = e.createElement("select"), c = {};
		for (let e = 0; e < a.length; ++e) {
			let t = a[e];
			c[t.uri] = !0;
		}
		let l = q(i).initialSelection;
		l && (c = l), s.setAttribute("multiple", "true");
		for (let e = 0; e < a.length; ++e) {
			let t = a[e], r = j(n(t), e);
			c[t.uri] && (r.selected = !0), s.appendChild(r);
		}
		return o.appendChild(s), i.filterFunction = function(e) {
			return !c || e && c[e.uri];
	...
	function G(t, n, r) {
		...
		function l() {
			s = a.value === "" ? null : Number(a.value), c = o.value === "" ? null : Number(o.value), V(t, n);
		}
		return a.addEventListener("keyup", l, !1), o.addEventListener("keyup", l, !1), i;
	}
	function he(e, t, n) {
		return n.checkedAnyValues && n.possiblyNumber ? G(e, t, n) : n.possiblyLiteral ? U(e, t, n) : null;
	}
	function ge(e, t, n) {
		if (n.superClass && n.alternatives.length > 0) return W(e, t, n, n.alternatives);
		let r = n.getConstraints(), i;
		for (let a = 0; a < r.length; a++) {
			if (i = r[a], n.checkedAnyValues && n.possiblyNumber || i.uri in m) return G(e, t, n);
			if (i.uri === "http://www.w3.org/2000/01/rdf-schema#Literal") return U(e, t, n);
			let o = f.each(i, u.ns.owl("oneOf"));
			if (o.length > 0) return W(e, t, n, o.elements);
		}
		return he(e, t, n);
	}
	function _e(t, n) {
		...
		for (let i = 0; i < n.length; ++i) {
			let a = e.createElement("td"), o = ge(t, n, n[i]);
	...
	function K(t, n, i) {
		i ||= {};
		let o = e.createElement("a"), s = i.linkFunction;
		return o.setAttribute("href", t), o.appendChild(e.createTextNode(n)), s ? o.addEventListener("click", function(e) {
			e.preventDefault(), e.stopPropagation();
			let t = r(e).getAttribute("href");
			t || a("No href found \n"), s(t);
		}, !0) : o.addEventListener("click", u.widgets.openHrefInOutlineMode, !0), o;
	}
	function ve(e, t) {
		let r = !1;
		return e.uri && (r = e.uri.match(/^mailto:(.*)/)), r ? K(e.uri, r[1], t) : K(e.uri, n(e), t);
	}
	function ye(t) {
	...
	function J(t, n) {
		...
		if (i) switch (i) {
			...
			if (t.datatype) {
				if (te[t.datatype.uri]) return e.createTextNode(u.widgets.shortDate(t.value));
				if (m[t.datatype.uri]) {
		...
		} else if (t.termType === "NamedNode" && n.isImageColumn()) return ye(t);
		else if (t.termType === "NamedNode" || t.termType === "BlankNode") return ve(t, r);
			...
			return r.appendChild(e.createTextNode("[")), t.elements.forEach(function(t) {
				r.appendChild(J(t, n)), r.appendChild(e.createTextNode(", "));
	...
	function be(t, n, r, i) {
		...
		n._subject && "uri" in n._subject && a.appendChild(K(n._subject.uri, "→")), t.appendChild(a);
		for (let i = 0; i < r.length; ++i) {
			...
			if (c in n.values) {
				...
				for (let i = 0; i < t.length; ++i) {
					let l = t[i];
					n.originalValues && n.originalValues[c] && n.originalValues[c].length > i && (s = n.originalValues[c][i], l.toString() !== s.toString() && (r = !0)), o.appendChild(J(l, a)), i !== t.length - 1 && o.appendChild(e.createTextNode(",\n")), r && (o.style.background = "#efe");
				}
			}
			t.appendChild(o);
		}
	...
	function xe(e, t, n) {
		...
		for (r in n) {
			let t = n[r];
			r in e.values || (e.values[r] = []), Y(t, e.values[r]) || (e.values[r].push(t), i = !0);
		}
		i && (D(e._htmlRow), be(e._htmlRow, e, t)), B(e, t);
	}
	function X(e) {
		...
		{
			let t = "" + g;
			return e._subject_id = t, ++g, t;
		}
	}
	function Z(n, r, i, o) {
		n.running = !0;
		let s = Date.now(), c = e.createElement("tr");
		o.appendChild(c), c.textContent = "Loading ...";
		for (let e = 0; e < r.length; e++) r[e].original = !0, r[e].originalValues || (r[e].originalValues = r[e].values), r[e].values = {};
		f.query(n, function(t) {
			if (!n.running) return;
			c.textContent += ".";
			let a = null, s = null, l;
			if (h in t && (s = t[h], l = X(s), l in p && (a = p[l])), !a) {
			...
			delete a.original, xe(a, i, t);
		}, void 0, function() {
			c && c.parentNode && c.parentNode.removeChild && (c.parentNode.removeChild(c), c = null);
			let e = Date.now() - s;
			a("Query done: " + r.length + " rows, " + e + "ms");
			for (let e = r.length - 1; e >= 0; e--) if (r[e].original) {
				a("   deleting row " + r[e]._subject);
				let t = r[e]._htmlRow;
				t.parentNode.removeChild(t), delete p[X(r[e]._subject)], r.splice(e, 1);
			}
			t.sortBy && H(r, fe(i, t.sortBy), t.sortReverse), t.onDone && t.onDone(C);
		});
	}
	function Q(e, t) {
		u.log.debug(">> processing formula");
		...
		for (let n = 0; n < t.optional.length; ++n) u.log.debug("recurse to optional subformula " + n), Q(e, t.optional[n]);
		u.log.debug("<< finished processing formula");
	}
	function Se(e) {
		let t = [], n = {};
		for (let r = 0; r < e.vars.length; ++r) {
			let i = new k(), a = e.vars[r];
			u.log.debug("column " + r + " : " + a), i.setVariable(a), n[a] = i, t.push(i);
		}
		return Q(n, e.pat), t;
	}
	function $(t, n) {
		let r;
		r = s ? Se(t) : n.getColumns();
		let i = [], a = e.createElement("table");
		return a.appendChild(z(r, n)), a.appendChild(_e(i, r)), a.logicalRows = i, a.columns = r, a.query = t, Z(t, i, r, a), a;
	}
	function Ce(e) {
		let t = -1, n = null, r;
		for (r in e) {
...
//#endregion
export { d as renderTableViewPane };
