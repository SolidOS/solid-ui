import { c as e, g as t, i as n, o as r, u as i } from "./components-DrP7BOrs.js";
//#region src/components/combobox-option/ComboboxOption.ts
var a, o, s, c, l, u, d;
function f(e, t, n) {
	p(e, t), t.set(e, n);
}
...
c = [t("solid-ui-combobox-option")];
var S, C = /*#__PURE__*/ new WeakMap();
d = (l = n({
	type: String,
	reflect: !0
}), "value"), a = class extends r {
	constructor(...e) {
		super(...e), f(this, C, (o(this), u(this, "")));
	}
	get [d]() {
		return h(C, this);
	}
...
//#endregion
//#region src/components/combobox-option/index.ts
var w = S;
//#endregion
export { S as n, w as t };

//# sourceMappingURL=combobox-option-B-twy1Zn.js.map