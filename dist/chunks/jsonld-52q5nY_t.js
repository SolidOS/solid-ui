...
var t = /* @__PURE__ */ e(((e, t) => {
	...
	t.exports = S, S.process = async ({ activeCtx: e, localCtx: t, options: n, propagate: s = !0, overrideProtected: d = !1, cycles: p = /* @__PURE__ */ new Set() }) => {
		...
		for (let i of y) {
			...
			if (b.processingMode = b.processingMode || e.processingMode, "@base" in s) {
				let e = s["@base"];
				if (!(e === null || c(e))) if (l(e)) e = u(b["@base"], e);
	...
	t.exports = C, C.fromRDF = async (e, t) => {
		...
		for (let n of e) {
			...
			let y = w(l, s, d, t);
			if (o(u, c, y, { propertyIsArray: !0 }), v) if (h === g) {
				let e = r[h];
	...
	function w(e, t, r, o) {
		...
		if (e.language) e.language.match(a) || o.eventHandler && s({
			...
			if (t) if (c === y) l["@value"] === "true" || l["@value"] === "1" ? l["@value"] = !0 : l["@value"] === "false" || l["@value"] === "0" ? l["@value"] = !1 : l["@type"] = c;
			else if (c === x) if (i.isNumeric(l["@value"])) {
		...
		if (o(p) || (e = await b({
			...
			for (let o of w) {
				...
				for (let t of h) {
					...
					if (y) if (r(x) || (x = [x]), !g.includes("@list")) x = { [k.compactIri({
						activeCtx: e,
						iri: "@list",
						relativeTo: { vocab: !0 }
					...
					if (_) if (g.includes("@graph") && (g.includes("@id") || g.includes("@index") && u(t))) {
						let r;
...
//# sourceMappingURL=jsonld-52q5nY_t.js.map