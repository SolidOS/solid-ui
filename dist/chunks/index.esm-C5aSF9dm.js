...
function I(e) {
	return se(e) && e.termType === "Collection";
}
function L(e) {
...
function z(e) {
	return se(e) && (e.termType === "NamedNode" || e.termType === "BlankNode" || e.termType === "Variable");
}
function oe(e) {
	return se(e) && e.termType === "Variable";
}
function se(e) {
...
function ce(e) {
	return se(e) && e.termType === "NamedNode";
}
function le(e) {
	return se(e) && "termType" in e && e.termType === "BlankNode";
}
function ue(e) {
	return se(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode");
}
function H(e) {
	return se(e) && (e.termType === "NamedNode" || e.termType === "Variable");
}
function de(e) {
	return se(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode" || e.termType === "Literal");
}
function fe(e) {
	return se(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode" || e.termType === "DefaultGraph");
}
//#endregion
...
var U = class e extends v {
	...
	static fromValue(t) {
		return t == null || se(t) ? t : new e(t);
	}
}, pe = {
	boolean: new U("http://www.w3.org/2001/XMLSchema#boolean"),
	dateTime: new U("http://www.w3.org/2001/XMLSchema#dateTime"),
	decimal: new U("http://www.w3.org/2001/XMLSchema#decimal"),
	double: new U("http://www.w3.org/2001/XMLSchema#double"),
	integer: new U("http://www.w3.org/2001/XMLSchema#integer"),
	langString: new U("http://www.w3.org/1999/02/22-rdf-syntax-ns#langString"),
	string: new U("http://www.w3.org/2001/XMLSchema#string")
}, me = class e extends v {
	constructor(e, t, n) {
		super(e), g(this, "termType", x), g(this, "classOrder", _.Literal), g(this, "datatype", pe.string), g(this, "isVar", 0), g(this, "language", ""), t ? (this.language = t, this.datatype = pe.langString) : this.datatype = n ? U.fromValue(n) : pe.string;
	}
	copy() {
	...
	static toNT(e) {
		...
		var t = e.value;
		return t = t.replace(/\\/g, "\\\\"), t = t.replace(/\"/g, "\\\""), t = t.replace(/\n/g, "\\n"), t = t.replace(/\r/g, "\\r"), t = "\"" + t + "\"", e.language ? t += "@" + e.language : e.datatype.equals(pe.string) || (t += "^^" + e.datatype.toCanonical()), t;
	}
	toString() {
		return "" + this.value;
	}
	static fromBoolean(t) {
		return new e(t ? "1" : "0", null, pe.boolean);
	}
	static fromDate(t) {
		...
		return new e(r, null, pe.dateTime);
	}
	static fromNumber(t) {
		if (typeof t != "number") throw TypeError("Invalid argument to Literal.fromNumber()");
		let n, r = t.toString();
		return n = r.indexOf("e") < 0 && Math.abs(t) <= 2 ** 53 - 1 ? Number.isInteger(t) ? pe.integer : pe.decimal : pe.double, new e(r, null, n);
	}
	static fromValue(t) {
		if (B(t)) return t;
		switch (typeof t) {
...
function he(e) {
	return e == null || se(e) ? e : Array.isArray(e) ? new ge(e) : me.fromValue(e);
}
var ge = class e extends v {
	constructor(e) {
...
}, ve = "chrome:theSession";
new U(ve);
//#endregion
//#region node_modules/rdflib/esm/default-graph.js
var ye = class extends v {
	constructor() {
		super(""), g(this, "value", ""), g(this, "termType", C), g(this, "uri", ve);
	}
	toCanonical() {
		return this.value;
	}
...
var xe = new ye(), Se = class e {
	constructor(e, t, n, r) {
		g(this, "subject", void 0), g(this, "predicate", void 0), g(this, "object", void 0), g(this, "graph", void 0), this.subject = v.fromValue(e), this.predicate = v.fromValue(t), this.object = v.fromValue(n), this.graph = r == null ? xe : v.fromValue(r);
	}
	get why() {
		return this.graph;
	}
	...
	substitute(t) {
		return new e(this.subject.substitute(t), this.predicate.substitute(t), this.object.substitute(t), be(this.graph) ? this.graph : this.graph.substitute(t));
	}
	toCanonical() {
		let e = [
...
function Oe(e, t) {
	...
	if (n < 0) return we("Invalid base: " + t + " in join with given: " + e), e;
...
var je = class e extends v {
	constructor(e = "") {
		super(e), g(this, "termType", S), g(this, "base", "varid:"), g(this, "classOrder", _.Variable), g(this, "isVar", 1), g(this, "uri", void 0), this.base = "varid:", this.uri = Oe(e, this.base);
	}
	equals(e) {
		return e ? this.termType === e.termType && this.value === e.value : !1;
	}
	...
	defaultGraph: () => Ne,
	equals(e, t) {
		return e === t || !e || !t ? !0 : V(e) || V(t) ? V(e) && V(t) ? this.equals(e.subject, t.subject) && this.equals(e.predicate, t.predicate) && this.equals(e.object, t.object) && this.equals(e.graph, t.graph) : !1 : se(e) && se(t) ? this.id(e) === this.id(t) : !1;
	},
	id(e) {
		if (!e) return "undefined";
		if (V(e)) return this.quadToNQ(e);
		switch (e.termType) {
			case C: return "defaultGraph";
			case w: return ge.toNT(e);
			case S: return je.toString(e);
			default:
	...
	literal(e, t) {
		if (typeof e != "string" && !t) return me.fromValue(e);
		let n = typeof e == "string" ? e : "" + e;
		return typeof t == "string" ? t.indexOf(":") === -1 ? new me(n, t) : new me(n, null, this.namedNode(t)) : new me(n, null, t);
	},
	namedNode(e) {
		return new U(e);
	},
	quad(e, t, n, r) {
		return new Se(e, t, n, r || Ne);
	},
	triple(e, t, n, r) {
...
var Ie = /* @__PURE__ */ s(((e, t) => {
	(function(e, n) {
		...
		function n(e, n) {
			...
			var r = {}, i = { turtleDoc: er }, a = er, o = function(e) {
				...
				return $.addBase(e), {};
			}, T = /^[Bb]/, E = X(["B", "b"], !1, !1), D = /^[Aa]/, O = X(["A", "a"], !1, !1), ee = /^[Ss]/, te = X(["S", "s"], !1, !1), k = /^[Ee]/, A = X(["E", "e"], !1, !1), ne = /^[Pp]/, re = X(["P", "p"], !1, !1), j = /^[Rr]/, ie = X(["R", "r"], !1, !1), M = /^[Ff]/, N = X(["F", "f"], !1, !1), P = /^[Ii]/, ae = X(["I", "i"], !1, !1), F = /^[Xx]/, I = X(["X", "x"], !1, !1), L = function(e, t) {
				var n = {};
			...
			}, ce = ",", le = Y(",", !1), ue = function(e, t) {
				return t;
			}, H = function(e, t) {
				return t.unshift(e), t;
			}, de = "a", fe = Y("a", !1), U = function() {
				return "@type";
			}, pe = function(e) {
				return ti(e, !0);
			}, me = function(e) {
				...
				return { "@id": e };
			}, _e = "[", ve = Y("[", !1), ye = "]", be = Y("]", !1), xe = "(", Se = Y("(", !1), Ce = ")", we = Y(")", !1), Te = function(e) {
				return { "@list": e };
			}, Ee = function(e, t) {
				return {
					"@value": e,
			...
			}, Ae = "true", je = Y("true", !1), Me = function() {
				return !0;
			}, Ne = "false", Pe = Y("false", !1), W = function() {
				return !1;
			}, Fe = function(e) {
				return e + ":";
			}, Ie = "<", Le = Y("<", !1), Re = /^[^\0- <>"{}|\^`\\]/, ze = X([
				...
				return "\f";
			}, cn = "\\\"", ln = Y("\\\"", !1), un = function() {
				return "\"";
			}, dn = "\\'", fn = Y("\\'", !1), pn = function() {
				return "'";
			}, mn = "\\\\", hn = Y("\\\\", !1), gn = function() {
				return "\\";
			}, G = /^[ \t\r\n]/, _n = X([
				" ",
				"	",
			...
			function ar() {
				...
				if (n !== r) {
					if (e.substr(K, 7) === y ? (i = y, K += 7) : (i = r, J === 0 && Z(b)), i !== r) {
			...
			function or() {
				...
				if (n !== r) {
					if (e.substr(K, 5) === S ? (i = S, K += 5) : (i = r, J === 0 && Z(C)), i !== r) {
						for (a = [], o = Q(); o !== r;) a.push(o), o = Q();
						if (a !== r) {
							if (o = Er(), o !== r) {
								for (s = [], c = Q(); c !== r;) s.push(c), c = Q();
			...
			function sr() {
				...
				if (n !== r) {
					if (T.test(e.charAt(K)) ? (i = e.charAt(K), K++) : (i = r, J === 0 && Z(E)), i !== r) {
						if (D.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(O)), a !== r) {
							if (ee.test(e.charAt(K)) ? (o = e.charAt(K), K++) : (o = r, J === 0 && Z(te)), o !== r) {
								if (k.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(A)), s !== r) {
			...
			function cr() {
				...
				if (n !== r) {
					if (ne.test(e.charAt(K)) ? (i = e.charAt(K), K++) : (i = r, J === 0 && Z(re)), i !== r) {
						if (j.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(ie)), a !== r) {
							if (k.test(e.charAt(K)) ? (o = e.charAt(K), K++) : (o = r, J === 0 && Z(A)), o !== r) {
								if (M.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(N)), s !== r) {
									if (P.test(e.charAt(K)) ? (c = e.charAt(K), K++) : (c = r, J === 0 && Z(ae)), c !== r) {
										if (F.test(e.charAt(K)) ? (l = e.charAt(K), K++) : (l = r, J === 0 && Z(I)), l !== r) {
			...
			function ur() {
				...
				if (n !== r) {
					if (i = dr(), i !== r) {
						...
						for (s === r ? (K = o, o = r) : (e.charCodeAt(K) === 59 ? (c = z, K++) : (c = r, J === 0 && Z(oe)), c === r ? (K = o, o = r) : (l = K, u = fr(), u === r ? (K = l, l = r) : (d = dr(), d === r ? (K = l, l = r) : (q = l, u = se(n, i, u, d), l = u)), l === r && (l = null), l === r ? (K = o, o = r) : (q = o, s = B(n, i, l), o = s))); o !== r;) {
							for (a.push(o), o = K, s = [], c = Q(); c !== r;) s.push(c), c = Q();
							s === r ? (K = o, o = r) : (e.charCodeAt(K) === 59 ? (c = z, K++) : (c = r, J === 0 && Z(oe)), c === r ? (K = o, o = r) : (l = K, u = fr(), u === r ? (K = l, l = r) : (d = dr(), d === r ? (K = l, l = r) : (q = l, u = se(n, i, u, d), l = u)), l === r && (l = null), l === r ? (K = o, o = r) : (q = o, s = B(n, i, l), o = s)));
						}
			...
			function dr() {
				...
				if (n !== r) {
					...
					for (o === r ? (K = a, a = r) : (e.charCodeAt(K) === 44 ? (s = ce, K++) : (s = r, J === 0 && Z(le)), s === r ? (K = a, a = r) : (c = hr(), c === r ? (K = a, a = r) : (q = a, o = ue(n, c), a = o))); a !== r;) {
						for (i.push(a), a = K, o = [], s = Q(); s !== r;) o.push(s), s = Q();
						o === r ? (K = a, a = r) : (e.charCodeAt(K) === 44 ? (s = ce, K++) : (s = r, J === 0 && Z(le)), s === r ? (K = a, a = r) : (c = hr(), c === r ? (K = a, a = r) : (q = a, o = ue(n, c), a = o)));
					}
					i === r ? (K = t, t = r) : (q = t, n = H(n, i), t = n);
				} else K = t, t = r;
				return t;
			}
			function fr() {
				...
				if (n !== r && (q = t, n = d(n)), t = n, t === r) {
					...
					n === r ? (K = t, t = r) : (e.charCodeAt(K) === 97 ? (i = de, K++) : (i = r, J === 0 && Z(fe)), i === r ? (K = t, t = r) : (q = t, n = U(), t = n));
				}
				return t;
			}
			function pr() {
				var e = K, t = vr();
				return t !== r && (q = e, t = pe(t)), e = t, e === r && (e = Tr(), e === r && (e = Cr())), e;
			}
			function mr() {
			...
			function hr() {
				var e = gr(), t;
				return e === r && (e = K, t = vr(), t !== r && (q = e, t = me(t)), e = t, e === r && (e = K, t = Tr(), t !== r && (q = e, t = he(t)), e = t, e === r && (e = K, t = _r(), t !== r && (q = e, t = d(t)), e = t, e === r && (e = K, t = Cr(), t !== r && (q = e, t = ge(t)), e = t)))), e;
			}
			function gr() {
				var e = br();
			...
			function _r() {
				...
				if (n !== r) {
					if (e.charCodeAt(K) === 91 ? (i = _e, K++) : (i = r, J === 0 && Z(ve)), i !== r) {
						if (a = ur(), a !== r) {
							for (o = [], s = Q(); s !== r;) o.push(s), s = Q();
							o === r ? (K = t, t = r) : (e.charCodeAt(K) === 93 ? (s = ye, K++) : (s = r, J === 0 && Z(be)), s === r ? (K = t, t = r) : (q = t, n = d(a), t = n));
						} else K = t, t = r;
					} else K = t, t = r;
				} else K = t, t = r;
				return t;
			...
			function vr() {
				for (var t = K, n = [], i = Q(), a, o, s; i !== r;) n.push(i), i = Q();
				if (n !== r) {
					if (e.charCodeAt(K) === 40 ? (i = xe, K++) : (i = r, J === 0 && Z(Se)), i !== r) {
						for (a = [], o = hr(); o !== r;) a.push(o), o = hr();
						if (a !== r) {
							for (o = [], s = Q(); s !== r;) o.push(s), s = Q();
							o === r ? (K = t, t = r) : (e.charCodeAt(K) === 41 ? (s = Ce, K++) : (s = r, J === 0 && Z(we)), s === r ? (K = t, t = r) : (q = t, n = Te(a), t = n));
						} else K = t, t = r;
					} else K = t, t = r;
				} else K = t, t = r;
				return t;
			...
			function br() {
				...
				if (n !== r) {
					if (i = Sr(), i !== r) {
						for (a = [], o = Q(); o !== r;) a.push(o), o = Q();
						a === r ? (K = t, t = r) : (o = jr(), o === r ? (K = t, t = r) : (q = t, n = Ee(i, o), t = n));
					} else K = t, t = r;
				} else K = t, t = r;
				if (t === r) {
					for (t = K, n = [], i = Q(); i !== r;) n.push(i), i = Q();
					if (n !== r) {
						if (i = Sr(), i !== r) {
							for (a = [], o = Q(); o !== r;) a.push(o), o = Q();
							if (a !== r) {
								if (e.substr(K, 2) === De ? (o = De, K += 2) : (o = r, J === 0 && Z(Oe)), o !== r) {
									for (s = [], c = Q(); c !== r;) s.push(c), c = Q();
									s === r ? (K = t, t = r) : (c = Cr(), c === r ? (K = t, t = r) : (q = t, n = ke(i, c), t = n));
								} else K = t, t = r;
							} else K = t, t = r;
						} else K = t, t = r;
					} else K = t, t = r;
			...
			function xr() {
				...
				if (n === r ? (K = t, t = r) : (e.substr(K, 4) === Ae ? (i = Ae, K += 4) : (i = r, J === 0 && Z(je)), i === r ? (K = t, t = r) : (q = t, n = Me(), t = n)), t === r) {
					for (t = K, n = [], i = Q(); i !== r;) n.push(i), i = Q();
					n === r ? (K = t, t = r) : (e.substr(K, 5) === Ne ? (i = Ne, K += 5) : (i = r, J === 0 && Z(Pe)), i === r ? (K = t, t = r) : (q = t, n = W(), t = n));
				}
				return t;
			}
			function Sr() {
			...
			function Ar() {
				...
				if (e.substr(K, 2) === Je ? (i = Je, K += 2) : (i = r, J === 0 && Z(Ye)), i !== r) {
					if (a = Gr(), a === r && (Xe.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(Ze))), a !== r) {
			...
			function Nr() {
				...
				if (ct.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(lt)), a === r && (a = null), a !== r) {
					...
					if (o !== r) {
						if (e.charCodeAt(K) === 46 ? (s = l, K++) : (s = r, J === 0 && Z(u)), s !== r) {
			...
			function Pr() {
				...
				if (ct.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(lt)), a === r && (a = null), a !== r) {
					...
					if (s !== r) {
						if (e.charCodeAt(K) === 46 ? (c = l, K++) : (c = r, J === 0 && Z(u)), c !== r) {
			...
			function Fr() {
				var t = K, n = K, i, a, o, s;
				if (pt.test(e.charAt(K)) ? (i = e.charAt(K), K++) : (i = r, J === 0 && Z(mt)), i !== r) {
					if (ct.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(lt)), a === r && (a = null), a !== r) {
						if (o = [], Xe.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(Ze)), s !== r) for (; s !== r;) o.push(s), Xe.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(Ze));
						else o = r;
						o === r ? (K = n, n = r) : (i = [
			...
			function Rr() {
				...
				if (e.substr(K, 3) === Ct ? (n = Ct, K += 3) : (n = r, J === 0 && Z(wt)), n !== r) {
					...
					if (i !== r) {
						...
						if (o === r) {
							if (o = K, e.charCodeAt(K) === 39 ? (s = yt, K++) : (s = r, J === 0 && Z(bt)), s !== r) {
								if (c = [], Tt.test(e.charAt(K)) ? (l = e.charAt(K), K++) : (l = r, J === 0 && Z(Et)), l === r && (l = Vr(), l === r && (l = Br())), l !== r) for (; l !== r;) c.push(l), Tt.test(e.charAt(K)) ? (l = e.charAt(K), K++) : (l = r, J === 0 && Z(Et)), l === r && (l = Vr(), l === r && (l = Br()));
								else c = r;
			...
			function zr() {
				...
				if (e.substr(K, 3) === Mt ? (n = Mt, K += 3) : (n = r, J === 0 && Z(Nt)), n !== r) {
					...
					if (i !== r) {
						...
						if (o === r) {
							if (o = K, e.charCodeAt(K) === 34 ? (s = ht, K++) : (s = r, J === 0 && Z(gt)), s !== r) {
								if (c = [], Pt.test(e.charAt(K)) ? (l = e.charAt(K), K++) : (l = r, J === 0 && Z(Ft)), l === r && (l = Vr(), l === r && (l = Br())), l !== r) for (; l !== r;) c.push(l), Pt.test(e.charAt(K)) ? (l = e.charAt(K), K++) : (l = r, J === 0 && Z(Ft)), l === r && (l = Vr(), l === r && (l = Br()));
								else c = r;
			...
			function Vr() {
				var t = K, n;
				return e.substr(K, 2) === Kt ? (n = Kt, K += 2) : (n = r, J === 0 && Z(qt)), n !== r && (q = t, n = Jt()), t = n, t === r && (t = K, e.substr(K, 2) === Yt ? (n = Yt, K += 2) : (n = r, J === 0 && Z(Xt)), n !== r && (q = t, n = Zt()), t = n, t === r && (t = K, e.substr(K, 2) === Qt ? (n = Qt, K += 2) : (n = r, J === 0 && Z($t)), n !== r && (q = t, n = en()), t = n, t === r && (t = K, e.substr(K, 2) === tn ? (n = tn, K += 2) : (n = r, J === 0 && Z(nn)), n !== r && (q = t, n = rn()), t = n, t === r && (t = K, e.substr(K, 2) === an ? (n = an, K += 2) : (n = r, J === 0 && Z(on)), n !== r && (q = t, n = sn()), t = n, t === r && (t = K, e.substr(K, 2) === cn ? (n = cn, K += 2) : (n = r, J === 0 && Z(ln)), n !== r && (q = t, n = un()), t = n, t === r && (t = K, e.substr(K, 2) === dn ? (n = dn, K += 2) : (n = r, J === 0 && Z(fn)), n !== r && (q = t, n = pn()), t = n, t === r && (t = K, e.substr(K, 2) === mn ? (n = mn, K += 2) : (n = r, J === 0 && Z(hn)), n !== r && (q = t, n = gn()), t = n))))))), t;
			}
			function Hr() {
				var t;
				return G.test(e.charAt(K)) ? (t = e.charAt(K), K++) : (t = r, J === 0 && Z(_n)), t;
			}
			function Ur() {
				var t = K, n, i, a;
				if (e.charCodeAt(K) === 91 ? (n = _e, K++) : (n = r, J === 0 && Z(ve)), n !== r) {
					for (i = [], a = Q(); a !== r;) i.push(a), a = Q();
					i === r ? (K = t, t = r) : (e.charCodeAt(K) === 93 ? (a = ye, K++) : (a = r, J === 0 && Z(be)), a === r ? (K = t, t = r) : (q = t, n = vn(), t = n));
				} else K = t, t = r;
				return t;
			}
			function Wr() {
	...
	var h = a("[", r(m), r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), g = a(m, h, "*"), _ = a("^", g, "$"), v = a(h, "+"), y = o(a("&", g, ";"), "|", o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/)), b = a("%", g, ";"), x = o(a("\"", o(/[^%&"]/, "|", b, "|", y), "*", "\""), "|", a("'", o(/[^%&']/, "|", b, "|", y), "*", "'")), S = o("\"", o(/[^<&"]/, "|", y), "*", "\"", "|", "'", o(/[^<&']/, "|", y), "*", "'"), C = a(i(m, ":"), i(h, ":"), "*"), w = a("^", C, "$"), T = a(C, o(":", C), "?"), E = a("^", T, "$"), D = a("(", T, ")"), O = o(/"[^"]*"|'[^']*'/), ee = a(/^<\?/, "(", g, ")", o(f, "(?!", u, ")(", c, "*?)"), "?", /\?>/), te = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, k = o("\"", te, "*\"", "|", "'", i(te, "'"), "*'"), A = "<!--", ne = "-->", re = a(A, o(i(c, "-"), "|", a("-", i(c, "-"))), "*", ne), j = "#PCDATA", ie = o("EMPTY", "|", "ANY", "|", o(a(/\(/, p, j, o(p, /\|/, p, T), "*", p, /\)\*/), "|", a(/\(/, p, j, p, /\)/)), "|", a(/\([^>]+\)/, /[?*+]?/)), M = a("<!ELEMENT", f, o(T, "|", b), f, o(ie, "|", b), p, ">"), N = a("<!ATTLIST", f, g, o(f, g, f, o(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", o(a("NOTATION", f, /\(/, p, g, o(p, /\|/, p, g), "*", p, /\)/), "|", a(/\(/, p, v, o(p, /\|/, p, v), "*", p, /\)/))), f, o(/#REQUIRED|#IMPLIED/, "|", o(o("#FIXED", f), "?", S))), "*", p, ">"), P = "about:legacy-compat", ae = o("\"" + P + "\"", "|", "'" + P + "'"), F = "SYSTEM", I = "PUBLIC", L = o(o(F, f, O), "|", o(I, f, k, f, O)), R = a("^", o(o(F, f, "(?<SystemLiteralOnly>", O, ")"), "|", o(I, f, "(?<PubidLiteral>", k, ")", f, "(?<SystemLiteral>", O, ")"))), z = a("^", k, "$"), oe = a("^", O, "$"), se = o(x, "|", o(L, o(f, "NDATA", f, g), "?")), B = "<!ENTITY", V = o(a(B, f, g, f, se, p, ">"), "|", a(B, f, "%", f, g, f, o(x, "|", L), p, ">")), ce = a("<!NOTATION", f, g, f, o(L, "|", a(I, f, k)), p, ">"), le = a(p, "=", p), ue = /1[.]\d+/, H = a(f, "version", le, o("'", ue, "'", "|", "\"", ue, "\"")), de = /[A-Za-z][-A-Za-z0-9._]*/, fe = a(/^<\?xml/, H, o(f, "encoding", le, o("\"", de, "\"", "|", "'", de, "'")), "?", o(f, "standalone", le, o("'", o("yes", "|", "no"), "'", "|", "\"", o("yes", "|", "no"), "\"")), "?", p, /\?>/), U = "<!DOCTYPE", pe = "<![CDATA[", me = "]]>", he = a(/<!\[CDATA\[/, a(c, "*?", /\]\]>/));
	e.chars = r, e.chars_without = i, e.detectUnicodeSupport = t, e.reg = a, e.regg = o, e.ABOUT_LEGACY_COMPAT = P, e.ABOUT_LEGACY_COMPAT_SystemLiteral = ae, e.AttlistDecl = N, e.CDATA_START = pe, e.CDATA_END = me, e.CDSect = he, e.Char = c, e.Comment = re, e.COMMENT_START = A, e.COMMENT_END = ne, e.DOCTYPE_DECL_START = U, e.elementdecl = M, e.EntityDecl = V, e.EntityValue = x, e.ExternalID = L, e.ExternalID_match = R, e.Name = g, e.Name_exact = _, e.NCName_exact = w, e.NotationDecl = ce, e.Reference = y, e.PEReference = b, e.PI = ee, e.PUBLIC = I, e.PubidLiteral = k, e.PubidLiteral_match = z, e.QName = T, e.QName_exact = E, e.QName_group = D, e.S = f, e.SChar_s = d, e.S_OPT = p, e.SYSTEM = F, e.SystemLiteral = O, e.SystemLiteral_match = oe, e.InvalidChar = l, e.UNICODE_REPLACEMENT_CHARACTER = s, e.UNICODE_SUPPORT = n, e.XMLDecl = fe;
})), Be = /* @__PURE__ */ s(((e) => {
	var t = Le(), n = t.find, r = t.hasDefaultHTMLNamespace, i = t.hasOwn, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, s = t.isHTMLVoidElement, c = t.MIME_TYPE, l = t.NAMESPACE, u = Symbol(), d = Re(), f = d.DOMException, p = d.DOMExceptionName, m = ze();
	function h(e) {
	...
	F.prototype = {
		...
		toString: function(e) {
			for (var t = typeof e == "function" ? {
				...
				splitCDATASections: !0,
				nodeFilter: null
			}, n = [], r = 0; r < this.length; r++) qe(this[r], n, null, t);
			return n.join("");
		},
		filter: function(e) {
	...
	function L(e) {
		...
		if (e._inc !== t) {
			...
			if (Xe(e, "length", n.length), !e.$$length || n.length < e.$$length) for (var r = n.length; r in e; r++) i(e, r) && delete e[r];
			C(n, e), e._inc = t;
		}
	}
	...
	function B(e, t) {
		oe(e, t.namespaceURI, !0)[t.localName] = t;
	}
	function V(e, t) {
		var n = oe(e, t.namespaceURI, !1);
		n && delete n[t.localName];
	}
	function ce(e, t, n, r) {
		if (r ? t[z(t, r)] = n : (t[t.length] = n, t.length++), B(t, n), e) {
			n.ownerElement = e;
			var i = e.ownerDocument;
			i && (r && he(i, e, r), me(i, e, n));
		}
	}
	function le(e, t, n) {
		var r = z(t, n);
		if (r >= 0) {
			...
			if (t.length = i, V(t, n), e) {
				var a = e.ownerDocument;
				a && he(a, e, n), n.ownerElement = null;
			}
		}
	}
	R.prototype = {
		...
		setNamedItem: function(e) {
			...
			var n = se(this, e.namespaceURI, e.localName);
	...
	ue.prototype = {
		...
		createHTMLDocument: function(e) {
			var t = new pe(u, { contentType: c.HTML });
	...
	H.prototype = {
		...
		replaceChild: function(e, t) {
			Oe(this, e, t, De), t && this.removeChild(t);
		},
			...
			U(this, null, { enter: function(e) {
				for (var t = e.firstChild; t;) {
					...
					if (n !== null && n.nodeType === O && t.nodeType === O) {
						...
						t.nextSibling = i, i === null ? e.lastChild = t : i.previousSibling = t, t.appendData(r.join("")), ge(e.ownerDocument, e), t = i;
					} else t = n;
				}
				return !0;
			} });
		...
		compareDocumentPosition: function(e) {
			...
			if (t instanceof Ae && (r = t, t = r.ownerElement), n instanceof Ae && (i = n, n = i.ownerElement, r && t && n === t)) for (var a = 0, o; o = n.attributes[a]; a++) {
	...
	C(T, H), C(T, H.prototype), C(N, H), C(N, H.prototype);
	function fe(e, t) {
	...
	function _e(e, t) {
		...
		return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, ge(e.ownerDocument, e), t.parentNode = null, t.previousSibling = null, t.nextSibling = null, t;
	}
	function ve(e) {
	...
	function Te(e, t, n) {
		if (!ve(e)) throw new f(f.HIERARCHY_REQUEST_ERR, "Unexpected parent node type " + e.nodeType);
		if (n && n.parentNode !== e) throw new f(f.NOT_FOUND_ERR, "child not in parent");
		if (!ye(t) || be(t) && e.nodeType !== H.DOCUMENT_NODE) throw new f(f.HIERARCHY_REQUEST_ERR, "Unexpected node type " + t.nodeType + " for parent node type " + e.nodeType);
	}
	function Ee(e, t, r) {
		var i = e.childNodes || [], a = t.childNodes || [];
		if (t.nodeType === H.DOCUMENT_FRAGMENT_NODE) {
			var o = a.filter(xe);
			if (o.length > 1 || n(a, Se)) throw new f(f.HIERARCHY_REQUEST_ERR, "More than one element or text in fragment");
			if (o.length === 1 && !Ce(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Element in fragment can not be inserted before doctype");
		}
		if (xe(t) && !Ce(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one element can be added and only after doctype");
		if (be(t)) {
			if (n(i, be)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one doctype is allowed");
			var s = n(i, xe);
	...
	function De(e, t, r) {
		...
		if (xe(t) && !we(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one element can be added and only after doctype");
		if (be(t)) {
			function e(e) {
				return be(e) && e !== r;
			}
	...
	function Oe(e, t, n, r) {
		Te(e, t, n), e.nodeType === H.DOCUMENT_NODE && (r || Ee)(e, t, n);
		var i = t.parentNode;
		...
		return ge(e.ownerDocument || e, e, t), t.nodeType == ie && (t.firstChild = t.lastChild = null), t;
	}
	pe.prototype = {
		implementation: null,
		nodeName: "#document",
		...
		insertBefore: function(e, t) {
			...
			return Oe(this, e, t), e.ownerDocument = this, this.documentElement === null && e.nodeType === E && (this.documentElement = e), e;
		},
		removeChild: function(e) {
			var t = _e(this, e);
		...
		replaceChild: function(e, t) {
			Oe(this, e, t, De), e.ownerDocument = this, t && this.removeChild(t), xe(e) && (this.documentElement = e);
		},
		...
		getElementById: function(e) {
			var t = null;
			return fe(this.documentElement, function(n) {
		...
		createElementNS: function(e, t) {
			var n = S(e, t), r = new ke(u), i = r.attributes = new R();
	...
	ke.prototype = {
		...
		getElementsByClassName: function(e) {
			...
			return new I(this, function(n) {
				var r = [];
				return t.length > 0 && fe(n, function(i) {
					if (i !== n && i.nodeType === E) {
		...
		getElementsByTagNameNS: function(e, t) {
			return new I(this, function(n) {
				var r = [];
				return fe(n, function(i) {
					i !== n && i.nodeType === E && (e === "*" || i.namespaceURI === e) && (t === "*" || i.localName == t) && r.push(i);
				}), r;
			});
		}
	}, pe.prototype.getElementsByClassName = ke.prototype.getElementsByClassName, pe.prototype.getElementsByTagName = ke.prototype.getElementsByTagName, pe.prototype.getElementsByTagNameNS = ke.prototype.getElementsByTagNameNS, w(ke, H);
	function Ae(e) {
		h(e), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
	}
	Ae.prototype.nodeType = D, w(Ae, H);
	function je(e) {
		h(e);
	}
	je.prototype = {
	...
	W.prototype.nodeType = j, w(W, H);
	function Fe(e) {
		h(e);
	}
	Fe.prototype.nodeType = M, w(Fe, H);
	function Ie(e) {
		h(e);
	}
	Ie.prototype.nodeType = k, w(Ie, H);
	function Be(e) {
		h(e);
	}
	Be.prototype.nodeType = te, w(Be, H);
	function Ve(e) {
		h(e);
	}
	Ve.prototype.nodeName = "#document-fragment", Ve.prototype.nodeType = ie, w(Ve, H);
	function He(e) {
		h(e);
	}
	He.prototype.nodeType = A, w(He, je);
	function Ue() {}
	Ue.prototype.serializeToString = function(e, t) {
		return We.call(e, t);
	}, H.prototype.toString = We;
	function We(e) {
			...
			enter: function(e, n) {
				...
				switch (e.nodeType) {
					case E:
						...
						for (var w = 0; w < g; w++) {
							...
							if (Ge(T, u, C)) {
								...
								Ke(t, k ? "xmlns:" + k : "xmlns", M, a), C.push({
									prefix: k,
									namespace: M
								});
							}
							var N = i ? i(T) : T;
							N && (typeof N == "string" ? t.push(N) : Ke(t, N.name, N.value, a));
						}
						if (_ === v && Ge(e, u, C)) {
							var P = e.prefix || "", M = e.namespaceURI;
							Ke(t, P ? "xmlns:" + P : "xmlns", M, a), C.push({
								prefix: P,
								namespace: M
							});
						}
						...
						if (t.push(">"), u && o(_)) {
							for (var F = e.firstChild; F;) F.data ? t.push(F.data) : qe(F, t, C.slice(), r), F = F.nextSibling;
					...
					case ie:
						...
						return { ns: d };
					case D: return Ke(t, e.name, e.value, a), null;
					case O:
						...
						return t.push(e.data.replace(/[<&>]/g, de)), null;
					case ee:
		...
		return U(t, null, { enter: function(t, a) {
			...
			switch (o.nodeType) {
				case E:
					...
					f._ownerElement = o;
					for (var m = 0; m < p; m++) o.setAttributeNode(Ye(e, d.item(m), !0));
					break;
				case D: l = !0;
			}
	...
	try {
		Object.defineProperty && (Object.defineProperty(I.prototype, "length", { get: function() {
		...
		}), Object.defineProperty(je.prototype, "data", {
			get: function() {
		...
		}), Object.defineProperty(je.prototype, "nodeValue", {
			get: function() {
				return this.data;
			},
			set: function(e) {
			...
			return new I(this, Ze);
		} }), Object.defineProperty(pe.prototype, "children", { get: function() {
			return new I(this, Ze);
		} }), Object.defineProperty(Ve.prototype, "children", { get: function() {
			return new I(this, Ze);
		} }), Xe = function(e, t, n) {
			e["$$" + t] = n;
		});
	} catch {}
	e._updateLiveList = L, e.Attr = Ae, e.CDATASection = Pe, e.CharacterData = je, e.Comment = Ne, e.Document = pe, e.DocumentFragment = Ve, e.DocumentType = W, e.DOMImplementation = ue, e.Element = ke, e.Entity = Ie, e.EntityReference = Be, e.LiveNodeList = I, e.NamedNodeMap = R, e.Node = H, e.NodeList = F, e.Notation = Fe, e.Text = Me, e.ProcessingInstruction = He, e.walkDOM = U, e.XMLSerializer = Ue;
})), Ve = /* @__PURE__ */ s(((e) => {
	var t = Le().freeze;
	e.XML_ENTITIES = t({
		amp: "&",
	...
	var t = Le(), n = ze(), r = Re(), i = t.isHTMLEscapableRawTextElement, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, s = t.hasOwn, c = t.NAMESPACE, l = r.ParseError, u = r.DOMException, d = 0, f = 1, p = 2, m = 3, h = 4, g = 5, _ = 6, v = 7;
	function y() {}
		...
		for (var x = [{ currentNSMap: r }], E = [], D = 0;;) {
			try {
				...
				switch (e.charAt(O + 1)) {
					...
					default:
						v && y(O);
						var z = new k(), oe = x[x.length - 1].currentNSMap, j = C(e, O, z, oe, p, c, d), se = z.length;
						if (z.closed || (d && t.isHTMLVoidElement(z.tagName) ? z.closed = !0 : E.push(z.tagName)), v && se) {
							for (var B = S(v, {}), V = 0; V < se; V++) {
								var ce = z[V];
								y(ce.offset), ce.locator = S(v, {});
							}
							o.locator = B, w(z, o, oe) && x.push(z), o.locator = v;
						} else w(z, o, oe) && x.push(z);
						d && !z.closed ? j = T(e, j, z.tagName, p, o) : j++;
				}
			} catch (e) {
	...
	var t = Le(), n = Be(), r = Re(), i = Ve(), a = He(), o = n.DOMImplementation, s = t.hasDefaultHTMLNamespace, c = t.isHTMLMimeType, l = t.isValidMimeType, u = t.MIME_TYPE, d = t.NAMESPACE, f = r.ParseError, p = a.XMLReader;
	function m(e) {
		return e.replace(/\r[\n\u0085]/g, "\n").replace(/[\r\u0085\u2028\u2029]/g, "\n");
	}
	function h(e) {
...
})), Ge = /* @__PURE__ */ u(Ie()), Ke = /* @__PURE__ */ c({
	DOMParserFactory: () => Qe,
	RDFArrayRemove: () => ot,
	callbackify: () => Ze,
	domToString: () => $e,
	...
	uri: () => Ce
}), qe = We(), Je = { template: ct };
function Ye(e) {
	return e = e.split(";")[0].trim(), new U("http://www.w3.org/ns/iana/media-types/" + e + "#Resource");
}
function Xe(e) {
	return new U("http://www.w3.org/ns/iana/link-relations/relation#" + e.trim());
}
function Ze(e, t) {
	e.callbacks = {};
...
function Qe() {
	return window.DOMParser ? new qe.DOMParser() : window.ActiveXObject ? new ActiveXObject("Microsoft.XMLDOM") : !1;
}
function $e(e, t) {
	t ||= {};
	var n = [];
	...
	if (e.nodeType === 1) {
		if (e.hasAttribute("class") && t && t.classWithChildText && e.matches(t.classWithChildText.class)) a += e.querySelector(t.classWithChildText.element).textContent;
			...
			if (c.length > 0 && (t && t.sortAttributes && c.sort(function(e, t) {
				...
				for (a += ">", a += s === "html" ? "\n  " : "", o.push(s === "style" || s === "script"), i = 0; i < e.childNodes.length; i++) a += et(e.childNodes[i]);
				o.pop(), a += s === "body" ? "</" + s + ">\n" : "</" + s + ">";
			}
		}
...
function rt(e, t, n, r) {
	return nt(e.subject, t.subject, n, r) || nt(e.predicate, t.predicate, n, r) || nt(e.object, t.object, n, r);
}
function it(e) {
...
function at(e, t) {
	var n;
	return t ||= {}, typeof module < "u" && module && module.exports ? new qe.DOMParser().parseFromString(e, t.contentType || "application/xhtml+xml") : (n = typeof window < "u" && window.DOMParser ? new window.DOMParser() : new qe.DOMParser(), n.parseFromString(e, "application/xml"));
}
function ot(e, t) {
...
var ft = class e {
	constructor(e) {
		...
		this.suggestPrefix("rdf", "http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.suggestPrefix("xml", "reserved:reservedForFutureUse"), this.namespacesUsed = [], this.keywords = ["a"], this.prefixchars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", this.incoming = null, this.formulas = [], this.store = e, this.rdfFactory = e.rdfFactory || Pe, this.xsd = ut(this.rdfFactory);
	}
	setBase(e) {
	...
	explicitURI(e) {
		return e = this.flags.indexOf("r") < 0 && this.base ? Ae(this.base, e) : this.flags.indexOf("u") >= 0 ? mt(e) : pt(decodeURI(e)), "<" + e + ">";
	}
	...
	statementsToXML(e) {
		...
		function l(e) {
			return c(this.base ? Ae(this.base, e.uri) : e.uri);
		}
		var u = l.bind(this);
		function d(e, t) {
		...
		for (var b in this.defaultNamespace && (y += " xmlns=\"" + c(this.defaultNamespace) + "\""), t) if (t.hasOwnProperty(b)) {
			var x = this.base && this.flags.includes("z") ? Ae(this.base, b) : b;
	...
	statementsToJsonld(e) {
		let t = this.statementsToN3(e), n = Ge.parse(t);
...
function vt(e, t, n) {
	...
	return n.reduce((t, n, i, a) => {
		r.push(e.quad(t, e.namedNode(_t.first), a[i]));
		let o;
		return i < a.length - 1 ? (o = e.blankNode(), r.push(e.quad(t, e.namedNode(_t.rest), o))) : r.push(e.quad(t, e.namedNode(_t.rest), e.namedNode(_t.nil))), o;
	}, t), r;
}
function yt(e, t, n = 0) {
	var r = e.length;
...
var bt = class e extends v {
	constructor(e = [], t = [], n = [], r = [], i = {}) {
		super(""), this.statements = e, this.constraints = t, this.initBindings = n, this.optional = r, g(this, "termType", E), g(this, "classOrder", _.Graph), g(this, "fetcher", void 0), g(this, "isVar", 0), g(this, "ns", Fe), g(this, "rdfFactory", void 0), this.rdfFactory = i && i.rdfFactory || Pe;
		for (let e of gt) this[e] = (...t) => this.rdfFactory[e](...t);
	}
	add(e, t, n, r) {
	...
	each(e, t, n, r) {
		...
		else if (r == null) for (let e = 0, t = a.length; e < t; e++) i.push(new U(a[e].graph.value));
		return i;
	}
	equals(e) {
	...
	list(e, t) {
		...
		{
			let n = t.rdfFactory.blankNode(), r = vt(t.rdfFactory, n, e);
			return t.addAll(r), n;
		}
	}
	NTtoURI(e) {
	...
	the(e, t, n, r) {
		let i = this.any(e, t, n, r);
		return i ?? W.error("No value found for the() {" + e + " " + t + " " + n + "}."), i;
	}
...
v.fromValue = he;
var xt = v, St = { xsd: Fe("http://www.w3.org/2001/XMLSchema#") };
v.toJS = function(e) {
	return I(e) ? e.elements.map(v.toJS) : B(e) ? e.datatype.equals(St.xsd("boolean")) ? e.value === "1" || e.value === "true" : e.datatype.equals(St.xsd("dateTime")) || e.datatype.equals(St.xsd("date")) ? new Date(e.value) : e.datatype.equals(St.xsd("integer")) || e.datatype.equals(St.xsd("float")) || e.datatype.equals(St.xsd("decimal")) ? Number(e.value) : e.value : e;
};
//#endregion
//#region node_modules/rdflib/esm/query.js
var Ct = class {
	constructor(e, t) {
		this.pat = new kt(), this.vars = [], this.name = e, this.id = t;
	}
};
function wt(e, t, n, r) {
	function i(e) {
	...
	u.prototype.checkAllDone = function() {
		...
		W.debug("OPTIONAL BIDNINGS ALL DONE:"), this.doCallBacks(this.branches.length - 1, this.trunkBindings);
	...
	d.prototype.reportMatch = function(e) {
		...
		this.done = !0, W.info("Mandatory query branch finished.***"), this.onDone !== void 0 && this.onDone();
	};
	var f = function(e) {
	...
	f.prototype.reportMatch = function(e) {
		...
		W.debug("Optional branch finished - results.length = " + this.results.length), this.results.length === 0 && (this.results.push({}), W.debug("Optional branch FAILED - that's OK.")), this.done = !0, this.junction.checkAllDone();
	};
	function p(e, t, n) {
		var r, i, a, o;
	...
	var h = 0, g = function(e, n, r, a, o, s, c) {
		W.debug("Match begins, Branch count now: " + c.count + " for " + c.pattern_debug);
		var l = n.statements;
		if (l.length === 0) {
			if (W.debug("FOUND MATCH WITH BINDINGS:" + i(r)), n.optional.length === 0) c.reportMatch(r);
			else {
				W.debug("OPTIONAL: " + n.optional);
			...
			c.count--, W.debug("Match ends -- success , Branch count now: " + c.count + " for " + c.pattern_debug);
			return;
		}
		var _, y, b = l.length;
		if (o) {
			...
			for (y = 0; y < b; y++) {
				if (_ = l[y], r[_.subject] !== void 0 && r[_.subject].uri && o && o.getState(Te(r[_.subject].uri)) === "unrequested") {
					S(r[_.subject], x);
					return;
				}
				if (r[_.object] !== void 0 && r[_.object].uri && o && o.getState(Te(r[_.object].uri)) === "unrequested") {
					S(r[_.object], x);
					return;
				}
			}
		...
		u.sort(m), S = u[0];
		var C = e.formula();
		C.optional = t.optional, C.constraints = t.constraints, C.statements = u.slice(1), W.debug(r + "match2 searching " + S.index.length + " for " + S + "; bindings so far=" + i(n));
		...
		for (w = 0; w < T; w++) for (D = S.index[w], E = s([
			...
			D.object,
			D.why
		], n, e), W.info(r + " From first: " + E.length + ": " + a(E)), v = E.length, h = 0; h < v; h++) if (b = [], x = E[h][0], !_(x, t.constraints)) W.debug("Branch count CS: " + l.count);
		else {
			for (y in x) x.hasOwnProperty(y) && (b[y] = x[y]);
			for (y in n) n.hasOwnProperty(y) && (b[y] = n[y]);
			l.count++, O++, g(e, C, b, r + "  ", o, c, l);
		}
		l.count--, O === 0 && W.debug("Match2 fails completely on " + S), W.debug("Match2 ends, Branch count: " + l.count + " for " + l.pattern_debug), l.count === 0 && (W.debug("Branch finished."), l.reportDone());
	}, y = this;
	W.debug("Query on " + this.statements.length);
	var b = new d(t, r);
...
var Tt = "http://www.w3.org/2002/07/owl#";
function Et(e, t, n, r) {
...
var kt = class e extends bt {
	constructor(e, t = {}) {
		super(void 0, void 0, void 0, void 0, t), g(this, "updater", void 0), g(this, "namespaces", void 0), g(this, "classActions", void 0), g(this, "propertyActions", void 0), g(this, "redirections", void 0), g(this, "aliases", void 0), g(this, "HTTPRedirects", void 0), g(this, "subjectIndex", void 0), g(this, "predicateIndex", void 0), g(this, "objectIndex", void 0), g(this, "whyIndex", void 0), g(this, "index", void 0), g(this, "features", void 0), g(this, "_universalVariables", void 0), g(this, "_existentialVariables", void 0), g(this, "rdfArrayRemove", void 0), g(this, "dataCallbacks", []), g(this, "dataRemovalCallbacks", []), this.propertyActions = {}, this.classActions = {}, this.redirections = [], this.aliases = [], this.HTTPRedirects = [], this.subjectIndex = [], this.predicateIndex = [], this.objectIndex = [], this.whyIndex = [], this.index = [
			...
			this.objectIndex,
			this.whyIndex
		], this.namespaces = {}, this.features = e || [], this.rdfArrayRemove = t.rdfArrayRemove || ot, t.dataCallback && (this.dataCallbacks = [t.dataCallback]), t.dataRemovalCallback && (this.dataRemovalCallbacks = [t.dataRemovalCallback]), this.initPropertyActions(this.features);
	}
	...
	initPropertyActions(e) {
		this.propertyActions[this.rdfFactory.id(this.rdfFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"))] = [Ot], yt(e, "sameAs") >= 0 && (this.propertyActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Tt}sameAs`))] = [function(e, t, n, r, i) {
			return e.equate(t, r), !0;
		}]), yt(e, "InverseFunctionalProperty") >= 0 && (this.classActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Tt}InverseFunctionalProperty`))] = [function(e, t, n, r, i) {
			return e.newPropertyAction(t, Dt);
		}]), yt(e, "FunctionalProperty") >= 0 && (this.classActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Tt}FunctionalProperty`))] = [function(e, t, n, r, i) {
			return e.newPropertyAction(t, Et);
		}]);
	}
	addStatement(e) {
	...
	add(e, t, n, r) {
		...
		if (arguments.length === 1) {
			...
			else V(e) ? this.add(e.subject, e.predicate, e.object, e.graph) : F(e) && this.add(e.statements);
			return this;
		}
		var a, o;
		r ||= this.fetcher ? this.fetcher.appNode : this.rdfFactory.defaultGraph(), typeof e == "string" && (e = this.rdfFactory.namedNode(e)), t = xt.fromValue(t);
		let s = xt.fromValue(n);
		if (r = xt.fromValue(r), !R(e)) throw Error("Subject is not a subject type");
		if (!z(t)) throw Error(`Predicate ${t} is not a predicate type`);
		if (!L(s)) throw Error(`Object ${s} is not an object type`);
		if (!fe(r)) throw Error("Why is not a graph type");
	...
	canon(e) {
		...
		switch (e.termType) {
			...
			case w: return e;
			case C: return new ye();
			case T: return e;
			case E: return e;
			case x: return new me(e.value, e.language, e.datatype);
			case y: return new U(e.value);
			case S: return new je(e.value);
	...
	copyTo(e, t, n) {
		...
		yt(n, "two-direction") !== -1 && r.concat(this.statementsMatching(void 0, void 0, e));
		for (var i = 0; i < r.length; i++) {
			var a = r[i];
			switch (a.object.termType) {
				case "NamedNode":
	...
	match(e, t, n, r) {
		return this.statementsMatching(xt.fromValue(e), xt.fromValue(t), xt.fromValue(n), xt.fromValue(r));
	}
	mentionsURI(e) {
		var t = "<" + e + ">";
	...
	querySync(e) {
		...
		var i = !1;
		if (e.sync = !0, wt.call(this, e, n, null, r), !i) throw Error("Sync query should have called done function");
		return t;
	}
	remove(e) {
		if (e instanceof Array) {
	...
	statementsMatching(e, t, n, r, i) {
		for (var a = [
			...
			n,
			r
		], o = [], s = [], c = [], l = [], u = 0, d; u < 4; u++) o[u] = this.canon(xt.fromValue(a[u])), o[u] ? (l.push(u), s[u] = this.id(o[u])) : c.push(u);
	...
	serialize(e, t, n, r) {
		...
		return r = {
			...r || {},
			namespaces: i
		}, ht(n, this, e, t, void 0, r);
	}
};
g(kt, "handleRDFType", void 0), kt.handleRDFType = Ot;
//#endregion
//#region node_modules/rdflib/esm/lists.js
var At = Fe("http://www.w3.org/1999/02/22-rdf-syntax-ns#");
function jt(e, t, n, r) {
	for (let i of e.statementsMatching(n, null, null, r)) {
		let n = new Se(t, i.predicate, i.object, r);
		e.remove(i), e.add(n);
	}
	for (let i of e.statementsMatching(null, n, null, r)) e.remove(i), e.add(new Se(i.subject, t, i.object, r));
	for (let i of e.statementsMatching(null, null, n, r)) e.remove(i), e.add(new Se(i.subject, i.predicate, t, r));
}
function Mt(e, t) {
	let n = At("nil");
	for (let r of e.statementsMatching(n, null, null, t)) {
		e.remove(r);
		let n = new ge();
		e.add(new Se(n, r.predicate, r.object, t));
	}
	for (let r of e.statementsMatching(null, null, n, t)) if (!r.predicate.sameTerm(At("rest"))) {
		e.remove(r);
		let n = new ge();
		e.add(new Se(r.subject, r.predicate, n, t));
	}
}
function Nt(e, t) {
	function n(r, i, a) {
		let o = e.statementsMatching(r, At("rest"), null, t);
		if (o.length !== 1) throw Error(`Bad list structure: no rest at ${r}`);
		let s = e.statementsMatching(r, At("first"), null, t);
		if (s.length !== 1) throw Error(`Bad list structure: rest but ${s.length} firsts at ${r}`);
		let c = [s[0].object].concat(i), l = a.concat(o).concat(s), u = e.statementsMatching(null, At("rest"), r, t);
		if (u.length === 0) {
			let n = new ge(c);
			e.remove(l), jt(e, n, r, t);
			return;
		}
	...
	Mt(e, t), e.statementsMatching(null, At("rest"), At("nil"), t).forEach((e) => {
...
}, It = "http://www.w3.org/2000/10/swap/log#", Lt = function(e) {
	return e;
}, Rt = function(e) {
	return e;
}, zt = function(e) {
...
}, Ht = Error("dummy error stop iteration"), Ut = function(e) {
	return this.last = 0, this.li = e, this.next = function() {
		if (this.last == this.li.length) throw Ht;
...
var qt = function(e, t) {
	return Oe(t, e);
}, Jt = null, Yt = 0, Xt = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", Zt = "http://www.w3.org/1999/02/22-rdf-syntax-ns#nil", Qt = "http://www.w3.org/2002/07/owl#sameAs", $t = "#", en = "http://www.w3.org/2001/XMLSchema#integer", tn = "http://www.w3.org/2001/XMLSchema#double", nn = "http://www.w3.org/2001/XMLSchema#decimal", rn = "http://www.w3.org/2001/XMLSchema#date", an = "http://www.w3.org/2001/XMLSchema#dateTime", on = "	\r\n !\"#$%&'()*.,+/;<=>?@[\\]^`{|}~", sn = on + ":", cn = /* @__PURE__ */ RegExp("^([-+]?[0-9]+)(\\.[0-9]+)?([eE][-+]?[0-9]+)?", "g"), ln = /* @__PURE__ */ RegExp("^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9](T[0-9][0-9]:[0-9][0-9](:[0-9][0-9](\\.[0-9]*)?)?)?Z?"), un = /* @__PURE__ */ RegExp("[\\s#]"), dn = /* @__PURE__ */ RegExp("[\\\\\\r\\n\\\"]", "g"), fn = /* @__PURE__ */ RegExp("^[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*", "g");
function pn(e, t) {
	var n = e.charAt(t + 1);
	return n === "" || un.test(n);
}
function mn(e, t, n, r, i, a, o, s) {
	return new hn(e, t, n, r, i, a, o, s);
}
var hn = class {
	constructor(e, t, n, r, i, a, o, s) {
		t === void 0 && (t = null), n === void 0 && (n = ""), r === void 0 && (r = null), i === void 0 && (i = ""), a === void 0 && (a = null), o === void 0 && (o = ""), s === void 0 && (s = null), this._bindings = new zt([]), this._flags = o, n != "" && (Gt(n.indexOf(":") >= 0, "Document URI not absolute: " + n), this._bindings[""] = n + "#"), this._store = e, i && e.setGenPrefix(i), this._thisDoc = n, this.source = e.sym(n), this.lines = 0, this.statementCount = 0, this.hasNil = !1, this.startOfLine = 0, this.previousLine = 0, this._genPrefix = i, this.keywords = new Rt([
			"a",
			"this",
			"bind",
			"has",
			...
			"true",
			"false"
		]), this.keywordsSet = 0, this._anonymousNodes = new zt([]), this._variables = new zt([]), this._parentVariables = new zt([]), this._reason = s, this._reason2 = null, this._baseURI = r || n || null, Gt(!this._baseURI || this._baseURI.indexOf(":") >= 0), this._genPrefix ||= this._thisDoc ? this._thisDoc + "#_g" : RDFSink_uniqueURI(), this._formula = t ?? (this._thisDoc ? e.formula(n + "#_formula") : e.formula()), this._context = this._formula, this._parentContext = null;
	}
	here(e) {
	...
	tok(e, t, n) {
		...
		else if (yt(this.keywords, e) < 0) return -1;
		var r = n + Bt(e);
		return t.slice(n, r) == e && on.indexOf(t.charAt(r)) >= 0 ? r : -1;
	}
	directive(e, t) {
		var n = this.skipSpace(e, t);
		if (n < 0) return n;
		var r = new Rt([]), n = this.tok("bind", e, t);
		...
		if (n > 0) {
			...
			return this.setKeywords(Vt(r, null, null)), Yt > 80 && this.keywords, t;
		}
		...
		if (n > 0) {
			...
			try {
				for (;;) {
					var a = i.next();
					(yt(this._variables, a) < 0 || yt(this._parentVariables, a) >= 0) && (this._variables[a] = this._context.newUniversal(a));
				}
			} catch (e) {
				if (e != Ht) throw e;
			}
		...
		if (n >= 0) {
			var o = new Rt([]), t = this.qname(e, n, o);
			...
			else Gt(s.indexOf(":") >= 0, "With no base URI, cannot handle relative URI for NS");
			return Gt(s.indexOf(":") >= 0), this._bindings[o[0][0]] = s, this.bind(o[0][0], Pt(s)), n;
		}
		var n = this.tok("base", e, t);
		if (n >= 0) {
			var o = new Rt([]), t = this.uri_ref2(e, n, o);
			...
			return Gt(s.indexOf(":") >= 0), this._baseURI = s, t;
		}
		return -1;
	}
	bind(e, t) {
	...
	startDoc() {}
	endDoc() {
		return this.hasNil && this._store.rdfFactory.supports.COLLECTIONS && Nt(this._store, this.source), this._formula;
	}
	makeStatement(e) {
		e[0].add(e[2], e[1], e[3], this.source), (e[2].uri && e[2].uri === Zt || e[3].uri && e[3].uri === Zt) && (this.hasNil = !0), this.statementCount += 1;
	}
	statement(e, t) {
		var n = new Rt([]), t = this.object(e, t, n);
		if (t < 0) return t;
	...
	verb(e, t, n) {
		...
		if (r >= 0) {
			...
			return n.push(new Lt(["<-", i[0]])), r;
		}
		var r = this.tok("a", e, t);
		if (r >= 0) return n.push(new Lt(["->", this._store.sym(Xt)])), r;
		if (e.slice(t, t + 2) == "<=") return n.push(new Lt(["<-", this._store.sym(It + "implies")])), t + 2;
		if (e.slice(t, t + 1) == "=") return e.slice(t + 1, t + 2) == ">" ? (n.push(new Lt(["->", this._store.sym(It + "implies")])), t + 2) : (n.push(new Lt(["->", this._store.sym(Qt)])), t + 1);
		if (e.slice(t, t + 2) == ":=") return n.push(new Lt(["->", It + "becomes"])), t + 2;
		var r = this.prop(e, t, i);
		if (r >= 0) return n.push(new Lt(["->", i[0]])), r;
	...
	path(e, t, n) {
		...
		for (; "!^.".indexOf(e.slice(r, r + 1)) >= 0;) {
			...
			var s = n.pop();
			i == "^" ? this.makeStatement(new Lt([
				this._context,
				s,
				o,
				a
			])) : this.makeStatement(new Lt([
				this._context,
				s,
				a,
				o
	...
	node(e, t, n, r) {
		...
		if (o == "[") {
			...
			if (e.slice(a, a + 1) == "=") {
				var t = a + 1, c = new Rt([]), a = this.objectList(e, t, c);
				if (a >= 0) {
					var i = c[0];
					if (Bt(c) > 1) {
						var l = new Ut(c);
		...
		if (o == "{") {
			...
			if (d == "$") {
				...
				for (var a = t + 1, f = new Rt([]), p = !0;;) {
					...
					var m = new Rt([]), a = this.item(e, t, m);
			...
			this._parentVariables = this._variables, this._anonymousNodes = new zt([]), this._variables = this._variables.slice();
			var v = this._reason2;
			if (this._reason2 = Jt, i == null) var i = this._store.formula();
			for (this._context = i;;) {
				var t = this.skipSpace(e, a);
				if (t < 0) throw G(this._thisDoc, this.lines, e, t, "needed '}', found end.");
				if (e.slice(t, t + 1) == "}") {
	...
	uri_ref2(e, t, n) {
		var r = new Rt([]), i = this.qname(e, t, r);
		if (i >= 0) {
			var a = r[0], o = a[0], s = a[1];
			if (o == null) {
				Gt(0, "not used?");
				var c = this._baseURI + $t;
			} else {
			...
			return yt(this._variables, l) >= 0 ? n.push(this._variables[l]) : n.push(l), i;
		}
		var t = this.skipSpace(e, t);
		if (t < 0) return -1;
		if (e.charAt(t) == "?") {
			var u = new Rt([]), i = this.variable(e, t, u);
			return i > 0 ? (n.push(u[0]), i) : -1;
		}
		if (e.charAt(t) == "<") {
			for (var t = t + 1, d = t; t < Bt(e);) {
				if (e.charAt(t) == ">") {
					var f = e.slice(d, t);
					if (this._baseURI) var f = qt(this._baseURI, f);
					else Gt(f.indexOf(":") >= 0, "With no base URI, cannot deal with relative URIs");
					if (e.slice(t - 1, t) == "#" && Vt(f, -1, null) != "#") var f = f + "#";
					var l = this._store.sym(f);
					return yt(this._variables, l) >= 0 ? n.push(this._variables[l]) : n.push(l), t + 1;
				}
				var t = t + 1;
			}
		...
		if (this.keywordsSet) {
			var u = new Rt([]), i = this.bareWord(e, t, u);
			if (i < 0) return -1;
			if (yt(this.keywords, u[0]) >= 0) throw G(this._thisDoc, this.lines, e, t, "Keyword \"" + u[0] + "\" not allowed here.");
	...
	variable(e, t, n) {
		...
		for (; t < Bt(e) && sn.indexOf(e.charAt(t)) < 0;) var t = t + 1;
	...
	bareWord(e, t, n) {
		...
		if (r < 0) return -1;
		var i = e.charAt(r);
		if ("0123456789-".indexOf(i) >= 0 || sn.indexOf(i) >= 0) return -1;
		for (var t = r; t < Bt(e);) {
			var a = e.charAt(t);
			if (a === ".") {
				if (pn(e, t)) break;
			} else if (sn.indexOf(a) >= 0) break;
			var t = t + 1;
		}
	...
	qname(e, t, n) {
		...
		if (sn.indexOf(r) < 0) for (var i = r, t = t + 1; t < Bt(e);) {
			var r = e.charAt(t);
			if (r === ".") {
				if (pn(e, t)) break;
			} else if (sn.indexOf(r) >= 0) break;
			var i = i + r, t = t + 1;
		}
		else var i = "";
		if (t < Bt(e) && e.charAt(t) == ":") {
			for (var a = i, t = t + 1, i = ""; t < Bt(e);) {
				var r = e.charAt(t);
				if (r === ".") {
					if (pn(e, t)) break;
				} else if (sn.indexOf(r) >= 0) break;
			...
			return n.push(new Lt([a, i])), t;
		}
		return i && this.keywordsSet && yt(this.keywords, i) < 0 ? (n.push(new Lt(["", i])), t) : -1;
	}
	object(e, t, n) {
		...
		if (r >= 0) return r;
		{
			...
			if (s == "\"" || s == "'") {
				...
				var t = t + Bt(i), a = this.strconst(e, t, i), r = a[0], o = a[1];
	...
	nodeOrLiteral(e, t, n) {
		...
		if ("-+0987654321".indexOf(i) >= 0) {
			...
			if (a != null) {
				var o = a[0];
				r = t + o.length, o.indexOf("T") >= 0 ? n.push(this._store.literal(o, this._store.sym(an))) : n.push(this._store.literal(o, this._store.sym(rn)));
			} else {
				cn.lastIndex = 0;
				var a = cn.exec(e.slice(t));
				if (a == null) throw G(this._thisDoc, this.lines, e, t, "Bad number or date syntax");
				r = t + cn.lastIndex;
				var o = e.slice(t, r);
				o.indexOf("e") >= 0 ? n.push(this._store.literal(parseFloat(o), this._store.sym(tn))) : e.slice(t, r).indexOf(".") >= 0 ? n.push(this._store.literal(parseFloat(o), this._store.sym(nn))) : n.push(this._store.literal(parseInt(o), this._store.sym(en)));
			}
			return r;
		}
		if (e.charAt(t) == "\"") {
			...
			var t = t + Bt(s), c = null, l = this.strconst(e, t, s), r = l[0], u = l[1], d = null;
			if (e.slice(r, r + 1) == "@") {
				fn.lastIndex = 0;
				var a = fn.exec(e.slice(r + 1));
				if (a == null) throw G(this._thisDoc, startline, e, t, "Bad language code syntax on string literal, after @");
				var t = fn.lastIndex + r + 1, d = e.slice(r + 1, t), r = t;
			}
			if (e.slice(r, r + 2) == "^^") var f = new Rt([]), r = this.uri_ref2(e, r + 2, f), c = f[0];
			return n.push(this._store.literal(u, d || c)), r;
		}
		return -1;
	}
	strconst(e, t, n) {
		for (var r = t, i = "", a = this.lines; r < Bt(e);) {
			var t = r + Bt(n);
			if (e.slice(r, t) == n) return new Lt([t, i]);
			if (e.charAt(r) == "\"") {
				var i = i + "\"", r = r + 1;
				continue;
			}
			if (dn.lastIndex = 0, !dn.exec(e.slice(r))) throw G(this._thisDoc, a, e, r, "Closing quote missing in string at ^ in " + e.slice(r - 20, r) + "^" + e.slice(r, r + 20));
			var t = r + dn.lastIndex - 1, i = i + e.slice(r, t), o = e.charAt(t);
			if (o == "\"") {
				var r = t;
				continue;
			}
	...
	uEscape(e, t, n) {
		for (var r = t, i = 0, a = 0; i < 4;) {
			...
			var s = Wt("0123456789abcdef", o);
			if (s < 0) throw G(this._thisDoc, n, e, t, "bad string literal hex escape");
			var a = a * 16 + s, i = i + 1;
		}
		return new Lt([r, String.fromCharCode(a)]);
	}
	UEscape(e, t, n) {
		for (var r = t, i = 0, a = "\\U"; i < 8;) {
			var o = e.slice(r, r + 1).toLowerCase(), r = r + 1;
			if (o == "") throw G(this._thisDoc, n, e, t, "unterminated string literal(3)");
			if (Wt("0123456789abcdef", o) < 0) throw G(this._thisDoc, n, e, t, "bad string literal hex escape");
			var a = a + o, i = i + 1;
		}
		return new Lt([r, Kt("0x" + Vt(a, 2, 10) - 0)]);
	}
};
...
var _n = {
	...
	id(e) {
		return I(e) ? ge.toNT(e) : oe(e) ? je.toString(e) : Pe.id(e);
	},
	termToNQ(e) {
		return e.termType === "Collection" ? ge.toNT(e) : Pe.termToNQ(e);
	}
};
//#endregion
...
function yn(e, t) {
	let n = t["@id"] ? Sn(e, t) : e.rdfFactory.blankNode(), r = t["@list"].map((t) => vn(e, t)), i = vt(e.rdfFactory, n, r);
	return e.addAll(i), n;
}
function bn(e, t) {
	if (!Array.isArray(t)) throw TypeError("Object must be an array");
	return e.rdfFactory.collection(t.map((t) => vn(e, t)));
}
async function xn(e, t, n) {
	let r = n && Object.prototype.hasOwnProperty.call(n, "termType") ? n.value : n, i = await import("./jsonld-DMltG8dh.js").then((e) => /* @__PURE__ */ u(e.default));
	return (await (i.default || i).flatten(JSON.parse(e), null, { base: r })).reduce((e, t) => Cn(e, n, t), t);
}
function Sn(e, t) {
	return t["@id"].startsWith("_:") ? e.rdfFactory.blankNode(t["@id"].substring(2)) : e.rdfFactory.namedNode(t["@id"]);
}
function Cn(e, t, n) {
	let r = n["@id"] ? Sn(e, n) : e.rdfFactory.blankNode();
	for (let i of Object.keys(n)) {
		if (i === "@id") continue;
		if (i == "@graph") {
			let t = r, a = n[i];
			for (let n = 0; n < a.length; n++) e = Cn(e, t, a[n]);
		}
		let a = n[i];
		if (Array.isArray(a)) for (let n = 0; n < a.length; n++) e.addStatement(wn(e, r, i, a[n], t));
		else e.addStatement(wn(e, r, i, a, t));
	}
	return e;
}
function wn(e, t, n, r, i) {
	let a, o;
	return n === "@type" ? (a = e.rdfFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"), o = e.rdfFactory.namedNode(r)) : (a = e.rdfFactory.namedNode(n), o = vn(e, r)), e.rdfFactory.quad(t, a, o, e.rdfFactory.namedNode(i));
}
//#endregion
...
var Tn = /* @__PURE__ */ s(((e) => {
	...
	var t = Tn(), n = En(), r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
	...
	function c(e, t, n) {
		...
		if (me(e, ArrayBuffer) || e && me(e.buffer, ArrayBuffer) || typeof SharedArrayBuffer < "u" && (me(e, SharedArrayBuffer) || e && me(e.buffer, SharedArrayBuffer))) return h(e, t, n);
	...
	function g(e) {
		...
		if (e.length !== void 0) return typeof e.length != "number" || he(e.length) ? o(0) : p(e);
	...
	s.isBuffer = function(e) {
		...
		if (me(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), me(t, Uint8Array) && (t = s.from(t, t.offset, t.byteLength)), !s.isBuffer(e) || !s.isBuffer(t)) throw TypeError("The \"buf1\", \"buf2\" arguments must be one of type Buffer or Uint8Array");
		if (e === t) return 0;
		...
		for (n = 0; n < e.length; ++n) {
			let t = e[n];
			if (me(t, Uint8Array)) i + t.length > r.length ? (s.isBuffer(t) || (t = s.from(t)), t.copy(r, i)) : Uint8Array.prototype.set.call(r, t, i);
	...
	s.prototype.swap16 = function() {
		...
		if (me(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), !s.isBuffer(e)) throw TypeError("The \"target\" argument must be one of type Buffer or Uint8Array. Received type " + typeof e);
	...
	function T(e, t, n, r) {
		return pe(H(t, e.length - n), e, n, r);
	}
	function E(e, t, n, r) {
	...
	}, s.prototype.readBigUInt64LE = _e(function(e) {
		e >>>= 0, V(e, "offset");
	...
	}), s.prototype.readBigUInt64BE = _e(function(e) {
		e >>>= 0, V(e, "offset");
		let t = this[e], n = this[e + 7];
		(t === void 0 || n === void 0) && ce(e, this.length - 8);
	...
	s.prototype.writeBigUInt64LE = _e(function(e, t = 0) {
		return P(this, e, t, BigInt(0), BigInt("0xffffffffffffffff"));
	}), s.prototype.writeBigUInt64BE = _e(function(e, t = 0) {
	...
	}, s.prototype.writeBigInt64LE = _e(function(e, t = 0) {
		return P(this, e, t, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
	}), s.prototype.writeBigInt64BE = _e(function(e, t = 0) {
...
})))(), On = "http://www.w3.org/1999/02/22-rdf-syntax-ns#", kn = "http://www.w3.org/2001/XMLSchema#", An = "http://www.w3.org/2000/10/swap/", jn = {
	xsd: {
		decimal: `${kn}decimal`,
		boolean: `${kn}boolean`,
...
}, { xsd: Mn } = jn, Nn = 32, Pn = 9, Fn = 10, In = 13, Ln = 35, Rn = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{8})|\\([^])/g, zn = {
	"\\": "\\",
	"'": "'",
	"\"": "\"",
	n: "\n",
...
var Un = {
	...
	constructor(e) {
		if (this._iri = /^<((?:[^ <>{}\\]|\\[uU])+)>[ \t]*/, this._unescapedIri = /^<([^\x00-\x20<>\\"\{\}\|\^\`]*)>[ \t]*/, this._simpleQuotedString = /^"([^"\\\r\n]*)"(?=[^"])/, this._simpleApostropheString = /^'([^'\\\r\n]*)'(?=[^'])/, this._langcode = /^@([a-z]+(?:-[a-z0-9]+)*)(?=[^a-z0-9])/i, this._prefix = /^((?:[A-Za-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)?:(?=[#\s<])/, this._prefixed = /^((?:[A-Za-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)?:((?:(?:[0-:A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~])(?:(?:[\.\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~])*(?:[\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~]))?)?)(?:[ \t]+|(?=\.?[,;!\^\s#()\[\]\{\}"'<>]))/, this._variable = /^\?(?:(?:[A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:[\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)(?=[.,;!\^\s#()\[\]\{\}"'<>])/, this._blank = /^_:((?:[0-9A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)(?:[ \t]+|(?=\.?[,;:!\^\s#()\[\]\{\}"'<>]))/, this._number = /^[\-+]?(?:(\d+\.\d*|\.?\d+)[eE][\-+]?|\d*(\.)?)\d+(?=\.?[,;:!\^\s#()\[\]\{\}"'<>])/, this._boolean = /^(?:true|false)(?=[.,;!\^\s#()\[\]\{\}"'<>])/, this._atKeyword = /^@[a-z]+(?=[\s#<:])/i, this._keyword = /^(?:PREFIX|BASE|VERSION|GRAPH)(?=[\s#<])/i, this._n3Verb = /^(?:has|is|of)(?=[\s#()\[\]\{\}"'<>?_+\-0-9])/, this._n3Id = /^id(?=[\s#<])/, this._shortPredicates = /^a(?=[\s#()\[\]\{\}"'<>])/, this._commentLine = /^[ \t]*#([^\n\r]*)(?:\r\n|\n|\r)([ \t]*)/, this._whitespace = /^[ \t]+/, e ||= {}, this._isImpliedBy = e.isImpliedBy, this._lineMode = !!e.lineMode) {
			this._n3Mode = !1;
			for (let e in this) !(e in Un) && this[e] instanceof RegExp && (this[e] = K);
		...
		for (;;) {
			for (;;) {
				...
				if (e === Nn || e === Pn) {
					...
					a = t === Nn || t === Pn ? this._whitespace.exec(n)[0].length : 1, e = n.charCodeAt(a);
				}
				if (e === Ln) {
					let e = this._commentLine.exec(n);
					if (e) {
						let o = e[0].length;
						if (!t && o === n.length && n.charCodeAt(o - 1) === In) return this._linePosition = r - n.length, this._input = n;
					...
					if (!t && e === In && a + 1 === n.length) return this._linePosition = r - n.length, this._input = n;
					a += e === In && n.charCodeAt(a + 1) === Fn ? 2 : 1;
					let i = 0, o = n.charCodeAt(a);
					if (o === Nn || o === Pn) {
						let e = n.charCodeAt(a + 1);
						i = e === Nn || e === Pn ? this._whitespace.exec(n.slice(a))[0].length : 1;
					}
			...
			switch (c) {
				...
				case "<":
					if (f = this._unescapedIri.exec(n)) l = "IRI", u = f[1], m = f[1].length + 2;
						...
						if (u = this._unescape(f[1], zn), u === null || Vn.test(u)) return o(this);
				...
				case "-":
					...
					(f = this._number.exec(n) || t && (f = this._number.exec(`${n} `))) && (l = "literal", u = f[0], d = typeof f[1] == "string" ? Mn.double : typeof f[2] == "string" ? Mn.decimal : Mn.integer);
					break;
				case "B":
				case "b":
				case "p":
				...
				case "f":
				case "t":
					this._boolean.test(n) ? (l = "literal", u = c === "t" ? "true" : "false", d = Mn.boolean, p = u.length) : g = !0;
					break;
				case "a":
			...
			if (g && ((this._previousMarker === "@prefix" || this._previousMarker === "PREFIX") && (f = this._prefix.exec(n)) ? (l = "prefix", u = f[1] || "") : ((f = this._prefixed.exec(n)) || t && (f = this._prefixed.exec(`${n} `))) && (l = "prefixed", d = f[1] || "", u = this._unescape(f[2], Bn), m = d.length + f[2].length + 1)), this._previousMarker === "^^") switch (l) {
				case "prefixed":
					l = "type";
					break;
				case "IRI":
	...
	_unescape(e, t) {
		...
		let n = !1, r = e.replace(Rn, (e, r, i, a) => {
			if (typeof r == "string") {
				let e = Number.parseInt(r, 16);
				return Hn(e) ? String.fromCharCode(e) : (n = !0, "");
			}
			if (typeof i == "string") {
				let e = Number.parseInt(i, 16);
				return Hn(e) ? e <= 65535 ? String.fromCharCode(Number.parseInt(i, 16)) : String.fromCharCode(55296 + ((e -= 65536) >> 10), 56320 + (e & 1023)) : (n = !0, "");
			}
	...
	tokenize(e, t) {
		...
		if (this._line = 1, this._linePosition = 0, this._previousMarker = void 0, this.previousToken = void 0, this._literalClosingPos = 0, this._input = void 0, typeof e == "string") {
			...
			this._tokenization === n && this._input !== null && e.length !== 0 && (this._pendingBuffer &&= (e = Dn.Buffer.concat([this._pendingBuffer, e]), null), e[e.length - 1] & 128 ? this._pendingBuffer = e : (this._input === void 0 ? this._input = this._readStartingBom(typeof e == "string" ? e : e.toString()) : this._input += e, this._tokenizeToEnd(t, !1)));
		}), e.on("end", () => {
	...
	get datatype() {
		return new Y(this.datatypeString);
	}
	get datatypeString() {
		let e = this.id, t = e.lastIndexOf("\"") + 1, n = t < e.length ? e[t] : "";
		return n === "^" ? e.substr(t + 2) : n === "@" ? e.indexOf("--", t) > 0 ? Wn.dirLangString : Wn.langString : Gn.string;
	}
	equals(t) {
...
Kn = new class extends Jn {
	constructor() {
		return super(""), Kn || this;
	}
	get termType() {
		return "DefaultGraph";
	}
...
var Zn = class extends Jn {
	constructor(e, t, n, r) {
		super(""), this._subject = e, this._predicate = t, this._object = n, this._graph = r || Kn;
	}
	get termType() {
		return "Quad";
	}
...
function Qn(e) {
	return new Yn(e || `n3-${J++}`);
}
function $n(e, t) {
	if (typeof t == "string") return new X(`"${e}"@${t.toLowerCase()}`);
	if (t !== void 0 && !("termType" in t)) return new X(`"${e}"@${t.language.toLowerCase()}${t.direction ? `--${t.direction.toLowerCase()}` : ""}`);
	let n = t ? t.value : "";
	return n === "" && (typeof e == "boolean" ? n = Gn.boolean : typeof e == "number" ? Number.isFinite(e) ? n = Number.isInteger(e) ? Gn.integer : Gn.double : (n = Gn.double, Number.isNaN(e) || (e = e > 0 ? "INF" : "-INF")) : e instanceof Date && !Number.isNaN(e.getTime()) && (n = Gn.dateTime, e = e.toISOString())), n === "" || n === Gn.string ? new X(`"${e}"`) : new X(`"${e}"^^${n}`);
}
function er(e) {
	return new Xn(e);
}
...
function rr(e) {
	...
	switch (e.termType) {
		case "NamedNode": return Z(e.value);
		case "BlankNode": return Qn(e.value);
		case "Variable": return er(e.value);
		case "DefaultGraph": return Kn;
...
function Q(e) {
	...
	return nr(rr(e.subject), rr(e.predicate), rr(e.object), rr(e.graph));
}
//#endregion
//#region node_modules/n3/src/N3Parser.js
var ir = 0, ar = class e {
	constructor(e) {
		this._contextStack = [], this._graph = null, e ||= {}, this._setBase(e.baseIRI), e.factory && sr(this, e.factory);
	...
	_error(e, t) {
		...
		}, this._callback(r), this._callback = or;
	}
	_resolveIRI(e) {
	...
	parse(e, t, n, r) {
		let i, a, o, s;
		if (t && (t.onQuad || t.onPrefix || t.onComment || t.onVersion) ? (i = t.onQuad, a = t.onPrefix, o = t.onComment, s = t.onVersion) : (i = t, a = n, s = r), this._readCallback = this._readBeforeTopContext, this._sparqlStyle = !1, this._prefixes = Object.create(null), this._prefixes._ = this._blankNodePrefix ? this._blankNodePrefix.substr(2) : `b${ir++}_`, this._n3Mode && this._implicitEmptyPrefix && this._base && (this._prefixes[""] = this._resolveIRI("#")), this._prefixCallback = a || or, this._versionCallback = s || or, this._inversePredicate = !1, this._expectOf = !1, this._quantified = Object.create(null), this._emptyFormula = !1, !i) {
			let t = [], n;
		...
		let c = (e, t) => {
			e === null ? this._readCallback &&= this._readCallback(t) : (this._callback(e), this._callback = or);
		};
		o && (this._lexer.comments = !0, c = (e, t) => {
			e === null ? this._readCallback && (t.type === "comment" ? o(t.value) : this._readCallback = this._readCallback(t)) : (this._callback(e), this._callback = or);
...
if (ar.SUPPORTED_VERSIONS = [
	...
	"1.2-basic",
	"1.1"
], sr(ar.prototype, qn), cr === void 0) var cr = {
	ELEMENT_NODE: 1,
	ATTRIBUTE_NODE: 2,
	TEXT_NODE: 3,
...
var lr = class e {
	...
	addTriple(e, t, n, r) {
		var i = t === void 0 ? Pe.namedNode(this.options.base) : this.toRDFNodeObject(t), a, o = this.toRDFNodeObject(n), s;
		a = this.toRDFNodeObject(r), s = Pe.namedNode(this.options.base), this.kb.add(i, o, a, s);
	}
	ancestorPath(e) {
		for (var t = ""; e && e.nodeType !== cr.DOCUMENT_NODE;) t = "/" + e.localName + t, e = e.parentNode;
		return t;
	}
	copyMappings(e) {
		var t = {};
	...
	parsePrefixMappings(e, t) {
		for (var n = this.tokenize(e), r = null, i = 0; i < n.length; i++) n[i][n[i].length - 1] === ":" ? r = n[i].substring(0, n[i].length - 1) : r &&= (t[r] = this.options.base ? Oe(n[i], this.options.base) : n[i], null);
	}
	...
	process(t, n) {
		n ||= {};
		var r;
		t.nodeType === cr.DOCUMENT_NODE ? (t.baseURI && !n.baseURI && (n.baseURI = t.baseURI), r = t.baseURI, t = t.documentElement, t.baseURI || (t.baseURI = r), this.setContext(t)) : t.parentNode.nodeType === cr.DOCUMENT_NODE && this.setContext(t);
		var i = [], a = function(e) {
		...
		for (i.push({
			...
			for (var w = 0; w < l.attributes.length; w++) {
				...
				if (T.nodeName.charAt(0) === "x" && T.nodeName.indexOf("xmlns:") === 0) {
					...
					h[E] = this.options.base ? Oe(D, this.options.base) : D;
				}
			}
			...
			if (f && f !== u.parentObject && (v = {}, y = !0), p) {
				...
				if (k) for (let t = 0; t < z.length; t++) this.addTriple(l, p, z[t], {
					type: e.objectURI,
					value: f
				});
			} else {
				...
				if (k) for (let e = 0; e < z.length; e++) _.push({
					predicate: z[e],
					forward: !1
				});
			}
			if (ne) {
				var B = null, V = null;
				re ? (B = re.value === "" ? e.PlainLiteralURI : this.parseTermOrCURIEOrAbsURI(re.value, x, u.terms, h, r), V = j && !ie ? j.value : B === e.XMLLiteralURI || B === e.HTMLLiteralURI ? null : ie ? ie.value : l.textContent) : ie ? (B = e.PlainLiteralURI, V = ie.value) : j ? (V = j.value, B = e.deriveDateTimeType(V), B ||= e.PlainLiteralURI) : !te && !k && (P && (V = this.parseSafeCURIEOrCURIEOrURI(P.value, h, r)), !V && ae ? V = this.resolveAndNormalize(r, encodeURI(ae.value)) : !V && N && (V = this.resolveAndNormalize(r, encodeURI(N.value))), V && (B = e.objectURI)), B || (A && !M ? (B = e.objectURI, V = m) : (V = l.textContent, this.inHTMLMode && l.localName === "time" && (B = e.deriveDateTimeType(V)), B ||= e.PlainLiteralURI)), R = this.tokenize(ne.value);
				for (let t = 0; t < R.length; t++) {
			...
			for (var ue = l.lastChild; ue; ue = ue.previousSibling) ue.nodeType === cr.ELEMENT_NODE && i.unshift({
				current: ue,
				context: ce
			});
		}
	...
	toRDFNodeObject(t) {
		if (t !== void 0) {
			if (typeof t == "string") return t.substring(0, 2) === "_:" ? (this.blankNodes[t.substring(2)] === void 0 && (this.blankNodes[t.substring(2)] = new N(t.substring(2))), this.blankNodes[t.substring(2)]) : Pe.namedNode(t);
			switch (t.type) {
				case e.objectURI: return t.value.substring(0, 2) === "_:" ? (this.blankNodes[t.value.substring(2)] === void 0 && (this.blankNodes[t.value.substring(2)] = new N(t.value.substring(2))), this.blankNodes[t.value.substring(2)]) : Pe.namedNode(t.value);
				case e.PlainLiteralURI: return new me(t.value, t.language || "");
				case e.XMLLiteralURI:
				case e.HTMLLiteralURI:
					var n = "";
					return Object.keys(t.value).forEach((e) => {
						n += $e(t.value[e], this.htmlOptions);
					}), new me(n, "", new U(t.type));
				default: return new me(t.value, "", new U(t.type));
			}
		}
	}
	trim(e) {
...
lr.XMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral", lr.HTMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML", lr.PlainLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral", lr.objectURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#object", lr.typeURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", lr.nameChar = "[-A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�က0-F.0-9·̀-ͯ‿-⁀]", lr.nameStartChar = "[A-Za-zÀ-ÖØ-öø-ÿĀ-ıĴ-ľŁ-ňŊ-žƀ-ǃǍ-ǰǴ-ǵǺ-ȗɐ-ʨʻ-ˁΆΈ-ΊΌΎ-ΡΣ-ώϐ-ϖϚϜϞϠϢ-ϳЁ-ЌЎ-яё-ќў-ҁҐ-ӄӇ-ӈӋ-ӌӐ-ӫӮ-ӵӸ-ӹԱ-Ֆՙա-ֆא-תװ-ײء-غف-يٱ-ڷں-ھۀ-ێې-ۓەۥ-ۦअ-हऽक़-ॡঅ-ঌএ-ঐও-নপ-রলশ-হড়-ঢ়য়-ৡৰ-ৱਅ-ਊਏ-ਐਓ-ਨਪ-ਰਲ-ਲ਼ਵ-ਸ਼ਸ-ਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઋઍએ-ઑઓ-નપ-રલ-ળવ-હઽૠଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଶ-ହଽଡ଼-ଢ଼ୟ-ୡஅ-ஊஎ-ஐஒ-கங-சஜஞ-டண-தந-பம-வஷ-ஹఅ-ఌఎ-ఐఒ-నప-ళవ-హౠ-ౡಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹೞೠ-ೡഅ-ഌഎ-ഐഒ-നപ-ഹൠ-ൡก-ฮะา-ำเ-ๅກ-ຂຄງ-ຈຊຍດ-ທນ-ຟມ-ຣລວສ-ຫອ-ຮະາ-ຳຽເ-ໄཀ-ཇཉ-ཀྵႠ-Ⴥა-ჶᄀᄂ-ᄃᄅ-ᄇᄉᄋ-ᄌᄎ-ᄒᄼᄾᅀᅌᅎᅐᅔ-ᅕᅙᅟ-ᅡᅣᅥᅧᅩᅭ-ᅮᅲ-ᅳᅵᆞᆨᆫᆮ-ᆯᆷ-ᆸᆺᆼ-ᇂᇫᇰᇹḀ-ẛẠ-ỹἀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼΩK-Å℮ↀ-ↂぁ-ゔァ-ヺㄅ-ㄬ가-힣一-龥〇〡-〩_]", lr.NCNAME = RegExp("^" + lr.nameStartChar + lr.nameChar + "*$"), lr.dateTimeTypes = [
	{
...
var ur = lr.parseRDFaDOM, dr = class e {
	constructor(e) {
	...
	frameFactory(t, n, r) {
		return {
			...
			addSymbol: function(e, t) {
				t = Oe(t, this.base), this.node = this.store.sym(t), this.nodeType = e;
			},
			loadTriple: function() {
				if (this.parent.parent.collection ? this.parent.parent.node.append(this.node) : this.store.add(this.parent.parent.node, this.parent.node, this.node, this.parser.why), this.parent.rdfid != null) {
					var t = this.store.sym(Oe("#" + this.parent.rdfid, this.base));
		...
		for (var n, r = function(e) {
			...
			if (a.nodeType === e.nodeType.TEXT || a.nodeType === e.nodeType.CDATA_SECTION) t.parent.nodeType === t.NODE && (t.addArc(e.ns.RDF + "value"), t = this.buildFrame(t)), t.addLiteral(a.nodeValue);
				...
				if (t.parent && t.parent.collection && (t.addCollectionArc(), t = this.buildFrame(t, t.element), t.parent.element = null), !t.parent || !t.parent.nodeType || t.parent.nodeType === t.ARC) {
					...
					e.ns.RDF + "Description" !== r(a) && (l = { nodeValue: r(a) }), l != null && (this.store.add(t.node, this.store.sym(e.ns.RDF + "type"), this.store.sym(Oe(l.nodeValue, t.base)), this.why), l.nodeName && a.removeAttributeNode(l));
	...
	buildFrame(t, n) {
		...
		for (var s = i.length - 1; s >= 0; s--) if (i[s].nodeName.substr(0, 3) === "xml") {
			if (i[s].name.slice(0, 6) === "xmlns:") {
				var c = i[s].nodeValue;
				this.base && (c = Oe(c, this.base)), this.store.setPrefixForURI(i[s].name.slice(6), c);
			}
...
function fr(e, t, n) {
	var r, i, a, o = [
		...
		"DELETE",
		"WHERE"
	], s = Fe("http://www.w3.org/ns/pim/patch#"), c = mn(t, t, n, n, null, null, "", null), l = {}, u = function(e, t, n, r, i) {
...
function pr(e, t, n, r = "text/turtle", i) {
	r ||= "text/turtle", r = r.split(";")[0];
	try {
		if (r === "text/n3" || r === "text/turtle") mn(t, t, n, n, null, null, "", null).loadBuf(e), o();
		else if (r === "application/rdf+xml") new dr(t).parse(at(e), n, t.sym(n)), o();
		else if (r === "application/xhtml+xml") ur(at(e, { contentType: M }), t, n), o();
		else if (r === "text/html") ur(at(e, { contentType: D }), t, n), o();
		else if (r === "application/sparql-update" || r === "application/sparql-update-single-match") fr(e, t, n), o();
		else if (r === "application/ld+json") xn(e, t, n).then(o).catch(s);
		else if (r === "application/n-quads" || r === "application/nquads") {
			var a = new ar({ factory: _n });
			c(null, e);
...
var mr = /* @__PURE__ */ u((/* @__PURE__ */ s(((e, t) => {
	...
	link: Fe("http://www.w3.org/2007/ont/link#", e),
	http: Fe("http://www.w3.org/2007/ont/http#", e),
	httph: Fe("http://www.w3.org/2007/ont/httph#", e),
	rdf: Fe("http://www.w3.org/1999/02/22-rdf-syntax-ns#", e),
	rdfs: Fe("http://www.w3.org/2000/01/rdf-schema#", e),
	dc: Fe("http://purl.org/dc/elements/1.1/", e),
	ldp: Fe("http://www.w3.org/ns/ldp#", e)
}), vr = _r(), yr = class {
	constructor(e, t) {
...
var br = class extends yr {
	...
	parse(e, t, n) {
		...
		return n.noMeta || r.add(n.original, vr.rdf("type"), vr.link("RDFDocument"), e.appNode), e.doneFetch(n, this.response);
	}
};
br.pattern = /* @__PURE__ */ RegExp("application/rdf\\+xml");
var xr = class extends yr {
	...
	parse(e, t, n) {
		...
		o.length > 0 && a.add(n.resource, vr.dc("title"), a.rdfFactory.literal(o[0].textContent), n.resource);
		...
		for (let e = 0; e < c.length; e++) {
			...
			hr[t] && (pr(c[e].textContent, a, n.original.value, t), pr(c[e].textContent, a, n.original.value, t));
		}
		if (n.noMeta || a.add(n.resource, vr.rdf("type"), vr.link("WebPage"), e.appNode), !n.noRDFa && ur) try {
			ur(this.dom, a, n.original.value);
		} catch (t) {
...
xr.pattern = /* @__PURE__ */ RegExp("application/xhtml");
var Sr = class e extends yr {
	static toString() {
		return "XMLHandler";
	}
	static register(e) {
...
var Cr = class extends yr {
	...
	parse(e, t, n) {
		let r = e.store;
		if (kr(t)) return e.addStatus(n.req, "Has an XML declaration. We'll assume it's XHTML as the content-type was text/html.\n"), new xr(this.response).parse(e, t, n);
		if (Or(t)) return e.addStatus(n.req, "Has XHTML DOCTYPE. Switching to XHTMLHandler.\n"), new xr(this.response).parse(e, t, n);
		if (Ar(t)) return e.addStatus(n.req, "Has default namespace for XHTML, so switching to XHTMLHandler.\n"), new xr(this.response).parse(e, t, n);
		let i = (/* @__PURE__ */ RegExp("<title>([\\s\\S]+?)</title>", "im")).exec(t);
		return i && r.add(n.resource, vr.dc("title"), r.rdfFactory.literal(i[1]), n.resource), r.add(n.resource, vr.rdf("type"), vr.link("WebPage"), e.appNode), e.addStatus(n.req, "non-XML HTML document, not parsed for data."), e.doneFetch(n, this.response);
	}
};
...
var wr = class extends yr {
	...
	async parse(e, t, n, r) {
		let i = e.store;
		try {
			return await xn(t, i, n.original.value), e.store.add(n.original, vr.rdf("type"), vr.link("RDFDocument"), e.appNode), e.doneFetch(n, r);
		} catch (t) {
...
wr.pattern = /application\/(ld\+json|activity\+json)/;
var Tr = class extends yr {
	static toString() {
		return "TextHandler";
	}
	static register(e) {
...
var Er = class extends yr {
	...
	parse(e, t, n, r) {
		let i = e.store, a = mn(i, i, n.original.value, n.original.value, null, null, "", null);
		try {
			a.loadBuf(t);
		} catch (t) {
		...
		return e.addStatus(n.req, "N3 parsed: " + a.statementCount + " triples in " + a.lines + " lines."), e.store.add(n.original, vr.rdf("type"), vr.link("RDFDocument"), e.appNode), e.doneFetch(n, this.response);
	}
};
Er.pattern = /* @__PURE__ */ RegExp("(application|text)/(x-)?(rdf\\+)?(n3|turtle)");
var Dr = {
	RDFXMLHandler: br,
	XHTMLHandler: xr,
	XMLHandler: Sr,
...
var jr = class e {
	constructor(e, t = {}) {
		g(this, "store", void 0), g(this, "timeout", void 0), g(this, "_fetch", void 0), g(this, "mediatypes", void 0), g(this, "appNode", void 0), g(this, "requested", void 0), g(this, "timeouts", void 0), g(this, "redirectedTo", void 0), g(this, "fetchQueue", void 0), g(this, "fetchCallbacks", void 0), g(this, "nonexistent", void 0), g(this, "lookedUp", void 0), g(this, "handlers", void 0), g(this, "ns", void 0), g(this, "fireCallbacks", void 0), this.store = e || new kt(), this.ns = _r(this.store.rdfFactory), this.timeout = t.timeout || 3e4;
		let n = t.fetch || typeof global < "u" && (global.solidFetcher || global.solidFetch) || typeof window < "u" && (window.solidFetcher || window.solidFetch) || mr.default;
		...
		this._fetch = typeof window < "u" && n === window.fetch ? n.bind(window) : typeof global < "u" && n === global.fetch ? n.bind(global) : n, this.appNode = this.store.sym("chrome://TheCurrentSession"), this.store.fetcher = this, this.requested = {}, this.timeouts = {}, this.redirectedTo = {}, this.fetchQueue = {}, this.fetchCallbacks = {}, this.nonexistent = {}, this.lookedUp = {}, this.handlers = [], this.mediatypes = {
			...
			"retract",
			"done"
		]), Object.keys(t.handlers || Dr).map((e) => this.addHandler(Dr[e]));
	}
	...
	static offlineOverride(e) {
		let t = e;
		var n;
		return typeof window < "u" && window.panes && (n = window.panes.UI) && n.preferences && n.preferences.get("offlineModeUsingLocalhost") && t.slice(0, 7) === "http://" && t.slice(7, 17) !== "localhost/" && (t = "http://localhost/" + t.slice(7), W.warn("Localhost kludge for offline use: actually getting <" + t + ">")), t;
	}
	...
	nowOrWhenFetched(e, t, n, r = {}) {
		let i = P(e);
		typeof t == "function" ? n = t : t === void 0 || (ce(t) ? r.referringTerm = t : r = t), this.load(i, r).then((e) => {
			if (n) {
				if (e) {
					if (e.ok) n(!0, "OK", e);
					else {
	...
	addStatus(e, t) {
		...
		I(i) ? i.append(r.rdfFactory.literal(t)) : W.warn("web.js: No list to add to: " + i + "," + t);
	}
	failFetch(e, t, n, r) {
		...
		(i === "GET" || i === "HEAD") && (e.resource.equals(e.original), this.requested[Te(e.original.value)] = n, this.fireCallbacks("fail", [e.original.value, t]));
		var a = /* @__PURE__ */ Error("Fetcher: " + t);
		return a.status = n, a.statusText = t, a.response = r, Promise.reject(a);
	}
	linkData(e, t, n, r, i) {
		if (!n) return;
		let a = this.store, o = a.rdfFactory.namedNode(Oe(n, e.value)), s;
	...
	ianaLinkRelation(e) {
		return Oe(encodeURIComponent(e), "http://www.iana.org/assignments/link-relations/");
	}
	...
	putBack(e, t = {}) {
		...
		return t.contentType = t["content-type"] || t["Content-Type"] || t.contentType || "text/turtle", t.contentType === "application/ld+json" ? new Promise((n, i) => {
			ht(r, this.store, r.uri, t.contentType, (r, a) => {
				r ? i(r) : (t.data = a, this.webOperation("PUT", e, t).then((e) => n(e)).catch((e) => i(e)));
			});
		}) : (t.data = ht(r, this.store, r.value, t.contentType), this.webOperation("PUT", n, t));
	}
	webCopy(e, t, n) {
	...
	lookUpThing(e, t) {
		...
		return n = n.map((e) => Te(e)), n.forEach((e) => {
			this.lookedUp[e] = !0;
	...
	saveRequestMetadata(e, t) {
		...
		this.addStatus(t.req, "Accept: " + t.headers.accept), ce(i) && r.add(r.rdfFactory.namedNode(e), this.ns.link("requestedBy"), i, this.appNode), t.original && t.original.value !== e && r.add(n, this.ns.link("orginalURI"), r.rdfFactory.literal(t.original.value), this.appNode);
	...
	saveResponseMetadata(e, t) {
		...
		return n.add(t.req, this.ns.link("response"), r, this.appNode), n.add(r, this.ns.http("status"), n.rdfFactory.literal(e.status), this.appNode), n.add(r, this.ns.http("statusText"), n.rdfFactory.literal(e.statusText), this.appNode), e.headers.forEach((e, i) => {
			n.add(r, this.ns.httph(i), this.store.rdfFactory.literal(e), this.appNode), i === "content-type" && n.add(t.resource, this.ns.rdf("type"), n.rdfFactory.namedNode(Ye(e).value), this.appNode);
		}), r;
	}
	objectRefresh(e) {
		let t = this.store.uris(e);
		if (t !== void 0) for (let e = 0; e < t.length; e++) this.refresh(this.store.rdfFactory.namedNode(Te(t[e])));
	}
	refresh(e, t) {
	...
	retract(e) {
		this.store.removeMany(void 0, void 0, void 0, e), e.value && delete this.requested[Te(e.value)], this.fireCallbacks("retract", arguments);
	}
	getState(e) {
	...
	handleResponse(e, t, n) {
		...
		var l = null, u = null;
		if (c && (u = Oe(c, t), u !== t && (l = u)), e.status === 200) {
...
g(jr, "HANDLERS", void 0), g(jr, "CONTENT_TYPE_BY_EXT", void 0), g(jr, "crossSiteProxyTemplate", void 0), jr.HANDLERS = Dr, jr.CONTENT_TYPE_BY_EXT = gr;
//#endregion
...
function Nr(e) {
	...
	function r(e) {
		...
		for (var r in n) W.debug("Found statement: " + n), t += s() + n[r] + "\n";
		return t;
	}
	function i(e) {
		var t = "";
	...
	function a(e) {
		for (var n = "", o = 0; o < e.optional.length; o++) W.debug("Found optional query"), n += s() + "OPTIONAL { \n", t++, n += r(e.optional[o]), n += i(e.optional[o]), n += a(e.optional[o]), t--, n += s() + "}\n";
		return n;
	}
	function o(e) {
		var n = s() + "WHERE \n{ \n";
...
function Pr(e, t, n) {
	...
	function h(e) {
		...
		else return W.error("SQARQL QUERY OOPS!"), a;
		a[0] = e.slice(0, s);
		var c = e.slice(s + 1).indexOf(o);
		if (c === -1) return W.error("SPARQL parsing error: no matching parentheses in literal " + e), e;
		var l;
		return e.slice(c + s + 2).match(/^\^\^/) ? (l = e.slice(c + s + 2).indexOf(" "), a[1] = n.literal(e.slice(s + 1, s + 1 + c), n.sym(m(e.slice(s + 4 + c, s + 2 + c + l)))), a = a.concat(h(e.slice(c + s + 3 + l)))) : e.slice(c + s + 2).match(/^@/) ? (l = e.slice(c + s + 2).indexOf(" "), a[1] = n.literal(e.slice(s + 1, s + 1 + c), e.slice(s + 3 + c, s + 2 + c + l), null), a = a.concat(h(e.slice(c + s + 2 + l)))) : (a[1] = n.literal(e.slice(s + 1, s + 1 + c)), W.info("Literal found: " + a[1]), a = a.concat(h(e.slice(c + s + 2)))), a;
	}
	function g(e) {
		e = e.replace(/\(/g, " ( ").replace(/\)/g, " ) ").replace(/</g, " <").replace(/>/g, "> ").replace(/{/g, " { ").replace(/}/g, " } ").replace(/[\t\n\r]/g, " ").replace(/; /g, " ; ").replace(/\. /g, " . ").replace(/, /g, " , "), W.info("New str into spaceDelimit: \n" + e);
		var t = [], n = e.split(" ");
	...
	function v(e) {
		for (var t = [], r = 0; r < e.length; r++) {
			...
			e[r] = s(e[r]), o(e[r]) ? t[r] = i(e[r].slice(1)) : l(e[r]) ? (W.info(e[r] + " was identified as a bnode."), t[r] = n.bnode()) : c(e[r]) ? (W.info(e[r] + " was identified as a symbol."), t[r] = n.sym(m(e[r]))) : d(e[r]) ? (W.info(e[r] + " was identified as a prefixed symbol"), ne[f(e[r])] ? t[r] = n.sym(e[r] = ne[f(e[r])] + p(e[r])) : (W.error("SPARQL error: " + e[r] + " with prefix " + f(e[r]) + " does not have a correct prefix entry."), t[r] = e[r])) : t[r] = e[r];
		}
		return t;
	}
	function y(e) {
		...
		return n = _(n), W.info("SPARQL Tokens: " + n), n;
	}
	function b(e, t) {
	...
	function S(e, t) {
		for (var n in W.info("SPARQL vars: " + e), e) if (o(e[n])) {
			W.info("Added " + e[n] + " to query variables from SPARQL");
			var r = i(e[n].slice(1));
			t.vars.push(r), r.label = e[n].slice(1);
		} else W.warn("Incorrect SPARQL variable in SELECT: " + e[n]);
	}
	function C(e) {
		var t = x("PREFIX", e), n = [];
		for (var r in t) {
			var i = e[t[r] + 1], a = e[t[r] + 2];
			if (!u(i)) W.error("Invalid SPARQL prefix: " + i);
			else if (!c(a)) W.error("Invalid SPARQL symbol: " + a);
			else {
				W.info("Prefix found: " + i + " -> " + a);
				var o = f(i);
				n[o] = m(a);
			}
		}
	...
	function w(e, t, n) {
		W.info("Looking for a close bracket of type " + n + " in " + e);
		for (var r = 0, i = 0; i < e.length; i++) if (e[i] === t && r++, e[i] === n && r--, r < 0) return i;
		return W.error("Statement had no close parenthesis in SPARQL query"), 0;
	}
	function T(e) {
	...
	function D(e, t) {
		e.length === 3 && e[0].termType === "Variable" && (e[2].termType === "NamedNode" || e[2].termType === "Literal") ? e[1] === "=" || e[1] === ">" || e[1] === "<" ? (W.debug("Constraint added: " + e), t.constraints[e[0]] = new T(e[2])) : W.warn("I don't know how to handle the constraint: " + e) : e.length === 6 && typeof e[0] == "string" && e[0].toLowerCase() === "regexp" && e[1] === "(" && e[5] === ")" && e[3] === "," && e[4].termType === "Variable" && e[2].termType === "Literal" && (W.debug("Constraint added: " + e), t.constraints[e[4]] = new E(e[2].value));
	}
	function O(e, t) {
		W.debug("Optional query: " + e + " not yet implemented.");
		var r = n.formula();
	...
	function ee(e, t) {
		var n = v(e), r;
		W.debug("WHERE: " + n);
		for (var i; b("OPTIONAL", n);) i = b("OPTIONAL", n), W.debug("OPT: " + i + " " + n[i] + " in " + n), n[i + 1] !== "{" && W.warn("Bad optional opening bracket in word " + i), r = w(n.slice(i + 2), "{", "}"), r === -1 ? W.error("No matching bracket in word " + i) : (O(n.slice(i + 2, i + 2 + r), t), i = b("OPTIONAL", n), r = w(n.slice(i + 2), "{", "}"), n.splice(i, r + 3));
		for (W.debug("WHERE after optionals: " + n); b("FILTER", n);) {
			var a = b("FILTER", n);
			n[a + 1] !== "(" && W.warn("Bad filter opening bracket in word " + a), r = w(n.slice(a + 2), "(", ")"), r === -1 ? W.error("No matching bracket in word " + a) : (D(n.slice(a + 2, a + 2 + r), t), a = b("FILTER", n), r = w(n.slice(a + 2), "(", ")"), n.splice(a, r + 3));
		}
		W.debug("WHERE after filters and optionals: " + n), te(n, t);
	}
	function te(e, t) {
		var n = [,];
		n[0] = -1;
		...
		for (a in i) {
			...
			for (a in c) {
				...
				for (a in f) {
					var p = f[a][0];
					W.info("Subj=" + o + " Pred=" + u + " Obj=" + p), t.add(o, u, p);
				}
			}
		}
	}
	W.info("SPARQL input: \n" + e);
	var k = new Ct(), A = y(e), ne = C(A);
	ne.rdf ||= "http://www.w3.org/1999/02/22-rdf-syntax-ns#", ne.rdfs ||= "http://www.w3.org/2000/01/rdf-schema#";
	var re = b("SELECT", A), j = b("WHERE", A);
	if (re < 0 || j < 0 || re > j) return W.error("Invalid or nonexistent SELECT and WHERE tags in SPARQL query"), !1;
...
var Fr = class {
	constructor(e) {
		if (g(this, "store", void 0), g(this, "ifps", void 0), g(this, "fps", void 0), g(this, "patchControl", void 0), g(this, "ns", void 0), e ||= new kt(), e.updater) throw Error("You can't have two UpdateManagers for the same store");
		e.fetcher || (e.fetcher = new jr(e)), this.store = e, e.updater = this, this.ifps = {}, this.fps = {}, this.ns = {}, this.ns.link = Fe("http://www.w3.org/2007/ont/link#"), this.ns.http = Fe("http://www.w3.org/2007/ont/http#"), this.ns.httph = Fe("http://www.w3.org/2007/ont/httph#"), this.ns.ldp = Fe("http://www.w3.org/ns/ldp#"), this.ns.rdf = Fe("http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.ns.rdfs = Fe("http://www.w3.org/2000/01/rdf-schema#"), this.ns.rdf = Fe("http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.ns.owl = Fe("http://www.w3.org/2002/07/owl#"), this.patchControl = [];
	}
	patchControlFor(e) {
	...
	editable(e, t) {
		...
		for (var a = t.each(void 0, this.ns.link("requestedURI"), Te(e), i), o, s = 0; s < a.length; s++) if (n = a[s], n !== void 0) {
	...
	updateDav(e, t, n, r, i = {}) {
		...
		for (let e = 0; e < t.length; e++) ot(l, t[e]);
		for (let e = 0; e < n.length; e++) l.push(n[e]);
		let u = this.serialize(e.value, l, c);
		var d = a.the(s, this.ns.httph("content-location")), f;
		return d && (f = Oe(d.value, f)), i.contentType = c, i.noMeta = !0, i.body = u, a.fetcher.webOperation("PUT", f, i).then((i) => {
	...
	updateLocalFile(e, t, n, r, i = {}) {
		...
		for (let e = 0; e < t.length; e++) ot(o, t[e]);
		...
		let l = jr.CONTENT_TYPE_BY_EXT[c];
	...
	graph(e = void 0, t = void 0) {
		return new kt(e, t || { rdfFactory: _n });
	},
	lit(e, t, n) {
...
var { fetcher: Vr, graph: Hr, lit: Ur, st: Wr, namedNode: Gr, variable: Kr, blankNode: qr, defaultGraph: Jr, literal: Yr, quad: Xr, triple: Zr } = Br, Qr = new bt(), $r = (e) => Qr.fromNT(e), ei = xt.fromValue, $ = N.nextId, ti = class extends kt {
	constructor(e) {
		super(e), g(this, "fetcher", void 0), this.fetcher = new jr(this, {});
	}
}, ni = class extends ti {
	constructor(e) {
		super(e), g(this, "updater", void 0), this.updater = new Fr(this);
	}
}, ri = (0, f.default)(zr), ii = (0, f.default)(zr), ai = Gr("http://www.iana.org/assignments/link-relations/acl");
function oi(e) {
	let t = ii;
	async function n(t) {
	...
	function i(t) {
		...
		return n.load(t).then((n) => {
			...
			let r = e.any(e.sym(t), ai);
			if (!r) throw Error("fetchACLRel: No Link rel=ACL header for " + t);
			return r;
		});
	}
	function a(e, n, r, i = {}) {
		let a = i.public || [], o = Hr(), s = Fe("http://www.w3.org/ns/auth/acl#"), c = o.sym(`${r}#a1`), l = o.sym(r), u = o.sym(e);
...
function ui() {
	...
	if (e !== void 0 && e.username) return si("Assuming the user is " + e.username), Gr(e.username);
	if (typeof document < "u" && document.location && ("" + document.location).slice(0, 16) === "http://localhost") {
		...
		return t ? (si("Assuming user is " + t), Gr(t)) : null;
	}
	return null;
}
//#endregion
...
}, fi = class extends di {}, pi = class extends di {}, mi = class extends di {}, hi = class extends di {}, gi = class extends di {}, _i = class extends di {
	constructor(e, t) {
...
function xi(e) {
	return Gr(e.uri.replace("/profile/", "/").replace("/public/", "/").split("/").slice(0, -1).join("/") + "/settings/prefs.ttl");
}
function Si(e, t) {
	return new U(new URL(`IndividualChats/${new URL(e.value).host}/`, t.value).toString());
}
//#endregion
...
function Ti(e, t, n, r) {
	...
	async function s(t, a) {
		...
		try {
			...
			if (n) s = n;
				...
				try {
					...
					ci(`User ${t} has no usable profile document directory for publicTypeIndex.`);
				}
				e && (s = await r.followOrCreateLinkWithContentOnCreate(t, i.solid("publicTypeIndex"), e, o, Ci()));
			}
		} catch (e) {
			ci(`User ${t} has no pointer in profile to publicTypeIndex file: ${e}`);
		}
		let c = s ? [{
			label: "public",
			index: s,
		...
		if (l) {
			...
			if (a) try {
				...
				ci(`User ${t} has no usable preferences document directory for privateTypeIndex.`);
			}
			let s = null;
			try {
				let c = e.any(t, i.solid("privateTypeIndex"), void 0, o);
				c ? s = c : a && n && (s = await r.followOrCreateLinkWithContentOnCreate(t, i.solid("privateTypeIndex"), n, l, wi()));
			} catch (e) {
				ci(`User ${t} has no pointer in preference file to privateTypeIndex file: ${e}`);
			}
			u = s ? [{
				label: "private",
				index: s,
		...
		try {
			...
			ci("Problems loading type index: ", e);
		}
		return d;
	}
	async function c(e) {
	...
	async function u(t) {
		...
		try {
			...
			ci(`User ${t} has no pointer in profile to preferences file.`);
		}
		if (r) {
			...
			for (let e of n) {
				if (e.termType !== "NamedNode" || !a(e.uri)) {
					ci(`Skipping malformed community node for ${t}: ${e}`);
					continue;
				}
				try {
					o = o.concat(await c(e));
				} catch (t) {
					ci(`Skipping community type indexes for ${e.uri}: ${t}`);
				}
			}
			return o;
		}
	...
	function m(e) {
		...
		let r = t.uri;
		if (!r || !a(r)) return si(`docDirUri: missing or non-http(s) doc uri for ${e?.uri}`), null;
		let i = r.split("#")[0], o = i.lastIndexOf("/");
		return o === -1 ? (si(`docDirUri: no slash in doc uri ${r}`), null) : i.slice(0, o + 1);
	}
	function h(e) {
		let t = m(e);
		if (!t) throw Error(`suggestPublicTypeIndex: Cannot derive directory for ${e.uri}`);
		return Gr(t + "publicTypeIndex.ttl");
	}
	function g(e) {
		let t = m(e);
		if (!t) throw Error(`suggestPrivateTypeIndex: Cannot derive directory for ${e.uri}`);
		return Gr(t + "privateTypeIndex.ttl");
	}
	async function _(t, n, r) {
		let a = vi(n), o = [
			Wr(a, i.rdf("type"), i.solid("TypeRegistration"), n),
			Wr(a, i.solid("forClass"), r, n),
			Wr(a, i.solid("instance"), t, n)
		];
		try {
...
var Ei = crypto, Di = (e) => e instanceof CryptoKey, Oi = async (e, t) => {
	let n = `SHA-${e.slice(-3)}`;
	return new Uint8Array(await Ei.subtle.digest(n, t));
}, ki = new TextEncoder(), Ai = new TextDecoder();
function ji(...e) {
...
var Mi = (e) => {
	let t = e;
	typeof t == "string" && (t = ki.encode(t));
	let n = 32768, r = [];
	for (let e = 0; e < t.length; e += n) r.push(String.fromCharCode.apply(null, t.subarray(e, e + n)));
	return btoa(r.join(""));
}, Ni = (e) => Mi(e).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_"), Pi = (e) => {
	let t = atob(e), n = new Uint8Array(t.length);
	for (let e = 0; e < t.length; e++) n[e] = t.charCodeAt(e);
	return n;
}, Fi = (e) => {
	let t = e;
	t instanceof Uint8Array && (t = Ai.decode(t)), t = t.replace(/-/g, "+").replace(/_/g, "/").replace(/\s/g, "");
	try {
		return Pi(t);
	} catch {
...
Li.code = "ERR_JWT_CLAIM_VALIDATION_FAILED";
...
Xi.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
function Zi(e, t = "algorithm.name") {
...
function na(e, t, ...n) {
	switch (t) {
		...
		case "HS384":
		case "HS512": {
			if (!Qi(e.algorithm, "HMAC")) throw Zi("HMAC");
			let n = parseInt(t.slice(2), 10);
			if ($i(e.algorithm.hash) !== n) throw Zi(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "RS256":
		case "RS384":
		case "RS512": {
			if (!Qi(e.algorithm, "RSASSA-PKCS1-v1_5")) throw Zi("RSASSA-PKCS1-v1_5");
			let n = parseInt(t.slice(2), 10);
			if ($i(e.algorithm.hash) !== n) throw Zi(`SHA-${n}`, "algorithm.hash");
			break;
		}
		...
		case "PS384":
		case "PS512": {
			if (!Qi(e.algorithm, "RSA-PSS")) throw Zi("RSA-PSS");
			let n = parseInt(t.slice(2), 10);
			if ($i(e.algorithm.hash) !== n) throw Zi(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "EdDSA":
			if (e.algorithm.name !== "Ed25519" && e.algorithm.name !== "Ed448") throw Zi("Ed25519 or Ed448");
			break;
		case "Ed25519":
			if (!Qi(e.algorithm, "Ed25519")) throw Zi("Ed25519");
			break;
		case "ES256":
		case "ES384":
		case "ES512": {
			if (!Qi(e.algorithm, "ECDSA")) throw Zi("ECDSA");
			let n = ea(t);
			if (e.algorithm.namedCurve !== n) throw Zi(n, "algorithm.namedCurve");
			break;
		}
...
var ia = (e, ...t) => ra("Key must be ", e, ...t);
function aa(e, t, ...n) {
	return ra(`Key for the ${e} algorithm must be `, t, ...n);
}
var oa = (e) => Di(e) ? !0 : e?.[Symbol.toStringTag] === "KeyObject", sa = ["CryptoKey"], ca = (...e) => {
...
function ua(e) {
	if (!la(e) || Object.prototype.toString.call(e) !== "[object Object]") return !1;
...
function fa(e) {
	return ua(e) && typeof e.kty == "string";
}
function pa(e) {
...
function ga(e) {
	...
	switch (e.kty) {
		case "RSA":
			switch (e.alg) {
				...
				case "RSA-OAEP-512":
					...
					break;
				default: throw new Bi("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
			}
			break;
		case "EC":
			switch (e.alg) {
		...
		case "OKP":
			...
			break;
		default: throw new Bi("Invalid or unsupported JWK \"kty\" (Key Type) Parameter value");
	}
	return {
		algorithm: t,
		keyUsages: n
...
var _a = async (e) => {
	...
	let { algorithm: t, keyUsages: n } = ga(e), r = [
		t,
		e.ext ?? !1,
		e.key_ops ?? n
	], i = { ...e };
	return delete i.alg, delete i.use, Ei.subtle.importKey("jwk", i, ...r);
}, va = (e) => Fi(e), ya, ba, xa = (e) => e?.[Symbol.toStringTag] === "KeyObject", Sa = async (e, t, n, r, i = !1) => {
	let a = e.get(t);
	if (a?.[r]) return a[r];
	let o = await _a({
		...n,
	...
	normalizePublicKey: (e, t) => {
		if (xa(e)) {
			...
			return delete n.d, delete n.dp, delete n.dq, delete n.p, delete n.q, delete n.qi, n.k ? va(n.k) : (ba ||= /* @__PURE__ */ new WeakMap(), Sa(ba, e, n, t));
		}
		return fa(e) ? e.k ? Fi(e.k) : (ba ||= /* @__PURE__ */ new WeakMap(), Sa(ba, e, e, t, !0)) : e;
	},
	normalizePrivateKey: (e, t) => {
		if (xa(e)) {
			let n = e.export({ format: "jwk" });
			return n.k ? va(n.k) : (ya ||= /* @__PURE__ */ new WeakMap(), Sa(ya, e, n, t));
		}
		return fa(e) ? e.k ? Fi(e.k) : (ya ||= /* @__PURE__ */ new WeakMap(), Sa(ya, e, e, t, !0)) : e;
	}
};
async function wa(e, t) {
	if (!ua(e)) throw TypeError("JWK must be an object");
	switch (t ||= e.alg, e.kty) {
		case "oct":
			if (typeof e.k != "string" || !e.k) throw TypeError("missing \"k\" (Key Value) Parameter value");
			return Fi(e.k);
		case "RSA": if ("oth" in e && e.oth !== void 0) throw new Bi("RSA JWK \"oth\" (Other Primes Info) Parameter value is not supported");
		case "EC":
		case "OKP": return _a({
			...e,
			alg: t
		});
		default: throw new Bi("Unsupported \"kty\" (Key Type) Parameter value");
	}
}
var Ta = (e) => e?.[Symbol.toStringTag], Ea = (e, t, n) => {
...
function ka(e, t, n, r) {
	t.startsWith("HS") || t === "dir" || t.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(t) ? Da(t, n, r, e) : Oa(t, n, r, e);
}
ka.bind(void 0, !1);
var Aa = ka.bind(void 0, !0);
function ja(e, t, n, r, i) {
	...
	for (let t of r.crit) {
		if (!a.has(t)) throw new Bi(`Extension Header Parameter "${t}" is not recognized`);
...
var Ma = (e, t) => {
	...
	if (!Di(e)) throw TypeError(ia(e, ...sa, "Uint8Array"));
	if (!e.extractable) throw TypeError("non-extractable CryptoKey cannot be exported as a JWK");
	let { ext: t, key_ops: n, alg: r, use: i, ...a } = await Ei.subtle.exportKey("jwk", e);
	return a;
};
async function Pa(e) {
	return Na(e);
...
function Fa(e, t) {
	...
	switch (e) {
		...
		default: throw new Bi(`alg ${e} is not supported either by JOSE or your javascript runtime`);
	}
}
async function Ia(e, t, n) {
	if (n === "sign" && (t = await Ca.normalizePrivateKey(t, e)), n === "verify" && (t = await Ca.normalizePublicKey(t, e)), Di(t)) return na(t, e, n), t;
	if (t instanceof Uint8Array) {
		if (!e.startsWith("HS")) throw TypeError(ia(t, ...sa));
		return Ei.subtle.importKey("raw", t, {
			hash: `SHA-${e.slice(-3)}`,
			name: "HMAC"
		}, !1, [n]);
	}
	throw TypeError(ia(t, ...sa, "Uint8Array", "JSON Web Key"));
}
var La = async (e, t, n, r) => {
	let i = await Ia(e, t, "verify");
	da(e, i);
	let a = Fa(e, i.algorithm);
	try {
		return await Ei.subtle.verify(a, i, n, r);
	} catch {
		return !1;
	}
};
async function Ra(e, t, n) {
	if (!ua(e)) throw new Ui("Flattened JWS must be an object");
	if (e.protected === void 0 && e.header === void 0) throw new Ui("Flattened JWS must have either of the \"protected\" or \"header\" members");
	if (e.protected !== void 0 && typeof e.protected != "string") throw new Ui("JWS Protected Header incorrect type");
	if (e.payload === void 0) throw new Ui("JWS Payload missing");
	if (typeof e.signature != "string") throw new Ui("JWS Signature missing or incorrect type");
	if (e.header !== void 0 && !ua(e.header)) throw new Ui("JWS Unprotected Header incorrect type");
	let r = {};
	if (e.protected) try {
		let t = Fi(e.protected);
		r = JSON.parse(Ai.decode(t));
	} catch {
		throw new Ui("JWS Protected Header is invalid");
	}
	if (!ca(r, e.header)) throw new Ui("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
	let i = {
		...r,
		...e.header
	}, a = ja(Ui, /* @__PURE__ */ new Map([["b64", !0]]), n?.crit, r, i), o = !0;
	if (a.has("b64") && (o = r.b64, typeof o != "boolean")) throw new Ui("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
	let { alg: s } = i;
	if (typeof s != "string" || !s) throw new Ui("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
	let c = n && Ma("algorithms", n.algorithms);
	if (c && !c.has(s)) throw new zi("\"alg\" (Algorithm) Header Parameter value not allowed");
	if (o) {
		if (typeof e.payload != "string") throw new Ui("JWS Payload must be a string");
	} else if (typeof e.payload != "string" && !(e.payload instanceof Uint8Array)) throw new Ui("JWS Payload must be a string or an Uint8Array instance");
	let l = !1;
	typeof t == "function" ? (t = await t(r, e), l = !0, Aa(s, t, "verify"), fa(t) && (t = await wa(t, s))) : Aa(s, t, "verify");
	let u = ji(ki.encode(e.protected ?? ""), ki.encode("."), typeof e.payload == "string" ? ki.encode(e.payload) : e.payload), d;
	try {
		d = Fi(e.signature);
	} catch {
		throw new Ui("Failed to base64url decode the signature");
	}
	if (!await La(s, t, d, u)) throw new Xi();
	let f;
	if (o) try {
		f = Fi(e.payload);
	} catch {
		throw new Ui("Failed to base64url decode the payload");
	}
	else f = typeof e.payload == "string" ? ki.encode(e.payload) : e.payload;
	let p = { payload: f };
...
async function za(e, t, n) {
	if (e instanceof Uint8Array && (e = Ai.decode(e)), typeof e != "string") throw new Ui("Compact JWS must be a string or Uint8Array");
	let { 0: r, 1: i, 2: a, length: o } = e.split(".");
	if (o !== 3) throw new Ui("Invalid Compact JWS");
	let s = await Ra({
		payload: i,
		protected: r,
		signature: a
...
var Ba = (e) => Math.floor(e.getTime() / 1e3), Va = 60, Ha = 3600, Ua = Ha * 24, Wa = Ua * 7, Ga = Ua * 365.25, Ka = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i, qa = (e) => {
	let t = Ka.exec(e);
	...
	switch (r) {
		...
		case "w":
			i = Math.round(n * Wa);
			break;
		default: i = Math.round(n * Ga);
	}
	return t[1] === "-" || t[4] === "ago" ? -i : i;
}, Ja = (e) => e.toLowerCase().replace(/^application\//, ""), Ya = (e, t) => typeof e == "string" ? t.includes(e) : Array.isArray(e) ? t.some(Set.prototype.has.bind(new Set(e))) : !1, Xa = (e, t, n = {}) => {
	let r;
	try {
		r = JSON.parse(Ai.decode(t));
	} catch {}
	if (!ua(r)) throw new Wi("JWT Claims Set must be a top-level JSON object");
	let { typ: i } = n;
	if (i && (typeof e.typ != "string" || Ja(e.typ) !== Ja(i))) throw new Li("unexpected \"typ\" JWT header value", r, "typ", "check_failed");
	...
	for (let e of new Set(u.reverse())) if (!(e in r)) throw new Li(`missing required "${e}" claim`, r, e, "missing");
	if (o && !(Array.isArray(o) ? o : [o]).includes(r.iss)) throw new Li("unexpected \"iss\" claim value", r, "iss", "check_failed");
	if (s && r.sub !== s) throw new Li("unexpected \"sub\" claim value", r, "sub", "check_failed");
	if (c && !Ya(r.aud, typeof c == "string" ? [c] : c)) throw new Li("unexpected \"aud\" claim value", r, "aud", "check_failed");
	let d;
	switch (typeof n.clockTolerance) {
		case "string":
			d = qa(n.clockTolerance);
			break;
		case "number":
			d = n.clockTolerance;
			break;
	...
	let { currentDate: f } = n, p = Ba(f || /* @__PURE__ */ new Date());
	if ((r.iat !== void 0 || l) && typeof r.iat != "number") throw new Li("\"iat\" claim must be a number", r, "iat", "invalid");
	if (r.nbf !== void 0) {
		if (typeof r.nbf != "number") throw new Li("\"nbf\" claim must be a number", r, "nbf", "invalid");
		if (r.nbf > p + d) throw new Li("\"nbf\" claim timestamp check failed", r, "nbf", "check_failed");
	}
	if (r.exp !== void 0) {
		if (typeof r.exp != "number") throw new Li("\"exp\" claim must be a number", r, "exp", "invalid");
		if (r.exp <= p - d) throw new Ri("\"exp\" claim timestamp check failed", r, "exp", "check_failed");
	}
	if (l) {
		let e = p - r.iat, t = typeof l == "number" ? l : qa(l);
		if (e - d > t) throw new Ri("\"iat\" claim timestamp check failed (too far in the past)", r, "iat", "check_failed");
		if (e < 0 - d) throw new Li("\"iat\" claim timestamp check failed (it should be in the past)", r, "iat", "check_failed");
	}
	return r;
};
async function Za(e, t, n) {
	let r = await za(e, t, n);
	if (r.protectedHeader.crit?.includes("b64") && r.protectedHeader.b64 === !1) throw new Wi("JWTs MUST NOT use unencoded payload");
	let i = {
		payload: Xa(r.protectedHeader, r.payload, n),
...
var Qa = async (e, t, n) => {
	let r = await Ia(e, t, "sign");
	da(e, r);
	let i = await Ei.subtle.sign(Fa(e, r.algorithm), r, n);
	...
	async sign(e, t) {
		if (!this._protectedHeader && !this._unprotectedHeader) throw new Ui("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
		if (!ca(this._protectedHeader, this._unprotectedHeader)) throw new Ui("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
		let n = {
			...this._protectedHeader,
			...this._unprotectedHeader
		}, r = ja(Ui, /* @__PURE__ */ new Map([["b64", !0]]), t?.crit, this._protectedHeader, n), i = !0;
		if (r.has("b64") && (i = this._protectedHeader.b64, typeof i != "boolean")) throw new Ui("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
		let { alg: a } = n;
		if (typeof a != "string" || !a) throw new Ui("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
		Aa(a, e, "sign");
		let o = this._payload;
		i && (o = ki.encode(Ni(o)));
		let s;
		s = this._protectedHeader ? ki.encode(Ni(JSON.stringify(this._protectedHeader))) : ki.encode("");
		let c = {
			signature: Ni(await Qa(a, e, ji(s, ki.encode("."), o))),
			payload: ""
		};
		return i && (c.payload = Ai.decode(o)), this._unprotectedHeader && (c.header = this._unprotectedHeader), this._protectedHeader && (c.protected = Ai.decode(s)), c;
	}
}, eo = class {
	constructor(e) {
		this._flattened = new $a(e);
	}
	setProtectedHeader(e) {
...
var no = class {
	constructor(e = {}) {
		if (!ua(e)) throw TypeError("JWT Claims Set MUST be an object");
		this._payload = e;
	}
	setIssuer(e) {
	...
	setNotBefore(e) {
		return this._payload = typeof e == "number" ? {
			...
			...this._payload,
			nbf: to("setNotBefore", Ba(e))
		} : {
			...this._payload,
			nbf: Ba(/* @__PURE__ */ new Date()) + qa(e)
		}, this;
	}
	setExpirationTime(e) {
		return this._payload = typeof e == "number" ? {
			...
			...this._payload,
			exp: to("setExpirationTime", Ba(e))
		} : {
			...this._payload,
			exp: Ba(/* @__PURE__ */ new Date()) + qa(e)
		}, this;
	}
	setIssuedAt(e) {
		return this._payload = e === void 0 ? {
			...this._payload,
			iat: Ba(/* @__PURE__ */ new Date())
		} : e instanceof Date ? {
			...this._payload,
			iat: to("setIssuedAt", Ba(e))
		} : typeof e == "string" ? {
			...this._payload,
			iat: to("setIssuedAt", Ba(/* @__PURE__ */ new Date()) + qa(e))
		} : {
			...this._payload,
	...
	async sign(e, t) {
		let n = new eo(ki.encode(JSON.stringify(this._payload)));
		if (n.setProtectedHeader(this._protectedHeader), Array.isArray(this._protectedHeader?.crit) && this._protectedHeader.crit.includes("b64") && this._protectedHeader.b64 === !1) throw new Wi("JWTs MUST NOT use unencoded payload");
		return n.sign(e, t);
	}
}, io = (e, t) => {
	if (typeof e != "string" || !e) throw new Gi(`${t} missing or invalid`);
};
async function ao(e, t) {
	...
	switch (e.kty) {
		case "EC":
			io(e.crv, "\"crv\" (Curve) Parameter"), io(e.x, "\"x\" (X Coordinate) Parameter"), io(e.y, "\"y\" (Y Coordinate) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x,
				y: e.y
			...
			break;
		case "OKP":
			io(e.crv, "\"crv\" (Subtype of Key Pair) Parameter"), io(e.x, "\"x\" (Public Key) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x
			};
			break;
		case "RSA":
			io(e.e, "\"e\" (Exponent) Parameter"), io(e.n, "\"n\" (Modulus) Parameter"), n = {
				e: e.e,
				kty: e.kty,
				n: e.n
			};
			break;
		case "oct":
			io(e.k, "\"k\" (Key Value) Parameter"), n = {
				k: e.k,
				kty: e.kty
			};
			break;
		default: throw new Bi("\"kty\" (Key Type) Parameter missing or unsupported");
	}
	let r = ki.encode(JSON.stringify(n));
	return Ni(await Oi(t, r));
}
function oo(e) {
	switch (typeof e == "string" && e.slice(0, 2)) {
		...
		case "ES": return "EC";
		case "Ed": return "OKP";
		default: throw new Bi("Unsupported \"alg\" value for a JSON Web Key Set");
	}
}
function so(e) {
	return e && typeof e == "object" && Array.isArray(e.keys) && e.keys.every(co);
}
function co(e) {
	return ua(e);
}
...
var uo = class {
	constructor(e) {
		if (this._cached = /* @__PURE__ */ new WeakMap(), !so(e)) throw new Ki("JSON Web Key Set malformed");
		this._jwks = lo(e);
	}
	async getKey(e, t) {
		let { alg: n, kid: r } = {
			...e,
			...t?.header
		}, i = oo(n), a = this._jwks.keys.filter((e) => {
			let t = i === e.kty;
...
async function fo(e, t, n) {
	...
	if (r[n] === void 0) {
		...
		if (e instanceof Uint8Array || e.type !== "public") throw new Ki("JSON Web Key Set members must be public keys");
		r[n] = e;
	}
	return r[n];
}
function po(e) {
	let t = new uo(e), n = async (e, n) => t.getKey(e, n);
...
var mo = async (e, t, n) => {
	...
	if (i !== void 0 && clearTimeout(i), o.status !== 200) throw new Ii("Expected 200 OK from the JSON Web Key Set HTTP response");
	try {
		return await o.json();
	} catch {
		throw new Ii("Failed to parse the JSON Web Key Set HTTP response as JSON");
	}
};
function ho() {
...
var go;
(typeof navigator > "u" || !navigator.userAgent?.startsWith?.("Mozilla/5.0 ")) && (go = "jose/v5.10.0");
var _o = Symbol();
function vo(e, t) {
	return !(typeof e != "object" || !e || !("uat" in e) || typeof e.uat != "number" || Date.now() - e.uat >= t || !("jwks" in e) || !ua(e.jwks) || !Array.isArray(e.jwks.keys) || !Array.prototype.every.call(e.jwks.keys, ua));
}
var yo = class {
	constructor(e, t) {
		...
		this._url = new URL(e.href), this._options = {
			agent: t?.agent,
			headers: t?.headers
		}, this._timeoutDuration = typeof t?.timeoutDuration == "number" ? t?.timeoutDuration : 5e3, this._cooldownDuration = typeof t?.cooldownDuration == "number" ? t?.cooldownDuration : 3e4, this._cacheMaxAge = typeof t?.cacheMaxAge == "number" ? t?.cacheMaxAge : 6e5, t?.[_o] !== void 0 && (this._cache = t?.[_o], vo(t?.[_o], this._cacheMaxAge) && (this._jwksTimestamp = this._cache.uat, this._local = po(this._cache.jwks)));
	}
	coolingDown() {
	...
	async getKey(e, t) {
		...
		try {
			...
			if (n instanceof qi && this.coolingDown() === !1) return await this.reload(), this._local(e, t);
			throw n;
		}
	}
	async reload() {
		this._pendingFetch && ho() && (this._pendingFetch = void 0);
		let e = new Headers(this._options.headers);
		go && !e.has("User-Agent") && (e.set("User-Agent", go), this._options.headers = Object.fromEntries(e.entries())), this._pendingFetch ||= mo(this._url, this._timeoutDuration, this._options).then((e) => {
			this._local = po(e), this._cache && (this._cache.uat = Date.now(), this._cache.jwks = e), this._jwksTimestamp = Date.now(), this._pendingFetch = void 0;
		}).catch((e) => {
...
function bo(e, t) {
	let n = new yo(e, t), r = async (e, t) => n.getKey(e, t);
...
var xo = Fi;
function So(e) {
	if (typeof e != "string") throw new Wi("JWTs must use Compact JWS serialization, JWT must be a string");
	let { 1: t, length: n } = e.split(".");
	if (n === 5) throw new Wi("Only JWTs using Compact JWS serialization can be decoded");
	if (n !== 3) throw new Wi("Invalid JWT");
	if (!t) throw new Wi("JWTs must contain a payload");
	let r;
	try {
		r = xo(t);
	} catch {
		throw new Wi("Failed to base64url decode the payload");
	}
	let i;
	try {
		i = JSON.parse(Ai.decode(r));
	} catch {
		throw new Wi("Failed to parse the decoded payload as JSON");
	}
	if (!ua(i)) throw new Wi("Invalid JWT Claims Set");
	return i;
}
function Co(e) {
	let t = e?.modulusLength ?? 2048;
	if (typeof t != "number" || t < 2048) throw new Bi("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
	return t;
}
		...
		case "EdDSA": {
			...
			switch (e) {
				...
				case "Ed448":
					n = { name: e };
					break;
				default: throw new Bi("Invalid or unsupported crv option provided");
			}
			break;
		}
		case "ECDH-ES":
		...
		case "ECDH-ES+A256KW": {
			...
			switch (e) {
				...
				case "X448":
					n = { name: e };
					break;
				default: throw new Bi("Invalid or unsupported crv option provided, supported values are P-256, P-384, P-521, X25519, and X448");
			}
			break;
		}
		default: throw new Bi("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
	}
	return Ei.subtle.generateKey(n, t?.extractable ?? !1, r);
}
...
var Eo = async (e, t) => {
	...
	if (!l) {
		...
		l = (await Eo(e, n ?? { redirect_uris: [i] }).then((e) => {
			if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
			return e.json();
		})).client_id;
	}
	...
	let { pkce_code_verifier: u, pkce_code_challenge: d } = await Oo();
	...
	let c = await To("ES256"), l = await Ao(r, a, n.toString(), o, s, c).then((e) => {
		if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
		return e.json();
	...
	let { payload: f } = await Za(u, bo(new URL(d)), {
		issuer: i,
		audience: "solid"
	}), p = await ao(await Pa(c.publicKey));
	...
	try {
		...
		let { payload: l } = await Za(o, bo(new URL(c)), {
			issuer: s,
			audience: "solid"
		}), u = await ao(await Pa(r.publicKey));
...
var Po = class extends EventTarget {
	isActive_ = !1;
	exp_;
	webId_ = void 0;
	currentAth_ = void 0;
	...
	rejectRefresh;
	constructor(e, t) {
		super(), this.authFetch = this.authFetch.bind(this), this.information = { clientDetails: e }, this.database = t?.database, t?.onSessionStateChange && this.addEventListener(No.STATE_CHANGE, (e) => t.onSessionStateChange?.(e)), t?.onSessionExpirationWarning && this.addEventListener(No.EXPIRATION_WARNING, (e) => t?.onSessionExpirationWarning?.(e)), t?.onSessionExpiration && this.addEventListener(No.EXPIRATION, (e) => t?.onSessionExpiration?.(e));
	}
	async login(e, t) {
		await Do(e, t, this.information.clientDetails);
	}
	async handleRedirectFromLogin() {
		let e = await ko(this.information.clientDetails, this.database);
	...
	async restore() {
		...
		let e = this.isActive;
		return jo(this.database).then((e) => this.setTokenDetails(e)).then(() => this.resolveRefresh()).catch((e) => {
	...
	async _createSignedDPoPToken(e) {
		...
		let t = await Pa(this.information.tokenDetails.dpop_key_pair.publicKey);
		return new ro(e).setIssuedAt().setJti(window.crypto.randomUUID()).setProtectedHeader({
			alg: "ES256",
			typ: "dpop+jwt",
			jwk: t
...
var Lo = class {
	...
	constructor(e, t) {
		...
		this.worker = new SharedWorker(i, { type: "module" }), this.worker.port.onmessage = (e) => {
			...
			this.worker.port.postMessage({ type: Io.DISCONNECT });
		});
	}
	async handleWorkerMessage(e) {
		let { type: t, payload: n, error: r } = e;
		switch (t) {
			case Io.TOKEN_DETAILS:
				let e = this.isActive;
			...
			case Io.ERROR_ON_REFRESH:
				...
				break;
			case Io.EXPIRED: this.isActive && (this.dispatchExpirationEvent(), await this.logout()), this.refreshPromise && this.rejectRefresh && (this.rejectRefresh(Error(r || "Token refresh failed")), this.clearRefreshPromise());
		}
	}
	async handleRedirectFromLogin() {
	...
	async restore() {
		return this.refreshPromise ? this.refreshPromise : (this.refreshPromise = new Promise((e, t) => {
			this.resolveRefresh = e, this.rejectRefresh = t;
		}), this.worker.port.postMessage({ type: Io.REFRESH }), this.refreshPromise);
	}
	async logout() {
		this.worker.port.postMessage({ type: Io.STOP }), await super.logout();
	}
}, zo = /* @__PURE__ */ c({
	SessionCore: () => qc,
	SessionEvents: () => Kc
}), Bo = crypto, Vo = (e) => e instanceof CryptoKey, Ho = async (e, t) => {
	let n = `SHA-${e.slice(-3)}`;
	return new Uint8Array(await Bo.subtle.digest(n, t));
}, Uo = new TextEncoder(), Wo = new TextDecoder();
function Go(...e) {
	let t = e.reduce((e, { length: t }) => e + t, 0), n = new Uint8Array(t), r = 0;
	for (let t of e) n.set(t, r), r += t.length;
	return n;
...
var Ko = (e) => {
	let t = e;
	typeof t == "string" && (t = Uo.encode(t));
	let n = 32768, r = [];
	for (let e = 0; e < t.length; e += n) r.push(String.fromCharCode.apply(null, t.subarray(e, e + n)));
	return btoa(r.join(""));
}, qo = (e) => Ko(e).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_"), Jo = (e) => {
	let t = atob(e), n = new Uint8Array(t.length);
	for (let e = 0; e < t.length; e++) n[e] = t.charCodeAt(e);
	return n;
}, Yo = (e) => {
	let t = e;
	t instanceof Uint8Array && (t = Wo.decode(t)), t = t.replace(/-/g, "+").replace(/_/g, "/").replace(/\s/g, "");
	try {
		return Jo(t);
	} catch {
		throw TypeError("The input to be decoded is not correctly encoded.");
...
Qo.code = "ERR_JWT_EXPIRED";
var $o = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JOSE_ALG_NOT_ALLOWED";
	}
};
...
es.code = "ERR_JOSE_NOT_SUPPORTED";
var ts = class extends Xo {
	constructor(e = "decryption operation failed", t) {
		super(e, t), this.code = "ERR_JWE_DECRYPTION_FAILED";
	}
};
ts.code = "ERR_JWE_DECRYPTION_FAILED";
var ns = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JWE_INVALID";
	}
};
ns.code = "ERR_JWE_INVALID";
var rs = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JWS_INVALID";
	}
};
rs.code = "ERR_JWS_INVALID";
var is = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JWT_INVALID";
	}
};
is.code = "ERR_JWT_INVALID";
var as = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JWK_INVALID";
	}
};
as.code = "ERR_JWK_INVALID";
var os = class extends Xo {
	constructor() {
		super(...arguments), this.code = "ERR_JWKS_INVALID";
	}
};
os.code = "ERR_JWKS_INVALID";
var ss = class extends Xo {
	constructor(e = "no applicable key found in the JSON Web Key Set", t) {
		super(e, t), this.code = "ERR_JWKS_NO_MATCHING_KEY";
	}
};
ss.code = "ERR_JWKS_NO_MATCHING_KEY";
var cs = class extends Xo {
	constructor(e = "multiple matching keys found in the JSON Web Key Set", t) {
		super(e, t), this.code = "ERR_JWKS_MULTIPLE_MATCHING_KEYS";
	}
};
cs.code = "ERR_JWKS_MULTIPLE_MATCHING_KEYS";
var ls = class extends Xo {
	constructor(e = "request timed out", t) {
		super(e, t), this.code = "ERR_JWKS_TIMEOUT";
	}
};
ls.code = "ERR_JWKS_TIMEOUT";
var us = class extends Xo {
	constructor(e = "signature verification failed", t) {
		super(e, t), this.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
	}
};
us.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
function ds(e, t = "algorithm.name") {
	return /* @__PURE__ */ TypeError(`CryptoKey does not support this operation, its ${t} must be ${e}`);
}
function fs(e, t) {
	return e.name === t;
...
function gs(e, t, ...n) {
	switch (t) {
		...
		case "HS384":
		case "HS512": {
			if (!fs(e.algorithm, "HMAC")) throw ds("HMAC");
			let n = parseInt(t.slice(2), 10);
			if (ps(e.algorithm.hash) !== n) throw ds(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "RS256":
		case "RS384":
		case "RS512": {
			if (!fs(e.algorithm, "RSASSA-PKCS1-v1_5")) throw ds("RSASSA-PKCS1-v1_5");
			let n = parseInt(t.slice(2), 10);
			if (ps(e.algorithm.hash) !== n) throw ds(`SHA-${n}`, "algorithm.hash");
			break;
		}
		...
		case "PS384":
		case "PS512": {
			if (!fs(e.algorithm, "RSA-PSS")) throw ds("RSA-PSS");
			let n = parseInt(t.slice(2), 10);
			if (ps(e.algorithm.hash) !== n) throw ds(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "EdDSA":
			if (e.algorithm.name !== "Ed25519" && e.algorithm.name !== "Ed448") throw ds("Ed25519 or Ed448");
			break;
		case "Ed25519":
			if (!fs(e.algorithm, "Ed25519")) throw ds("Ed25519");
			break;
		case "ES256":
		case "ES384":
		case "ES512": {
			if (!fs(e.algorithm, "ECDSA")) throw ds("ECDSA");
			let n = ms(t);
			if (e.algorithm.namedCurve !== n) throw ds(n, "algorithm.namedCurve");
			break;
		}
		default: throw TypeError("CryptoKey does not support this operation");
	}
...
var vs = (e, ...t) => _s("Key must be ", e, ...t);
function ys(e, t, ...n) {
	return _s(`Key for the ${e} algorithm must be `, t, ...n);
}
var bs = (e) => Vo(e) ? !0 : e?.[Symbol.toStringTag] === "KeyObject", xs = ["CryptoKey"], Ss = (...e) => {
	let t = e.filter(Boolean);
	if (t.length === 0 || t.length === 1) return !0;
	let n;
	for (let e of t) {
...
function Es(e) {
	return ws(e) && typeof e.kty == "string";
}
function Ds(e) {
	return e.kty !== "oct" && typeof e.d == "string";
}
...
function As(e) {
	...
	switch (e.kty) {
		case "RSA":
			switch (e.alg) {
				...
				case "RSA-OAEP-512":
					...
					break;
				default: throw new es("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
			}
			break;
		case "EC":
			switch (e.alg) {
		...
		case "OKP":
			...
			break;
		default: throw new es("Invalid or unsupported JWK \"kty\" (Key Type) Parameter value");
	}
	return {
		algorithm: t,
		keyUsages: n
...
var js = async (e) => {
	if (!e.alg) throw TypeError("\"alg\" argument is required when \"jwk.alg\" is not present");
	let { algorithm: t, keyUsages: n } = As(e), r = [
		t,
		e.ext ?? !1,
		e.key_ops ?? n
	], i = { ...e };
	return delete i.alg, delete i.use, Bo.subtle.importKey("jwk", i, ...r);
}, Ms = (e) => Yo(e), Ns, Ps, Fs = (e) => e?.[Symbol.toStringTag] === "KeyObject", Is = async (e, t, n, r, i = !1) => {
	let a = e.get(t);
	if (a?.[r]) return a[r];
	let o = await js({
		...n,
	...
	normalizePublicKey: (e, t) => {
		if (Fs(e)) {
			let n = e.export({ format: "jwk" });
			return delete n.d, delete n.dp, delete n.dq, delete n.p, delete n.q, delete n.qi, n.k ? Ms(n.k) : (Ps ||= /* @__PURE__ */ new WeakMap(), Is(Ps, e, n, t));
		}
		return Es(e) ? e.k ? Yo(e.k) : (Ps ||= /* @__PURE__ */ new WeakMap(), Is(Ps, e, e, t, !0)) : e;
	},
	normalizePrivateKey: (e, t) => {
		if (Fs(e)) {
			let n = e.export({ format: "jwk" });
			return n.k ? Ms(n.k) : (Ns ||= /* @__PURE__ */ new WeakMap(), Is(Ns, e, n, t));
		}
		return Es(e) ? e.k ? Yo(e.k) : (Ns ||= /* @__PURE__ */ new WeakMap(), Is(Ns, e, e, t, !0)) : e;
	}
};
async function Rs(e, t) {
	if (!ws(e)) throw TypeError("JWK must be an object");
	switch (t ||= e.alg, e.kty) {
		case "oct":
			if (typeof e.k != "string" || !e.k) throw TypeError("missing \"k\" (Key Value) Parameter value");
			return Yo(e.k);
		case "RSA": if ("oth" in e && e.oth !== void 0) throw new es("RSA JWK \"oth\" (Other Primes Info) Parameter value is not supported");
		case "EC":
		case "OKP": return js({
			...e,
			alg: t
		});
		default: throw new es("Unsupported \"kty\" (Key Type) Parameter value");
	}
}
var zs = (e) => e?.[Symbol.toStringTag], Bs = (e, t, n) => {
	if (t.use !== void 0 && t.use !== "sig") throw TypeError("Invalid key for this operation, when present its use must be sig");
	if (t.key_ops !== void 0 && t.key_ops.includes?.(n) !== !0) throw TypeError(`Invalid key for this operation, when present its key_ops must include ${n}`);
	if (t.alg !== void 0 && t.alg !== e) throw TypeError(`Invalid key for this operation, when present its alg must be ${e}`);
	return !0;
	...
	if (!(t instanceof Uint8Array)) {
		if (r && Es(t)) {
			if (ks(t) && Bs(e, t, n)) return;
			throw TypeError("JSON Web Key for symmetric algorithms must have JWK \"kty\" (Key Type) equal to \"oct\" and the JWK \"k\" (Key Value) present");
		}
		if (!bs(t)) throw TypeError(ys(e, t, ...xs, "Uint8Array", r ? "JSON Web Key" : null));
		if (t.type !== "secret") throw TypeError(`${zs(t)} instances for symmetric algorithms must be of type "secret"`);
	}
}, Hs = (e, t, n, r) => {
	if (r && Es(t)) switch (n) {
		case "sign":
			if (Ds(t) && Bs(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a private JWK");
		case "verify":
			if (Os(t) && Bs(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a public JWK");
	}
	if (!bs(t)) throw TypeError(ys(e, t, ...xs, r ? "JSON Web Key" : null));
	if (t.type === "secret") throw TypeError(`${zs(t)} instances for asymmetric algorithms must not be of type "secret"`);
	if (n === "sign" && t.type === "public") throw TypeError(`${zs(t)} instances for asymmetric algorithm signing must be of type "private"`);
	if (n === "decrypt" && t.type === "public") throw TypeError(`${zs(t)} instances for asymmetric algorithm decryption must be of type "private"`);
	if (t.algorithm && n === "verify" && t.type === "private") throw TypeError(`${zs(t)} instances for asymmetric algorithm verifying must be of type "public"`);
	if (t.algorithm && n === "encrypt" && t.type === "private") throw TypeError(`${zs(t)} instances for asymmetric algorithm encryption must be of type "public"`);
};
function Us(e, t, n, r) {
	t.startsWith("HS") || t === "dir" || t.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(t) ? Vs(t, n, r, e) : Hs(t, n, r, e);
}
Us.bind(void 0, !1);
var Ws = Us.bind(void 0, !0);
function Gs(e, t, n, r, i) {
	...
	a = n === void 0 ? t : new Map([...Object.entries(n), ...t.entries()]);
	for (let t of r.crit) {
		if (!a.has(t)) throw new es(`Extension Header Parameter "${t}" is not recognized`);
		if (i[t] === void 0) throw new e(`Extension Header Parameter "${t}" is missing`);
		if (a.get(t) && r[t] === void 0) throw new e(`Extension Header Parameter "${t}" MUST be integrity protected`);
	}
	return new Set(r.crit);
...
var Ks = (e, t) => {
	...
	if (!Vo(e)) throw TypeError(vs(e, ...xs, "Uint8Array"));
	if (!e.extractable) throw TypeError("non-extractable CryptoKey cannot be exported as a JWK");
	let { ext: t, key_ops: n, alg: r, use: i, ...a } = await Bo.subtle.exportKey("jwk", e);
	return a;
};
async function Js(e) {
	return qs(e);
...
function Ys(e, t) {
	...
	switch (e) {
		...
		case "Ed25519": return { name: "Ed25519" };
		case "EdDSA": return { name: t.name };
		default: throw new es(`alg ${e} is not supported either by JOSE or your javascript runtime`);
	}
}
async function Xs(e, t, n) {
	if (n === "sign" && (t = await Ls.normalizePrivateKey(t, e)), n === "verify" && (t = await Ls.normalizePublicKey(t, e)), Vo(t)) return gs(t, e, n), t;
	if (t instanceof Uint8Array) {
		if (!e.startsWith("HS")) throw TypeError(vs(t, ...xs));
		return Bo.subtle.importKey("raw", t, {
			hash: `SHA-${e.slice(-3)}`,
			name: "HMAC"
		}, !1, [n]);
	}
	throw TypeError(vs(t, ...xs, "Uint8Array", "JSON Web Key"));
}
var Zs = async (e, t, n, r) => {
	let i = await Xs(e, t, "verify");
	Ts(e, i);
	let a = Ys(e, i.algorithm);
	try {
		return await Bo.subtle.verify(a, i, n, r);
	} catch {
		return !1;
	}
};
async function Qs(e, t, n) {
	if (!ws(e)) throw new rs("Flattened JWS must be an object");
	if (e.protected === void 0 && e.header === void 0) throw new rs("Flattened JWS must have either of the \"protected\" or \"header\" members");
	if (e.protected !== void 0 && typeof e.protected != "string") throw new rs("JWS Protected Header incorrect type");
	if (e.payload === void 0) throw new rs("JWS Payload missing");
	if (typeof e.signature != "string") throw new rs("JWS Signature missing or incorrect type");
	if (e.header !== void 0 && !ws(e.header)) throw new rs("JWS Unprotected Header incorrect type");
	let r = {};
	if (e.protected) try {
		let t = Yo(e.protected);
		r = JSON.parse(Wo.decode(t));
	} catch {
		throw new rs("JWS Protected Header is invalid");
	}
	if (!Ss(r, e.header)) throw new rs("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
	let i = {
		...r,
		...e.header
	}, a = Gs(rs, /* @__PURE__ */ new Map([["b64", !0]]), n?.crit, r, i), o = !0;
	if (a.has("b64") && (o = r.b64, typeof o != "boolean")) throw new rs("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
	let { alg: s } = i;
	if (typeof s != "string" || !s) throw new rs("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
	let c = n && Ks("algorithms", n.algorithms);
	if (c && !c.has(s)) throw new $o("\"alg\" (Algorithm) Header Parameter value not allowed");
	if (o) {
		if (typeof e.payload != "string") throw new rs("JWS Payload must be a string");
	} else if (typeof e.payload != "string" && !(e.payload instanceof Uint8Array)) throw new rs("JWS Payload must be a string or an Uint8Array instance");
	let l = !1;
	typeof t == "function" ? (t = await t(r, e), l = !0, Ws(s, t, "verify"), Es(t) && (t = await Rs(t, s))) : Ws(s, t, "verify");
	let u = Go(Uo.encode(e.protected ?? ""), Uo.encode("."), typeof e.payload == "string" ? Uo.encode(e.payload) : e.payload), d;
	try {
		d = Yo(e.signature);
	} catch {
		throw new rs("Failed to base64url decode the signature");
	}
	if (!await Zs(s, t, d, u)) throw new us();
	let f;
	if (o) try {
		f = Yo(e.payload);
	} catch {
		throw new rs("Failed to base64url decode the payload");
	}
	else f = typeof e.payload == "string" ? Uo.encode(e.payload) : e.payload;
	let p = { payload: f };
	return e.protected !== void 0 && (p.protectedHeader = r), e.header !== void 0 && (p.unprotectedHeader = e.header), l ? {
		...p,
		key: t
...
async function $s(e, t, n) {
	if (e instanceof Uint8Array && (e = Wo.decode(e)), typeof e != "string") throw new rs("Compact JWS must be a string or Uint8Array");
	let { 0: r, 1: i, 2: a, length: o } = e.split(".");
	if (o !== 3) throw new rs("Invalid Compact JWS");
	let s = await Qs({
		payload: i,
		protected: r,
		signature: a
...
var ec = (e) => Math.floor(e.getTime() / 1e3), tc = 60, nc = 3600, rc = nc * 24, ic = rc * 7, ac = rc * 365.25, oc = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i, sc = (e) => {
	let t = oc.exec(e);
	if (!t || t[4] && t[1]) throw TypeError("Invalid time period format");
	let n = parseFloat(t[2]), r = t[3].toLowerCase(), i;
	switch (r) {
		...
		case "w":
			i = Math.round(n * ic);
			break;
		default: i = Math.round(n * ac);
	}
	return t[1] === "-" || t[4] === "ago" ? -i : i;
}, cc = (e) => e.toLowerCase().replace(/^application\//, ""), lc = (e, t) => typeof e == "string" ? t.includes(e) : Array.isArray(e) ? t.some(Set.prototype.has.bind(new Set(e))) : !1, uc = (e, t, n = {}) => {
	let r;
	try {
		r = JSON.parse(Wo.decode(t));
	} catch {}
	if (!ws(r)) throw new is("JWT Claims Set must be a top-level JSON object");
	let { typ: i } = n;
	if (i && (typeof e.typ != "string" || cc(e.typ) !== cc(i))) throw new Zo("unexpected \"typ\" JWT header value", r, "typ", "check_failed");
	let { requiredClaims: a = [], issuer: o, subject: s, audience: c, maxTokenAge: l } = n, u = [...a];
	l !== void 0 && u.push("iat"), c !== void 0 && u.push("aud"), s !== void 0 && u.push("sub"), o !== void 0 && u.push("iss");
	for (let e of new Set(u.reverse())) if (!(e in r)) throw new Zo(`missing required "${e}" claim`, r, e, "missing");
	if (o && !(Array.isArray(o) ? o : [o]).includes(r.iss)) throw new Zo("unexpected \"iss\" claim value", r, "iss", "check_failed");
	if (s && r.sub !== s) throw new Zo("unexpected \"sub\" claim value", r, "sub", "check_failed");
	if (c && !lc(r.aud, typeof c == "string" ? [c] : c)) throw new Zo("unexpected \"aud\" claim value", r, "aud", "check_failed");
	let d;
	switch (typeof n.clockTolerance) {
		case "string":
			d = sc(n.clockTolerance);
			break;
		case "number":
			d = n.clockTolerance;
			break;
	...
	let { currentDate: f } = n, p = ec(f || /* @__PURE__ */ new Date());
	if ((r.iat !== void 0 || l) && typeof r.iat != "number") throw new Zo("\"iat\" claim must be a number", r, "iat", "invalid");
	if (r.nbf !== void 0) {
		if (typeof r.nbf != "number") throw new Zo("\"nbf\" claim must be a number", r, "nbf", "invalid");
		if (r.nbf > p + d) throw new Zo("\"nbf\" claim timestamp check failed", r, "nbf", "check_failed");
	}
	if (r.exp !== void 0) {
		if (typeof r.exp != "number") throw new Zo("\"exp\" claim must be a number", r, "exp", "invalid");
		if (r.exp <= p - d) throw new Qo("\"exp\" claim timestamp check failed", r, "exp", "check_failed");
	}
	if (l) {
		let e = p - r.iat, t = typeof l == "number" ? l : sc(l);
		if (e - d > t) throw new Qo("\"iat\" claim timestamp check failed (too far in the past)", r, "iat", "check_failed");
		if (e < 0 - d) throw new Zo("\"iat\" claim timestamp check failed (it should be in the past)", r, "iat", "check_failed");
	}
	return r;
};
async function dc(e, t, n) {
	let r = await $s(e, t, n);
	if (r.protectedHeader.crit?.includes("b64") && r.protectedHeader.b64 === !1) throw new is("JWTs MUST NOT use unencoded payload");
	let i = {
		payload: uc(r.protectedHeader, r.payload, n),
		protectedHeader: r.protectedHeader
	};
	return typeof t == "function" ? {
		...i,
...
var fc = async (e, t, n) => {
	let r = await Xs(e, t, "sign");
	Ts(e, r);
	let i = await Bo.subtle.sign(Ys(e, r.algorithm), r, n);
	return new Uint8Array(i);
}, pc = class {
	constructor(e) {
		if (!(e instanceof Uint8Array)) throw TypeError("payload must be an instance of Uint8Array");
	...
	async sign(e, t) {
		if (!this._protectedHeader && !this._unprotectedHeader) throw new rs("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
		if (!Ss(this._protectedHeader, this._unprotectedHeader)) throw new rs("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
		let n = {
			...this._protectedHeader,
			...this._unprotectedHeader
		}, r = Gs(rs, /* @__PURE__ */ new Map([["b64", !0]]), t?.crit, this._protectedHeader, n), i = !0;
		if (r.has("b64") && (i = this._protectedHeader.b64, typeof i != "boolean")) throw new rs("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
		let { alg: a } = n;
		if (typeof a != "string" || !a) throw new rs("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
		Ws(a, e, "sign");
		let o = this._payload;
		i && (o = Uo.encode(qo(o)));
		let s;
		s = this._protectedHeader ? Uo.encode(qo(JSON.stringify(this._protectedHeader))) : Uo.encode("");
		let c = {
			signature: qo(await fc(a, e, Go(s, Uo.encode("."), o))),
			payload: ""
		};
		return i && (c.payload = Wo.decode(o)), this._unprotectedHeader && (c.header = this._unprotectedHeader), this._protectedHeader && (c.protected = Wo.decode(s)), c;
	}
}, mc = class {
	constructor(e) {
		this._flattened = new pc(e);
	}
	setProtectedHeader(e) {
		return this._flattened.setProtectedHeader(e), this;
	}
...
var gc = class {
	constructor(e = {}) {
		if (!ws(e)) throw TypeError("JWT Claims Set MUST be an object");
		this._payload = e;
	}
	setIssuer(e) {
		return this._payload = {
	...
	setNotBefore(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			nbf: hc("setNotBefore", e)
		} : e instanceof Date ? {
			...this._payload,
			nbf: hc("setNotBefore", ec(e))
		} : {
			...this._payload,
			nbf: ec(/* @__PURE__ */ new Date()) + sc(e)
		}, this;
	}
	setExpirationTime(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			exp: hc("setExpirationTime", e)
		} : e instanceof Date ? {
			...this._payload,
			exp: hc("setExpirationTime", ec(e))
		} : {
			...this._payload,
			exp: ec(/* @__PURE__ */ new Date()) + sc(e)
		}, this;
	}
	setIssuedAt(e) {
		return this._payload = e === void 0 ? {
			...this._payload,
			iat: ec(/* @__PURE__ */ new Date())
		} : e instanceof Date ? {
			...this._payload,
			iat: hc("setIssuedAt", ec(e))
		} : typeof e == "string" ? {
			...this._payload,
			iat: hc("setIssuedAt", ec(/* @__PURE__ */ new Date()) + sc(e))
		} : {
			...this._payload,
			iat: hc("setIssuedAt", e)
		}, this;
	}
}, _c = class extends gc {
	setProtectedHeader(e) {
	...
	async sign(e, t) {
		let n = new mc(Uo.encode(JSON.stringify(this._payload)));
		if (n.setProtectedHeader(this._protectedHeader), Array.isArray(this._protectedHeader?.crit) && this._protectedHeader.crit.includes("b64") && this._protectedHeader.b64 === !1) throw new is("JWTs MUST NOT use unencoded payload");
		return n.sign(e, t);
	}
}, vc = (e, t) => {
	if (typeof e != "string" || !e) throw new as(`${t} missing or invalid`);
};
async function yc(e, t) {
	...
	switch (e.kty) {
		...
		case "oct":
			...
			break;
		default: throw new es("\"kty\" (Key Type) Parameter missing or unsupported");
	}
	let r = Uo.encode(JSON.stringify(n));
	return qo(await Ho(t, r));
}
function bc(e) {
	switch (typeof e == "string" && e.slice(0, 2)) {
		case "RS":
		...
		case "ES": return "EC";
		case "Ed": return "OKP";
		default: throw new es("Unsupported \"alg\" value for a JSON Web Key Set");
	}
}
function xc(e) {
...
var wc = class {
	constructor(e) {
		if (this._cached = /* @__PURE__ */ new WeakMap(), !xc(e)) throw new os("JSON Web Key Set malformed");
		this._jwks = Cc(e);
	}
	async getKey(e, t) {
		let { alg: n, kid: r } = {
			...e,
			...t?.header
		}, i = bc(n), a = this._jwks.keys.filter((e) => {
			let t = i === e.kty;
			if (t && typeof r == "string" && (t = r === e.kid), t && typeof e.alg == "string" && (t = n === e.alg), t && typeof e.use == "string" && (t = e.use === "sig"), t && Array.isArray(e.key_ops) && (t = e.key_ops.includes("verify")), t) switch (n) {
				case "ES256":
					t = e.crv === "P-256";
...
async function Tc(e, t, n) {
	...
	if (r[n] === void 0) {
		...
		if (e instanceof Uint8Array || e.type !== "public") throw new os("JSON Web Key Set members must be public keys");
		r[n] = e;
	}
	return r[n];
}
function Ec(e) {
	let t = new wc(e), n = async (e, n) => t.getKey(e, n);
	return Object.defineProperties(n, { jwks: {
		value: () => Cc(t._jwks),
		enumerable: !0,
		configurable: !1,
...
var Dc = async (e, t, n) => {
	...
	if (i !== void 0 && clearTimeout(i), o.status !== 200) throw new Xo("Expected 200 OK from the JSON Web Key Set HTTP response");
	try {
		return await o.json();
	} catch {
...
var kc;
(typeof navigator > "u" || !navigator.userAgent?.startsWith?.("Mozilla/5.0 ")) && (kc = "jose/v5.10.0");
var Ac = Symbol();
function jc(e, t) {
	return !(typeof e != "object" || !e || !("uat" in e) || typeof e.uat != "number" || Date.now() - e.uat >= t || !("jwks" in e) || !ws(e.jwks) || !Array.isArray(e.jwks.keys) || !Array.prototype.every.call(e.jwks.keys, ws));
}
var Mc = class {
	constructor(e, t) {
		if (!(e instanceof URL)) throw TypeError("url must be an instance of URL");
		this._url = new URL(e.href), this._options = {
			agent: t?.agent,
			headers: t?.headers
		}, this._timeoutDuration = typeof t?.timeoutDuration == "number" ? t?.timeoutDuration : 5e3, this._cooldownDuration = typeof t?.cooldownDuration == "number" ? t?.cooldownDuration : 3e4, this._cacheMaxAge = typeof t?.cacheMaxAge == "number" ? t?.cacheMaxAge : 6e5, t?.[Ac] !== void 0 && (this._cache = t?.[Ac], jc(t?.[Ac], this._cacheMaxAge) && (this._jwksTimestamp = this._cache.uat, this._local = Ec(this._cache.jwks)));
	}
	coolingDown() {
		return typeof this._jwksTimestamp == "number" && Date.now() < this._jwksTimestamp + this._cooldownDuration;
	}
	...
	async getKey(e, t) {
		...
		try {
			...
			if (n instanceof ss && this.coolingDown() === !1) return await this.reload(), this._local(e, t);
			throw n;
		}
	}
	async reload() {
		this._pendingFetch && Oc() && (this._pendingFetch = void 0);
		let e = new Headers(this._options.headers);
		kc && !e.has("User-Agent") && (e.set("User-Agent", kc), this._options.headers = Object.fromEntries(e.entries())), this._pendingFetch ||= Dc(this._url, this._timeoutDuration, this._options).then((e) => {
			this._local = Ec(e), this._cache && (this._cache.uat = Date.now(), this._cache.jwks = e), this._jwksTimestamp = Date.now(), this._pendingFetch = void 0;
		}).catch((e) => {
			throw this._pendingFetch = void 0, e;
		}), await this._pendingFetch;
	}
...
function Nc(e, t) {
	let n = new Mc(e, t), r = async (e, t) => n.getKey(e, t);
	return Object.defineProperties(r, {
		coolingDown: {
			get: () => n.coolingDown(),
			enumerable: !0,
...
var Pc = Yo;
function Fc(e) {
	if (typeof e != "string") throw new is("JWTs must use Compact JWS serialization, JWT must be a string");
	let { 1: t, length: n } = e.split(".");
	if (n === 5) throw new is("Only JWTs using Compact JWS serialization can be decoded");
	...
	if (!ws(i)) throw new is("Invalid JWT Claims Set");
	return i;
}
function Ic(e) {
	let t = e?.modulusLength ?? 2048;
	if (typeof t != "number" || t < 2048) throw new es("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
	return t;
}
		...
		case "EdDSA": {
			...
			switch (e) {
				...
				case "Ed448":
					n = { name: e };
					break;
				default: throw new es("Invalid or unsupported crv option provided");
			}
			break;
		}
		case "ECDH-ES":
		...
		case "ECDH-ES+A256KW": {
			...
			switch (e) {
				...
				case "X448":
					n = { name: e };
					break;
				default: throw new es("Invalid or unsupported crv option provided, supported values are P-256, P-384, P-521, X25519, and X448");
			}
			break;
		}
		default: throw new es("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
	}
	return Bo.subtle.generateKey(n, t?.extractable ?? !1, r);
}
...
var zc = async (e, t) => {
	...
	if (!l) {
		let e = o.registration_endpoint;
		l = (await zc(e, n ?? { redirect_uris: [i] }).then((e) => {
			if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
			return e.json();
		})).client_id;
	}
	...
	let { pkce_code_verifier: u, pkce_code_challenge: d } = await Vc();
	sessionStorage.setItem("pkce_code_verifier", u);
	let f = window.crypto.randomUUID();
	sessionStorage.setItem("csrf_token", f);
	let p = o.authorization_endpoint + `?response_type=code&redirect_uri=${encodeURIComponent(i)}&scope=openid offline_access webid&client_id=${encodeURIComponent(l)}&code_challenge_method=S256&code_challenge=${d}&state=${f}&prompt=consent`;
	...
	let s = sessionStorage.getItem("token_endpoint");
	if (s === null) throw Error("Access Token Request preparation - Could not find in sessionStorage: token_endpoint");
	let c = await Rc("ES256"), l = await Uc(r, a, n.toString(), o, s, c).then((e) => {
		if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
		return e.json();
	}), u = l.access_token, d = sessionStorage.getItem("jwks_uri");
	if (d === null) throw Error("Access Token validation preparation - Could not find in sessionStorage: jwks_uri");
	let { payload: f } = await dc(u, Nc(new URL(d)), {
		issuer: i,
		audience: "solid"
	}), p = await yc(await Js(c.publicKey));
	if (f.cnf.jkt !== p) throw Error("Access Token validation failed on `jkt`: jkt !== DPoP thumbprint - " + f.cnf.jkt + " !== " + p);
	if (f.client_id !== o) throw Error("Access Token validation failed on `client_id`: JWT payload !== client_id - " + f.client_id + " !== " + o);
	let m = {
		...l,
...
}, Uc = async (e, t, n, r, i, a) => {
	let o = await Js(a.publicKey);
	o.alg = "ES256";
	let s = await new _c({
		htu: i,
		htm: "POST"
	...
	try {
		...
		let c = await e.getItem("jwks_uri");
		if (c === null) throw Error("Access Token validation preparation - Could not find in sessionDatabase: jwks_uri");
		let { payload: l } = await dc(o, Nc(new URL(c)), {
			issuer: s,
			audience: "solid"
		}), u = await yc(await Js(r.publicKey));
		if (l.cnf.jkt !== u) throw Error("Access Token validation failed on `jkt`: jkt !== DPoP thumbprint - " + l.cnf.jkt + " !== " + u);
		if (l.client_id !== t) throw Error("Access Token validation failed on `client_id`: JWT payload !== client_id - " + l.client_id + " !== " + t);
		return await e.setItem("refresh_token", a.refresh_token), {
			...a,
...
var qc = class extends EventTarget {
	isActive_ = !1;
	exp_;
	webId_ = void 0;
	currentAth_ = void 0;
	...
	rejectRefresh;
	constructor(e, t) {
		super(), this.authFetch = this.authFetch.bind(this), this.information = { clientDetails: e }, this.database = t?.database, t?.onSessionStateChange && this.addEventListener(Kc.STATE_CHANGE, (e) => t.onSessionStateChange?.(e)), t?.onSessionExpirationWarning && this.addEventListener(Kc.EXPIRATION_WARNING, (e) => t?.onSessionExpirationWarning?.(e)), t?.onSessionExpiration && this.addEventListener(Kc.EXPIRATION, (e) => t?.onSessionExpiration?.(e));
	}
	async login(e, t) {
		await Bc(e, t, this.information.clientDetails);
	}
	async handleRedirectFromLogin() {
		let e = await Hc(this.information.clientDetails, this.database);
		e.tokenDetails && (this.information.clientDetails = e.clientDetails, this.information.idpDetails = e.idpDetails, await this.setTokenDetails(e.tokenDetails), this.dispatchStateChangeEvent());
	}
	async restore() {
		if (!this.database) throw Error("Could not refresh tokens: missing database. Provide database in sessionOption.");
		...
		let e = this.isActive;
		return Wc(this.database).then((e) => this.setTokenDetails(e)).then(() => this.resolveRefresh()).catch((e) => {
			this.isActive ? (this.rejectRefresh(Error(e || "Token refresh failed")), this.isExpired() ? this.dispatchExpirationEvent() : this.dispatchExpirationWarningEvent()) : this.rejectRefresh(/* @__PURE__ */ Error("No session to restore."));
		}).finally(() => {
			this.clearRefreshPromise(), e !== this.isActive && this.dispatchStateChangeEvent();
		}), this.refreshPromise;
	...
	async _createSignedDPoPToken(e) {
		if (!this.information.tokenDetails || !this.currentAth_) throw Error("Session not established.");
		e.ath = this.currentAth_;
		let t = await Js(this.information.tokenDetails.dpop_key_pair.publicKey);
		return new _c(e).setIssuedAt().setJti(window.crypto.randomUUID()).setProtectedHeader({
			alg: "ES256",
			typ: "dpop+jwt",
			jwk: t
		}).sign(this.information.tokenDetails.dpop_key_pair.privateKey);
	...
	dispatchStateChangeEvent() {
		this.dispatchEvent(new CustomEvent(Kc.STATE_CHANGE, { detail: {
			isActive: this.isActive,
			webId: this.webId
		} }));
	}
	dispatchExpirationWarningEvent() {
		this.dispatchEvent(new CustomEvent(Kc.EXPIRATION_WARNING, { detail: { expires_in: this.getExpiresIn() } }));
	}
	dispatchExpirationEvent() {
		this.dispatchEvent(new CustomEvent(Kc.EXPIRATION));
	}
}, Jc = class {
	constructor() {
...
function Xc() {
	let e = zo, t = e.SessionCore ?? e.default?.SessionCore ?? e.default;
...
function Qc() {
	...
	})()) return Zc ? new Zc(void 0, { database: new Yc() }) : new Ro();
	try {
		return new Ro();
	} catch (e) {
		...
		try {
			...
			return console.warn("solid-logic: IndexedDB unavailable, using in-memory session database:", e), Zc ? new Zc(void 0, { database: new Jc() }) : new Ro();
		}
	}
}
var $c = Qc();
...
}, rl = $c, il = typeof rl.login == "function" ? rl.login.bind($c) : void 0;
il && (rl.login = async (e, t) => {
	if (e && typeof e == "object" && !Array.isArray(e)) {
		let t = e.oidcIssuer ?? e.idp ?? e.issuer, n = e.redirectUrl ?? e.redirect_uri ?? e.redirectUri;
		if (typeof t == "string" && typeof n == "string") return il(await tl(t), n);
	}
	return il(typeof e == "string" ? await tl(e) : e, t);
});
var al = new nl(), ol = $c.isActive ?? !!$c.webId;
typeof $c.addEventListener == "function" && $c.addEventListener("sessionStateChange", () => {
	let e = $c.isActive ?? !!$c.webId;
	ol && !e && al.emit("logout"), ol = e;
});
var sl = Object.assign($c, { events: al }), cl = 5e3;
async function ll(e) {
	if (e === null) return;
	let t, n = new Promise((e) => {
		t = setTimeout(() => e(void 0), cl);
	});
	try {
...
var ul = class {
	...
	currentUser() {
		let e = li();
		if (e.viewingNoAuthPage) return Gr(e.webId);
		...
		return this && this.session && i && s ? Gr(i) : ui();
	}
	async checkUser(e) {
		...
		!this.sessionRestoreHookAttached && typeof n?.events?.on == "function" && (n.events.on("sessionRestore", (e) => {
			si(`Session restored to ${e}`), document.location.toString() !== e && history.replaceState(null, "", e);
	...
	async resolveCurrentUser() {
		...
		if (t.hash = "", typeof e?.handleIncomingRedirect == "function") await e.handleIncomingRedirect({
			...
			if (typeof e?.restore == "function") {
				try {
					...
					si(`Session restore failed, continuing logged-out: ${n}`);
				}
		...
		return i ||= await this.probeNssCookieBackedWebId(), this.fallbackWebId = i || null, i && (r = this.saveUser(i)), r && si(`(Logged in as ${r} by authentication)`), r;
	}
...
function fl(e, t) {
	...
	async function r(t, n, r) {
		await e.fetcher.load(t);
		let i = e.any(t, new U("http://www.iana.org/assignments/link-relations/acl"));
	...
	async function i(t, r) {
		...
		let a = vi(i), o = [
			Wr(a, n.rdf("type"), n.solid("TypeRegistration"), i.doc()),
			Wr(a, n.solid("forClass"), n.meeting("LongChat"), i.doc()),
			Wr(a, n.solid("instance"), t, i.doc())
		];
	...
	async function a(n) {
		...
		try {
			await e.fetcher.load(new U(i.value + "index.ttl#this"));
		} catch {
			a = !1;
		}
		return {
	...
	function s(t) {
		...
		let a = t.newInstance = t.newInstance || r.sym(t.newBase + dl), o = a.doc();
		return r.add(a, n.rdf("type"), n.meeting("LongChat"), o), r.add(a, n.dc("title"), "Chat channel", o), r.add(a, n.dc("created"), ei(new Date(Date.now())), o), t.me && r.add(a, n.dc("author"), t.me, o), new Promise(function(e, n) {
...
function gl(e, t, n = {}) {
	if (e.ok || n.allowNotFound && hl(e.status)) return;
...
function yl(e) {
	...
	let t = vl(e), n = t.get("user") ?? /* @__PURE__ */ new Set(), r = t.get("public") ?? /* @__PURE__ */ new Set();
	return {
		canEdit: n.has("write"),
...
function bl(e, t, n, r) {
	...
	function s(t, n) {
		...
		if (n.headers) {
			...
			let c = yl(n.headers.get("wac-allow"));
			i = c.canEdit, a = c.isPublic, o = n.headers.get("etag") ?? void 0, s = e.anyValue(t, ii.dct("modified")) || e.anyValue(t, ii.dc("modified")) || void 0;
		}
		(!n.headers || !n.headers.get("content-type")) && (!n.headers || !n.headers.get("wac-allow") || !n.headers.get("etag")) && e.each(null, e.sym("http://www.w3.org/2007/ont/link#requestedURI"), t).map((n) => {
			...
			if (c && c.termType === "NamedNode") {
				let n = e.anyValue(c, ii.httph("content-type")) || void 0;
				r === void 0 && (r = n);
				let l = yl(e.anyValue(c, ii.httph("wac-allow")) || e.anyValue(c, ii.httph("WAC-Allow")));
				i ||= l.canEdit, a ||= l.isPublic;
				let u = e.anyValue(c, ii.httph("etag")) || void 0;
				o === void 0 && (o = u), s = e.anyValue(t, ii.dct("modified")) || e.anyValue(t, ii.dc("modified")) || void 0;
			}
		});
		let c = e.any(t, ai)?.value || void 0;
		return {
			contentType: r,
			access: {
				canEdit: i,
	...
	async function c(t) {
		...
		return gl(n, "HEAD"), s(t, n);
	}
	async function l(t) {
		let n = e.any(t, ii.ldp("contains")) || t.dir();
	...
	async function m(t, r = {}) {
		...
		if (a(t)) {
			...
			await Promise.all(e.map((e) => m(Gr(e), r)));
		}
		let o;
		try {
			o = await e.fetcher._fetch(t.value, { method: "DELETE" }), gl(o, "DELETE", { allowNotFound: !0 });
		} catch (e) {
			if (!_l(e)) throw e;
		}
		return r.deleteTypeIndexes && await p(t, r.user), i && e.removeMatches(i, ii.ldp("contains"), t, i.doc()), e.removeDocument(t), e.fetcher.unload(t.doc()), o;
	}
...
function xl(e) {
	function t(t) {
		return e.statementsMatching(t, Gr("http://www.w3.org/ns/ldp#contains"), void 0).map((e) => e.object);
	}
	function n(t) {
		let n = e.findTypeURIs(t);
		return !!(t.value.charAt(t.value.length - 1) === "/" || n[ii.ldp("Container").uri] || n[ii.ldp("BasicContainer").uri]);
	}
	function r(e) {
		return t(e).length;
	}
	async function i(t) {
		if (!n(Gr(t))) throw Error(`Not a container URL ${t}`);
		let r = await e.fetcher._fetch(t, {
			method: "PUT",
			headers: {
...
function Tl(e, t, n) {
	let r = ii, i = xl(e), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
	function s(e) {
		return !!e && (e.startsWith("https://") || e.startsWith("http://"));
	}
	function c(e) {
	...
	async function f(t, n) {
		...
		let i = Gr(r), a;
		try {
			await e.fetcher.load(i), a = e.any(i, ai)?.value;
		} catch (e) {
			if (!u(e)) throw e;
		}
		a ||= `${r}.acl`;
	...
	async function p(t, r, i = !1) {
		...
		let a;
		try {
			await e.fetcher.load(r), a = e.any(r, ai)?.value;
		} catch (e) {
			if (!u(e)) throw e;
		}
		a ||= `${r.uri}.acl`;
	...
	async function m(e) {
		await n.loadOrCreateWithContentOnCreate(e, wi());
	}
	async function h(t, i) {
		...
		let h = [];
		e.holds(a, r.rdf("type"), r.space("ConfigurationFile"), a) || h.push(Wr(a, r.rdf("type"), r.space("ConfigurationFile"), a)), e.holds(a, r.dct("title"), void 0, a) || h.push(Wr(a, r.dct("title"), Yr("Preferences file"), a)), e.holds(t, r.solid("publicTypeIndex"), u, a) || h.push(Wr(t, r.solid("publicTypeIndex"), u, a)), e.holds(t, r.solid("privateTypeIndex"), d, a) || h.push(Wr(t, r.solid("privateTypeIndex"), d, a)), h.length > 0 && (await e.updater.update([], h), await e.fetcher.load(a)), await p(t, u, f), await m(d);
	}
	async function g(e) {
		try {
			return !!await n.loadOrCreateWithContentOnCreate(e, Cl());
		} catch (t) {
			throw t.response?.status === 401 ? new fi() : t.response?.status === 403 ? bi(e) ? new pi() : new mi() : t;
		}
	}
	async function _(e) {
		try {
	...
	async function v(t) {
		...
		let c = (async () => {
			...
			try {
				...
				throw ci(`User ${t} has no pointer in profile to preferences file.`), e instanceof hi || e instanceof gi || e instanceof fi || e instanceof pi || e instanceof mi || e instanceof _i, e;
			}
			try {
				await e.fetcher.load(a);
			} catch (n) {
				...
				throw ci(r), n.response.status === 401 ? new fi() : n.response.status === 403 ? bi(a) ? new pi() : new mi() : Error(r);
			}
...
function El(e, t, n) {
		...
		try {
			...
			if (n?.response?.status === 404) {
				try {
					...
					if ((e?.response?.status ?? e?.status) !== 412) throw new gi(`createIfNotExists: PUT FAILED: ${t}: ${e}`);
				}
				return await e.fetcher.load(t);
			}
			if (n?.response?.status === 401) throw new fi();
			if (n?.response?.status === 403) throw bi(t) ? new pi() : new mi();
			let r = `createIfNotExists doc load error: ${t}: ${n}`;
			throw new _i(n?.status, `${n?.message || ""}${r}`);
		}
	}
	...
	async function a(t, n, i, a) {
		...
		try {
			await e.updater.update([], [Wr(t, n, i, a)]);
		} catch (e) {
			throw ci(`followOrCreateLink: Error making link in ${a} to ${i}: ${e}`), new gi(e);
		}
		try {
			await r(i);
		} catch (e) {
			throw ci(`followOrCreateLink: Error loading or saving new linked document: ${i}: ${e}`), e;
		}
		return i;
	}
	async function o(t, n, r, a, o) {
		...
		try {
			await e.updater.update([], [Wr(t, n, r, a)]);
		} catch (e) {
		...
		try {
			...
			throw ci(`followOrCreateLinkWithContentOnCreate: Error loading or saving new linked document: ${r}: ${e}`), e;
		}
		return r;
	}
	async function s(n) {
		...
		let i = await t.findAclDocUrl(Gr(n.target));
...
function Dl(e, t) {
	si("SolidLogic: Unique instance created.  There should only be one of these.");
	let n = Hr();
	Vr(n, { fetch: e.fetch }), n.updater = new Fr(n), n.features = [];
	let r = new ul(t), i = oi(n), a = xl(n), o = El(n, i, a), s = Tl(n, r, o), c = fl(n, s), l = pl(n, s, o, a, i), u = Ti(n, r, s, o), d = bl(n, i, a, u);
	si("SolidAuthnLogic initialized");
	function f(e) {
...
var Ol = async (e, t) => {
	let n = t && t.credentials && t.credentials == "omit", r = sl;
...
}, kl = Symbol.for("solid-logic-singleton"), Al = typeof window < "u" ? window : global;
function jl() {
	return Al[kl] ? si("SolidLogic: Using existing global singleton instance.") : (si("SolidLogic: Creating new global singleton instance."), Al[kl] = Dl({ fetch: Ol }, sl), si("Unique quadstore initialized.")), Al[kl];
}
var Ml = jl(), Nl = Ml.authn, Pl = Ml.authn.authSession, Fl = Ml.store;
//#endregion
export { ht as A, o as B, ei as C, pr as D, jr as E, ge as F, d as H, me as I, U as L, Fe as M, Oe as N, Ct as O, Se as P, N as R, Wr as S, Fr as T, u as U, c as V, $r as _, Ti as a, Yr as b, gi as c, fi as d, ui as f, Vr as g, zr as h, Ml as i, Ye as j, xt as k, mi as l, ri as m, Pl as n, hi as o, ai as p, Nl as r, pi as s, Fl as t, _i as u, Hr as v, Kr as w, Gr as x, Ur as y, s as z };

//# sourceMappingURL=index.esm-C5aSF9dm.js.map