import { c as e, i as t, r as n, t as r } from "./lit-C4H1jI4q.js";
...
}, p = (e, t, n) => t.has(e) || d("Cannot " + n), m = (e, t, n) => (p(e, t, "read from private field"), n ? n.call(e) : t.get(e)), h = (e, t, n) => t.has(e) ? d("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, n), g = (e, t, n, r) => (p(e, t, "write to private field"), r ? r.call(e, n) : t.set(e, n), n), _ = e`
  :host {
...
x = /* @__PURE__ */ new WeakMap(), f([i()], S.prototype, "dir", 2), f([i()], S.prototype, "lang", 2), f([i({
	type: Boolean,
	reflect: !0,
	attribute: "did-ssr"
...
//#endregion
//#region node_modules/@awesome.me/webawesome/dist/chunks/chunk.7MPIABXH.js
function Nt(e) {
...
var Pt = !!globalThis?.HTMLElement?.prototype.hasOwnProperty("popover"), $ = class extends S {
	...
	async handleAnchorChange() {
		...
		} else this.anchor instanceof Element || Nt(this.anchor) ? this.anchorEl = this.anchor : this.anchorEl = this.querySelector("[slot=\"anchor\"]");
...
$.css = c, f([a(".popup")], $.prototype, "popup", 2), f([a(".arrow")], $.prototype, "arrowEl", 2), f([i({
	attribute: !1,
	type: Boolean
})], $.prototype, "SUPPORTS_POPOVER", 2), f([i()], $.prototype, "anchor", 2), f([i({
	type: Boolean,
	reflect: !0
})], $.prototype, "active", 2), f([i({ reflect: !0 })], $.prototype, "placement", 2), f([i()], $.prototype, "boundary", 2), f([i({ type: Number })], $.prototype, "distance", 2), f([i({ type: Number })], $.prototype, "skidding", 2), f([i({ type: Boolean })], $.prototype, "arrow", 2), f([i({ attribute: "arrow-placement" })], $.prototype, "arrowPlacement", 2), f([i({
	attribute: "arrow-padding",
	type: Number
})], $.prototype, "arrowPadding", 2), f([i({ type: Boolean })], $.prototype, "flip", 2), f([i({
	attribute: "flip-fallback-placements",
	converter: {
		fromAttribute: (e) => e.split(" ").map((e) => e.trim()).filter((e) => e !== ""),
		toAttribute: (e) => e.join(" ")
	}
})], $.prototype, "flipFallbackPlacements", 2), f([i({ attribute: "flip-fallback-strategy" })], $.prototype, "flipFallbackStrategy", 2), f([i({ type: Object })], $.prototype, "flipBoundary", 2), f([i({
	attribute: "flip-padding",
	type: Number
})], $.prototype, "flipPadding", 2), f([i({ type: Boolean })], $.prototype, "shift", 2), f([i({ type: Object })], $.prototype, "shiftBoundary", 2), f([i({
	attribute: "shift-padding",
	type: Number
})], $.prototype, "shiftPadding", 2), f([i({ attribute: "auto-size" })], $.prototype, "autoSize", 2), f([i()], $.prototype, "sync", 2), f([i({ type: Object })], $.prototype, "autoSizeBoundary", 2), f([i({
	attribute: "auto-size-padding",
	type: Number
})], $.prototype, "autoSizePadding", 2), f([i({
...
//# sourceMappingURL=chunk.7MPIABXH-CEYdxYyt.js.map