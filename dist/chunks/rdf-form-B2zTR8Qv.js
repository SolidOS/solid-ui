import { S as e, h as t } from "./index.esm-AZPmKqjU.js";
import { b as n, g as r, i, o as a, r as o, u as s } from "./components-BHoVP7zE.js";
import { a as c, i as l, o as u, r as d, s as f } from "./rdf-input-DeDhyQ3p.js";
...
j = (_ = n({
	...
	render() {
		...
		let a = e(U(this.formUrl)), o = n.each(i, t.ui("parts"), null, a), c = (f(n, o) || []).flatMap((e) => e && typeof e == "object" && "elements" in e && Array.isArray(e.elements) ? e.elements : [e]).map((e) => {
			let r = n.each(e, t.rdf("type"), null, a)[0], i = r ? r.value || String(r) : e.value || String(e), o = i.lastIndexOf("#");
			return {
				value: e,
        ...
        ${c.map((t) => {
			switch (t.fieldValue) {
				...
				case "NamedNodeURIField": return s` <solid-ui-rdf-input 
                  .formSubject=${e(t.value)} 
                  .dataSubject=${e(r)}
                  .storeVersion=${this._loadVersion}
                  .readonly=${this.entireDataIsReadonly}
                ></solid-ui-rdf-input>
                <br>`;
				case "MultiLineTextField": return s`<input .rdf=${t}></input>`;
				case "BooleanField": return s`<input .rdf=${t}></input>`;
				case "TristateField": return s`<input .rdf=${t}></input>`;
				case "Classifier": return s`<input .rdf=${t}></input>`;
				case "Choice": return s`<input .rdf=${t}></input>`;
				case "Multiple": return s`<input .rdf=${t}></input>`;
				case "Options": return s`<input .rdf=${t}></input>`;
				case "AutocompleteField": return s`<input .rdf=${t}></input>`;
				case "Comment":
				case "Heading": return s`<input .rdf=${t}></input>`;
				default: return s`<div>Unknown part type: ${t}</div>`;
			}
		})}
      </form>
    `;
...
//# sourceMappingURL=rdf-form-B2zTR8Qv.js.map