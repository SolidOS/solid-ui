import { g as e, o as t, p as n } from "./components-DrP7BOrs.js";
//#region src/components/dialog-header/DialogHeader.styles.css
var r = n`:host{background:var(--solid-ui-color-slate-50);border-bottom:1px solid var(--solid-ui-color-slate-200);font-size:var(--solid-ui-font-size-lg);justify-content:space-between;align-items:center;gap:15px;padding:15px;font-weight:500;display:flex}`, i, a, o, s, c;
function l(e, t, n) {
...
//#endregion
//#region src/components/dialog-header/index.ts
var _ = g;
//#endregion
export { g as n, _ as t };

//# sourceMappingURL=dialog-header-BjellR7_.js.map