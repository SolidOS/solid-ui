...
l = [n("solid-ui-signup-button")];
var C, w = /*#__PURE__*/ new WeakMap();
f = (u = i({
	context: e,
	subscribe: !0
}), "auth"), o = class extends r {
	constructor(...e) {
		super(...e), p(this, w, (s(this), d(this, t)));
	}
	get [f]() {
		return g(w, this);
	}
...
//#endregion
//#region src/components/signup-button/index.ts
var T = C;
//#endregion
export { C as n, T as t };

//# sourceMappingURL=signup-button-DfHU6Tib.js.map