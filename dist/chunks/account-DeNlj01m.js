import { a as e, o as t } from "./auth-Knq99zZ9.js";
import { i as n, l as r, o as i, p as a } from "./components-BD458q30.js";
import { c as o, i as s, n as c } from "./lit-C4H1jI4q.js";
import "./chevron-down-ujxRg3MD.js";
import "./button-Dvkek1tx.js";
import "./avatar-DgO_p94F.js";
import "./login-button-BafqiKef.js";
import "./logout-button-D54NF9EW.js";
import "./menu-item-D9BqJtKZ.js";
import "./menu-DKxtACGA.js";
import "./signup-button-D5wS8_gB.js";
...
y = [r("solid-ui-account")];
var R;
new (w = (h = /*#__PURE__*/ new WeakMap(), g = /*#__PURE__*/ new WeakMap(), T = (b = n({ type: Array }), S = a({
	context: t,
	subscribe: !0
}), "menuItems"), m = class extends i {
	constructor(...t) {
	...
	render() {
		return this.auth.initialized ? this.auth.account ? s`
        <solid-ui-menu placement="bottom-end">
            ...
            ${this.menuItems.map((e) => s`
                <solid-ui-menu-item .href=${e.href ?? c} ?selected=${e.selected} @solid-ui-select=${() => e.onSelected?.()}>
                    ${e.label}
                </solid-ui-menu-item>
            `)}
	...
	1,
	"auth"
]], y, 0, void 0, i), m), p = class extends L {
	constructor() {
...
//# sourceMappingURL=account-DeNlj01m.js.map