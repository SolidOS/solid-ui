import { a as e, o as t, r as n } from "./components-Bp5jfkEz.js";
import "./DialogProvider-ChNquG8e.js";
import { i as r } from "./lit-C4H1jI4q.js";
import { t as i } from "./show-dialog-eEW5yRBv.js";
import { t as a } from "./decorators-BqWyWiL9.js";
//#region src/components/dialogs-root/DialogsRoot.ts
var o, s, c, l, u, d, f;
function p(e, t, n) {
	m(e, t), t.set(e, n);
}
...
l = [t("solid-ui-dialogs-root")];
var C, w = /*#__PURE__*/ new WeakMap();
f = (u = a(), "dialogs"), o = class extends n {
	constructor(...e) {
		super(...e), p(this, w, (s(this), d(this, [])));
	}
	get [f]() {
		return g(w, this);
	}
	...
	connectedCallback() {
		super.connectedCallback(), this.addGlobalEventListener(i.eventName, (e) => {
			e.stopImmediatePropagation(), this.dialogs = [...this.dialogs, e.dialog];
		}), this.addGlobalEventListener(e.eventName, (e) => {
			e.stopImmediatePropagation();
			let t = this.dialogs.find((t) => t.id === e.id);
			this.dialogs = this.dialogs.filter((t) => t.id !== e.id), t?.closed(e.data);
		});
	}
	render() {
		return r`${this.dialogs.map((e) => r`
...
//#endregion
//#region src/components/dialogs-root/index.ts
var T = C;
//#endregion
export { C as n, T as t };

//# sourceMappingURL=dialogs-root-BVKCO6Kx.js.map