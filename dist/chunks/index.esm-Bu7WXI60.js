...
var Le = /* @__PURE__ */ s(((e, t) => {
		...
		function n(e, n) {
			...
			function fr() {
				...
				if (n !== r) {
					...
					for (o === r ? (G = a, a = r) : (e.charCodeAt(G) === 44 ? (s = V, G++) : (s = r, q === 0 && X(le)), s === r ? (G = a, a = r) : (c = gr(), c === r ? (G = a, a = r) : (K = a, o = ue(n, c), a = o))); a !== r;) {
						for (i.push(a), a = G, o = [], s = Z(); s !== r;) o.push(s), s = Z();
						o === r ? (G = a, a = r) : (e.charCodeAt(G) === 44 ? (s = V, G++) : (s = r, q === 0 && X(le)), s === r ? (G = a, a = r) : (c = gr(), c === r ? (G = a, a = r) : (K = a, o = ue(n, c), a = o)));
					}
	...
	var h = a("[", r(m), r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), g = a(m, h, "*"), _ = a(h, "+"), v = o(a("&", g, ";"), "|", o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/)), y = a("%", g, ";"), b = o(a("\"", o(/[^%&"]/, "|", y, "|", v), "*", "\""), "|", a("'", o(/[^%&']/, "|", y, "|", v), "*", "'")), x = o("\"", o(/[^<&"]/, "|", v), "*", "\"", "|", "'", o(/[^<&']/, "|", v), "*", "'"), S = a(i(m, ":"), i(h, ":"), "*"), C = a(S, o(":", S), "?"), w = a("^", C, "$"), T = a("(", C, ")"), E = o(/"[^"]*"|'[^']*'/), D = a(/^<\?/, "(", g, ")", o(f, "(?!", u, ")(", c, "*?)"), "?", /\?>/), O = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, ee = o("\"", O, "*\"", "|", "'", i(O, "'"), "*'"), te = "<!--", k = "-->", A = a(te, o(i(c, "-"), "|", a("-", i(c, "-"))), "*", k), ne = "#PCDATA", re = o("EMPTY", "|", "ANY", "|", o(a(/\(/, p, ne, o(p, /\|/, p, C), "*", p, /\)\*/), "|", a(/\(/, p, ne, p, /\)/)), "|", a(/\([^>]+\)/, /[?*+]?/)), j = a("<!ELEMENT", f, o(C, "|", y), f, o(re, "|", y), p, ">"), ie = a("<!ATTLIST", f, g, o(f, g, f, o(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", o(a("NOTATION", f, /\(/, p, g, o(p, /\|/, p, g), "*", p, /\)/), "|", a(/\(/, p, _, o(p, /\|/, p, _), "*", p, /\)/))), f, o(/#REQUIRED|#IMPLIED/, "|", o(o("#FIXED", f), "?", x))), "*", p, ">"), M = "about:legacy-compat", N = o("\"" + M + "\"", "|", "'" + M + "'"), P = "SYSTEM", ae = "PUBLIC", F = o(o(P, f, E), "|", o(ae, f, ee, f, E)), I = a("^", o(o(P, f, "(?<SystemLiteralOnly>", E, ")"), "|", o(ae, f, "(?<PubidLiteral>", ee, ")", f, "(?<SystemLiteral>", E, ")"))), L = a("^", ee, "$"), R = a("^", E, "$"), oe = o(b, "|", o(F, o(f, "NDATA", f, g), "?")), se = "<!ENTITY", ce = o(a(se, f, g, f, oe, p, ">"), "|", a(se, f, "%", f, g, f, o(b, "|", F), p, ">")), z = a("<!NOTATION", f, g, f, o(F, "|", a(ae, f, ee)), p, ">"), B = a(p, "=", p), V = /1[.]\d+/, le = a(f, "version", B, o("'", V, "'", "|", "\"", V, "\"")), ue = /[A-Za-z][-A-Za-z0-9._]*/, de = a(/^<\?xml/, le, o(f, "encoding", B, o("\"", ue, "\"", "|", "'", ue, "'")), "?", o(f, "standalone", B, o("'", o("yes", "|", "no"), "'", "|", "\"", o("yes", "|", "no"), "\"")), "?", p, /\?>/), fe = "<!DOCTYPE", pe = "<![CDATA[", H = "]]>", me = a(/<!\[CDATA\[/, a(c, "*?", /\]\]>/));
	e.chars = r, e.chars_without = i, e.detectUnicodeSupport = t, e.reg = a, e.regg = o, e.ABOUT_LEGACY_COMPAT = M, e.ABOUT_LEGACY_COMPAT_SystemLiteral = N, e.AttlistDecl = ie, e.CDATA_START = pe, e.CDATA_END = H, e.CDSect = me, e.Char = c, e.Comment = A, e.COMMENT_START = te, e.COMMENT_END = k, e.DOCTYPE_DECL_START = fe, e.elementdecl = j, e.EntityDecl = ce, e.EntityValue = b, e.ExternalID = F, e.ExternalID_match = I, e.Name = g, e.NotationDecl = z, e.Reference = v, e.PEReference = y, e.PI = D, e.PUBLIC = ae, e.PubidLiteral = ee, e.PubidLiteral_match = L, e.QName = C, e.QName_exact = w, e.QName_group = T, e.S = f, e.SChar_s = d, e.S_OPT = p, e.SYSTEM = P, e.SystemLiteral = E, e.SystemLiteral_match = R, e.InvalidChar = l, e.UNICODE_REPLACEMENT_CHARACTER = s, e.UNICODE_SUPPORT = n, e.XMLDecl = de;
})), Ve = /* @__PURE__ */ s(((e) => {
	...
	R.prototype = {
		...
		removeNamedItem: function(e) {
			...
			return ce(this._ownerElement, this, t), t;
		},
		removeNamedItemNS: function(e, t) {
			var n = this.getNamedItemNS(e, t);
			if (!n) throw new f(f.NOT_FOUND_ERR, e ? e + " : " + t : t);
			return ce(this._ownerElement, this, n), n;
		},
	...
	C(T, B), C(T, B.prototype), C(N, B), C(N, B.prototype);
	function le(e, t) {
	...
	function me(e, t) {
		...
		return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, H(e.ownerDocument, e), t.parentNode = null, t.previousSibling = null, t.nextSibling = null, t;
	}
	function he(e) {
		return e && (e.nodeType === B.DOCUMENT_NODE || e.nodeType === B.DOCUMENT_FRAGMENT_NODE || e.nodeType === B.ELEMENT_NODE);
	}
	function ge(e) {
		return e && (e.nodeType === B.CDATA_SECTION_NODE || e.nodeType === B.COMMENT_NODE || e.nodeType === B.DOCUMENT_FRAGMENT_NODE || e.nodeType === B.DOCUMENT_TYPE_NODE || e.nodeType === B.ELEMENT_NODE || e.nodeType === B.PROCESSING_INSTRUCTION_NODE || e.nodeType === B.TEXT_NODE);
	}
	function _e(e) {
	...
	function Se(e, t, n) {
		...
		if (!ge(t) || _e(t) && e.nodeType !== B.DOCUMENT_NODE) throw new f(f.HIERARCHY_REQUEST_ERR, "Unexpected node type " + t.nodeType + " for parent node type " + e.nodeType);
	}
	function Ce(e, t, r) {
	...
	function Te(e, t, n, r) {
		Se(e, t, n), e.nodeType === B.DOCUMENT_NODE && (r || Ce)(e, t, n);
		var i = t.parentNode;
		...
		return H(e.ownerDocument || e, e, t), t.nodeType == ie && (t.firstChild = t.lastChild = null), t;
	}
	de.prototype = {
		implementation: null,
		nodeName: "#document",
	...
	}, de.prototype.getElementsByClassName = Ee.prototype.getElementsByClassName, de.prototype.getElementsByTagName = Ee.prototype.getElementsByTagName, de.prototype.getElementsByTagNameNS = Ee.prototype.getElementsByTagNameNS, w(Ee, B);
	function De(e) {
		h(e), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
	}
	De.prototype.nodeType = D, w(De, B);
	function Oe(e) {
		h(e);
	}
	Oe.prototype = {
	...
	Me.prototype.nodeType = j, w(Me, B);
	function Ne(e) {
		h(e);
	}
	Ne.prototype.nodeType = M, w(Ne, B);
	function Pe(e) {
		h(e);
	}
	Pe.prototype.nodeType = k, w(Pe, B);
	function Fe(e) {
		h(e);
	}
	Fe.prototype.nodeType = te, w(Fe, B);
	function U(e) {
		h(e);
	}
	U.prototype.nodeName = "#document-fragment", U.prototype.nodeType = ie, w(U, B);
	function Ie(e) {
		h(e);
	}
	Ie.prototype.nodeType = A, w(Ie, Oe);
	function Le() {}
	Le.prototype.serializeToString = function(e, t) {
		return Ve.call(e, t);
	}, B.prototype.toString = Ve;
	function Ve(e) {
			...
			enter: function(e, n) {
				...
				switch (e.nodeType) {
					case E:
						...
						for (var w = 0; w < g; w++) {
							...
							if (He(T, u, C)) {
								...
								Ue(t, k ? "xmlns:" + k : "xmlns", M, a), C.push({
									prefix: k,
									namespace: M
								});
							}
							var N = i ? i(T) : T;
							N && (typeof N == "string" ? t.push(N) : Ue(t, N.name, N.value, a));
						}
						if (_ === v && He(e, u, C)) {
							var P = e.prefix || "", M = e.namespaceURI;
							Ue(t, P ? "xmlns:" + P : "xmlns", M, a), C.push({
								prefix: P,
								namespace: M
							});
						}
					...
					case ie:
						...
						return { ns: d };
					case D: return Ue(t, e.name, e.value, a), null;
					case O:
						...
						return t.push(e.data.replace(/[<&>]/g, V)), null;
					case ee:
	...
	try {
		Object.defineProperty && (Object.defineProperty(I.prototype, "length", { get: function() {
		...
		}), Object.defineProperty(Oe.prototype, "data", {
			get: function() {
		...
		}), Object.defineProperty(Oe.prototype, "nodeValue", {
			get: function() {
				return this.data;
			},
			set: function(e) {
			...
			return new I(this, Je);
		} }), Object.defineProperty(U.prototype, "children", { get: function() {
			return new I(this, Je);
		} }), qe = function(e, t, n) {
			e["$$" + t] = n;
		});
	} catch {}
	e._updateLiveList = L, e.Attr = De, e.CDATASection = je, e.CharacterData = Oe, e.Comment = Ae, e.Document = de, e.DocumentFragment = U, e.DocumentType = Me, e.DOMImplementation = z, e.Element = Ee, e.Entity = Pe, e.EntityReference = Fe, e.LiveNodeList = I, e.NamedNodeMap = R, e.Node = B, e.NodeList = F, e.Notation = Ne, e.Text = ke, e.ProcessingInstruction = Ie, e.walkDOM = ue, e.XMLSerializer = Le;
})), He = /* @__PURE__ */ s(((e) => {
	var t = Re().freeze;
	e.XML_ENTITIES = t({
		amp: "&",
			...
			try {
				...
				switch (e.charAt(O + 1)) {
					case "/":
						...
						var M = j > 0 && n.reg("^", n.QName_group, n.S_OPT, "$").exec(ie);
						...
						if (N !== M[1]) {
							...
							if (!d || N.toLowerCase() !== P) return c.fatalError("Opening and ending tag mismatch: \"" + N + "\" != \"" + ie + "\"");
						}
						var ae = x.pop();
						E.pop();
						var F = ae.localNSMap;
						if (o.endElement(ae.uri, ae.localName, N), F) for (var I in F) s(F, I) && o.endPrefixMapping(I);
						j++;
						break;
					case "?":
						v && y(O), j = te(e, O, o, c);
					...
					default:
						v && y(O);
						var L = new k(), R = x[x.length - 1].currentNSMap, j = C(e, O, L, R, p, c, d), oe = L.length;
						if (L.closed || (d && t.isHTMLVoidElement(L.tagName) ? L.closed = !0 : E.push(L.tagName)), v && oe) {
							for (var se = S(v, {}), ce = 0; ce < oe; ce++) {
								var z = L[ce];
								y(z.offset), z.locator = S(v, {});
							}
							o.locator = se, w(L, o, R) && x.push(L), o.locator = v;
						} else w(L, o, R) && x.push(L);
						d && !L.closed ? j = T(e, j, L.tagName, p, o) : j++;
				}
			} catch (e) {
...
async function Sn(e, t, n) {
	let r = n && Object.prototype.hasOwnProperty.call(n, "termType") ? n.value : n, i = await import("./jsonld-B2M5QgXx.js").then((e) => /* @__PURE__ */ u(e.default));
...
var En = /* @__PURE__ */ s(((e) => {
	...
	s.prototype.readUintLE = s.prototype.readUIntLE = function(e, t, n) {
		...
		(t === void 0 || n === void 0) && V(e, this.length - 8);
	...
	function ce(e, t, n) {
		B(t, "offset"), (e[t] === void 0 || e[t + n] === void 0) && V(t, e.length - (n + 1));
	}
...
var Rn = {
	...
	constructor(e) {
		if (this._iri = /^<((?:[^ <>{}\\]|\\[uU])+)>[ \t]*/, this._unescapedIri = /^<([^\x00-\x20<>\\"\{\}\|\^\`]*)>[ \t]*/, this._simpleQuotedString = /^"([^"\\\r\n]*)"(?=[^"])/, this._simpleApostropheString = /^'([^'\\\r\n]*)'(?=[^'])/, this._langcode = /^@([a-z]+(?:-[a-z0-9]+)*)(?=[^a-z0-9])/i, this._dircode = /^--(ltr)|(rtl)/, this._prefix = /^((?:[A-Za-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)?:(?=[#\s<])/, this._prefixed = /^((?:[A-Za-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)?:((?:(?:[0-:A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~])(?:(?:[\.\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~])*(?:[\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff]|%[0-9a-fA-F]{2}|\\[!#-\/;=?\-@_~]))?)?)(?:[ \t]+|(?=\.?[,;!\^\s#()\[\]\{\}"'<>]))/, this._variable = /^\?(?:(?:[A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:[\-0-:A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)(?=[.,;!\^\s#()\[\]\{\}"'<>])/, this._blank = /^_:((?:[0-9A-Z_a-z\xc0-\xd6\xd8-\xf6\xf8-\u02ff\u0370-\u037d\u037f-\u1fff\u200c\u200d\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])(?:\.?[\-0-9A-Z_a-z\xb7\xc0-\xd6\xd8-\xf6\xf8-\u037d\u037f-\u1fff\u200c\u200d\u203f\u2040\u2070-\u218f\u2c00-\u2fef\u3001-\ud7ff\uf900-\ufdcf\ufdf0-\ufffd]|[\ud800-\udb7f][\udc00-\udfff])*)(?:[ \t]+|(?=\.?[,;:\s#()\[\]\{\}"'<>]))/, this._number = /^[\-+]?(?:(\d+\.\d*|\.?\d+)[eE][\-+]?|\d*(\.)?)\d+(?=\.?[,;:\s#()\[\]\{\}"'<>])/, this._boolean = /^(?:true|false)(?=[.,;\s#()\[\]\{\}"'<>])/, this._atKeyword = /^@[a-z]+(?=[\s#<:])/i, this._keyword = /^(?:PREFIX|BASE|VERSION|GRAPH)(?=[\s#<])/i, this._shortPredicates = /^a(?=[\s#()\[\]\{\}"'<>])/, this._newline = /^[ \t]*(?:#[^\n\r]*)?(?:\r\n|\n|\r)[ \t]*/, this._comment = /#([^\n\r]*)/, this._whitespace = /^[ \t]+/, this._endOfFile = /^(?:#[^\n\r]*)?$/, e ||= {}, this._isImpliedBy = e.isImpliedBy, this._lineMode = !!e.lineMode) {
			this._n3Mode = !1;
			for (let e in this) !(e in Rn) && this[e] instanceof RegExp && (this[e] = zn);
			...
			switch (c) {
				...
				case "<":
					if (f = this._unescapedIri.exec(n)) l = "IRI", u = f[1];
						...
						if (u = this._unescape(f[1]), u === null || In.test(u)) return a(this);
						l = "IRI";
	...
	_unescape(e) {
		let t = !1, n = e.replace(Pn, (e, n, r, i) => {
			if (typeof n == "string") {
				let e = Number.parseInt(n, 16);
				return Ln(e) ? String.fromCharCode(e) : (t = !0, "");
			}
			if (typeof r == "string") {
				let e = Number.parseInt(r, 16);
				return Ln(e) ? e <= 65535 ? String.fromCharCode(Number.parseInt(r, 16)) : String.fromCharCode(55296 + ((e -= 65536) >> 10), 56320 + (e & 1023)) : (t = !0, "");
			}
			return i in Fn ? Fn[i] : (t = !0, "");
		});
		return t ? null : n;
	}
	_parseLiteral(e) {
	...
	get datatype() {
		return new Gn(this.datatypeString);
	}
	get datatypeString() {
		let e = this.id, t = e.lastIndexOf("\"") + 1, n = t < e.length ? e[t] : "";
		return n === "^" ? e.substr(t + 2) : n === "@" ? e.indexOf("--", t) > 0 ? Vn.dirLangString : Vn.langString : Hn.string;
	}
	equals(t) {
...
Un = new class extends K {
	constructor() {
		return super(""), Un || this;
	}
	get termType() {
		return "DefaultGraph";
	}
...
var Jn = class extends K {
	constructor(e, t, n, r) {
		super(""), this._subject = e, this._predicate = t, this._object = n, this._graph = r || Un;
	}
	get termType() {
		return "Quad";
	}
...
function J(e) {
	return new qn(e || `n3-${Wn++}`);
}
function Y(e, t) {
	if (typeof t == "string") return new Kn(`"${e}"@${t.toLowerCase()}`);
	if (t !== void 0 && !("termType" in t)) return new Kn(`"${e}"@${t.language.toLowerCase()}${t.direction ? `--${t.direction.toLowerCase()}` : ""}`);
	let n = t ? t.value : "";
	return n === "" && (typeof e == "boolean" ? n = Hn.boolean : typeof e == "number" && (Number.isFinite(e) ? n = Number.isInteger(e) ? Hn.integer : Hn.double : (n = Hn.double, Number.isNaN(e) || (e = e > 0 ? "INF" : "-INF")))), n === "" || n === Hn.string ? new Kn(`"${e}"`) : new Kn(`"${e}"^^${n}`);
}
function Xn(e) {
	return new q(e);
}
...
function Qn(e, t, n, r) {
	return new Jn(e, t, n, r);
}
function X(e) {
	if (e instanceof K) return e;
	switch (e.termType) {
		case "NamedNode": return Yn(e.value);
		case "BlankNode": return J(e.value);
		case "Variable": return Xn(e.value);
		case "DefaultGraph": return Un;
		case "Literal": return Y(e.value, e.language || e.datatype);
...
function $n(e) {
	...
	return Qn(X(e.subject), X(e.predicate), X(e.object), X(e.graph));
}
//#endregion
//#region node_modules/n3/src/N3Parser.js
var er = 0, tr = class e {
	constructor(e) {
		this._contextStack = [], this._graph = null, e ||= {}, this._setBase(e.baseIRI), e.factory && rr(this, e.factory);
		...
		(this._supportsNamedGraphs = !(n || o)) || (this._readPredicateOrNamedGraph = this._readPredicate), this._supportsQuads = !(n || r || i || o), this._isImpliedBy = e.isImpliedBy, s && (this._resolveRelativeIRI = (e) => null), this._blankNodePrefix = typeof e.blankNodePrefix == "string" ? e.blankNodePrefix.replace(/^(?!_:)/, "_:") : "", this._lexer = e.lexer || new Bn({
			lineMode: s,
			n3: o,
	...
	_error(e, t) {
		...
		}, this._callback(n), this._callback = nr;
	}
	_resolveIRI(e) {
	...
	parse(e, t, n, r) {
		let i, a, o, s;
		if (t && (t.onQuad || t.onPrefix || t.onComment || t.onVersion) ? (i = t.onQuad, a = t.onPrefix, o = t.onComment, s = t.onVersion) : (i = t, a = n, s = r), this._readCallback = this._readBeforeTopContext, this._sparqlStyle = !1, this._prefixes = Object.create(null), this._prefixes._ = this._blankNodePrefix ? this._blankNodePrefix.substr(2) : `b${er++}_`, this._prefixCallback = a || nr, this._versionCallback = s || nr, this._inversePredicate = !1, this._quantified = Object.create(null), !i) {
			let t = [], n;
		...
		let c = (e, t) => {
			e === null ? this._readCallback &&= this._readCallback(t) : (this._callback(e), this._callback = nr);
		};
		o && (this._lexer.comments = !0, c = (e, t) => {
			e === null ? this._readCallback && (t.type === "comment" ? o(t.value) : this._readCallback = this._readCallback(t)) : (this._callback(e), this._callback = nr);
		}), this._callback = i, this._lexer.tokenize(e, c);
	}
};
function nr() {}
function rr(e, t) {
	e._factory = t, e.DEFAULTGRAPH = t.defaultGraph(), e.RDF_FIRST = t.namedNode(Mn.rdf.first), e.RDF_REST = t.namedNode(Mn.rdf.rest), e.RDF_NIL = t.namedNode(Mn.rdf.nil), e.RDF_REIFIES = t.namedNode(Mn.rdf.reifies), e.N3_FORALL = t.namedNode(Mn.r.forAll), e.N3_FORSOME = t.namedNode(Mn.r.forSome), e.ABBREVIATIONS = {
...
if (tr.SUPPORTED_VERSIONS = [
	"1.2",
	"1.2-basic",
	"1.1"
], rr(tr.prototype, G), ir === void 0) var ir = {
	ELEMENT_NODE: 1,
	ATTRIBUTE_NODE: 2,
	TEXT_NODE: 3,
...
var Z = class e {
	...
	ancestorPath(e) {
		for (var t = ""; e && e.nodeType !== ir.DOCUMENT_NODE;) t = "/" + e.localName + t, e = e.parentNode;
		return t;
	}
	copyMappings(e) {
		var t = {};
	...
	process(t, n) {
		n ||= {};
		var r;
		t.nodeType === ir.DOCUMENT_NODE ? (t.baseURI && !n.baseURI && (n.baseURI = t.baseURI), r = t.baseURI, t = t.documentElement, t.baseURI || (t.baseURI = r), this.setContext(t)) : t.parentNode.nodeType === ir.DOCUMENT_NODE && this.setContext(t);
		var i = [], a = function(e) {
		...
		for (i.push({
			...
			var V = null, le = f;
			d ? (V = this.push(u, u.subject), V.parentObject = a(l.parentNode.baseURI) === u.parentObject ? a(l.baseURI) : u.parentObject, V.incomplete = u.incomplete, V.language = b, V.prefixes = h, V.vocabulary = x) : (V = this.push(u, f), V.parentObject = p || f || u.subject, V.prefixes = h, V.incomplete = _, p && (le = p, v = {}, y = !0), V.listMapping = v, V.language = b, V.vocabulary = x), y && i.unshift({
				parent: l,
				context: u,
				subject: le,
				listMapping: v
			});
			for (var ue = l.lastChild; ue; ue = ue.previousSibling) ue.nodeType === ir.ELEMENT_NODE && i.unshift({
				current: ue,
				context: V
			});
		}
...
Z.XMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral", Z.HTMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML", Z.PlainLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral", Z.objectURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#object", Z.typeURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", Z.nameChar = "[-A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�က0-F.0-9·̀-ͯ‿-⁀]", Z.nameStartChar = "[A-Za-zÀ-ÖØ-öø-ÿĀ-ıĴ-ľŁ-ňŊ-žƀ-ǃǍ-ǰǴ-ǵǺ-ȗɐ-ʨʻ-ˁΆΈ-ΊΌΎ-ΡΣ-ώϐ-ϖϚϜϞϠϢ-ϳЁ-ЌЎ-яё-ќў-ҁҐ-ӄӇ-ӈӋ-ӌӐ-ӫӮ-ӵӸ-ӹԱ-Ֆՙա-ֆא-תװ-ײء-غف-يٱ-ڷں-ھۀ-ێې-ۓەۥ-ۦअ-हऽक़-ॡঅ-ঌএ-ঐও-নপ-রলশ-হড়-ঢ়য়-ৡৰ-ৱਅ-ਊਏ-ਐਓ-ਨਪ-ਰਲ-ਲ਼ਵ-ਸ਼ਸ-ਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઋઍએ-ઑઓ-નપ-રલ-ળવ-હઽૠଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଶ-ହଽଡ଼-ଢ଼ୟ-ୡஅ-ஊஎ-ஐஒ-கங-சஜஞ-டண-தந-பம-வஷ-ஹఅ-ఌఎ-ఐఒ-నప-ళవ-హౠ-ౡಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹೞೠ-ೡഅ-ഌഎ-ഐഒ-നപ-ഹൠ-ൡก-ฮะา-ำเ-ๅກ-ຂຄງ-ຈຊຍດ-ທນ-ຟມ-ຣລວສ-ຫອ-ຮະາ-ຳຽເ-ໄཀ-ཇཉ-ཀྵႠ-Ⴥა-ჶᄀᄂ-ᄃᄅ-ᄇᄉᄋ-ᄌᄎ-ᄒᄼᄾᅀᅌᅎᅐᅔ-ᅕᅙᅟ-ᅡᅣᅥᅧᅩᅭ-ᅮᅲ-ᅳᅵᆞᆨᆫᆮ-ᆯᆷ-ᆸᆺᆼ-ᇂᇫᇰᇹḀ-ẛẠ-ỹἀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼΩK-Å℮ↀ-ↂぁ-ゔァ-ヺㄅ-ㄬ가-힣一-龥〇〡-〩_]", Z.NCNAME = RegExp("^" + Z.nameStartChar + Z.nameChar + "*$"), Z.dateTimeTypes = [
	{
...
var ar = Z.parseRDFaDOM, or = class e {
	constructor(e) {
...
function cr(e, t, n, r = "text/turtle", i) {
	r ||= "text/turtle", r = r.split(";")[0];
	try {
		if (r === "text/n3" || r === "text/turtle") hn(t, t, n, n, null, null, "", null).loadBuf(e), o();
		else if (r === "application/rdf+xml") new or(t).parse(ot(e), n, t.sym(n)), o();
		else if (r === "application/xhtml+xml") ar(ot(e, { contentType: M }), t, n), o();
		else if (r === "text/html") ar(ot(e, { contentType: D }), t, n), o();
		else if (r === "application/sparql-update" || r === "application/sparql-update-single-match") sr(e, t, n), o();
		else if (r === "application/ld+json") Sn(e, t, n).then(o).catch(s);
		else if (r === "application/n-quads" || r === "application/nquads") {
			var a = new tr({ factory: vn });
			c(null, e);
...
var lr = /* @__PURE__ */ u((/* @__PURE__ */ s(((e, t) => {
...
var hr = class extends mr {
	...
	parse(e, t, n) {
		...
		return n.noMeta || r.add(n.original, pr.rdf("type"), pr.link("RDFDocument"), e.appNode), e.doneFetch(n, this.response);
	}
};
hr.pattern = /* @__PURE__ */ RegExp("application/rdf\\+xml");
var gr = class extends mr {
	...
	parse(e, t, n) {
		...
		o.length > 0 && a.add(n.resource, pr.dc("title"), a.rdfFactory.literal(o[0].textContent), n.resource);
		...
		for (let e = 0; e < c.length; e++) {
			...
			ur[t] && (cr(c[e].textContent, a, n.original.value, t), cr(c[e].textContent, a, n.original.value, t));
		}
		if (n.noMeta || a.add(n.resource, pr.rdf("type"), pr.link("WebPage"), e.appNode), !n.noRDFa && ar) try {
			ar(this.dom, a, n.original.value);
		} catch (t) {
...
gr.pattern = /* @__PURE__ */ RegExp("application/xhtml");
var _r = class e extends mr {
	static toString() {
		return "XMLHandler";
	}
	static register(e) {
...
_r.pattern = /* @__PURE__ */ RegExp("(text|application)/(.*)xml");
var vr = class extends mr {
	...
	parse(e, t, n) {
		let r = e.store;
		if (wr(t)) return e.addStatus(n.req, "Has an XML declaration. We'll assume it's XHTML as the content-type was text/html.\n"), new gr(this.response).parse(e, t, n);
		if (Cr(t)) return e.addStatus(n.req, "Has XHTML DOCTYPE. Switching to XHTMLHandler.\n"), new gr(this.response).parse(e, t, n);
		if (Tr(t)) return e.addStatus(n.req, "Has default namespace for XHTML, so switching to XHTMLHandler.\n"), new gr(this.response).parse(e, t, n);
		let i = (/* @__PURE__ */ RegExp("<title>([\\s\\S]+?)</title>", "im")).exec(t);
		return i && r.add(n.resource, pr.dc("title"), r.rdfFactory.literal(i[1]), n.resource), r.add(n.resource, pr.rdf("type"), pr.link("WebPage"), e.appNode), e.addStatus(n.req, "non-XML HTML document, not parsed for data."), e.doneFetch(n, this.response);
	}
};
vr.pattern = /* @__PURE__ */ RegExp("text/html");
var yr = class extends mr {
	...
	async parse(e, t, n, r) {
		let i = e.store;
		try {
			return await Sn(t, i, n.original.value), e.store.add(n.original, pr.rdf("type"), pr.link("RDFDocument"), e.appNode), e.doneFetch(n, r);
		} catch (t) {
...
yr.pattern = /application\/(ld\+json|activity\+json)/;
var br = class extends mr {
	...
	parse(e, t, n) {
		return wr(t) ? (e.addStatus(n.req, "Warning: " + n.resource + " has an XML declaration. We'll assume it's XML but its content-type wasn't XML.\n"), new _r(this.response).parse(e, t, n)) : t.slice(0, 500).match(/xmlns:/) ? (e.addStatus(n.req, "May have an XML namespace. We'll assume it's XML but its content-type wasn't XML.\n"), new _r(this.response).parse(e, t, n)) : (e.addStatus(n.req, "Plain text document, no known RDF semantics."), e.doneFetch(n, this.response));
	}
};
br.pattern = /* @__PURE__ */ RegExp("text/plain");
var xr = class extends mr {
	...
	parse(e, t, n, r) {
		...
		return e.addStatus(n.req, "N3 parsed: " + a.statementCount + " triples in " + a.lines + " lines."), e.store.add(n.original, pr.rdf("type"), pr.link("RDFDocument"), e.appNode), e.doneFetch(n, this.response);
	}
};
xr.pattern = /* @__PURE__ */ RegExp("(application|text)/(x-)?(rdf\\+)?(n3|turtle)");
var Sr = {
	RDFXMLHandler: hr,
	XHTMLHandler: gr,
	XMLHandler: _r,
...
var Er = class e {
	constructor(e, t = {}) {
		g(this, "store", void 0), g(this, "timeout", void 0), g(this, "_fetch", void 0), g(this, "mediatypes", void 0), g(this, "appNode", void 0), g(this, "requested", void 0), g(this, "timeouts", void 0), g(this, "redirectedTo", void 0), g(this, "fetchQueue", void 0), g(this, "fetchCallbacks", void 0), g(this, "nonexistent", void 0), g(this, "lookedUp", void 0), g(this, "handlers", void 0), g(this, "ns", void 0), g(this, "fireCallbacks", void 0), this.store = e || new At(), this.ns = fr(this.store.rdfFactory), this.timeout = t.timeout || 3e4;
		let n = t.fetch || typeof global < "u" && (global.solidFetcher || global.solidFetch) || typeof window < "u" && (window.solidFetcher || window.solidFetch) || lr.default;
		...
		this._fetch = typeof window < "u" && n === window.fetch ? n.bind(window) : typeof global < "u" && n === global.fetch ? n.bind(global) : n, this.appNode = this.store.sym("chrome://TheCurrentSession"), this.store.fetcher = this, this.requested = {}, this.timeouts = {}, this.redirectedTo = {}, this.fetchQueue = {}, this.fetchCallbacks = {}, this.nonexistent = {}, this.lookedUp = {}, this.handlers = [], this.mediatypes = {
			...
			"retract",
			"done"
		]), Object.keys(t.handlers || Sr).map((e) => this.addHandler(Sr[e]));
	}
	...
	nowOrWhenFetched(e, t, n, r = {}) {
		let i = P(e);
		typeof t == "function" ? n = t : t === void 0 || (V(t) ? r.referringTerm = t : r = t), this.load(i, r).then((e) => {
			if (n) {
				if (e) {
					if (e.ok) n(!0, "OK", e);
					else {
	...
	saveRequestMetadata(e, t) {
		...
		this.addStatus(t.req, "Accept: " + t.headers.accept), V(i) && r.add(r.rdfFactory.namedNode(e), this.ns.link("requestedBy"), i, this.appNode), t.original && t.original.value !== e && r.add(n, this.ns.link("orginalURI"), r.rdfFactory.literal(t.original.value), this.appNode);
...
g(Er, "HANDLERS", void 0), g(Er, "CONTENT_TYPE_BY_EXT", void 0), g(Er, "crossSiteProxyTemplate", void 0), Er.HANDLERS = Sr, Er.CONTENT_TYPE_BY_EXT = dr;
//#endregion
...
var Ar = class {
	...
	updateLocalFile(e, t, n, r, i = {}) {
		...
		let l = Er.CONTENT_TYPE_BY_EXT[c];
	...
	onUpdate(e, t) {
		return this.fetcher.refresh(jr.namedNode(e));
	}
	register(e, t) {
		return this.via[e] ?? (this.via[e] = new Mr(this, e)), this.via[e].subscribe(t);
	}
}, Pr = /* @__PURE__ */ c({
	BlankNode: () => N,
	Collection: () => _e,
...
for (let e in jr) typeof jr[e] == "function" && (Fr[e] = jr[e].bind(jr));
var { fetcher: Ir, graph: Lr, lit: Rr, st: zr, namedNode: Br, variable: Q, blankNode: Vr, defaultGraph: Hr, literal: Ur, quad: Wr, triple: Gr } = Fr, Kr = new xt(), qr = (e) => Kr.fromNT(e), Jr = St.fromValue, Yr = N.nextId, Xr = class extends At {
	constructor(e) {
		super(e), g(this, "fetcher", void 0), this.fetcher = new Er(this, {});
	}
}, Zr = class extends Xr {
	constructor(e) {
		super(e), g(this, "updater", void 0), this.updater = new Ar(this);
	}
}, Qr = (0, f.default)(Pr), $r = (0, f.default)(Pr), ei = Br("http://www.iana.org/assignments/link-relations/acl");
function $(e) {
	let t = $r;
	async function n(t) {
	...
	function a(e, n, r, i = {}) {
		let a = i.public || [], o = Lr(), s = Ie("http://www.w3.org/ns/auth/acl#"), c = o.sym(`${r}#a1`), l = o.sym(r), u = o.sym(e);
...
function ii() {
	...
	if (e !== void 0 && e.username) return ti("Assuming the user is " + e.username), Br(e.username);
	if (typeof document < "u" && document.location && ("" + document.location).slice(0, 16) === "http://localhost") {
		...
		return t ? (ti("Assuming user is " + t), Br(t)) : null;
	}
	return null;
}
//#endregion
...
function hi(e) {
	return Br(e.uri.replace("/profile/", "/").replace("/public/", "/").split("/").slice(0, -1).join("/") + "/settings/prefs.ttl");
}
function gi(e, t) {
...
function yi(e, t, n, r) {
	...
	function h(e) {
		...
		return Br(t + "publicTypeIndex.ttl");
	}
	function g(e) {
		let t = m(e);
		if (!t) throw Error(`suggestPrivateTypeIndex: Cannot derive directory for ${e.uri}`);
		return Br(t + "privateTypeIndex.ttl");
	}
	async function _(t, n, r) {
		let a = fi(n), o = [
			zr(a, i.rdf("type"), i.solid("TypeRegistration"), n),
			zr(a, i.solid("forClass"), r, n),
			zr(a, i.solid("instance"), t, n)
		];
		try {
...
var il = class {
	...
	currentUser() {
		let e = ri();
		if (e.viewingNoAuthPage) return Br(e.webId);
		...
		return this && this.session && i && s ? Br(i) : ii();
	}
	async checkUser(e) {
...
function ol(e, t) {
	...
	async function i(t, r) {
		...
		let a = fi(i), o = [
			zr(a, n.rdf("type"), n.solid("TypeRegistration"), i.doc()),
			zr(a, n.solid("forClass"), n.meeting("LongChat"), i.doc()),
			zr(a, n.solid("instance"), t, i.doc())
		];
...
function ml(e, t, n, r) {
	...
	async function m(t, r = {}) {
		...
		if (a(t)) {
			...
			await Promise.all(e.map((e) => m(Br(e), r)));
		}
		let o;
		try {
...
function hl(e) {
	function t(t) {
		return e.statementsMatching(t, Br("http://www.w3.org/ns/ldp#contains"), void 0).map((e) => e.object);
	}
	function n(t) {
	...
	async function i(t) {
		if (!n(Br(t))) throw Error(`Not a container URL ${t}`);
		let r = await e.fetcher._fetch(t, {
			method: "PUT",
			headers: {
...
function yl(e, t, n) {
	...
	async function h(t, i) {
		...
		let h = [];
		e.holds(a, r.rdf("type"), r.space("ConfigurationFile"), a) || h.push(zr(a, r.rdf("type"), r.space("ConfigurationFile"), a)), e.holds(a, r.dct("title"), void 0, a) || h.push(zr(a, r.dct("title"), Ur("Preferences file"), a)), e.holds(t, r.solid("publicTypeIndex"), u, a) || h.push(zr(t, r.solid("publicTypeIndex"), u, a)), e.holds(t, r.solid("privateTypeIndex"), d, a) || h.push(zr(t, r.solid("privateTypeIndex"), d, a)), h.length > 0 && (await e.updater.update([], h), await e.fetcher.load(a)), await p(t, u, f), await m(d);
	}
	async function g(e) {
		try {
...
function bl(e, t, n) {
	...
	async function a(t, n, i, a) {
		...
		try {
			await e.updater.update([], [zr(t, n, i, a)]);
		} catch (e) {
	...
	async function o(t, n, r, a, o) {
		...
		try {
			await e.updater.update([], [zr(t, n, r, a)]);
		} catch (e) {
	...
	async function s(n) {
		...
		let i = await t.findAclDocUrl(Br(n.target));
...
function xl(e, t) {
	...
	let n = Lr();
	Ir(n, { fetch: e.fetch }), n.updater = new Ar(n), n.features = [];
...
//#endregion
export { gt as A, o as B, Jr as C, cr as D, Er as E, _e as F, d as H, he as I, H as L, Ie as M, ke as N, wt as O, Ce as P, N as R, zr as S, Ar as T, u as U, c as V, qr as _, yi as a, Ur as b, ui as c, oi as d, ii as f, Ir as g, Pr as h, El as i, Xe as j, St as k, ci as l, Qr as m, Ol as n, li as o, ei as p, Dl as r, si as s, kl as t, di as u, Lr as v, Q as w, Br as x, Rr as y, s as z };

//# sourceMappingURL=index.esm-Bu7WXI60.js.map