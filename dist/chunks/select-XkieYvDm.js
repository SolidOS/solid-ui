...
g = [t("solid-ui-select")];
var I;
new (S = (f = /*#__PURE__*/ new WeakMap(), p = /*#__PURE__*/ new WeakMap(), C = (_ = e({ type: Array }), v = s("select"), b = n(), "options"), d = class extends r {
	constructor(...e) {
	...
	render() {
		let e = this.options.some((e) => c(e.value)) ? o : a`<option disabled value="" ?selected=${!this.value}>Select an option</option>`;
		return a`
...
], g, 0, void 0, r), d), u = class extends F {
	constructor() {
...
//# sourceMappingURL=select-XkieYvDm.js.map