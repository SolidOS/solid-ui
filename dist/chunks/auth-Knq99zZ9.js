...
import { i as a, l as o, m as s, o as c, p as l, r as u } from "./components-BD458q30.js";
import { c as d, i as f, n as p } from "./lit-C4H1jI4q.js";
import { t as m } from "./query-BYu9q8lA.js";
import { t as h } from "./dialogs-DEuwXC46.js";
...
import "./combobox-B5j4LoHY.js";
import "./combobox-option-C5lKAumO.js";
...
}, v = new _(), y = s(Symbol("auth")), b = d`.error-message{color:var(--solid-ui-color-error);font-size:var(--solid-ui-font-size-sm);text-align:center;width:100%;font-weight:500}solid-ui-combobox{width:100%}solid-ui-button{flex:1}`, x, S, C, w, T, E, D, O, k, A, j, M, N, P, F, I, L, R, z, B, V, H, U, W, G;
function K(e, t, n) {
	ee(e, t), t.set(e, n);
}
function ee(e, t) {
...
j = [o("solid-ui-login-modal")];
var $;
new (W = (C = /*#__PURE__*/ new WeakMap(), w = /*#__PURE__*/ new WeakMap(), T = /*#__PURE__*/ new WeakMap(), E = /*#__PURE__*/ new WeakMap(), D = /*#__PURE__*/ new WeakMap(), O = /*#__PURE__*/ new WeakMap(), G = (M = a({
	type: String,
	reflect: !0
}), P = u(), I = u(), R = u(), B = l({
	context: y,
	subscribe: !0
}), H = m("solid-ui-dialog"), "issuerUrl"), S = class extends c {
	constructor(...e) {
        ...
        <solid-ui-dialog title="Select an identity provider">
            <form @submit=${this.onSubmit}>
                <solid-ui-dialog-content>
                    ...
                    ${this.failed ? f`<p class="error-message">Something went wrong</p>` : p}
                </solid-ui-dialog-content>
...
], j, 0, void 0, c), S), x = class extends ie {
	constructor() {
...
//# sourceMappingURL=auth-Knq99zZ9.js.map