import { d as e, h as t, i as n, l as r, o as i } from "./components-BD458q30.js";
...
var a = class {
	...
	constructor(e, n, r) {
		super(n.context === void 0 ? r : n.initialValue), this.onContextRequest = (e) => {
			...
			for (let [e, { consumerHost: r }] of this.subscriptions) n.has(e) || (n.add(e), r.dispatchEvent(new t(this.context, r, e, !0)));
			e.stopPropagation();
		}, this.host = e, n.context === void 0 ? this.context = n : this.context = n.context, this.attachListeners(), this.host.addController?.(this);
	}
	attachListeners() {
...
f = [r("solid-ui-dialog-provider")];
var O, k = /*#__PURE__*/ new WeakMap(), A = /*#__PURE__*/ new WeakMap();
_ = (p = n({
	type: String,
	reflect: !0
}), h = c({ context: e }), "dialogId"), l = class extends i {
	constructor(...e) {
...
//# sourceMappingURL=DialogProvider-B7wEBrVN.js.map