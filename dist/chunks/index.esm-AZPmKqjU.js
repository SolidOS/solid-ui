...
function I(e) {
	return ce(e) && e.termType === "Collection";
}
function L(e) {
...
function oe(e) {
	return ce(e) && (e.termType === "NamedNode" || e.termType === "BlankNode" || e.termType === "Variable");
}
function se(e) {
	return ce(e) && e.termType === "Variable";
}
function ce(e) {
...
function le(e) {
	return ce(e) && e.termType === "NamedNode";
}
function ue(e) {
	return ce(e) && "termType" in e && e.termType === "BlankNode";
}
function de(e) {
	return ce(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode");
}
function V(e) {
	return ce(e) && (e.termType === "NamedNode" || e.termType === "Variable");
}
function fe(e) {
	return ce(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode" || e.termType === "Literal");
}
function pe(e) {
	return ce(e) && (e.termType === "NamedNode" || e.termType === "Variable" || e.termType === "BlankNode" || e.termType === "DefaultGraph");
}
//#endregion
...
var H = class e extends v {
	...
	static fromValue(t) {
		return t == null || ce(t) ? t : new e(t);
	}
}, me = {
	boolean: new H("http://www.w3.org/2001/XMLSchema#boolean"),
	dateTime: new H("http://www.w3.org/2001/XMLSchema#dateTime"),
	decimal: new H("http://www.w3.org/2001/XMLSchema#decimal"),
	double: new H("http://www.w3.org/2001/XMLSchema#double"),
	integer: new H("http://www.w3.org/2001/XMLSchema#integer"),
	langString: new H("http://www.w3.org/1999/02/22-rdf-syntax-ns#langString"),
	string: new H("http://www.w3.org/2001/XMLSchema#string")
}, he = class e extends v {
	constructor(e, t, n) {
		super(e), g(this, "termType", x), g(this, "classOrder", _.Literal), g(this, "datatype", me.string), g(this, "isVar", 0), g(this, "language", ""), t ? (this.language = t, this.datatype = me.langString) : this.datatype = n ? H.fromValue(n) : me.string;
	}
	copy() {
	...
	static toNT(e) {
		...
		var t = e.value;
		return t = t.replace(/\\/g, "\\\\"), t = t.replace(/\"/g, "\\\""), t = t.replace(/\n/g, "\\n"), t = t.replace(/\r/g, "\\r"), t = "\"" + t + "\"", e.language ? t += "@" + e.language : e.datatype.equals(me.string) || (t += "^^" + e.datatype.toCanonical()), t;
	}
	toString() {
		return "" + this.value;
	}
	static fromBoolean(t) {
		return new e(t ? "1" : "0", null, me.boolean);
	}
	static fromDate(t) {
		...
		return new e(r, null, me.dateTime);
	}
	static fromNumber(t) {
		if (typeof t != "number") throw TypeError("Invalid argument to Literal.fromNumber()");
		let n, r = t.toString();
		return n = r.indexOf("e") < 0 && Math.abs(t) <= 2 ** 53 - 1 ? Number.isInteger(t) ? me.integer : me.decimal : me.double, new e(r, null, n);
	}
	static fromValue(t) {
		if (z(t)) return t;
		switch (typeof t) {
...
function ge(e) {
	return e == null || ce(e) ? e : Array.isArray(e) ? new _e(e) : he.fromValue(e);
}
var _e = class e extends v {
	constructor(e) {
...
}, ye = "chrome:theSession";
new H(ye);
//#endregion
//#region node_modules/rdflib/esm/default-graph.js
var be = class extends v {
	constructor() {
		super(""), g(this, "value", ""), g(this, "termType", C), g(this, "uri", ye);
	}
	toCanonical() {
		return this.value;
	}
...
var Se = new be(), Ce = class e {
	constructor(e, t, n, r) {
		g(this, "subject", void 0), g(this, "predicate", void 0), g(this, "object", void 0), g(this, "graph", void 0), this.subject = v.fromValue(e), this.predicate = v.fromValue(t), this.object = v.fromValue(n), this.graph = r == null ? Se : v.fromValue(r);
	}
	get why() {
		return this.graph;
	}
	...
	substitute(t) {
		return new e(this.subject.substitute(t), this.predicate.substitute(t), this.object.substitute(t), xe(this.graph) ? this.graph : this.graph.substitute(t));
	}
	toCanonical() {
		let e = [
...
function ke(e, t) {
	...
	if (n < 0) return Te("Invalid base: " + t + " in join with given: " + e), e;
...
var Me = class e extends v {
	constructor(e = "") {
		super(e), g(this, "termType", S), g(this, "base", "varid:"), g(this, "classOrder", _.Variable), g(this, "isVar", 1), g(this, "uri", void 0), this.base = "varid:", this.uri = ke(e, this.base);
	}
	equals(e) {
		return e ? this.termType === e.termType && this.value === e.value : !1;
	}
	...
	defaultGraph: () => Pe,
	equals(e, t) {
		return e === t || !e || !t ? !0 : B(e) || B(t) ? B(e) && B(t) ? this.equals(e.subject, t.subject) && this.equals(e.predicate, t.predicate) && this.equals(e.object, t.object) && this.equals(e.graph, t.graph) : !1 : ce(e) && ce(t) ? this.id(e) === this.id(t) : !1;
	},
	id(e) {
		if (!e) return "undefined";
		if (B(e)) return this.quadToNQ(e);
		switch (e.termType) {
			case C: return "defaultGraph";
			case w: return _e.toNT(e);
			case S: return Me.toString(e);
			default:
	...
	literal(e, t) {
		if (typeof e != "string" && !t) return he.fromValue(e);
		let n = typeof e == "string" ? e : "" + e;
		return typeof t == "string" ? t.indexOf(":") === -1 ? new he(n, t) : new he(n, null, this.namedNode(t)) : new he(n, null, t);
	},
	namedNode(e) {
		return new H(e);
	},
	quad(e, t, n, r) {
		return new Ce(e, t, n, r || Pe);
	},
	triple(e, t, n, r) {
...
var Le = /* @__PURE__ */ s(((e, t) => {
	(function(e, n) {
		...
		function n(e, n) {
			...
			var r = {}, i = { turtleDoc: tr }, a = tr, o = function(e) {
				...
				return $.addBase(e), {};
			}, T = /^[Bb]/, E = Y(["B", "b"], !1, !1), D = /^[Aa]/, O = Y(["A", "a"], !1, !1), ee = /^[Ss]/, te = Y(["S", "s"], !1, !1), k = /^[Ee]/, A = Y(["E", "e"], !1, !1), ne = /^[Pp]/, re = Y(["P", "p"], !1, !1), j = /^[Rr]/, ie = Y(["R", "r"], !1, !1), M = /^[Ff]/, N = Y(["F", "f"], !1, !1), P = /^[Ii]/, ae = Y(["I", "i"], !1, !1), F = /^[Xx]/, I = Y(["X", "x"], !1, !1), L = function(e, t) {
				var n = {};
			...
			}, le = ",", ue = J(",", !1), de = function(e, t) {
				return t;
			}, V = function(e, t) {
				return t.unshift(e), t;
			}, fe = "a", pe = J("a", !1), H = function() {
				return "@type";
			}, me = function(e) {
				return ti(e, !0);
			}, he = function(e) {
				...
				return { "@id": e };
			}, ve = "[", ye = J("[", !1), be = "]", xe = J("]", !1), Se = "(", Ce = J("(", !1), we = ")", Te = J(")", !1), Ee = function(e) {
				return { "@list": e };
			}, De = function(e, t) {
				return {
					"@value": e,
			...
			}, je = "true", Me = J("true", !1), Ne = function() {
				return !0;
			}, Pe = "false", Fe = J("false", !1), U = function() {
				return !1;
			}, Ie = function(e) {
				return e + ":";
			}, Le = "<", Re = J("<", !1), ze = /^[^\0- <>"{}|\^`\\]/, Be = Y([
				...
				return e ||= "0", $.hasPrefix(e) === !1 && Yn("undefined prefix " + e), e;
			}, qe = function(e) {
				return e || "";
			}, Je = function(e, t) {
				...
				return "\f";
			}, ln = "\\\"", un = J("\\\"", !1), dn = function() {
				return "\"";
			}, fn = "\\'", pn = J("\\'", !1), mn = function() {
				return "'";
			}, hn = "\\\\", gn = J("\\\\", !1), _n = function() {
				return "\\";
			}, W = /^[ \t\r\n]/, vn = Y([
				" ",
				"	",
			...
			function or() {
				...
				if (n !== r) {
					if (e.substr(G, 7) === y ? (i = y, G += 7) : (i = r, q === 0 && X(b)), i !== r) {
			...
			function sr() {
				...
				if (n !== r) {
					if (e.substr(G, 5) === S ? (i = S, G += 5) : (i = r, q === 0 && X(C)), i !== r) {
						for (a = [], o = Z(); o !== r;) a.push(o), o = Z();
						if (a !== r) {
							if (o = Dr(), o !== r) {
								for (s = [], c = Z(); c !== r;) s.push(c), c = Z();
			...
			function cr() {
				...
				if (n !== r) {
					if (T.test(e.charAt(G)) ? (i = e.charAt(G), G++) : (i = r, q === 0 && X(E)), i !== r) {
						if (D.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(O)), a !== r) {
							if (ee.test(e.charAt(G)) ? (o = e.charAt(G), G++) : (o = r, q === 0 && X(te)), o !== r) {
								if (k.test(e.charAt(G)) ? (s = e.charAt(G), G++) : (s = r, q === 0 && X(A)), s !== r) {
			...
			function lr() {
				...
				if (n !== r) {
					if (ne.test(e.charAt(G)) ? (i = e.charAt(G), G++) : (i = r, q === 0 && X(re)), i !== r) {
						if (j.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(ie)), a !== r) {
							if (k.test(e.charAt(G)) ? (o = e.charAt(G), G++) : (o = r, q === 0 && X(A)), o !== r) {
								if (M.test(e.charAt(G)) ? (s = e.charAt(G), G++) : (s = r, q === 0 && X(N)), s !== r) {
									if (P.test(e.charAt(G)) ? (c = e.charAt(G), G++) : (c = r, q === 0 && X(ae)), c !== r) {
										if (F.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(I)), l !== r) {
			...
			function dr() {
				...
				if (n !== r) {
					if (i = fr(), i !== r) {
						...
						for (s === r ? (G = o, o = r) : (e.charCodeAt(G) === 59 ? (c = oe, G++) : (c = r, q === 0 && X(se)), c === r ? (G = o, o = r) : (l = G, u = pr(), u === r ? (G = l, l = r) : (d = fr(), d === r ? (G = l, l = r) : (K = l, u = ce(n, i, u, d), l = u)), l === r && (l = null), l === r ? (G = o, o = r) : (K = o, s = z(n, i, l), o = s))); o !== r;) {
							for (a.push(o), o = G, s = [], c = Z(); c !== r;) s.push(c), c = Z();
							s === r ? (G = o, o = r) : (e.charCodeAt(G) === 59 ? (c = oe, G++) : (c = r, q === 0 && X(se)), c === r ? (G = o, o = r) : (l = G, u = pr(), u === r ? (G = l, l = r) : (d = fr(), d === r ? (G = l, l = r) : (K = l, u = ce(n, i, u, d), l = u)), l === r && (l = null), l === r ? (G = o, o = r) : (K = o, s = z(n, i, l), o = s)));
						}
						a === r ? (G = t, t = r) : (K = t, n = B(n, i, a), t = n);
					} else G = t, t = r;
				} else G = t, t = r;
				return t;
			}
			function fr() {
				...
				if (n !== r) {
					...
					for (o === r ? (G = a, a = r) : (e.charCodeAt(G) === 44 ? (s = le, G++) : (s = r, q === 0 && X(ue)), s === r ? (G = a, a = r) : (c = gr(), c === r ? (G = a, a = r) : (K = a, o = de(n, c), a = o))); a !== r;) {
						for (i.push(a), a = G, o = [], s = Z(); s !== r;) o.push(s), s = Z();
						o === r ? (G = a, a = r) : (e.charCodeAt(G) === 44 ? (s = le, G++) : (s = r, q === 0 && X(ue)), s === r ? (G = a, a = r) : (c = gr(), c === r ? (G = a, a = r) : (K = a, o = de(n, c), a = o)));
					}
					i === r ? (G = t, t = r) : (K = t, n = V(n, i), t = n);
				} else G = t, t = r;
				return t;
			}
			function pr() {
				...
				if (n !== r && (K = t, n = d(n)), t = n, t === r) {
					...
					n === r ? (G = t, t = r) : (e.charCodeAt(G) === 97 ? (i = fe, G++) : (i = r, q === 0 && X(pe)), i === r ? (G = t, t = r) : (K = t, n = H(), t = n));
				}
				return t;
			}
			function mr() {
				var e = G, t = yr();
				return t !== r && (K = e, t = me(t)), e = t, e === r && (e = Er(), e === r && (e = wr())), e;
			}
			function hr() {
			...
			function gr() {
				var e = _r(), t;
				return e === r && (e = G, t = yr(), t !== r && (K = e, t = he(t)), e = t, e === r && (e = G, t = Er(), t !== r && (K = e, t = ge(t)), e = t, e === r && (e = G, t = vr(), t !== r && (K = e, t = d(t)), e = t, e === r && (e = G, t = wr(), t !== r && (K = e, t = _e(t)), e = t)))), e;
			}
			function _r() {
				var e = xr();
			...
			function vr() {
				...
				if (n !== r) {
					if (e.charCodeAt(G) === 91 ? (i = ve, G++) : (i = r, q === 0 && X(ye)), i !== r) {
						if (a = dr(), a !== r) {
							for (o = [], s = Z(); s !== r;) o.push(s), s = Z();
							o === r ? (G = t, t = r) : (e.charCodeAt(G) === 93 ? (s = be, G++) : (s = r, q === 0 && X(xe)), s === r ? (G = t, t = r) : (K = t, n = d(a), t = n));
						} else G = t, t = r;
					} else G = t, t = r;
				} else G = t, t = r;
				return t;
			...
			function yr() {
				for (var t = G, n = [], i = Z(), a, o, s; i !== r;) n.push(i), i = Z();
				if (n !== r) {
					if (e.charCodeAt(G) === 40 ? (i = Se, G++) : (i = r, q === 0 && X(Ce)), i !== r) {
						for (a = [], o = gr(); o !== r;) a.push(o), o = gr();
						if (a !== r) {
							for (o = [], s = Z(); s !== r;) o.push(s), s = Z();
							o === r ? (G = t, t = r) : (e.charCodeAt(G) === 41 ? (s = we, G++) : (s = r, q === 0 && X(Te)), s === r ? (G = t, t = r) : (K = t, n = Ee(a), t = n));
						} else G = t, t = r;
					} else G = t, t = r;
				} else G = t, t = r;
				return t;
			...
			function xr() {
				...
				if (n !== r) {
					if (i = Cr(), i !== r) {
						for (a = [], o = Z(); o !== r;) a.push(o), o = Z();
						a === r ? (G = t, t = r) : (o = Mr(), o === r ? (G = t, t = r) : (K = t, n = De(i, o), t = n));
					} else G = t, t = r;
				} else G = t, t = r;
				if (t === r) {
					for (t = G, n = [], i = Z(); i !== r;) n.push(i), i = Z();
					if (n !== r) {
						if (i = Cr(), i !== r) {
							for (a = [], o = Z(); o !== r;) a.push(o), o = Z();
							if (a !== r) {
								if (e.substr(G, 2) === Oe ? (o = Oe, G += 2) : (o = r, q === 0 && X(ke)), o !== r) {
									for (s = [], c = Z(); c !== r;) s.push(c), c = Z();
									s === r ? (G = t, t = r) : (c = wr(), c === r ? (G = t, t = r) : (K = t, n = Ae(i, c), t = n));
								} else G = t, t = r;
							} else G = t, t = r;
						} else G = t, t = r;
					} else G = t, t = r;
			...
			function Sr() {
				...
				if (n === r ? (G = t, t = r) : (e.substr(G, 4) === je ? (i = je, G += 4) : (i = r, q === 0 && X(Me)), i === r ? (G = t, t = r) : (K = t, n = Ne(), t = n)), t === r) {
					for (t = G, n = [], i = Z(); i !== r;) n.push(i), i = Z();
					n === r ? (G = t, t = r) : (e.substr(G, 5) === Pe ? (i = Pe, G += 5) : (i = r, q === 0 && X(Fe)), i === r ? (G = t, t = r) : (K = t, n = U(), t = n));
				}
				return t;
			}
			function Cr() {
			...
			function Er() {
				...
				if (t === r ? (G = e, e = r) : (n = jr(), n === r ? (G = e, e = r) : (K = e, t = d(n), e = t)), e === r) {
					for (e = G, t = [], n = Z(); n !== r;) t.push(n), n = Z();
					t === r ? (G = e, e = r) : (n = Ur(), n === r ? (G = e, e = r) : (K = e, t = d(n), e = t));
				}
				return e;
			}
			function Dr() {
				...
				if (e.charCodeAt(G) === 60 ? (n = Le, G++) : (n = r, q === 0 && X(Re)), n !== r) {
					for (i = [], ze.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Be)), a === r && (a = Q()); a !== r;) i.push(a), ze.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Be)), a === r && (a = Q());
			...
			function Ar() {
				var e = G, t = Or(), n;
				return t === r ? (G = e, e = r) : (n = Jr(), n === r ? (G = e, e = r) : (K = e, t = Je(t, n), e = t)), e;
			}
			function jr() {
				var t = G, n = G, i, a, o, s, c, d, f, p;
				if (e.substr(G, 2) === Ye ? (i = Ye, G += 2) : (i = r, q === 0 && X(Xe)), i !== r) {
					if (a = Gr(), a === r && (Ze.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Qe))), a !== r) {
			...
			function Pr() {
				...
				if (lt.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(ut)), a === r && (a = null), a !== r) {
					...
					if (o !== r) {
						if (e.charCodeAt(G) === 46 ? (s = l, G++) : (s = r, q === 0 && X(u)), s !== r) {
			...
			function Fr() {
				...
				if (lt.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(ut)), a === r && (a = null), a !== r) {
					...
					if (s !== r) {
						if (e.charCodeAt(G) === 46 ? (c = l, G++) : (c = r, q === 0 && X(u)), c !== r) {
			...
			function Ir() {
				var t = G, n = G, i, a, o, s;
				if (mt.test(e.charAt(G)) ? (i = e.charAt(G), G++) : (i = r, q === 0 && X(ht)), i !== r) {
					if (lt.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(ut)), a === r && (a = null), a !== r) {
						if (o = [], Ze.test(e.charAt(G)) ? (s = e.charAt(G), G++) : (s = r, q === 0 && X(Qe)), s !== r) for (; s !== r;) o.push(s), Ze.test(e.charAt(G)) ? (s = e.charAt(G), G++) : (s = r, q === 0 && X(Qe));
						else o = r;
						o === r ? (G = n, n = r) : (i = [
			...
			function Lr() {
				...
				if (e.charCodeAt(G) === 34 ? (n = gt, G++) : (n = r, q === 0 && X(_t)), n !== r) {
					for (i = [], vt.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(yt)), a === r && (a = Vr(), a === r && (a = Q())); a !== r;) i.push(a), vt.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(yt)), a === r && (a = Vr(), a === r && (a = Q()));
			...
			function Rr() {
				...
				if (e.charCodeAt(G) === 39 ? (n = bt, G++) : (n = r, q === 0 && X(xt)), n !== r) {
					for (i = [], St.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Ct)), a === r && (a = Vr(), a === r && (a = Q())); a !== r;) i.push(a), St.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Ct)), a === r && (a = Vr(), a === r && (a = Q()));
			...
			function zr() {
				...
				if (e.substr(G, 3) === wt ? (n = wt, G += 3) : (n = r, q === 0 && X(Tt)), n !== r) {
					for (i = [], Et.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Dt)), a === r && (a = Vr(), a === r && (a = Q())); a !== r;) i.push(a), Et.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(Dt)), a === r && (a = Vr(), a === r && (a = Q()));
					if (i !== r) {
						if (a = [], o = G, e.substr(G, 2) === Ot ? (s = Ot, G += 2) : (s = r, q === 0 && X(kt)), s !== r) {
							if (c = [], Et.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(Dt)), l === r && (l = Vr(), l === r && (l = Q())), l !== r) for (; l !== r;) c.push(l), Et.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(Dt)), l === r && (l = Vr(), l === r && (l = Q()));
							else c = r;
							c === r ? (G = o, o = r) : (K = o, s = At(i, c), o = s);
						} else G = o, o = r;
						if (o === r) {
							if (o = G, e.charCodeAt(G) === 39 ? (s = bt, G++) : (s = r, q === 0 && X(xt)), s !== r) {
								if (c = [], Et.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(Dt)), l === r && (l = Vr(), l === r && (l = Q())), l !== r) for (; l !== r;) c.push(l), Et.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(Dt)), l === r && (l = Vr(), l === r && (l = Q()));
								else c = r;
			...
			function Br() {
				...
				if (e.substr(G, 3) === Nt ? (n = Nt, G += 3) : (n = r, q === 0 && X(Pt)), n !== r) {
					for (i = [], Ft.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(It)), a === r && (a = Vr(), a === r && (a = Q())); a !== r;) i.push(a), Ft.test(e.charAt(G)) ? (a = e.charAt(G), G++) : (a = r, q === 0 && X(It)), a === r && (a = Vr(), a === r && (a = Q()));
					if (i !== r) {
						if (a = [], o = G, e.substr(G, 2) === Lt ? (s = Lt, G += 2) : (s = r, q === 0 && X(Rt)), s !== r) {
							if (c = [], Ft.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(It)), l === r && (l = Vr(), l === r && (l = Q())), l !== r) for (; l !== r;) c.push(l), Ft.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(It)), l === r && (l = Vr(), l === r && (l = Q()));
							else c = r;
							c === r ? (G = o, o = r) : (K = o, s = zt(i, c), o = s);
						} else G = o, o = r;
						if (o === r) {
							if (o = G, e.charCodeAt(G) === 34 ? (s = gt, G++) : (s = r, q === 0 && X(_t)), s !== r) {
								if (c = [], Ft.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(It)), l === r && (l = Vr(), l === r && (l = Q())), l !== r) for (; l !== r;) c.push(l), Ft.test(e.charAt(G)) ? (l = e.charAt(G), G++) : (l = r, q === 0 && X(It)), l === r && (l = Vr(), l === r && (l = Q()));
								else c = r;
			...
			function Q() {
				...
				return e.substr(G, 2) === Vt ? (n = Vt, G += 2) : (n = r, q === 0 && X(Ht)), n === r ? (G = t, t = r) : (i = G, a = Zr(), a === r ? (G = i, i = r) : (o = Zr(), o === r ? (G = i, i = r) : (s = Zr(), s === r ? (G = i, i = r) : (c = Zr(), c === r ? (G = i, i = r) : (l = Zr(), l === r ? (G = i, i = r) : (u = Zr(), u === r ? (G = i, i = r) : (d = Zr(), d === r ? (G = i, i = r) : (f = Zr(), f === r ? (G = i, i = r) : (a = [
					a,
					o,
					s,
					c,
					...
					d,
					f
				], i = a)))))))), i === r ? (G = t, t = r) : (K = t, n = Ut(i), t = n)), t === r && (t = G, e.substr(G, 2) === Wt ? (n = Wt, G += 2) : (n = r, q === 0 && X(Gt)), n === r ? (G = t, t = r) : (i = G, a = Zr(), a === r ? (G = i, i = r) : (o = Zr(), o === r ? (G = i, i = r) : (s = Zr(), s === r ? (G = i, i = r) : (c = Zr(), c === r ? (G = i, i = r) : (a = [
					a,
					o,
					s,
					c
			...
			function Vr() {
				var t = G, n;
				return e.substr(G, 2) === qt ? (n = qt, G += 2) : (n = r, q === 0 && X(Jt)), n !== r && (K = t, n = Yt()), t = n, t === r && (t = G, e.substr(G, 2) === Xt ? (n = Xt, G += 2) : (n = r, q === 0 && X(Zt)), n !== r && (K = t, n = Qt()), t = n, t === r && (t = G, e.substr(G, 2) === $t ? (n = $t, G += 2) : (n = r, q === 0 && X(en)), n !== r && (K = t, n = tn()), t = n, t === r && (t = G, e.substr(G, 2) === nn ? (n = nn, G += 2) : (n = r, q === 0 && X(rn)), n !== r && (K = t, n = an()), t = n, t === r && (t = G, e.substr(G, 2) === on ? (n = on, G += 2) : (n = r, q === 0 && X(sn)), n !== r && (K = t, n = cn()), t = n, t === r && (t = G, e.substr(G, 2) === ln ? (n = ln, G += 2) : (n = r, q === 0 && X(un)), n !== r && (K = t, n = dn()), t = n, t === r && (t = G, e.substr(G, 2) === fn ? (n = fn, G += 2) : (n = r, q === 0 && X(pn)), n !== r && (K = t, n = mn()), t = n, t === r && (t = G, e.substr(G, 2) === hn ? (n = hn, G += 2) : (n = r, q === 0 && X(gn)), n !== r && (K = t, n = _n()), t = n))))))), t;
			}
			function Hr() {
				var t;
				return W.test(e.charAt(G)) ? (t = e.charAt(G), G++) : (t = r, q === 0 && X(vn)), t;
			}
			function Ur() {
				var t = G, n, i, a;
				if (e.charCodeAt(G) === 91 ? (n = ve, G++) : (n = r, q === 0 && X(ye)), n !== r) {
					for (i = [], a = Z(); a !== r;) i.push(a), a = Z();
					i === r ? (G = t, t = r) : (e.charCodeAt(G) === 93 ? (a = be, G++) : (a = r, q === 0 && X(xe)), a === r ? (G = t, t = r) : (K = t, n = yn(), t = n));
				} else G = t, t = r;
				return t;
			}
			function Wr() {
			...
			function Jr() {
				var t = G, n = Gr(), i, a, o, s, c, d;
				if (n === r && (e.charCodeAt(G) === 58 ? (n = We, G++) : (n = r, q === 0 && X(Ge)), n === r && (Ze.test(e.charAt(G)) ? (n = e.charAt(G), G++) : (n = r, q === 0 && X(Qe)), n === r && (n = Yr()))), n !== r) {
					for (i = [], a = Kr(), a === r && (e.charCodeAt(G) === 58 ? (a = We, G++) : (a = r, q === 0 && X(Ge)), a === r && (a = Yr())); a !== r;) i.push(a), a = Kr(), a === r && (e.charCodeAt(G) === 58 ? (a = We, G++) : (a = r, q === 0 && X(Ge)), a === r && (a = Yr()));
					if (i !== r) {
						if (a = [], o = G, s = [], e.charCodeAt(G) === 46 ? (c = l, G++) : (c = r, q === 0 && X(u)), c !== r) for (; c !== r;) s.push(c), e.charCodeAt(G) === 46 ? (c = l, G++) : (c = r, q === 0 && X(u));
						else s = r;
						if (s !== r) {
							if (c = [], d = Kr(), d === r && (e.charCodeAt(G) === 58 ? (d = We, G++) : (d = r, q === 0 && X(Ge)), d === r && (d = Yr())), d !== r) for (; d !== r;) c.push(d), d = Kr(), d === r && (e.charCodeAt(G) === 58 ? (d = We, G++) : (d = r, q === 0 && X(Ge)), d === r && (d = Yr()));
							else c = r;
			...
			function Xr() {
				var t = G, n = G, i, a, o;
				return e.charCodeAt(G) === 37 ? (i = Ln, G++) : (i = r, q === 0 && X(Rn)), i === r ? (G = n, n = r) : (a = Zr(), a === r ? (G = n, n = r) : (o = Zr(), o === r ? (G = n, n = r) : (i = [
					i,
					a,
					o
	...
	var h = a("[", r(m), r(/[-.0-9\xB7]/), r(/[\u0300-\u036F\u203F-\u2040]/), "]"), g = a(m, h, "*"), _ = a("^", g, "$"), v = a(h, "+"), y = o(a("&", g, ";"), "|", o(/&#[0-9]+;|&#x[0-9a-fA-F]+;/)), b = a("%", g, ";"), x = o(a("\"", o(/[^%&"]/, "|", b, "|", y), "*", "\""), "|", a("'", o(/[^%&']/, "|", b, "|", y), "*", "'")), S = o("\"", o(/[^<&"]/, "|", y), "*", "\"", "|", "'", o(/[^<&']/, "|", y), "*", "'"), C = a(i(m, ":"), i(h, ":"), "*"), w = a("^", C, "$"), T = a(C, o(":", C), "?"), E = a("^", T, "$"), D = a("(", T, ")"), O = o(/"[^"]*"|'[^']*'/), ee = a(/^<\?/, "(", g, ")", o(f, "(?!", u, ")(", c, "*?)"), "?", /\?>/), te = /[\x20\x0D\x0Aa-zA-Z0-9-'()+,./:=?;!*#@$_%]/, k = o("\"", te, "*\"", "|", "'", i(te, "'"), "*'"), A = "<!--", ne = "-->", re = a(A, o(i(c, "-"), "|", a("-", i(c, "-"))), "*", ne), j = "#PCDATA", ie = o("EMPTY", "|", "ANY", "|", o(a(/\(/, p, j, o(p, /\|/, p, T), "*", p, /\)\*/), "|", a(/\(/, p, j, p, /\)/)), "|", a(/\([^>]+\)/, /[?*+]?/)), M = a("<!ELEMENT", f, o(T, "|", b), f, o(ie, "|", b), p, ">"), N = a("<!ATTLIST", f, g, o(f, g, f, o(/CDATA|ID|IDREF|IDREFS|ENTITY|ENTITIES|NMTOKEN|NMTOKENS/, "|", o(a("NOTATION", f, /\(/, p, g, o(p, /\|/, p, g), "*", p, /\)/), "|", a(/\(/, p, v, o(p, /\|/, p, v), "*", p, /\)/))), f, o(/#REQUIRED|#IMPLIED/, "|", o(o("#FIXED", f), "?", S))), "*", p, ">"), P = "about:legacy-compat", ae = o("\"" + P + "\"", "|", "'" + P + "'"), F = "SYSTEM", I = "PUBLIC", L = o(o(F, f, O), "|", o(I, f, k, f, O)), R = a("^", o(o(F, f, "(?<SystemLiteralOnly>", O, ")"), "|", o(I, f, "(?<PubidLiteral>", k, ")", f, "(?<SystemLiteral>", O, ")"))), oe = a("^", k, "$"), se = a("^", O, "$"), ce = o(x, "|", o(L, o(f, "NDATA", f, g), "?")), z = "<!ENTITY", B = o(a(z, f, g, f, ce, p, ">"), "|", a(z, f, "%", f, g, f, o(x, "|", L), p, ">")), le = a("<!NOTATION", f, g, f, o(L, "|", a(I, f, k)), p, ">"), ue = a(p, "=", p), de = /1[.]\d+/, V = a(f, "version", ue, o("'", de, "'", "|", "\"", de, "\"")), fe = /[A-Za-z][-A-Za-z0-9._]*/, pe = a(/^<\?xml/, V, o(f, "encoding", ue, o("\"", fe, "\"", "|", "'", fe, "'")), "?", o(f, "standalone", ue, o("'", o("yes", "|", "no"), "'", "|", "\"", o("yes", "|", "no"), "\"")), "?", p, /\?>/), H = "<!DOCTYPE", me = "<![CDATA[", he = "]]>", ge = a(/<!\[CDATA\[/, a(c, "*?", /\]\]>/));
	e.chars = r, e.chars_without = i, e.detectUnicodeSupport = t, e.reg = a, e.regg = o, e.ABOUT_LEGACY_COMPAT = P, e.ABOUT_LEGACY_COMPAT_SystemLiteral = ae, e.AttlistDecl = N, e.CDATA_START = me, e.CDATA_END = he, e.CDSect = ge, e.Char = c, e.Comment = re, e.COMMENT_START = A, e.COMMENT_END = ne, e.DOCTYPE_DECL_START = H, e.elementdecl = M, e.EntityDecl = B, e.EntityValue = x, e.ExternalID = L, e.ExternalID_match = R, e.Name = g, e.Name_exact = _, e.NCName_exact = w, e.NotationDecl = le, e.Reference = y, e.PEReference = b, e.PI = ee, e.PUBLIC = I, e.PubidLiteral = k, e.PubidLiteral_match = oe, e.QName = T, e.QName_exact = E, e.QName_group = D, e.S = f, e.SChar_s = d, e.S_OPT = p, e.SYSTEM = F, e.SystemLiteral = O, e.SystemLiteral_match = se, e.InvalidChar = l, e.UNICODE_REPLACEMENT_CHARACTER = s, e.UNICODE_SUPPORT = n, e.XMLDecl = pe;
})), Ve = /* @__PURE__ */ s(((e) => {
	var t = Re(), n = t.find, r = t.hasDefaultHTMLNamespace, i = t.hasOwn, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, s = t.isHTMLVoidElement, c = t.MIME_TYPE, l = t.NAMESPACE, u = Symbol(), d = ze(), f = d.DOMException, p = d.DOMExceptionName, m = Be();
	function h(e) {
	...
	F.prototype = {
		...
		toString: function(e) {
			for (var t = typeof e == "function" ? {
				...
				splitCDATASections: !0,
				nodeFilter: null
			}, n = [], r = 0; r < this.length; r++) Je(this[r], n, null, t);
			return n.join("");
		},
		filter: function(e) {
	...
	function z(e, t) {
		se(e, t.namespaceURI, !0)[t.localName] = t;
	}
	function B(e, t) {
		var n = se(e, t.namespaceURI, !1);
		n && delete n[t.localName];
	}
	function le(e, t, n, r) {
		if (r ? t[oe(t, r)] = n : (t[t.length] = n, t.length++), z(t, n), e) {
			n.ownerElement = e;
			var i = e.ownerDocument;
			i && (r && ge(i, e, r), he(i, e, n));
		}
	}
	function ue(e, t, n) {
		var r = oe(t, n);
		if (r >= 0) {
			...
			if (t.length = i, B(t, n), e) {
				var a = e.ownerDocument;
				a && ge(a, e, n), n.ownerElement = null;
			}
		}
	}
	R.prototype = {
		...
		setNamedItem: function(e) {
			...
			var n = ce(this, e.namespaceURI, e.localName);
			return n === e ? e : (le(this._ownerElement, this, e, n), n);
		},
		...
		removeNamedItem: function(e) {
			...
			return ue(this._ownerElement, this, t), t;
		},
		removeNamedItemNS: function(e, t) {
			var n = this.getNamedItemNS(e, t);
			if (!n) throw new f(f.NOT_FOUND_ERR, e ? e + " : " + t : t);
			return ue(this._ownerElement, this, n), n;
		},
	...
	de.prototype = {
		...
		createHTMLDocument: function(e) {
			var t = new me(u, { contentType: c.HTML });
	...
	V.prototype = {
		...
		replaceChild: function(e, t) {
			ke(this, e, t, Oe), t && this.removeChild(t);
		},
		...
		cloneNode: function(e) {
			return Xe(this.ownerDocument || this, this, e);
		},
		normalize: function() {
			H(this, null, { enter: function(e) {
				for (var t = e.firstChild; t;) {
					...
					if (n !== null && n.nodeType === O && t.nodeType === O) {
						...
						t.nextSibling = i, i === null ? e.lastChild = t : i.previousSibling = t, t.appendData(r.join("")), _e(e.ownerDocument, e), t = i;
					} else t = n;
				}
				return !0;
			} });
		...
		compareDocumentPosition: function(e) {
			...
			if (t instanceof je && (r = t, t = r.ownerElement), n instanceof je && (i = n, n = i.ownerElement, r && t && n === t)) for (var a = 0, o; o = n.attributes[a]; a++) {
	...
	function ve(e, t) {
		...
		return n ? n.nextSibling = r : e.firstChild = r, r ? r.previousSibling = n : e.lastChild = n, _e(e.ownerDocument, e), t.parentNode = null, t.previousSibling = null, t.nextSibling = null, t;
	}
	function ye(e) {
	...
	function Ee(e, t, n) {
		if (!ye(e)) throw new f(f.HIERARCHY_REQUEST_ERR, "Unexpected parent node type " + e.nodeType);
		if (n && n.parentNode !== e) throw new f(f.NOT_FOUND_ERR, "child not in parent");
		if (!be(t) || xe(t) && e.nodeType !== V.DOCUMENT_NODE) throw new f(f.HIERARCHY_REQUEST_ERR, "Unexpected node type " + t.nodeType + " for parent node type " + e.nodeType);
	}
	function De(e, t, r) {
		var i = e.childNodes || [], a = t.childNodes || [];
		if (t.nodeType === V.DOCUMENT_FRAGMENT_NODE) {
			var o = a.filter(Se);
			if (o.length > 1 || n(a, Ce)) throw new f(f.HIERARCHY_REQUEST_ERR, "More than one element or text in fragment");
			if (o.length === 1 && !we(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Element in fragment can not be inserted before doctype");
		}
		if (Se(t) && !we(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one element can be added and only after doctype");
		if (xe(t)) {
			if (n(i, xe)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one doctype is allowed");
			var s = n(i, Se);
	...
	function Oe(e, t, r) {
		...
		if (t.nodeType === V.DOCUMENT_FRAGMENT_NODE) {
			var o = a.filter(Se);
			if (o.length > 1 || n(a, Ce)) throw new f(f.HIERARCHY_REQUEST_ERR, "More than one element or text in fragment");
			if (o.length === 1 && !Te(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Element in fragment can not be inserted before doctype");
		}
		if (Se(t) && !Te(e, r)) throw new f(f.HIERARCHY_REQUEST_ERR, "Only one element can be added and only after doctype");
		if (xe(t)) {
			function e(e) {
				return xe(e) && e !== r;
			}
	...
	function ke(e, t, n, r) {
		Ee(e, t, n), e.nodeType === V.DOCUMENT_NODE && (r || De)(e, t, n);
		var i = t.parentNode;
		...
		return _e(e.ownerDocument || e, e, t), t.nodeType == ie && (t.firstChild = t.lastChild = null), t;
	}
	me.prototype = {
		implementation: null,
		nodeName: "#document",
		...
		insertBefore: function(e, t) {
			...
			return ke(this, e, t), e.ownerDocument = this, this.documentElement === null && e.nodeType === E && (this.documentElement = e), e;
		},
		removeChild: function(e) {
			var t = ve(this, e);
		...
		replaceChild: function(e, t) {
			ke(this, e, t, Oe), e.ownerDocument = this, t && this.removeChild(t), Se(e) && (this.documentElement = e);
		},
		...
		getElementById: function(e) {
			var t = null;
			return pe(this.documentElement, function(n) {
		...
		createElementNS: function(e, t) {
			var n = S(e, t), r = new Ae(u), i = r.attributes = new R();
	...
	Ae.prototype = {
		...
		getElementsByClassName: function(e) {
			...
			return new I(this, function(n) {
				var r = [];
				return t.length > 0 && pe(n, function(i) {
					if (i !== n && i.nodeType === E) {
	...
	}, me.prototype.getElementsByClassName = Ae.prototype.getElementsByClassName, me.prototype.getElementsByTagName = Ae.prototype.getElementsByTagName, me.prototype.getElementsByTagNameNS = Ae.prototype.getElementsByTagNameNS, w(Ae, V);
	function je(e) {
		h(e), this.namespaceURI = null, this.prefix = null, this.ownerElement = null;
	}
	je.prototype.nodeType = D, w(je, V);
	function Me(e) {
		h(e);
	}
	Me.prototype = {
	...
	U.prototype.nodeType = j, w(U, V);
	function Ie(e) {
		h(e);
	}
	Ie.prototype.nodeType = M, w(Ie, V);
	function Le(e) {
		h(e);
	}
	Le.prototype.nodeType = k, w(Le, V);
	function Ve(e) {
		h(e);
	}
	Ve.prototype.nodeType = te, w(Ve, V);
	function He(e) {
		h(e);
	}
	He.prototype.nodeName = "#document-fragment", He.prototype.nodeType = ie, w(He, V);
	function Ue(e) {
		h(e);
	}
	Ue.prototype.nodeType = A, w(Ue, Me);
	function We() {}
	We.prototype.serializeToString = function(e, t) {
		return Ge.call(e, t);
	}, V.prototype.toString = Ge;
	function Ge(e) {
			...
			enter: function(e, n) {
				...
				switch (e.nodeType) {
					case E:
						...
						for (var w = 0; w < g; w++) {
							...
							if (Ke(T, u, C)) {
								...
								qe(t, k ? "xmlns:" + k : "xmlns", M, a), C.push({
									prefix: k,
									namespace: M
								});
							}
							var N = i ? i(T) : T;
							N && (typeof N == "string" ? t.push(N) : qe(t, N.name, N.value, a));
						}
						if (_ === v && Ke(e, u, C)) {
							var P = e.prefix || "", M = e.namespaceURI;
							qe(t, P ? "xmlns:" + P : "xmlns", M, a), C.push({
								prefix: P,
								namespace: M
							});
						}
						...
						if (t.push(">"), u && o(_)) {
							for (var F = e.firstChild; F;) F.data ? t.push(F.data) : Je(F, t, C.slice(), r), F = F.nextSibling;
					...
					case ie:
						...
						return { ns: d };
					case D: return qe(t, e.name, e.value, a), null;
					case O:
						...
						return t.push(e.data.replace(/[<&>]/g, fe)), null;
					case ee:
		...
		return H(t, null, { enter: function(t, a) {
			...
			switch (o.nodeType) {
				case E:
					...
					f._ownerElement = o;
					for (var m = 0; m < p; m++) o.setAttributeNode(Xe(e, d.item(m), !0));
					break;
				case D: l = !0;
			}
	...
	try {
		Object.defineProperty && (Object.defineProperty(I.prototype, "length", { get: function() {
		...
		}), Object.defineProperty(Me.prototype, "nodeValue", {
			get: function() {
				return this.data;
			},
			set: function(e) {
			...
			return new I(this, Qe);
		} }), Object.defineProperty(He.prototype, "children", { get: function() {
			return new I(this, Qe);
		} }), Ze = function(e, t, n) {
			e["$$" + t] = n;
		});
	} catch {}
	e._updateLiveList = L, e.Attr = je, e.CDATASection = Fe, e.CharacterData = Me, e.Comment = Pe, e.Document = me, e.DocumentFragment = He, e.DocumentType = U, e.DOMImplementation = de, e.Element = Ae, e.Entity = Le, e.EntityReference = Ve, e.LiveNodeList = I, e.NamedNodeMap = R, e.Node = V, e.NodeList = F, e.Notation = Ie, e.Text = Ne, e.ProcessingInstruction = Ue, e.walkDOM = H, e.XMLSerializer = We;
})), He = /* @__PURE__ */ s(((e) => {
	var t = Re().freeze;
	e.XML_ENTITIES = t({
		amp: "&",
	...
	var t = Re(), n = Be(), r = ze(), i = t.isHTMLEscapableRawTextElement, a = t.isHTMLMimeType, o = t.isHTMLRawTextElement, s = t.hasOwn, c = t.NAMESPACE, l = r.ParseError, u = r.DOMException, d = 0, f = 1, p = 2, m = 3, h = 4, g = 5, _ = 6, v = 7;
	function y() {}
			...
			try {
				...
				switch (e.charAt(O + 1)) {
					case "/":
						...
						E.pop();
						var L = I.localNSMap;
						if (o.endElement(I.uri, I.localName, ae), L) for (var R in L) s(L, R) && o.endPrefixMapping(R);
						j++;
						break;
					case "?":
						v && y(O), j = te(e, O, o, c);
					...
					default:
						v && y(O);
						var oe = new k(), se = x[x.length - 1].currentNSMap, j = C(e, O, oe, se, p, c, d), ce = oe.length;
						if (oe.closed || (d && t.isHTMLVoidElement(oe.tagName) ? oe.closed = !0 : E.push(oe.tagName)), v && ce) {
							for (var z = S(v, {}), B = 0; B < ce; B++) {
								var le = oe[B];
								y(le.offset), le.locator = S(v, {});
							}
							o.locator = z, w(oe, o, se) && x.push(oe), o.locator = v;
						} else w(oe, o, se) && x.push(oe);
						d && !oe.closed ? j = T(e, j, oe.tagName, p, o) : j++;
				}
			} catch (e) {
	...
	var t = Re(), n = Ve(), r = ze(), i = He(), a = Ue(), o = n.DOMImplementation, s = t.hasDefaultHTMLNamespace, c = t.isHTMLMimeType, l = t.isValidMimeType, u = t.MIME_TYPE, d = t.NAMESPACE, f = r.ParseError, p = a.XMLReader;
	function m(e) {
		return e.replace(/\r[\n\u0085]/g, "\n").replace(/[\r\u0085\u2028\u2029]/g, "\n");
	}
	function h(e) {
...
})), Ke = /* @__PURE__ */ u(Le()), qe = /* @__PURE__ */ c({
	DOMParserFactory: () => $e,
	RDFArrayRemove: () => st,
	callbackify: () => Qe,
	domToString: () => et,
	...
	stackString: () => ut,
	string: () => Ye,
	string_startswith: () => ct,
	uri: () => we
}), Je = Ge(), Ye = { template: lt };
function Xe(e) {
	return e = e.split(";")[0].trim(), new H("http://www.w3.org/ns/iana/media-types/" + e + "#Resource");
}
function Ze(e) {
	return new H("http://www.w3.org/ns/iana/link-relations/relation#" + e.trim());
}
function Qe(e, t) {
	e.callbacks = {};
...
function $e() {
	return window.DOMParser ? new Je.DOMParser() : window.ActiveXObject ? new ActiveXObject("Microsoft.XMLDOM") : !1;
}
function et(e, t) {
	t ||= {};
	var n = [];
	...
	if (e.nodeType === 1) {
		if (e.hasAttribute("class") && t && t.classWithChildText && e.matches(t.classWithChildText.class)) a += e.querySelector(t.classWithChildText.element).textContent;
			...
			if (c.length > 0 && (t && t.sortAttributes && c.sort(function(e, t) {
				...
				for (a += ">", a += s === "html" ? "\n  " : "", o.push(s === "style" || s === "script"), i = 0; i < e.childNodes.length; i++) a += tt(e.childNodes[i]);
				o.pop(), a += s === "body" ? "</" + s + ">\n" : "</" + s + ">";
			}
		}
...
function it(e, t, n, r) {
	return rt(e.subject, t.subject, n, r) || rt(e.predicate, t.predicate, n, r) || rt(e.object, t.object, n, r);
}
function at(e) {
...
function ot(e, t) {
	var n;
	return t ||= {}, typeof module < "u" && module && module.exports ? new Je.DOMParser().parseFromString(e, t.contentType || "application/xhtml+xml") : (n = typeof window < "u" && window.DOMParser ? new window.DOMParser() : new Je.DOMParser(), n.parseFromString(e, "application/xml"));
}
function st(e, t) {
...
var pt = class e {
	constructor(e) {
		...
		this.suggestPrefix("rdf", "http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.suggestPrefix("xml", "reserved:reservedForFutureUse"), this.namespacesUsed = [], this.keywords = ["a"], this.prefixchars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ", this.incoming = null, this.formulas = [], this.store = e, this.rdfFactory = e.rdfFactory || Fe, this.xsd = dt(this.rdfFactory);
	}
	setBase(e) {
	...
	explicitURI(e) {
		return e = this.flags.indexOf("r") < 0 && this.base ? je(this.base, e) : this.flags.indexOf("u") >= 0 ? ht(e) : mt(decodeURI(e)), "<" + e + ">";
	}
	...
	statementsToXML(e) {
		...
		function l(e) {
			return c(this.base ? je(this.base, e.uri) : e.uri);
		}
		var u = l.bind(this);
		function d(e, t) {
		...
		for (var b in this.defaultNamespace && (y += " xmlns=\"" + c(this.defaultNamespace) + "\""), t) if (t.hasOwnProperty(b)) {
			var x = this.base && this.flags.includes("z") ? je(this.base, b) : b;
	...
	statementsToJsonld(e) {
		let t = this.statementsToN3(e), n = Ke.parse(t);
...
function yt(e, t, n) {
	...
	return n.reduce((t, n, i, a) => {
		r.push(e.quad(t, e.namedNode(vt.first), a[i]));
		let o;
		return i < a.length - 1 ? (o = e.blankNode(), r.push(e.quad(t, e.namedNode(vt.rest), o))) : r.push(e.quad(t, e.namedNode(vt.rest), e.namedNode(vt.nil))), o;
	}, t), r;
}
function bt(e, t, n = 0) {
	var r = e.length;
...
var xt = class e extends v {
	constructor(e = [], t = [], n = [], r = [], i = {}) {
		super(""), this.statements = e, this.constraints = t, this.initBindings = n, this.optional = r, g(this, "termType", E), g(this, "classOrder", _.Graph), g(this, "fetcher", void 0), g(this, "isVar", 0), g(this, "ns", Ie), g(this, "rdfFactory", void 0), this.rdfFactory = i && i.rdfFactory || Fe;
		for (let e of _t) this[e] = (...t) => this.rdfFactory[e](...t);
	}
	add(e, t, n, r) {
	...
	each(e, t, n, r) {
		...
		else if (r == null) for (let e = 0, t = a.length; e < t; e++) i.push(new H(a[e].graph.value));
		return i;
	}
	equals(e) {
	...
	list(e, t) {
		...
		{
			let n = t.rdfFactory.blankNode(), r = yt(t.rdfFactory, n, e);
			return t.addAll(r), n;
		}
	}
	NTtoURI(e) {
...
v.fromValue = ge;
var St = v, Ct = { xsd: Ie("http://www.w3.org/2001/XMLSchema#") };
v.toJS = function(e) {
	return I(e) ? e.elements.map(v.toJS) : z(e) ? e.datatype.equals(Ct.xsd("boolean")) ? e.value === "1" || e.value === "true" : e.datatype.equals(Ct.xsd("dateTime")) || e.datatype.equals(Ct.xsd("date")) ? new Date(e.value) : e.datatype.equals(Ct.xsd("integer")) || e.datatype.equals(Ct.xsd("float")) || e.datatype.equals(Ct.xsd("decimal")) ? Number(e.value) : e.value : e;
};
//#endregion
//#region node_modules/rdflib/esm/query.js
var wt = class {
	constructor(e, t) {
		this.pat = new At(), this.vars = [], this.name = e, this.id = t;
	}
};
function Tt(e, t, n, r) {
	function i(e) {
	...
	var h = 0, g = function(e, n, r, a, o, s, c) {
		...
		if (o) {
			...
			for (y = 0; y < b; y++) {
				if (_ = l[y], r[_.subject] !== void 0 && r[_.subject].uri && o && o.getState(Ee(r[_.subject].uri)) === "unrequested") {
					S(r[_.subject], x);
					return;
				}
				if (r[_.object] !== void 0 && r[_.object].uri && o && o.getState(Ee(r[_.object].uri)) === "unrequested") {
					S(r[_.object], x);
					return;
				}
			}
...
var Et = "http://www.w3.org/2002/07/owl#";
function Dt(e, t, n, r) {
...
var At = class e extends xt {
	constructor(e, t = {}) {
		super(void 0, void 0, void 0, void 0, t), g(this, "updater", void 0), g(this, "namespaces", void 0), g(this, "classActions", void 0), g(this, "propertyActions", void 0), g(this, "redirections", void 0), g(this, "aliases", void 0), g(this, "HTTPRedirects", void 0), g(this, "subjectIndex", void 0), g(this, "predicateIndex", void 0), g(this, "objectIndex", void 0), g(this, "whyIndex", void 0), g(this, "index", void 0), g(this, "features", void 0), g(this, "_universalVariables", void 0), g(this, "_existentialVariables", void 0), g(this, "rdfArrayRemove", void 0), g(this, "dataCallbacks", []), g(this, "dataRemovalCallbacks", []), this.propertyActions = {}, this.classActions = {}, this.redirections = [], this.aliases = [], this.HTTPRedirects = [], this.subjectIndex = [], this.predicateIndex = [], this.objectIndex = [], this.whyIndex = [], this.index = [
			...
			this.objectIndex,
			this.whyIndex
		], this.namespaces = {}, this.features = e || [], this.rdfArrayRemove = t.rdfArrayRemove || st, t.dataCallback && (this.dataCallbacks = [t.dataCallback]), t.dataRemovalCallback && (this.dataRemovalCallbacks = [t.dataRemovalCallback]), this.initPropertyActions(this.features);
	}
	...
	initPropertyActions(e) {
		this.propertyActions[this.rdfFactory.id(this.rdfFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"))] = [kt], bt(e, "sameAs") >= 0 && (this.propertyActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Et}sameAs`))] = [function(e, t, n, r, i) {
			return e.equate(t, r), !0;
		}]), bt(e, "InverseFunctionalProperty") >= 0 && (this.classActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Et}InverseFunctionalProperty`))] = [function(e, t, n, r, i) {
			return e.newPropertyAction(t, Ot);
		}]), bt(e, "FunctionalProperty") >= 0 && (this.classActions[this.rdfFactory.id(this.rdfFactory.namedNode(`${Et}FunctionalProperty`))] = [function(e, t, n, r, i) {
			return e.newPropertyAction(t, Dt);
		}]);
	}
	addStatement(e) {
	...
	add(e, t, n, r) {
		...
		if (arguments.length === 1) {
			...
			else B(e) ? this.add(e.subject, e.predicate, e.object, e.graph) : F(e) && this.add(e.statements);
			return this;
		}
		var a, o;
		r ||= this.fetcher ? this.fetcher.appNode : this.rdfFactory.defaultGraph(), typeof e == "string" && (e = this.rdfFactory.namedNode(e)), t = St.fromValue(t);
		let s = St.fromValue(n);
		if (r = St.fromValue(r), !R(e)) throw Error("Subject is not a subject type");
		if (!oe(t)) throw Error(`Predicate ${t} is not a predicate type`);
		if (!L(s)) throw Error(`Object ${s} is not an object type`);
		if (!pe(r)) throw Error("Why is not a graph type");
	...
	canon(e) {
		...
		switch (e.termType) {
			...
			case w: return e;
			case C: return new be();
			case T: return e;
			case E: return e;
			case x: return new he(e.value, e.language, e.datatype);
			case y: return new H(e.value);
			case S: return new Me(e.value);
	...
	copyTo(e, t, n) {
		...
		bt(n, "two-direction") !== -1 && r.concat(this.statementsMatching(void 0, void 0, e));
		for (var i = 0; i < r.length; i++) {
			var a = r[i];
			switch (a.object.termType) {
				case "NamedNode":
	...
	match(e, t, n, r) {
		return this.statementsMatching(St.fromValue(e), St.fromValue(t), St.fromValue(n), St.fromValue(r));
	}
	mentionsURI(e) {
		var t = "<" + e + ">";
	...
	querySync(e) {
		...
		var i = !1;
		if (e.sync = !0, Tt.call(this, e, n, null, r), !i) throw Error("Sync query should have called done function");
		return t;
	}
	remove(e) {
		if (e instanceof Array) {
	...
	statementsMatching(e, t, n, r, i) {
		for (var a = [
			...
			n,
			r
		], o = [], s = [], c = [], l = [], u = 0, d; u < 4; u++) o[u] = this.canon(St.fromValue(a[u])), o[u] ? (l.push(u), s[u] = this.id(o[u])) : c.push(u);
	...
	serialize(e, t, n, r) {
		...
		return r = {
			...r || {},
			namespaces: i
		}, gt(n, this, e, t, void 0, r);
	}
};
g(At, "handleRDFType", void 0), At.handleRDFType = kt;
//#endregion
//#region node_modules/rdflib/esm/lists.js
var jt = Ie("http://www.w3.org/1999/02/22-rdf-syntax-ns#");
function Mt(e, t, n, r) {
	for (let i of e.statementsMatching(n, null, null, r)) {
		let n = new Ce(t, i.predicate, i.object, r);
		e.remove(i), e.add(n);
	}
	for (let i of e.statementsMatching(null, n, null, r)) e.remove(i), e.add(new Ce(i.subject, t, i.object, r));
	for (let i of e.statementsMatching(null, null, n, r)) e.remove(i), e.add(new Ce(i.subject, i.predicate, t, r));
}
function Nt(e, t) {
	let n = jt("nil");
	for (let r of e.statementsMatching(n, null, null, t)) {
		e.remove(r);
		let n = new _e();
		e.add(new Ce(n, r.predicate, r.object, t));
	}
	for (let r of e.statementsMatching(null, null, n, t)) if (!r.predicate.sameTerm(jt("rest"))) {
		e.remove(r);
		let n = new _e();
		e.add(new Ce(r.subject, r.predicate, n, t));
	}
}
function Pt(e, t) {
	function n(r, i, a) {
		let o = e.statementsMatching(r, jt("rest"), null, t);
		if (o.length !== 1) throw Error(`Bad list structure: no rest at ${r}`);
		let s = e.statementsMatching(r, jt("first"), null, t);
		if (s.length !== 1) throw Error(`Bad list structure: rest but ${s.length} firsts at ${r}`);
		let c = [s[0].object].concat(i), l = a.concat(o).concat(s), u = e.statementsMatching(null, jt("rest"), r, t);
		if (u.length === 0) {
			let n = new _e(c);
			e.remove(l), Mt(e, n, r, t);
			return;
		}
	...
	Nt(e, t), e.statementsMatching(null, jt("rest"), jt("nil"), t).forEach((e) => {
...
}, Lt = "http://www.w3.org/2000/10/swap/log#", Rt = function(e) {
	return e;
}, zt = function(e) {
	return e;
}, Bt = function(e) {
...
}, Ut = Error("dummy error stop iteration"), Wt = function(e) {
	return this.last = 0, this.li = e, this.next = function() {
		if (this.last == this.li.length) throw Ut;
...
var Jt = function(e, t) {
	return ke(t, e);
}, Yt = null, Xt = 0, Zt = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", Qt = "http://www.w3.org/1999/02/22-rdf-syntax-ns#nil", $t = "http://www.w3.org/2002/07/owl#sameAs", en = "#", tn = "http://www.w3.org/2001/XMLSchema#integer", nn = "http://www.w3.org/2001/XMLSchema#double", rn = "http://www.w3.org/2001/XMLSchema#decimal", an = "http://www.w3.org/2001/XMLSchema#date", on = "http://www.w3.org/2001/XMLSchema#dateTime", sn = "	\r\n !\"#$%&'()*.,+/;<=>?@[\\]^`{|}~", cn = sn + ":", ln = /* @__PURE__ */ RegExp("^([-+]?[0-9]+)(\\.[0-9]+)?([eE][-+]?[0-9]+)?", "g"), un = /* @__PURE__ */ RegExp("^[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9](T[0-9][0-9]:[0-9][0-9](:[0-9][0-9](\\.[0-9]*)?)?)?Z?"), dn = /* @__PURE__ */ RegExp("[\\s#]"), fn = /* @__PURE__ */ RegExp("[\\\\\\r\\n\\\"]", "g"), pn = /* @__PURE__ */ RegExp("^[a-zA-Z0-9]+(-[a-zA-Z0-9]+)*", "g");
function mn(e, t) {
	var n = e.charAt(t + 1);
	return n === "" || dn.test(n);
}
function hn(e, t, n, r, i, a, o, s) {
	return new gn(e, t, n, r, i, a, o, s);
}
var gn = class {
	constructor(e, t, n, r, i, a, o, s) {
		t === void 0 && (t = null), n === void 0 && (n = ""), r === void 0 && (r = null), i === void 0 && (i = ""), a === void 0 && (a = null), o === void 0 && (o = ""), s === void 0 && (s = null), this._bindings = new Bt([]), this._flags = o, n != "" && (Kt(n.indexOf(":") >= 0, "Document URI not absolute: " + n), this._bindings[""] = n + "#"), this._store = e, i && e.setGenPrefix(i), this._thisDoc = n, this.source = e.sym(n), this.lines = 0, this.statementCount = 0, this.hasNil = !1, this.startOfLine = 0, this.previousLine = 0, this._genPrefix = i, this.keywords = new zt([
			"a",
			"this",
			"bind",
			"has",
			...
			"true",
			"false"
		]), this.keywordsSet = 0, this._anonymousNodes = new Bt([]), this._variables = new Bt([]), this._parentVariables = new Bt([]), this._reason = s, this._reason2 = null, this._baseURI = r || n || null, Kt(!this._baseURI || this._baseURI.indexOf(":") >= 0), this._genPrefix ||= this._thisDoc ? this._thisDoc + "#_g" : RDFSink_uniqueURI(), this._formula = t ?? (this._thisDoc ? e.formula(n + "#_formula") : e.formula()), this._context = this._formula, this._parentContext = null;
	}
	here(e) {
	...
	tok(e, t, n) {
		...
		else if (bt(this.keywords, e) < 0) return -1;
		var r = n + Vt(e);
		return t.slice(n, r) == e && sn.indexOf(t.charAt(r)) >= 0 ? r : -1;
	}
	directive(e, t) {
		var n = this.skipSpace(e, t);
		if (n < 0) return n;
		var r = new zt([]), n = this.tok("bind", e, t);
		...
		if (n > 0) {
			...
			return this.setKeywords(Ht(r, null, null)), Xt > 80 && this.keywords, t;
		}
		...
		if (n > 0) {
			...
			try {
				for (;;) {
					var a = i.next();
					(bt(this._variables, a) < 0 || bt(this._parentVariables, a) >= 0) && (this._variables[a] = this._context.newUniversal(a));
				}
			} catch (e) {
				if (e != Ut) throw e;
			}
		...
		if (n >= 0) {
			var o = new zt([]), t = this.qname(e, n, o);
			...
			var s = o[1].uri;
			if (this._baseURI) var s = Jt(this._baseURI, s);
			else Kt(s.indexOf(":") >= 0, "With no base URI, cannot handle relative URI for NS");
			return Kt(s.indexOf(":") >= 0), this._bindings[o[0][0]] = s, this.bind(o[0][0], Ft(s)), n;
		}
		var n = this.tok("base", e, t);
		if (n >= 0) {
			var o = new zt([]), t = this.uri_ref2(e, n, o);
			...
			return Kt(s.indexOf(":") >= 0), this._baseURI = s, t;
		}
		return -1;
	}
	bind(e, t) {
	...
	startDoc() {}
	endDoc() {
		return this.hasNil && this._store.rdfFactory.supports.COLLECTIONS && Pt(this._store, this.source), this._formula;
	}
	makeStatement(e) {
		e[0].add(e[2], e[1], e[3], this.source), (e[2].uri && e[2].uri === Qt || e[3].uri && e[3].uri === Qt) && (this.hasNil = !0), this.statementCount += 1;
	}
	statement(e, t) {
		var n = new zt([]), t = this.object(e, t, n);
		if (t < 0) return t;
	...
	verb(e, t, n) {
		...
		if (r >= 0) {
			...
			return n.push(new Rt(["<-", i[0]])), r;
		}
		var r = this.tok("a", e, t);
		if (r >= 0) return n.push(new Rt(["->", this._store.sym(Zt)])), r;
		if (e.slice(t, t + 2) == "<=") return n.push(new Rt(["<-", this._store.sym(Lt + "implies")])), t + 2;
		if (e.slice(t, t + 1) == "=") return e.slice(t + 1, t + 2) == ">" ? (n.push(new Rt(["->", this._store.sym(Lt + "implies")])), t + 2) : (n.push(new Rt(["->", this._store.sym($t)])), t + 1);
		if (e.slice(t, t + 2) == ":=") return n.push(new Rt(["->", Lt + "becomes"])), t + 2;
		var r = this.prop(e, t, i);
		if (r >= 0) return n.push(new Rt(["->", i[0]])), r;
	...
	path(e, t, n) {
		...
		for (; "!^.".indexOf(e.slice(r, r + 1)) >= 0;) {
			...
			var s = n.pop();
			i == "^" ? this.makeStatement(new Rt([
				this._context,
				s,
				o,
				a
			])) : this.makeStatement(new Rt([
				this._context,
				s,
				a,
				o
	...
	node(e, t, n, r) {
		...
		if (o == "[") {
			...
			if (e.slice(a, a + 1) == "=") {
				var t = a + 1, c = new zt([]), a = this.objectList(e, t, c);
				if (a >= 0) {
					var i = c[0];
					if (Vt(c) > 1) {
						var l = new Wt(c);
		...
		if (o == "{") {
			...
			if (d == "$") {
				...
				for (var a = t + 1, f = new zt([]), p = !0;;) {
					...
					var m = new zt([]), a = this.item(e, t, m);
			...
			this._parentVariables = this._variables, this._anonymousNodes = new Bt([]), this._variables = this._variables.slice();
			var v = this._reason2;
			if (this._reason2 = Yt, i == null) var i = this._store.formula();
			for (this._context = i;;) {
				var t = this.skipSpace(e, a);
				if (t < 0) throw W(this._thisDoc, this.lines, e, t, "needed '}', found end.");
				if (e.slice(t, t + 1) == "}") {
	...
	uri_ref2(e, t, n) {
		var r = new zt([]), i = this.qname(e, t, r);
		if (i >= 0) {
			var a = r[0], o = a[0], s = a[1];
			if (o == null) {
				Kt(0, "not used?");
				var c = this._baseURI + en;
			} else {
			...
			return bt(this._variables, l) >= 0 ? n.push(this._variables[l]) : n.push(l), i;
		}
		var t = this.skipSpace(e, t);
		if (t < 0) return -1;
		if (e.charAt(t) == "?") {
			var u = new zt([]), i = this.variable(e, t, u);
			return i > 0 ? (n.push(u[0]), i) : -1;
		}
		if (e.charAt(t) == "<") {
			for (var t = t + 1, d = t; t < Vt(e);) {
				if (e.charAt(t) == ">") {
					var f = e.slice(d, t);
					if (this._baseURI) var f = Jt(this._baseURI, f);
					else Kt(f.indexOf(":") >= 0, "With no base URI, cannot deal with relative URIs");
					if (e.slice(t - 1, t) == "#" && Ht(f, -1, null) != "#") var f = f + "#";
					var l = this._store.sym(f);
					return bt(this._variables, l) >= 0 ? n.push(this._variables[l]) : n.push(l), t + 1;
				}
				var t = t + 1;
			}
		...
		if (this.keywordsSet) {
			var u = new zt([]), i = this.bareWord(e, t, u);
			if (i < 0) return -1;
			if (bt(this.keywords, u[0]) >= 0) throw W(this._thisDoc, this.lines, e, t, "Keyword \"" + u[0] + "\" not allowed here.");
	...
	variable(e, t, n) {
		...
		for (; t < Vt(e) && cn.indexOf(e.charAt(t)) < 0;) var t = t + 1;
	...
	bareWord(e, t, n) {
		...
		if (r < 0) return -1;
		var i = e.charAt(r);
		if ("0123456789-".indexOf(i) >= 0 || cn.indexOf(i) >= 0) return -1;
		for (var t = r; t < Vt(e);) {
			var a = e.charAt(t);
			if (a === ".") {
				if (mn(e, t)) break;
			} else if (cn.indexOf(a) >= 0) break;
			var t = t + 1;
		}
	...
	qname(e, t, n) {
		...
		if (cn.indexOf(r) < 0) for (var i = r, t = t + 1; t < Vt(e);) {
			var r = e.charAt(t);
			if (r === ".") {
				if (mn(e, t)) break;
			} else if (cn.indexOf(r) >= 0) break;
			var i = i + r, t = t + 1;
		}
		else var i = "";
		if (t < Vt(e) && e.charAt(t) == ":") {
			for (var a = i, t = t + 1, i = ""; t < Vt(e);) {
				var r = e.charAt(t);
				if (r === ".") {
					if (mn(e, t)) break;
				} else if (cn.indexOf(r) >= 0) break;
			...
			return n.push(new Rt([a, i])), t;
		}
		return i && this.keywordsSet && bt(this.keywords, i) < 0 ? (n.push(new Rt(["", i])), t) : -1;
	}
	object(e, t, n) {
		...
		if (r >= 0) return r;
		{
			...
			if (s == "\"" || s == "'") {
				...
				var t = t + Vt(i), a = this.strconst(e, t, i), r = a[0], o = a[1];
	...
	nodeOrLiteral(e, t, n) {
		...
		if ("-+0987654321".indexOf(i) >= 0) {
			un.lastIndex = 0;
			var a = un.exec(e.slice(t));
			if (a != null) {
				var o = a[0];
				r = t + o.length, o.indexOf("T") >= 0 ? n.push(this._store.literal(o, this._store.sym(on))) : n.push(this._store.literal(o, this._store.sym(an)));
			} else {
				ln.lastIndex = 0;
				var a = ln.exec(e.slice(t));
				if (a == null) throw W(this._thisDoc, this.lines, e, t, "Bad number or date syntax");
				r = t + ln.lastIndex;
				var o = e.slice(t, r);
				o.indexOf("e") >= 0 ? n.push(this._store.literal(parseFloat(o), this._store.sym(nn))) : e.slice(t, r).indexOf(".") >= 0 ? n.push(this._store.literal(parseFloat(o), this._store.sym(rn))) : n.push(this._store.literal(parseInt(o), this._store.sym(tn)));
			}
			return r;
		}
		if (e.charAt(t) == "\"") {
			...
			var t = t + Vt(s), c = null, l = this.strconst(e, t, s), r = l[0], u = l[1], d = null;
			if (e.slice(r, r + 1) == "@") {
				pn.lastIndex = 0;
				var a = pn.exec(e.slice(r + 1));
				if (a == null) throw W(this._thisDoc, startline, e, t, "Bad language code syntax on string literal, after @");
				var t = pn.lastIndex + r + 1, d = e.slice(r + 1, t), r = t;
			}
			if (e.slice(r, r + 2) == "^^") var f = new zt([]), r = this.uri_ref2(e, r + 2, f), c = f[0];
			return n.push(this._store.literal(u, d || c)), r;
		}
		return -1;
	}
	strconst(e, t, n) {
		for (var r = t, i = "", a = this.lines; r < Vt(e);) {
			var t = r + Vt(n);
			if (e.slice(r, t) == n) return new Rt([t, i]);
			if (e.charAt(r) == "\"") {
				var i = i + "\"", r = r + 1;
				continue;
			}
			if (fn.lastIndex = 0, !fn.exec(e.slice(r))) throw W(this._thisDoc, a, e, r, "Closing quote missing in string at ^ in " + e.slice(r - 20, r) + "^" + e.slice(r, r + 20));
			var t = r + fn.lastIndex - 1, i = i + e.slice(r, t), o = e.charAt(t);
			if (o == "\"") {
				var r = t;
				continue;
			}
	...
	uEscape(e, t, n) {
		for (var r = t, i = 0, a = 0; i < 4;) {
			...
			var s = Gt("0123456789abcdef", o);
			if (s < 0) throw W(this._thisDoc, n, e, t, "bad string literal hex escape");
			var a = a * 16 + s, i = i + 1;
		}
		return new Rt([r, String.fromCharCode(a)]);
	}
	UEscape(e, t, n) {
		for (var r = t, i = 0, a = "\\U"; i < 8;) {
			var o = e.slice(r, r + 1).toLowerCase(), r = r + 1;
			if (o == "") throw W(this._thisDoc, n, e, t, "unterminated string literal(3)");
			if (Gt("0123456789abcdef", o) < 0) throw W(this._thisDoc, n, e, t, "bad string literal hex escape");
			var a = a + o, i = i + 1;
		}
		return new Rt([r, qt("0x" + Ht(a, 2, 10) - 0)]);
	}
};
...
var vn = {
	...
	id(e) {
		return I(e) ? _e.toNT(e) : se(e) ? Me.toString(e) : Fe.id(e);
	},
	termToNQ(e) {
		return e.termType === "Collection" ? _e.toNT(e) : Fe.termToNQ(e);
	}
};
//#endregion
//#region node_modules/rdflib/esm/jsonldparser.js
function yn(e, t) {
	return typeof t == "string" ? e.rdfFactory.literal(t) : Object.prototype.hasOwnProperty.call(t, "@list") ? e.rdfFactory.supports.COLLECTIONS === !0 ? xn(e, t["@list"]) : bn(e, t) : Object.prototype.hasOwnProperty.call(t, "@id") ? Cn(e, t) : Object.prototype.hasOwnProperty.call(t, "@language") ? e.rdfFactory.literal(t["@value"], t["@language"]) : Object.prototype.hasOwnProperty.call(t, "@type") ? e.rdfFactory.literal(t["@value"], e.rdfFactory.namedNode(t["@type"])) : Object.prototype.hasOwnProperty.call(t, "@value") ? e.rdfFactory.literal(t["@value"]) : e.rdfFactory.literal(t);
}
function bn(e, t) {
	let n = t["@id"] ? Cn(e, t) : e.rdfFactory.blankNode(), r = t["@list"].map((t) => yn(e, t)), i = yt(e.rdfFactory, n, r);
	return e.addAll(i), n;
}
function xn(e, t) {
	if (!Array.isArray(t)) throw TypeError("Object must be an array");
	return e.rdfFactory.collection(t.map((t) => yn(e, t)));
}
async function Sn(e, t, n) {
	let r = n && Object.prototype.hasOwnProperty.call(n, "termType") ? n.value : n, i = await import("./jsonld-CDR2WyN_.js").then((e) => /* @__PURE__ */ u(e.default));
	return (await (i.default || i).flatten(JSON.parse(e), null, { base: r })).reduce((e, t) => wn(e, n, t), t);
}
function Cn(e, t) {
	return t["@id"].startsWith("_:") ? e.rdfFactory.blankNode(t["@id"].substring(2)) : e.rdfFactory.namedNode(t["@id"]);
}
function wn(e, t, n) {
	let r = n["@id"] ? Cn(e, n) : e.rdfFactory.blankNode();
	for (let i of Object.keys(n)) {
		if (i === "@id") continue;
		if (i == "@graph") {
			let t = r, a = n[i];
			for (let n = 0; n < a.length; n++) e = wn(e, t, a[n]);
		}
		let a = n[i];
		if (Array.isArray(a)) for (let n = 0; n < a.length; n++) e.addStatement(Tn(e, r, i, a[n], t));
		else e.addStatement(Tn(e, r, i, a, t));
	}
	return e;
}
function Tn(e, t, n, r, i) {
	let a, o;
	return n === "@type" ? (a = e.rdfFactory.namedNode("http://www.w3.org/1999/02/22-rdf-syntax-ns#type"), o = e.rdfFactory.namedNode(r)) : (a = e.rdfFactory.namedNode(n), o = yn(e, r)), e.rdfFactory.quad(t, a, o, e.rdfFactory.namedNode(i));
}
//#endregion
...
var En = /* @__PURE__ */ s(((e) => {
	...
	var t = En(), n = Dn(), r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
	...
	function T(e, t, n, r) {
		return me(V(t, e.length - n), e, n, r);
	}
	function E(e, t, n, r) {
	...
	function ce(e, t, n) {
		B(t, "offset"), (e[t] === void 0 || e[t + n] === void 0) && le(t, e.length - (n + 1));
	}
	...
	function le(e, t, n) {
		throw Math.floor(e) === e ? t < 0 ? new R.ERR_BUFFER_OUT_OF_BOUNDS() : new R.ERR_OUT_OF_RANGE(n || "offset", `>= ${+!!n} and <= ${t}`, e) : (B(e, n), new R.ERR_OUT_OF_RANGE(n || "offset", "an integer", e));
	}
...
})))(), kn = "http://www.w3.org/1999/02/22-rdf-syntax-ns#", An = "http://www.w3.org/2001/XMLSchema#", jn = "http://www.w3.org/2000/10/swap/", Mn = {
	xsd: {
		decimal: `${An}decimal`,
		boolean: `${An}boolean`,
	...
	rdf: {
		...
		first: `${kn}first`,
		rest: `${kn}rest`,
		langString: `${kn}langString`,
		dirLangString: `${kn}dirLangString`,
		reifies: `${kn}reifies`
	},
	owl: { sameAs: "http://www.w3.org/2002/07/owl#sameAs" },
	r: {
		forSome: `${jn}reify#forSome`,
		forAll: `${jn}reify#forAll`
	},
	log: {
		implies: `${jn}log#implies`,
		isImpliedBy: `${jn}log#isImpliedBy`
	}
}, { xsd: Nn } = Mn, Pn = 32, Fn = 9, In = 10, Ln = 13, Rn = 35, zn = /\\u([a-fA-F0-9]{4})|\\U([a-fA-F0-9]{8})|\\([^])/g, Bn = {
	"\\": "\\",
	"'": "'",
	"\"": "\"",
	n: "\n",
...
var Wn = {
	...
	_tokenizeToEnd(e, t) {
		...
		for (;;) {
			...
			switch (c) {
				...
				case "<":
					if (f = this._unescapedIri.exec(n)) l = "IRI", u = f[1], m = f[1].length + 2;
					else if (f = this._iri.exec(n)) {
						if (u = this._unescape(f[1], Bn), u === null || Hn.test(u)) return o(this);
						l = "IRI", m = f[1].length + 2;
					} else n.length > 2 && n[1] === "<" && n[2] === "(" ? (l = "<<(", p = 3) : !this._lineMode && n.length > (t ? 1 : 2) && n[1] === "<" ? (l = "<<", p = 2) : this._n3Mode && n.length > 1 && n[1] === "=" ? (p = 2, this._isImpliedBy ? (l = "abbreviation", u = "<") : (l = "inverse", u = ">")) : this._n3Mode && n.length > 1 && n[1] === "-" && (l = "inversePredicate", p = 2);
					break;
				case ">":
					n.length > 1 && n[1] === ">" && (l = ">>", p = 2);
					break;
				case "_":
					((f = this._blank.exec(n)) || t && (f = this._blank.exec(`${n} `))) && (l = "blank", d = "_", u = f[1], m = f[1].length + 2);
					break;
				case "\"":
					if (f = this._simpleQuotedString.exec(n)) u = f[1];
					else if ({value: u, matchLength: p, finalLineLength: h} = this._parseLiteral(n), u === null) return o(this);
				...
				case "-":
					if (n[1] === "-") {
						this._previousMarker === "langcode" && (n.startsWith("--ltr") ? (l = "dircode", u = "ltr", p = 5) : n.startsWith("--rtl") && (l = "dircode", u = "rtl", p = 5));
						break;
					}
					(f = this._number.exec(n) || t && (f = this._number.exec(`${n} `))) && (l = "literal", u = f[0], d = typeof f[1] == "string" ? Nn.double : typeof f[2] == "string" ? Nn.decimal : Nn.integer);
					break;
				case "B":
				case "b":
				case "p":
				...
				case "V":
				case "v":
					(f = this._keyword.exec(n)) ? l = f[0].toUpperCase() : g = !0;
					break;
				case "f":
				case "t":
					this._boolean.test(n) ? (l = "literal", u = c === "t" ? "true" : "false", d = Nn.boolean, p = u.length) : g = !0;
					break;
				case "a":
					this._shortPredicates.test(n) ? (l = "abbreviation", u = "a", p = 1) : g = !0;
					break;
				case "h":
				case "o":
					this._n3Mode && (f = this._matchN3Verb(n, t)) ? l = f[0] : g = !0;
					break;
				case "i":
					this._n3Mode && this._n3Id.test(n) ? (l = "id", p = 2) : this._n3Mode && (f = this._matchN3Verb(n, t)) ? l = f[0] : g = !0;
					break;
				case "=":
			...
			if (g && ((this._previousMarker === "@prefix" || this._previousMarker === "PREFIX") && (f = this._prefix.exec(n)) ? (l = "prefix", u = f[1] || "") : ((f = this._prefixed.exec(n)) || t && (f = this._prefixed.exec(`${n} `))) && (l = "prefixed", d = f[1] || "", u = this._unescape(f[2], Vn), m = d.length + f[2].length + 1)), this._previousMarker === "^^") switch (l) {
				case "prefixed":
					l = "type";
					break;
				case "IRI":
			...
			if (!l) return t || !/^'''|^"""/.test(n) && /\n|\r/.test(n) ? o(this) : (this._linePosition = r - n.length, this._input = n);
			let _ = p || f[0].length, v;
			h ? (v = {
				type: l,
				value: u,
				prefix: d,
				...
				endLine: this._line
			}, e(null, v)) : v = a(l, u, d, s, m || _), this.previousToken = v, this._previousMarker = l, n = n.slice(_), h && (r = n.length + h);
		}
		function i(t, i, a) {
			let o = r - n.length + a;
			e(null, {
	...
	_matchN3Verb(e, t) {
		let n = this._n3Verb.exec(e);
		if (!n) return null;
		let r = e[n[0].length];
		return r !== "-" && r !== "_" && (r < "0" || r > "9") ? n : this._prefixed.exec(e) || this._prefixed.exec(`${e} `) || !t && this._prefix.exec(`${e}: `) ? null : n;
	}
	_unescape(e, t) {
		if (e.indexOf("\\") < 0) return e;
		let n = !1, r = e.replace(zn, (e, r, i, a) => {
			if (typeof r == "string") {
				let e = Number.parseInt(r, 16);
				return Un(e) ? String.fromCharCode(e) : (n = !0, "");
			}
			if (typeof i == "string") {
				let e = Number.parseInt(i, 16);
				return Un(e) ? e <= 65535 ? String.fromCharCode(Number.parseInt(i, 16)) : String.fromCharCode(55296 + ((e -= 65536) >> 10), 56320 + (e & 1023)) : (n = !0, "");
			}
			return a in t ? t[a] : (n = !0, "");
		});
		return n ? null : r;
	}
	_parseLiteral(e) {
		if (e.length >= 3) {
			let t = e[0], n = e[1] === t && e[2] === t ? 3 : 1, r = t;
			n === 3 && (r = t === "\"" ? "\"\"\"" : "'''");
			...
			for (; (i = e.indexOf(r, i)) > 0;) {
				...
				for (; e[i - t - 1] === "\\";) t++;
				if (t % 2 == 0) {
					let t = e.substring(n, i), r = t.split(/\r\n|\r|\n/), a = r.length - 1, o = i + n;
					if (n === 1 && a !== 0 || n === 3 && this._lineMode) break;
					this._line += a;
					let s = a === 0 ? 0 : r[r.length - 1].length + n;
					return {
						value: this._unescape(t, Bn),
						matchLength: o,
						finalLineLength: s
					};
				}
	...
	tokenize(e, t) {
		let n = this._tokenization = {};
		if (this._line = 1, this._linePosition = 0, this._previousMarker = void 0, this.previousToken = void 0, this._literalClosingPos = 0, this._input = void 0, typeof e == "string") {
			if (this._input = this._readStartingBom(e), typeof t == "function") queueMicrotask(() => {
				this._tokenization === n && this._tokenizeToEnd(t, !0);
			});
			else {
				let e = [], t;
			...
			this._tokenization === n && this._input !== null && e.length !== 0 && (this._pendingBuffer &&= (e = On.Buffer.concat([this._pendingBuffer, e]), null), e[e.length - 1] & 128 ? this._pendingBuffer = e : (this._input === void 0 ? this._input = this._readStartingBom(typeof e == "string" ? e : e.toString()) : this._input += e, this._tokenizeToEnd(t, !1)));
		}), e.on("end", () => {
			this._tokenization === n && typeof this._input == "string" && this._tokenizeToEnd(t, !0);
		}), e.on("error", (e) => {
			this._tokenization === n && t(e);
		});
	}
}, { rdf: Gn, xsd: Kn } = Mn, qn, q = 0, Jn = {
	namedNode: X,
	blankNode: $n,
	variable: tr,
	literal: er,
	...
	get datatype() {
		return new J(this.datatypeString);
	}
	get datatypeString() {
		let e = this.id, t = e.lastIndexOf("\"") + 1, n = t < e.length ? e[t] : "";
		return n === "^" ? e.substr(t + 2) : n === "@" ? e.indexOf("--", t) > 0 ? Gn.dirLangString : Gn.langString : Kn.string;
	}
	equals(t) {
...
qn = new class extends Yn {
	constructor() {
		return super(""), qn || this;
	}
	get termType() {
		return "DefaultGraph";
	}
...
var Qn = class extends Yn {
	constructor(e, t, n, r) {
		super(""), this._subject = e, this._predicate = t, this._object = n, this._graph = r || qn;
	}
	get termType() {
		return "Quad";
	}
...
function $n(e) {
	return new Xn(e || `n3-${q++}`);
}
function er(e, t) {
	if (typeof t == "string") return new Y(`"${e}"@${t.toLowerCase()}`);
	if (t !== void 0 && !("termType" in t)) return new Y(`"${e}"@${t.language.toLowerCase()}${t.direction ? `--${t.direction.toLowerCase()}` : ""}`);
	let n = t ? t.value : "";
	return n === "" && (typeof e == "boolean" ? n = Kn.boolean : typeof e == "number" ? Number.isFinite(e) ? n = Number.isInteger(e) ? Kn.integer : Kn.double : (n = Kn.double, Number.isNaN(e) || (e = e > 0 ? "INF" : "-INF")) : e instanceof Date && !Number.isNaN(e.getTime()) && (n = Kn.dateTime, e = e.toISOString())), n === "" || n === Kn.string ? new Y(`"${e}"`) : new Y(`"${e}"^^${n}`);
}
function tr(e) {
	return new Zn(e);
}
...
function rr(e, t, n, r) {
	return new Qn(e, t, n, r);
}
function ir(e) {
	if (e instanceof Yn) return e;
	switch (e.termType) {
		case "NamedNode": return X(e.value);
		case "BlankNode": return $n(e.value);
		case "Variable": return tr(e.value);
		case "DefaultGraph": return qn;
		case "Literal": return er(e.value, e.language || e.datatype);
		case "Quad": return Z(e);
...
function Z(e) {
	...
	return rr(ir(e.subject), ir(e.predicate), ir(e.object), ir(e.graph));
}
//#endregion
//#region node_modules/n3/src/N3Parser.js
var ar = 0, or = class e {
	constructor(e) {
		this._contextStack = [], this._graph = null, e ||= {}, this._setBase(e.baseIRI), e.factory && cr(this, e.factory);
	...
	_saveContext(e, t, n, r, i) {
		...
		e === "formula" && (a.prefixes = this._prefixes, a.base = [
			this._base,
			this._basePath,
			this._baseRoot,
			this._baseScheme
		], this._prefixes = Object.create(this._prefixes)), this._contextStack.push(a), this._inversePredicate = !1, this._expectOf = !1, this._prefixes._ = this._graph ? `${this._graph.value}.` : ".", this._quantified = Object.create(this._quantified), e === "formula" && (this._subject = null, this._emptyFormula = !0);
	}
	_restoreContext(e, t) {
		let n = this._contextStack.pop();
		if (!n || n.type !== e) return this._error(`Unexpected ${t.type}`, t);
		this._subject = n.subject, this._predicate = n.predicate, this._object = n.object, this._graph = n.graph, this._n3Mode && (this._inversePredicate = n.inverse, this._expectOf = n.expectOf, e === "formula" ? (this._prefixes = n.prefixes, [this._base, this._basePath, this._baseRoot, this._baseScheme] = n.base) : this._prefixes._ = n.blankPrefix, this._quantified = n.quantified, this._emptyFormula = n.emptyFormula);
	}
	...
	_completeLiteral(e, t) {
		...
		switch (e.type) {
			...
			case "typeIRI":
				...
				if (i === void 0) return;
				if (i.value === Mn.rdf.langString || i.value === Mn.rdf.dirLangString) return this._error("Detected illegal (directional) languaged-tagged string with explicit datatype", e);
	...
	_readPunctuation(e) {
		...
		switch (e.type) {
			case "}":
				...
				this._graph = null;
			case ".":
				this._subject = null, this._tripleTerm = null, t = this._getStatementReader(), a && (this._inversePredicate = !1);
				break;
			case ";":
				a && (this._inversePredicate = !1), t = this._readPredicate;
				break;
			case ",":
				t = this._readObject;
				break;
			case "~":
				i !== null && (this._tripleTerm = null), t = this._readReifierInAnnotation, r = !0;
				break;
			case "{|":
				i !== null && (this._tripleTerm = null), this._subject = this._readTripleTerm(), this._inversePredicate = !1, this._validAnnotation = !1, r = !0, t = this._readPredicate;
				break;
			case "|}":
				...
				this._subject = null, this._annotation = !1, this._inversePredicate = !1, t = this._getContextEndReader();
				break;
			default:
	...
	_readBlankNodePunctuation(e) {
		...
		return this._subject === null ? this._error("Expected ] to follow annotation", e) : (this._emitCurrent(this._subject, this._predicate, this._object, this._graph), n && (this._inversePredicate = !1), t);
	}
	...
	_readReifierInAnnotation(e) {
		return e.type === "IRI" || e.type === "typeIRI" || e.type === "type" || e.type === "prefixed" || e.type === "blank" || e.type === "var" ? (this._reifier = this._readEntity(e), this._readAnnotationBlockOrPunctuation) : (this._readTripleTerm(), this._subject = null, this._getContextEndReader().call(this, e));
	}
	_readAnnotationBlockOrPunctuation(e) {
		if (e.type === "{|") return this._readPunctuation(e);
		switch (this._readTripleTerm(), this._annotation = !1, this._tripleTerm = null, e.type) {
	...
	_error(e, t) {
		...
		}, this._callback(r), this._callback = sr;
	}
	_resolveIRI(e) {
	...
	parse(e, t, n, r) {
		let i, a, o, s;
		if (t && (t.onQuad || t.onPrefix || t.onComment || t.onVersion) ? (i = t.onQuad, a = t.onPrefix, o = t.onComment, s = t.onVersion) : (i = t, a = n, s = r), this._readCallback = this._readBeforeTopContext, this._sparqlStyle = !1, this._prefixes = Object.create(null), this._prefixes._ = this._blankNodePrefix ? this._blankNodePrefix.substr(2) : `b${ar++}_`, this._n3Mode && this._implicitEmptyPrefix && this._base && (this._prefixes[""] = this._resolveIRI("#")), this._prefixCallback = a || sr, this._versionCallback = s || sr, this._inversePredicate = !1, this._expectOf = !1, this._quantified = Object.create(null), this._emptyFormula = !1, !i) {
			let t = [], n;
		...
		let c = (e, t) => {
			e === null ? this._readCallback &&= this._readCallback(t) : (this._callback(e), this._callback = sr);
		};
		o && (this._lexer.comments = !0, c = (e, t) => {
			e === null ? this._readCallback && (t.type === "comment" ? o(t.value) : this._readCallback = this._readCallback(t)) : (this._callback(e), this._callback = sr);
		}), this._callback = i, this._lexer.tokenize(e, c);
	}
};
function sr() {}
function cr(e, t) {
	e._factory = t, e.DEFAULTGRAPH = t.defaultGraph(), e.RDF_FIRST = t.namedNode(Mn.rdf.first), e.RDF_REST = t.namedNode(Mn.rdf.rest), e.RDF_NIL = t.namedNode(Mn.rdf.nil), e.RDF_REIFIES = t.namedNode(Mn.rdf.reifies), e.N3_FORALL = t.namedNode(Mn.r.forAll), e.N3_FORSOME = t.namedNode(Mn.r.forSome), e.N3_TRUE = t.literal("true", t.namedNode(Mn.xsd.boolean)), e.ABBREVIATIONS = {
		a: t.namedNode(Mn.rdf.type),
		"=": t.namedNode(Mn.owl.sameAs),
		">": t.namedNode(Mn.log.implies),
		"<": t.namedNode(Mn.log.isImpliedBy)
	}, e.QUANTIFIERS_GRAPH = t.namedNode("urn:n3:quantifiers");
}
//#endregion
//#region node_modules/rdflib/esm/rdfaparser.js
if (or.SUPPORTED_VERSIONS = [
	"1.2",
	"1.2-basic",
	"1.1"
], cr(or.prototype, Jn), lr === void 0) var lr = {
	ELEMENT_NODE: 1,
	ATTRIBUTE_NODE: 2,
	TEXT_NODE: 3,
...
var ur = class e {
	...
	addTriple(e, t, n, r) {
		var i = t === void 0 ? Fe.namedNode(this.options.base) : this.toRDFNodeObject(t), a, o = this.toRDFNodeObject(n), s;
		a = this.toRDFNodeObject(r), s = Fe.namedNode(this.options.base), this.kb.add(i, o, a, s);
	}
	ancestorPath(e) {
		for (var t = ""; e && e.nodeType !== lr.DOCUMENT_NODE;) t = "/" + e.localName + t, e = e.parentNode;
		return t;
	}
	copyMappings(e) {
		var t = {};
	...
	parsePrefixMappings(e, t) {
		for (var n = this.tokenize(e), r = null, i = 0; i < n.length; i++) n[i][n[i].length - 1] === ":" ? r = n[i].substring(0, n[i].length - 1) : r &&= (t[r] = this.options.base ? ke(n[i], this.options.base) : n[i], null);
	}
	...
	process(t, n) {
		n ||= {};
		var r;
		t.nodeType === lr.DOCUMENT_NODE ? (t.baseURI && !n.baseURI && (n.baseURI = t.baseURI), r = t.baseURI, t = t.documentElement, t.baseURI || (t.baseURI = r), this.setContext(t)) : t.parentNode.nodeType === lr.DOCUMENT_NODE && this.setContext(t);
		var i = [], a = function(e) {
		...
		for (i.push({
			...
			for (var w = 0; w < l.attributes.length; w++) {
				...
				if (T.nodeName.charAt(0) === "x" && T.nodeName.indexOf("xmlns:") === 0) {
					...
					h[E] = this.options.base ? ke(D, this.options.base) : D;
				}
			}
			...
			if (f && f !== u.parentObject && (v = {}, y = !0), p) {
				...
				if (k) for (let t = 0; t < oe.length; t++) this.addTriple(l, p, oe[t], {
					type: e.objectURI,
					value: f
				});
			} else {
				...
				if (k) for (let e = 0; e < oe.length; e++) _.push({
					predicate: oe[e],
					forward: !1
				});
			}
			if (ne) {
				var z = null, B = null;
				re ? (z = re.value === "" ? e.PlainLiteralURI : this.parseTermOrCURIEOrAbsURI(re.value, x, u.terms, h, r), B = j && !ie ? j.value : z === e.XMLLiteralURI || z === e.HTMLLiteralURI ? null : ie ? ie.value : l.textContent) : ie ? (z = e.PlainLiteralURI, B = ie.value) : j ? (B = j.value, z = e.deriveDateTimeType(B), z ||= e.PlainLiteralURI) : !te && !k && (P && (B = this.parseSafeCURIEOrCURIEOrURI(P.value, h, r)), !B && ae ? B = this.resolveAndNormalize(r, encodeURI(ae.value)) : !B && N && (B = this.resolveAndNormalize(r, encodeURI(N.value))), B && (z = e.objectURI)), z || (A && !M ? (z = e.objectURI, B = m) : (B = l.textContent, this.inHTMLMode && l.localName === "time" && (z = e.deriveDateTimeType(B)), z ||= e.PlainLiteralURI)), R = this.tokenize(ne.value);
				for (let t = 0; t < R.length; t++) {
					let n = this.parsePredicate(R[t], x, u.terms, h, r);
					if (n) {
						if (F) {
							let t = v[n];
							t || (t = [], v[n] = t), t.push(z === e.XMLLiteralURI || z === e.HTMLLiteralURI ? {
								type: z,
								value: l.childNodes
							} : {
								type: z || e.PlainLiteralURI,
								value: B,
								language: b
							});
						} else z === e.XMLLiteralURI || z === e.HTMLLiteralURI ? this.addTriple(l, f, n, {
							type: z,
							value: l.childNodes
			...
			var le = null, ue = f;
			d ? (le = this.push(u, u.subject), le.parentObject = a(l.parentNode.baseURI) === u.parentObject ? a(l.baseURI) : u.parentObject, le.incomplete = u.incomplete, le.language = b, le.prefixes = h, le.vocabulary = x) : (le = this.push(u, f), le.parentObject = p || f || u.subject, le.prefixes = h, le.incomplete = _, p && (ue = p, v = {}, y = !0), le.listMapping = v, le.language = b, le.vocabulary = x), y && i.unshift({
				parent: l,
				context: u,
				subject: ue,
				listMapping: v
			});
			for (var de = l.lastChild; de; de = de.previousSibling) de.nodeType === lr.ELEMENT_NODE && i.unshift({
				current: de,
				context: le
			});
		}
	...
	toRDFNodeObject(t) {
		if (t !== void 0) {
			if (typeof t == "string") return t.substring(0, 2) === "_:" ? (this.blankNodes[t.substring(2)] === void 0 && (this.blankNodes[t.substring(2)] = new N(t.substring(2))), this.blankNodes[t.substring(2)]) : Fe.namedNode(t);
			switch (t.type) {
				case e.objectURI: return t.value.substring(0, 2) === "_:" ? (this.blankNodes[t.value.substring(2)] === void 0 && (this.blankNodes[t.value.substring(2)] = new N(t.value.substring(2))), this.blankNodes[t.value.substring(2)]) : Fe.namedNode(t.value);
				case e.PlainLiteralURI: return new he(t.value, t.language || "");
				case e.XMLLiteralURI:
				case e.HTMLLiteralURI:
					var n = "";
					return Object.keys(t.value).forEach((e) => {
						n += et(t.value[e], this.htmlOptions);
					}), new he(n, "", new H(t.type));
				default: return new he(t.value, "", new H(t.type));
			}
		}
	}
	trim(e) {
...
ur.XMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#XMLLiteral", ur.HTMLLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#HTML", ur.PlainLiteralURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#PlainLiteral", ur.objectURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#object", ur.typeURI = "http://www.w3.org/1999/02/22-rdf-syntax-ns#type", ur.nameChar = "[-A-Z_a-zÀ-ÖØ-öø-˿Ͱ-ͽͿ-῿‌-‍⁰-↏Ⰰ-⿯、-퟿豈-﷏ﷰ-�က0-F.0-9·̀-ͯ‿-⁀]", ur.nameStartChar = "[A-Za-zÀ-ÖØ-öø-ÿĀ-ıĴ-ľŁ-ňŊ-žƀ-ǃǍ-ǰǴ-ǵǺ-ȗɐ-ʨʻ-ˁΆΈ-ΊΌΎ-ΡΣ-ώϐ-ϖϚϜϞϠϢ-ϳЁ-ЌЎ-яё-ќў-ҁҐ-ӄӇ-ӈӋ-ӌӐ-ӫӮ-ӵӸ-ӹԱ-Ֆՙա-ֆא-תװ-ײء-غف-يٱ-ڷں-ھۀ-ێې-ۓەۥ-ۦअ-हऽक़-ॡঅ-ঌএ-ঐও-নপ-রলশ-হড়-ঢ়য়-ৡৰ-ৱਅ-ਊਏ-ਐਓ-ਨਪ-ਰਲ-ਲ਼ਵ-ਸ਼ਸ-ਹਖ਼-ੜਫ਼ੲ-ੴઅ-ઋઍએ-ઑઓ-નપ-રલ-ળવ-હઽૠଅ-ଌଏ-ଐଓ-ନପ-ରଲ-ଳଶ-ହଽଡ଼-ଢ଼ୟ-ୡஅ-ஊஎ-ஐஒ-கங-சஜஞ-டண-தந-பம-வஷ-ஹఅ-ఌఎ-ఐఒ-నప-ళవ-హౠ-ౡಅ-ಌಎ-ಐಒ-ನಪ-ಳವ-ಹೞೠ-ೡഅ-ഌഎ-ഐഒ-നപ-ഹൠ-ൡก-ฮะา-ำเ-ๅກ-ຂຄງ-ຈຊຍດ-ທນ-ຟມ-ຣລວສ-ຫອ-ຮະາ-ຳຽເ-ໄཀ-ཇཉ-ཀྵႠ-Ⴥა-ჶᄀᄂ-ᄃᄅ-ᄇᄉᄋ-ᄌᄎ-ᄒᄼᄾᅀᅌᅎᅐᅔ-ᅕᅙᅟ-ᅡᅣᅥᅧᅩᅭ-ᅮᅲ-ᅳᅵᆞᆨᆫᆮ-ᆯᆷ-ᆸᆺᆼ-ᇂᇫᇰᇹḀ-ẛẠ-ỹἀ-ἕἘ-Ἕἠ-ὅὈ-Ὅὐ-ὗὙὛὝὟ-ώᾀ-ᾴᾶ-ᾼιῂ-ῄῆ-ῌῐ-ΐῖ-Ίῠ-Ῥῲ-ῴῶ-ῼΩK-Å℮ↀ-ↂぁ-ゔァ-ヺㄅ-ㄬ가-힣一-龥〇〡-〩_]", ur.NCNAME = RegExp("^" + ur.nameStartChar + ur.nameChar + "*$"), ur.dateTimeTypes = [
	{
...
var dr = ur.parseRDFaDOM, fr = class e {
	constructor(e) {
	...
	frameFactory(t, n, r) {
		return {
			...
			addSymbol: function(e, t) {
				t = ke(t, this.base), this.node = this.store.sym(t), this.nodeType = e;
			},
			loadTriple: function() {
				if (this.parent.parent.collection ? this.parent.parent.node.append(this.node) : this.store.add(this.parent.parent.node, this.parent.node, this.node, this.parser.why), this.parent.rdfid != null) {
					var t = this.store.sym(ke("#" + this.parent.rdfid, this.base));
		...
		for (var n, r = function(e) {
			...
			if (a.nodeType === e.nodeType.TEXT || a.nodeType === e.nodeType.CDATA_SECTION) t.parent.nodeType === t.NODE && (t.addArc(e.ns.RDF + "value"), t = this.buildFrame(t)), t.addLiteral(a.nodeValue);
				...
				if (t.parent && t.parent.collection && (t.addCollectionArc(), t = this.buildFrame(t, t.element), t.parent.element = null), !t.parent || !t.parent.nodeType || t.parent.nodeType === t.ARC) {
					...
					e.ns.RDF + "Description" !== r(a) && (l = { nodeValue: r(a) }), l != null && (this.store.add(t.node, this.store.sym(e.ns.RDF + "type"), this.store.sym(ke(l.nodeValue, t.base)), this.why), l.nodeName && a.removeAttributeNode(l));
	...
	buildFrame(t, n) {
		...
		for (var s = i.length - 1; s >= 0; s--) if (i[s].nodeName.substr(0, 3) === "xml") {
			if (i[s].name.slice(0, 6) === "xmlns:") {
				var c = i[s].nodeValue;
				this.base && (c = ke(c, this.base)), this.store.setPrefixForURI(i[s].name.slice(6), c);
			}
...
function pr(e, t, n) {
	var r, i, a, o = [
		...
		"DELETE",
		"WHERE"
	], s = Ie("http://www.w3.org/ns/pim/patch#"), c = hn(t, t, n, n, null, null, "", null), l = {}, u = function(e, t, n, r, i) {
...
function mr(e, t, n, r = "text/turtle", i) {
	r ||= "text/turtle", r = r.split(";")[0];
	try {
		if (r === "text/n3" || r === "text/turtle" || r === "application/n-triples") hn(t, t, n, n, null, null, "", null).loadBuf(e), o();
		else if (r === "application/rdf+xml") new fr(t).parse(ot(e), n, t.sym(n)), o();
		else if (r === "application/xhtml+xml") dr(ot(e, { contentType: M }), t, n), o();
		else if (r === "text/html") dr(ot(e, { contentType: D }), t, n), o();
		else if (r === "application/sparql-update" || r === "application/sparql-update-single-match") pr(e, t, n), o();
		else if (r === "application/ld+json") Sn(e, t, n).then(o).catch(s);
		else if (r === "application/n-quads" || r === "application/nquads") {
			var a = new or({ factory: vn });
			c(null, e);
...
var hr = /* @__PURE__ */ u((/* @__PURE__ */ s(((e, t) => {
	...
	link: Ie("http://www.w3.org/2007/ont/link#", e),
	http: Ie("http://www.w3.org/2007/ont/http#", e),
	httph: Ie("http://www.w3.org/2007/ont/httph#", e),
	rdf: Ie("http://www.w3.org/1999/02/22-rdf-syntax-ns#", e),
	rdfs: Ie("http://www.w3.org/2000/01/rdf-schema#", e),
	dc: Ie("http://purl.org/dc/elements/1.1/", e),
	ldp: Ie("http://www.w3.org/ns/ldp#", e)
}), yr = vr(), br = class {
	constructor(e, t) {
...
xr.pattern = /* @__PURE__ */ RegExp("application/rdf\\+xml");
var Sr = class extends br {
	...
	parse(e, t, n) {
		...
		for (let e = 0; e < c.length; e++) {
			...
			gr[t] && (mr(c[e].textContent, a, n.original.value, t), mr(c[e].textContent, a, n.original.value, t));
		}
		if (n.noMeta || a.add(n.resource, yr.rdf("type"), yr.link("WebPage"), e.appNode), !n.noRDFa && dr) try {
			dr(this.dom, a, n.original.value);
		} catch (t) {
	...
	parse(t, n, r) {
		...
		for (let a = 0; a < i.childNodes.length; a++) {
			...
			if (e.isElement(o)) {
				...
				if (e && e === e.rdf) return t.addStatus(r.req, "Has XML root element in the RDF namespace, so assume RDF/XML."), new xr(this.response, i).parse(t, n, r);
				break;
			}
		}
...
var wr = class extends br {
	...
	parse(e, t, n) {
		let r = e.store;
		if (Ar(t)) return e.addStatus(n.req, "Has an XML declaration. We'll assume it's XHTML as the content-type was text/html.\n"), new Sr(this.response).parse(e, t, n);
		if (kr(t)) return e.addStatus(n.req, "Has XHTML DOCTYPE. Switching to XHTMLHandler.\n"), new Sr(this.response).parse(e, t, n);
		if (jr(t)) return e.addStatus(n.req, "Has default namespace for XHTML, so switching to XHTMLHandler.\n"), new Sr(this.response).parse(e, t, n);
...
wr.pattern = /* @__PURE__ */ RegExp("text/html");
var Tr = class extends br {
	...
	async parse(e, t, n, r) {
		let i = e.store;
		try {
			return await Sn(t, i, n.original.value), e.store.add(n.original, yr.rdf("type"), yr.link("RDFDocument"), e.appNode), e.doneFetch(n, r);
		} catch (t) {
...
Tr.pattern = /application\/(ld\+json|activity\+json)/;
...
var Dr = class extends br {
	...
	parse(e, t, n, r) {
		let i = e.store, a = hn(i, i, n.original.value, n.original.value, null, null, "", null);
		try {
			a.loadBuf(t);
		} catch (t) {
...
var Mr = class e {
	constructor(e, t = {}) {
		g(this, "store", void 0), g(this, "timeout", void 0), g(this, "_fetch", void 0), g(this, "mediatypes", void 0), g(this, "appNode", void 0), g(this, "requested", void 0), g(this, "timeouts", void 0), g(this, "redirectedTo", void 0), g(this, "fetchQueue", void 0), g(this, "fetchCallbacks", void 0), g(this, "nonexistent", void 0), g(this, "lookedUp", void 0), g(this, "handlers", void 0), g(this, "ns", void 0), g(this, "fireCallbacks", void 0), this.store = e || new At(), this.ns = vr(this.store.rdfFactory), this.timeout = t.timeout || 3e4;
		let n = t.fetch || typeof global < "u" && (global.solidFetcher || global.solidFetch) || typeof window < "u" && (window.solidFetcher || window.solidFetch) || hr.default;
		...
		this._fetch = typeof window < "u" && n === window.fetch ? n.bind(window) : typeof global < "u" && n === global.fetch ? n.bind(global) : n, this.appNode = this.store.sym("chrome://TheCurrentSession"), this.store.fetcher = this, this.requested = {}, this.timeouts = {}, this.redirectedTo = {}, this.fetchQueue = {}, this.fetchCallbacks = {}, this.nonexistent = {}, this.lookedUp = {}, this.handlers = [], this.mediatypes = {
			...
			"retract",
			"done"
		]), Object.keys(t.handlers || Or).map((e) => this.addHandler(Or[e]));
	}
	...
	nowOrWhenFetched(e, t, n, r = {}) {
		let i = P(e);
		typeof t == "function" ? n = t : t === void 0 || (le(t) ? r.referringTerm = t : r = t), this.load(i, r).then((e) => {
			if (n) {
				if (e) {
					if (e.ok) n(!0, "OK", e);
					else {
	...
	addStatus(e, t) {
		...
		I(i) ? i.append(r.rdfFactory.literal(t)) : U.warn("web.js: No list to add to: " + i + "," + t);
	}
	failFetch(e, t, n, r) {
		...
		(i === "GET" || i === "HEAD") && (e.resource.equals(e.original), this.requested[Ee(e.original.value)] = n, this.fireCallbacks("fail", [e.original.value, t]));
		var a = /* @__PURE__ */ Error("Fetcher: " + t);
		return a.status = n, a.statusText = t, a.response = r, Promise.reject(a);
	}
	linkData(e, t, n, r, i) {
		if (!n) return;
		let a = this.store, o = a.rdfFactory.namedNode(ke(n, e.value)), s;
	...
	ianaLinkRelation(e) {
		return ke(encodeURIComponent(e), "http://www.iana.org/assignments/link-relations/");
	}
	...
	putBack(e, t = {}) {
		...
		return t.contentType = t["content-type"] || t["Content-Type"] || t.contentType || "text/turtle", t.contentType === "application/ld+json" ? new Promise((n, i) => {
			gt(r, this.store, r.uri, t.contentType, (r, a) => {
				r ? i(r) : (t.data = a, this.webOperation("PUT", e, t).then((e) => n(e)).catch((e) => i(e)));
			});
		}) : (t.data = gt(r, this.store, r.value, t.contentType), this.webOperation("PUT", n, t));
	}
	webCopy(e, t, n) {
	...
	lookUpThing(e, t) {
		...
		return n = n.map((e) => Ee(e)), n.forEach((e) => {
			this.lookedUp[e] = !0;
	...
	saveRequestMetadata(e, t) {
		...
		this.addStatus(t.req, "Accept: " + t.headers.accept), le(i) && r.add(r.rdfFactory.namedNode(e), this.ns.link("requestedBy"), i, this.appNode), t.original && t.original.value !== e && r.add(n, this.ns.link("orginalURI"), r.rdfFactory.literal(t.original.value), this.appNode);
	...
	saveResponseMetadata(e, t) {
		...
		return n.add(t.req, this.ns.link("response"), r, this.appNode), n.add(r, this.ns.http("status"), n.rdfFactory.literal(e.status), this.appNode), n.add(r, this.ns.http("statusText"), n.rdfFactory.literal(e.statusText), this.appNode), e.headers.forEach((e, i) => {
			n.add(r, this.ns.httph(i), this.store.rdfFactory.literal(e), this.appNode), i === "content-type" && n.add(t.resource, this.ns.rdf("type"), n.rdfFactory.namedNode(Xe(e).value), this.appNode);
		}), r;
	}
	objectRefresh(e) {
		let t = this.store.uris(e);
		if (t !== void 0) for (let e = 0; e < t.length; e++) this.refresh(this.store.rdfFactory.namedNode(Ee(t[e])));
	}
	refresh(e, t) {
	...
	retract(e) {
		this.store.removeMany(void 0, void 0, void 0, e), e.value && delete this.requested[Ee(e.value)], this.fireCallbacks("retract", arguments);
	}
	getState(e) {
	...
	handleResponse(e, t, n) {
		...
		var l = null, u = null;
		if (c && (u = ke(c, t), u !== t && (l = u)), e.status === 200) {
...
g(Mr, "HANDLERS", void 0), g(Mr, "CONTENT_TYPE_BY_EXT", void 0), g(Mr, "crossSiteProxyTemplate", void 0), Mr.HANDLERS = Or, Mr.CONTENT_TYPE_BY_EXT = _r;
//#endregion
...
function Pr(e, t, n) {
	...
	function v(e) {
		for (var t = [], r = 0; r < e.length; r++) {
			...
			e[r] = s(e[r]), o(e[r]) ? t[r] = i(e[r].slice(1)) : l(e[r]) ? (U.info(e[r] + " was identified as a bnode."), t[r] = n.bnode()) : c(e[r]) ? (U.info(e[r] + " was identified as a symbol."), t[r] = n.sym(m(e[r]))) : d(e[r]) ? (U.info(e[r] + " was identified as a prefixed symbol"), ne[f(e[r])] ? t[r] = n.sym(e[r] = ne[f(e[r])] + p(e[r])) : (U.error("SPARQL error: " + e[r] + " with prefix " + f(e[r]) + " does not have a correct prefix entry."), t[r] = e[r])) : t[r] = e[r];
		}
		return t;
	}
	function y(e) {
	...
	function ee(e, t) {
		...
		U.debug("WHERE after filters and optionals: " + n), te(n, t);
	}
	function te(e, t) {
		var n = [,];
		n[0] = -1;
	...
	U.info("SPARQL input: \n" + e);
	var k = new wt(), A = y(e), ne = C(A);
	ne.rdf ||= "http://www.w3.org/1999/02/22-rdf-syntax-ns#", ne.rdfs ||= "http://www.w3.org/2000/01/rdf-schema#";
	var re = b("SELECT", A), j = b("WHERE", A);
	if (re < 0 || j < 0 || re > j) return U.error("Invalid or nonexistent SELECT and WHERE tags in SPARQL query"), !1;
...
var Fr = class {
	constructor(e) {
		if (g(this, "store", void 0), g(this, "ifps", void 0), g(this, "fps", void 0), g(this, "patchControl", void 0), g(this, "ns", void 0), e ||= new At(), e.updater) throw Error("You can't have two UpdateManagers for the same store");
		e.fetcher || (e.fetcher = new Mr(e)), this.store = e, e.updater = this, this.ifps = {}, this.fps = {}, this.ns = {}, this.ns.link = Ie("http://www.w3.org/2007/ont/link#"), this.ns.http = Ie("http://www.w3.org/2007/ont/http#"), this.ns.httph = Ie("http://www.w3.org/2007/ont/httph#"), this.ns.ldp = Ie("http://www.w3.org/ns/ldp#"), this.ns.rdf = Ie("http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.ns.rdfs = Ie("http://www.w3.org/2000/01/rdf-schema#"), this.ns.rdf = Ie("http://www.w3.org/1999/02/22-rdf-syntax-ns#"), this.ns.owl = Ie("http://www.w3.org/2002/07/owl#"), this.patchControl = [];
	}
	patchControlFor(e) {
	...
	editable(e, t) {
		...
		for (var a = t.each(void 0, this.ns.link("requestedURI"), Ee(e), i), o, s = 0; s < a.length; s++) if (n = a[s], n !== void 0) {
	...
	updateDav(e, t, n, r, i = {}) {
		...
		for (let e = 0; e < t.length; e++) st(l, t[e]);
		for (let e = 0; e < n.length; e++) l.push(n[e]);
		let u = this.serialize(e.value, l, c);
		var d = a.the(s, this.ns.httph("content-location")), f;
		return d && (f = ke(d.value, f)), i.contentType = c, i.noMeta = !0, i.body = u, a.fetcher.webOperation("PUT", f, i).then((i) => {
	...
	updateLocalFile(e, t, n, r, i = {}) {
		...
		for (let e = 0; e < t.length; e++) st(o, t[e]);
		...
		let l = Mr.CONTENT_TYPE_BY_EXT[c];
	...
	graph(e = void 0, t = void 0) {
		return new At(e, t || { rdfFactory: vn });
	},
	lit(e, t, n) {
	...
	onUpdate(e, t) {
		return this.fetcher.refresh(Ir.namedNode(e));
	}
	register(e, t) {
		return this.via[e] ?? (this.via[e] = new Lr(this, e)), this.via[e].subscribe(t);
	}
}, zr = /* @__PURE__ */ c({
	BlankNode: () => N,
	Collection: () => _e,
...
for (let e in Ir) typeof Ir[e] == "function" && (Br[e] = Ir[e].bind(Ir));
var { fetcher: Q, graph: Vr, lit: Hr, st: Ur, namedNode: Wr, variable: Gr, blankNode: Kr, defaultGraph: qr, literal: Jr, quad: Yr, triple: Xr } = Br, Zr = new xt(), Qr = (e) => Zr.fromNT(e), $r = St.fromValue, ei = N.nextId, $ = class extends At {
	constructor(e) {
		super(e), g(this, "fetcher", void 0), this.fetcher = new Mr(this, {});
	}
}, ti = class extends $ {
	constructor(e) {
		super(e), g(this, "updater", void 0), this.updater = new Fr(this);
	}
}, ni = (0, f.default)(zr);
//#endregion
...
var ai = (e) => e.isActive === !0 || e.isActive === void 0 && !!e.webId, oi = 2e3, si = /* @__PURE__ */ new WeakMap(), ci = /* @__PURE__ */ new WeakMap(), li = (e) => {
	...
	}, t.raw = pi(t), si.set(e, t)), t;
};
function ui(e) {
	return typeof e != "object" || !e ? !1 : si.get(e)?.cleared === !0;
}
function di(e) {
	return ui(e) ? !0 : e?.isActive === !1 || e?.info?.isLoggedIn === !1;
}
function fi(e) {
	return !di(e) && ai(e);
}
var pi = (e) => e.cleared ? { isActive: !1 } : {
	isActive: ai(e.session),
	webId: e.session.webId
};
function mi(e) {
	let t = li(e);
	return t ? fi(e) ? e.webId === void 0 ? { source: "none" } : {
		webId: e.webId,
		source: "session"
...
function vi(e) {
	e.cleared && ai(e.session) && (e.cleared = !1), fi(e.session) && (e.cookieWebId = null);
	let t = pi(e), n = ri(e.raw, t), r = ii(e.raw, t), i = n !== null || r;
	if (e.raw = t, !i) return;
	e.version += 1;
	let a = [];
	n && a.push(n), r && a.push("identityReplaced"), _i(e, a);
}
function yi(e) {
	if (e.cleared) return;
	let t = e.raw.isActive, n = e.raw.webId !== void 0;
	if (!t || !n) {
		e.raw = pi(e), t && (e.version += 1, _i(e, ["logout"]));
		return;
	}
	e.cleared = !0, e.raw = pi(e), e.version += 1, _i(e, ["logout", "identityReplaced"]);
}
function bi(e, t) {
...
async function xi(e) {
	...
	let n = t, r = bi(e, () => n()), i = () => r.id !== e.attemptId || e.version !== r.version, a = () => ai(e.session) === r.raw.isActive && e.session.webId === r.raw.webId, o, s = !1, c = r.promise.then((e) => {
		o = e, s = !0;
	}, () => {
		s = !0;
	}), l = () => {
...
function Ci(e) {
	...
	typeof n != "function" || e.watchingTokenUpdates || (e.watchingTokenUpdates = !0, t.setTokenDetails = (...r) => {
		...
		return o && typeof o.then == "function" ? o.then((t) => (a() && vi(e), t), (t) => {
			throw a() && vi(e), t;
		}) : (a() && vi(e), o);
	});
}
function wi(e, t = {}) {
	...
	let r = { ...t };
	n.subscribers.add(r), n.listenerAttached || (n.listenerAttached = !0, typeof e.addEventListener == "function" && e.addEventListener("sessionStateChange", () => vi(n)), Ci(n));
	let i = typeof document > "u" ? void 0 : document;
	if (n.subscribers.size === 1 && i && typeof i.addEventListener == "function") {
		let e = () => {
			i.visibilityState === "visible" && (xi(n), n.subscribers.forEach((e) => {
				e.onRefocus?.();
			}));
		};
...
function Ti(e, t) {
	if (e.cookieWebId === t || fi(e.session)) return;
	let n = e.cookieWebId !== null;
	e.cookieWebId = t;
	let r = ["sessionChange"];
	n && r.push("identityReplaced"), _i(e, r);
}
function Ei(e, t = () => {
...
var Di = (0, f.default)(zr), Oi = Wr("http://www.iana.org/assignments/link-relations/acl");
function ki(e) {
	let t = Di;
	async function n(t) {
	...
	function i(t) {
		...
		return n.load(t).then((n) => {
			...
			let r = e.any(e.sym(t), Oi);
			if (!r) throw Error("fetchACLRel: No Link rel=ACL header for " + t);
			return r;
		});
	}
	function a(e, n, r, i = {}) {
		let a = i.public || [], o = Vr(), s = Ie("http://www.w3.org/ns/auth/acl#"), c = o.sym(`${r}#a1`), l = o.sym(r), u = o.sym(e);
...
function Ni() {
	...
	if (e !== void 0 && e.username) return Ai("Assuming the user is " + e.username), Wr(e.username);
	if (typeof document < "u" && document.location && ("" + document.location).slice(0, 16) === "http://localhost") {
		...
		return t ? (Ai("Assuming user is " + t), Wr(t)) : null;
	}
	return null;
}
//#endregion
...
}, Fi = class extends Pi {}, Ii = class extends Pi {}, Li = class extends Pi {}, Ri = class extends Pi {}, zi = class extends Pi {}, Bi = class extends Pi {
	constructor(e, t) {
...
function Wi(e) {
	return Wr(e.uri.replace("/profile/", "/").replace("/public/", "/").split("/").slice(0, -1).join("/") + "/settings/prefs.ttl");
}
function Gi(e, t) {
	return new H(new URL(`IndividualChats/${new URL(e.value).host}/`, t.value).toString());
}
//#endregion
...
function Ji(e, t, n, r) {
	...
	async function s(t, a) {
		...
		try {
			...
			if (n) s = n;
				...
				try {
					...
					ji(`User ${t} has no usable profile document directory for publicTypeIndex.`);
				}
				e && (s = await r.followOrCreateLinkWithContentOnCreate(t, i.solid("publicTypeIndex"), e, o, Ki()));
			}
		} catch (e) {
			ji(`User ${t} has no pointer in profile to publicTypeIndex file: ${e}`);
		}
		let c = s ? [{
			label: "public",
			index: s,
		...
		if (l) {
			...
			if (a) try {
				...
				ji(`User ${t} has no usable preferences document directory for privateTypeIndex.`);
			}
			let s = null;
			try {
				let c = e.any(t, i.solid("privateTypeIndex"), void 0, o);
				c ? s = c : a && n && (s = await r.followOrCreateLinkWithContentOnCreate(t, i.solid("privateTypeIndex"), n, l, qi()));
			} catch (e) {
				ji(`User ${t} has no pointer in preference file to privateTypeIndex file: ${e}`);
			}
			u = s ? [{
				label: "private",
				index: s,
		...
		try {
			...
			ji("Problems loading type index: ", e);
		}
		return d;
	}
	async function c(e) {
	...
	async function u(t) {
		...
		try {
			...
			ji(`User ${t} has no pointer in profile to preferences file.`);
		}
		if (r) {
			...
			for (let e of n) {
				if (e.termType !== "NamedNode" || !a(e.uri)) {
					ji(`Skipping malformed community node for ${t}: ${e}`);
					continue;
				}
				try {
					o = o.concat(await c(e));
				} catch (t) {
					ji(`Skipping community type indexes for ${e.uri}: ${t}`);
				}
			}
			return o;
		}
	...
	function m(e) {
		...
		let r = t.uri;
		if (!r || !a(r)) return Ai(`docDirUri: missing or non-http(s) doc uri for ${e?.uri}`), null;
		let i = r.split("#")[0], o = i.lastIndexOf("/");
		return o === -1 ? (Ai(`docDirUri: no slash in doc uri ${r}`), null) : i.slice(0, o + 1);
	}
	function h(e) {
		let t = m(e);
		if (!t) throw Error(`suggestPublicTypeIndex: Cannot derive directory for ${e.uri}`);
		return Wr(t + "publicTypeIndex.ttl");
	}
	function g(e) {
		let t = m(e);
		if (!t) throw Error(`suggestPrivateTypeIndex: Cannot derive directory for ${e.uri}`);
		return Wr(t + "privateTypeIndex.ttl");
	}
	async function _(t, n, r) {
		let a = Vi(n), o = [
			Ur(a, i.rdf("type"), i.solid("TypeRegistration"), n),
			Ur(a, i.solid("forClass"), r, n),
			Ur(a, i.solid("instance"), t, n)
		];
		try {
...
var Yi = crypto, Xi = (e) => e instanceof CryptoKey, Zi = async (e, t) => {
	let n = `SHA-${e.slice(-3)}`;
	return new Uint8Array(await Yi.subtle.digest(n, t));
}, Qi = new TextEncoder(), $i = new TextDecoder();
function ea(...e) {
...
oa.code = "ERR_JWT_CLAIM_VALIDATION_FAILED";
...
ga.code = "ERR_JWKS_NO_MATCHING_KEY";
...
ya.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
function ba(e, t = "algorithm.name") {
...
function Ta(e, t, ...n) {
	switch (t) {
		...
		case "HS384":
		case "HS512": {
			if (!xa(e.algorithm, "HMAC")) throw ba("HMAC");
			let n = parseInt(t.slice(2), 10);
			if (Sa(e.algorithm.hash) !== n) throw ba(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "RS256":
		case "RS384":
		case "RS512": {
			if (!xa(e.algorithm, "RSASSA-PKCS1-v1_5")) throw ba("RSASSA-PKCS1-v1_5");
			let n = parseInt(t.slice(2), 10);
			if (Sa(e.algorithm.hash) !== n) throw ba(`SHA-${n}`, "algorithm.hash");
			break;
		}
		...
		case "PS384":
		case "PS512": {
			if (!xa(e.algorithm, "RSA-PSS")) throw ba("RSA-PSS");
			let n = parseInt(t.slice(2), 10);
			if (Sa(e.algorithm.hash) !== n) throw ba(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "EdDSA":
			if (e.algorithm.name !== "Ed25519" && e.algorithm.name !== "Ed448") throw ba("Ed25519 or Ed448");
			break;
		case "Ed25519":
			if (!xa(e.algorithm, "Ed25519")) throw ba("Ed25519");
			break;
		case "ES256":
		case "ES384":
		case "ES512": {
			if (!xa(e.algorithm, "ECDSA")) throw ba("ECDSA");
			let n = Ca(t);
			if (e.algorithm.namedCurve !== n) throw ba(n, "algorithm.namedCurve");
			break;
		}
...
var Da = (e, ...t) => Ea("Key must be ", e, ...t);
function Oa(e, t, ...n) {
	return Ea(`Key for the ${e} algorithm must be `, t, ...n);
}
var ka = (e) => Xi(e) ? !0 : e?.[Symbol.toStringTag] === "KeyObject", Aa = ["CryptoKey"], ja = (...e) => {
...
function Na(e) {
	if (!Ma(e) || Object.prototype.toString.call(e) !== "[object Object]") return !1;
...
function Fa(e) {
	return Na(e) && typeof e.kty == "string";
}
function Ia(e) {
...
function Ra(e) {
	return Fa(e) && e.kty === "oct" && typeof e.k == "string";
}
function za(e) {
	let t, n;
	switch (e.kty) {
		case "RSA":
			switch (e.alg) {
				...
				case "RSA-OAEP-512":
					...
					break;
				default: throw new la("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
			}
			break;
		case "EC":
			switch (e.alg) {
		...
		case "OKP":
			...
			break;
		default: throw new la("Invalid or unsupported JWK \"kty\" (Key Type) Parameter value");
	}
	return {
		algorithm: t,
		keyUsages: n
...
var Ba = async (e) => {
	...
	let { algorithm: t, keyUsages: n } = za(e), r = [
		t,
		e.ext ?? !1,
		e.key_ops ?? n
	], i = { ...e };
	return delete i.alg, delete i.use, Yi.subtle.importKey("jwk", i, ...r);
}, Va = (e) => ia(e), Ha, Ua, Wa = (e) => e?.[Symbol.toStringTag] === "KeyObject", Ga = async (e, t, n, r, i = !1) => {
	let a = e.get(t);
	if (a?.[r]) return a[r];
	let o = await Ba({
		...n,
	...
	normalizePublicKey: (e, t) => {
		if (Wa(e)) {
			...
			return delete n.d, delete n.dp, delete n.dq, delete n.p, delete n.q, delete n.qi, n.k ? Va(n.k) : (Ua ||= /* @__PURE__ */ new WeakMap(), Ga(Ua, e, n, t));
		}
		return Fa(e) ? e.k ? ia(e.k) : (Ua ||= /* @__PURE__ */ new WeakMap(), Ga(Ua, e, e, t, !0)) : e;
	},
	normalizePrivateKey: (e, t) => {
		if (Wa(e)) {
			let n = e.export({ format: "jwk" });
			return n.k ? Va(n.k) : (Ha ||= /* @__PURE__ */ new WeakMap(), Ga(Ha, e, n, t));
		}
		return Fa(e) ? e.k ? ia(e.k) : (Ha ||= /* @__PURE__ */ new WeakMap(), Ga(Ha, e, e, t, !0)) : e;
	}
};
async function qa(e, t) {
	if (!Na(e)) throw TypeError("JWK must be an object");
	switch (t ||= e.alg, e.kty) {
		case "oct":
			if (typeof e.k != "string" || !e.k) throw TypeError("missing \"k\" (Key Value) Parameter value");
			return ia(e.k);
		case "RSA": if ("oth" in e && e.oth !== void 0) throw new la("RSA JWK \"oth\" (Other Primes Info) Parameter value is not supported");
		case "EC":
		case "OKP": return Ba({
			...e,
			alg: t
		});
		default: throw new la("Unsupported \"kty\" (Key Type) Parameter value");
	}
}
var Ja = (e) => e?.[Symbol.toStringTag], Ya = (e, t, n) => {
	...
	if (!(t instanceof Uint8Array)) {
		...
		if (!ka(t)) throw TypeError(Oa(e, t, ...Aa, "Uint8Array", r ? "JSON Web Key" : null));
		if (t.type !== "secret") throw TypeError(`${Ja(t)} instances for symmetric algorithms must be of type "secret"`);
	}
}, Za = (e, t, n, r) => {
	if (r && Fa(t)) switch (n) {
		case "sign":
			if (Ia(t) && Ya(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a private JWK");
		case "verify":
			if (La(t) && Ya(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a public JWK");
	}
	if (!ka(t)) throw TypeError(Oa(e, t, ...Aa, r ? "JSON Web Key" : null));
	if (t.type === "secret") throw TypeError(`${Ja(t)} instances for asymmetric algorithms must not be of type "secret"`);
	if (n === "sign" && t.type === "public") throw TypeError(`${Ja(t)} instances for asymmetric algorithm signing must be of type "private"`);
	if (n === "decrypt" && t.type === "public") throw TypeError(`${Ja(t)} instances for asymmetric algorithm decryption must be of type "private"`);
	if (t.algorithm && n === "verify" && t.type === "private") throw TypeError(`${Ja(t)} instances for asymmetric algorithm verifying must be of type "public"`);
	if (t.algorithm && n === "encrypt" && t.type === "private") throw TypeError(`${Ja(t)} instances for asymmetric algorithm encryption must be of type "public"`);
};
function Qa(e, t, n, r) {
	t.startsWith("HS") || t === "dir" || t.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(t) ? Xa(t, n, r, e) : Za(t, n, r, e);
}
Qa.bind(void 0, !1);
var $a = Qa.bind(void 0, !0);
function eo(e, t, n, r, i) {
	...
	for (let t of r.crit) {
		if (!a.has(t)) throw new la(`Extension Header Parameter "${t}" is not recognized`);
...
var to = (e, t) => {
	...
	if (!Xi(e)) throw TypeError(Da(e, ...Aa, "Uint8Array"));
	if (!e.extractable) throw TypeError("non-extractable CryptoKey cannot be exported as a JWK");
	let { ext: t, key_ops: n, alg: r, use: i, ...a } = await Yi.subtle.exportKey("jwk", e);
	return a;
};
async function ro(e) {
	return no(e);
...
function io(e, t) {
	...
	switch (e) {
		...
		default: throw new la(`alg ${e} is not supported either by JOSE or your javascript runtime`);
	}
}
async function ao(e, t, n) {
	if (n === "sign" && (t = await Ka.normalizePrivateKey(t, e)), n === "verify" && (t = await Ka.normalizePublicKey(t, e)), Xi(t)) return Ta(t, e, n), t;
	if (t instanceof Uint8Array) {
		if (!e.startsWith("HS")) throw TypeError(Da(t, ...Aa));
		return Yi.subtle.importKey("raw", t, {
			hash: `SHA-${e.slice(-3)}`,
			name: "HMAC"
		}, !1, [n]);
	}
	throw TypeError(Da(t, ...Aa, "Uint8Array", "JSON Web Key"));
}
var oo = async (e, t, n, r) => {
	let i = await ao(e, t, "verify");
	Pa(e, i);
	let a = io(e, i.algorithm);
	try {
		return await Yi.subtle.verify(a, i, n, r);
	} catch {
		return !1;
	}
};
async function so(e, t, n) {
	if (!Na(e)) throw new fa("Flattened JWS must be an object");
	if (e.protected === void 0 && e.header === void 0) throw new fa("Flattened JWS must have either of the \"protected\" or \"header\" members");
	if (e.protected !== void 0 && typeof e.protected != "string") throw new fa("JWS Protected Header incorrect type");
	if (e.payload === void 0) throw new fa("JWS Payload missing");
	if (typeof e.signature != "string") throw new fa("JWS Signature missing or incorrect type");
	if (e.header !== void 0 && !Na(e.header)) throw new fa("JWS Unprotected Header incorrect type");
	let r = {};
	if (e.protected) try {
		let t = ia(e.protected);
		r = JSON.parse($i.decode(t));
	} catch {
		throw new fa("JWS Protected Header is invalid");
	}
	if (!ja(r, e.header)) throw new fa("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
	let i = {
		...r,
		...e.header
	}, a = eo(fa, /* @__PURE__ */ new Map([["b64", !0]]), n?.crit, r, i), o = !0;
	if (a.has("b64") && (o = r.b64, typeof o != "boolean")) throw new fa("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
	let { alg: s } = i;
	if (typeof s != "string" || !s) throw new fa("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
	let c = n && to("algorithms", n.algorithms);
	if (c && !c.has(s)) throw new ca("\"alg\" (Algorithm) Header Parameter value not allowed");
	if (o) {
		if (typeof e.payload != "string") throw new fa("JWS Payload must be a string");
	} else if (typeof e.payload != "string" && !(e.payload instanceof Uint8Array)) throw new fa("JWS Payload must be a string or an Uint8Array instance");
	let l = !1;
	typeof t == "function" ? (t = await t(r, e), l = !0, $a(s, t, "verify"), Fa(t) && (t = await qa(t, s))) : $a(s, t, "verify");
	let u = ea(Qi.encode(e.protected ?? ""), Qi.encode("."), typeof e.payload == "string" ? Qi.encode(e.payload) : e.payload), d;
	try {
		d = ia(e.signature);
	} catch {
		throw new fa("Failed to base64url decode the signature");
	}
	if (!await oo(s, t, d, u)) throw new ya();
	let f;
	if (o) try {
		f = ia(e.payload);
	} catch {
		throw new fa("Failed to base64url decode the payload");
	}
	else f = typeof e.payload == "string" ? Qi.encode(e.payload) : e.payload;
	let p = { payload: f };
...
async function co(e, t, n) {
	if (e instanceof Uint8Array && (e = $i.decode(e)), typeof e != "string") throw new fa("Compact JWS must be a string or Uint8Array");
	let { 0: r, 1: i, 2: a, length: o } = e.split(".");
	if (o !== 3) throw new fa("Invalid Compact JWS");
	let s = await so({
		payload: i,
		protected: r,
		signature: a
...
var lo = (e) => Math.floor(e.getTime() / 1e3), uo = 60, fo = 3600, po = fo * 24, mo = po * 7, ho = po * 365.25, go = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i, _o = (e) => {
	let t = go.exec(e);
	...
	switch (r) {
		...
		case "w":
			i = Math.round(n * mo);
			break;
		default: i = Math.round(n * ho);
	}
	return t[1] === "-" || t[4] === "ago" ? -i : i;
}, vo = (e) => e.toLowerCase().replace(/^application\//, ""), yo = (e, t) => typeof e == "string" ? t.includes(e) : Array.isArray(e) ? t.some(Set.prototype.has.bind(new Set(e))) : !1, bo = (e, t, n = {}) => {
	let r;
	try {
		r = JSON.parse($i.decode(t));
	} catch {}
	if (!Na(r)) throw new pa("JWT Claims Set must be a top-level JSON object");
	let { typ: i } = n;
	if (i && (typeof e.typ != "string" || vo(e.typ) !== vo(i))) throw new oa("unexpected \"typ\" JWT header value", r, "typ", "check_failed");
	...
	for (let e of new Set(u.reverse())) if (!(e in r)) throw new oa(`missing required "${e}" claim`, r, e, "missing");
	if (o && !(Array.isArray(o) ? o : [o]).includes(r.iss)) throw new oa("unexpected \"iss\" claim value", r, "iss", "check_failed");
	if (s && r.sub !== s) throw new oa("unexpected \"sub\" claim value", r, "sub", "check_failed");
	if (c && !yo(r.aud, typeof c == "string" ? [c] : c)) throw new oa("unexpected \"aud\" claim value", r, "aud", "check_failed");
	let d;
	switch (typeof n.clockTolerance) {
		case "string":
			d = _o(n.clockTolerance);
			break;
		case "number":
			d = n.clockTolerance;
			break;
	...
	let { currentDate: f } = n, p = lo(f || /* @__PURE__ */ new Date());
	if ((r.iat !== void 0 || l) && typeof r.iat != "number") throw new oa("\"iat\" claim must be a number", r, "iat", "invalid");
	if (r.nbf !== void 0) {
		if (typeof r.nbf != "number") throw new oa("\"nbf\" claim must be a number", r, "nbf", "invalid");
		if (r.nbf > p + d) throw new oa("\"nbf\" claim timestamp check failed", r, "nbf", "check_failed");
	}
	if (r.exp !== void 0) {
		if (typeof r.exp != "number") throw new oa("\"exp\" claim must be a number", r, "exp", "invalid");
		if (r.exp <= p - d) throw new sa("\"exp\" claim timestamp check failed", r, "exp", "check_failed");
	}
	if (l) {
		let e = p - r.iat, t = typeof l == "number" ? l : _o(l);
		if (e - d > t) throw new sa("\"iat\" claim timestamp check failed (too far in the past)", r, "iat", "check_failed");
		if (e < 0 - d) throw new oa("\"iat\" claim timestamp check failed (it should be in the past)", r, "iat", "check_failed");
	}
	return r;
};
async function xo(e, t, n) {
	let r = await co(e, t, n);
	if (r.protectedHeader.crit?.includes("b64") && r.protectedHeader.b64 === !1) throw new pa("JWTs MUST NOT use unencoded payload");
	let i = {
		payload: bo(r.protectedHeader, r.payload, n),
...
var So = async (e, t, n) => {
	let r = await ao(e, t, "sign");
	Pa(e, r);
	let i = await Yi.subtle.sign(io(e, r.algorithm), r, n);
	...
	async sign(e, t) {
		if (!this._protectedHeader && !this._unprotectedHeader) throw new fa("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
		if (!ja(this._protectedHeader, this._unprotectedHeader)) throw new fa("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
		let n = {
			...this._protectedHeader,
			...this._unprotectedHeader
		}, r = eo(fa, /* @__PURE__ */ new Map([["b64", !0]]), t?.crit, this._protectedHeader, n), i = !0;
		if (r.has("b64") && (i = this._protectedHeader.b64, typeof i != "boolean")) throw new fa("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
		let { alg: a } = n;
		if (typeof a != "string" || !a) throw new fa("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
		$a(a, e, "sign");
		let o = this._payload;
		i && (o = Qi.encode(na(o)));
		let s;
		s = this._protectedHeader ? Qi.encode(na(JSON.stringify(this._protectedHeader))) : Qi.encode("");
		let c = {
			signature: na(await So(a, e, ea(s, Qi.encode("."), o))),
			payload: ""
		};
		return i && (c.payload = $i.decode(o)), this._unprotectedHeader && (c.header = this._unprotectedHeader), this._protectedHeader && (c.protected = $i.decode(s)), c;
	}
}, wo = class {
	constructor(e) {
		this._flattened = new Co(e);
	}
	setProtectedHeader(e) {
...
var Eo = class {
	constructor(e = {}) {
		if (!Na(e)) throw TypeError("JWT Claims Set MUST be an object");
		this._payload = e;
	}
	setIssuer(e) {
	...
	setNotBefore(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			nbf: To("setNotBefore", e)
		} : e instanceof Date ? {
			...this._payload,
			nbf: To("setNotBefore", lo(e))
		} : {
			...this._payload,
			nbf: lo(/* @__PURE__ */ new Date()) + _o(e)
		}, this;
	}
	setExpirationTime(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			exp: To("setExpirationTime", e)
		} : e instanceof Date ? {
			...this._payload,
			exp: To("setExpirationTime", lo(e))
		} : {
			...this._payload,
			exp: lo(/* @__PURE__ */ new Date()) + _o(e)
		}, this;
	}
	setIssuedAt(e) {
		return this._payload = e === void 0 ? {
			...this._payload,
			iat: lo(/* @__PURE__ */ new Date())
		} : e instanceof Date ? {
			...this._payload,
			iat: To("setIssuedAt", lo(e))
		} : typeof e == "string" ? {
			...this._payload,
			iat: To("setIssuedAt", lo(/* @__PURE__ */ new Date()) + _o(e))
		} : {
			...this._payload,
			iat: To("setIssuedAt", e)
		}, this;
	}
}, Do = class extends Eo {
	setProtectedHeader(e) {
	...
	async sign(e, t) {
		let n = new wo(Qi.encode(JSON.stringify(this._payload)));
		if (n.setProtectedHeader(this._protectedHeader), Array.isArray(this._protectedHeader?.crit) && this._protectedHeader.crit.includes("b64") && this._protectedHeader.b64 === !1) throw new pa("JWTs MUST NOT use unencoded payload");
		return n.sign(e, t);
	}
}, Oo = (e, t) => {
	if (typeof e != "string" || !e) throw new ma(`${t} missing or invalid`);
};
async function ko(e, t) {
	...
	switch (e.kty) {
		case "EC":
			Oo(e.crv, "\"crv\" (Curve) Parameter"), Oo(e.x, "\"x\" (X Coordinate) Parameter"), Oo(e.y, "\"y\" (Y Coordinate) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x,
				y: e.y
			...
			break;
		case "OKP":
			Oo(e.crv, "\"crv\" (Subtype of Key Pair) Parameter"), Oo(e.x, "\"x\" (Public Key) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x
			};
			break;
		case "RSA":
			Oo(e.e, "\"e\" (Exponent) Parameter"), Oo(e.n, "\"n\" (Modulus) Parameter"), n = {
				e: e.e,
				kty: e.kty,
				n: e.n
			};
			break;
		case "oct":
			Oo(e.k, "\"k\" (Key Value) Parameter"), n = {
				k: e.k,
				kty: e.kty
			};
			break;
		default: throw new la("\"kty\" (Key Type) Parameter missing or unsupported");
	}
	let r = Qi.encode(JSON.stringify(n));
	return na(await Zi(t, r));
}
function Ao(e) {
	switch (typeof e == "string" && e.slice(0, 2)) {
		...
		case "ES": return "EC";
		case "Ed": return "OKP";
		default: throw new la("Unsupported \"alg\" value for a JSON Web Key Set");
	}
}
function jo(e) {
	return e && typeof e == "object" && Array.isArray(e.keys) && e.keys.every(Mo);
}
function Mo(e) {
	return Na(e);
}
...
var Po = class {
	constructor(e) {
		if (this._cached = /* @__PURE__ */ new WeakMap(), !jo(e)) throw new ha("JSON Web Key Set malformed");
		this._jwks = No(e);
	}
	async getKey(e, t) {
		let { alg: n, kid: r } = {
			...e,
			...t?.header
		}, i = Ao(n), a = this._jwks.keys.filter((e) => {
			let t = i === e.kty;
		...
		if (s === 0) throw new ga();
		if (s !== 1) {
			let e = new _a(), { _cached: t } = this;
			throw e[Symbol.asyncIterator] = async function* () {
				for (let e of a) try {
					yield await Fo(t, e, n);
				} catch {}
			}, e;
		}
		return Fo(this._cached, o, n);
	}
};
async function Fo(e, t, n) {
	...
	if (r[n] === void 0) {
		...
		if (e instanceof Uint8Array || e.type !== "public") throw new ha("JSON Web Key Set members must be public keys");
		r[n] = e;
	}
	return r[n];
}
function Io(e) {
	let t = new Po(e), n = async (e, n) => t.getKey(e, n);
...
var Lo = async (e, t, n) => {
	...
	if (i !== void 0 && clearTimeout(i), o.status !== 200) throw new aa("Expected 200 OK from the JSON Web Key Set HTTP response");
	try {
		return await o.json();
	} catch {
		throw new aa("Failed to parse the JSON Web Key Set HTTP response as JSON");
	}
};
function Ro() {
...
var zo;
(typeof navigator > "u" || !navigator.userAgent?.startsWith?.("Mozilla/5.0 ")) && (zo = "jose/v5.10.0");
var Bo = Symbol();
function Vo(e, t) {
	return !(typeof e != "object" || !e || !("uat" in e) || typeof e.uat != "number" || Date.now() - e.uat >= t || !("jwks" in e) || !Na(e.jwks) || !Array.isArray(e.jwks.keys) || !Array.prototype.every.call(e.jwks.keys, Na));
}
var Ho = class {
	constructor(e, t) {
		...
		this._url = new URL(e.href), this._options = {
			agent: t?.agent,
			headers: t?.headers
		}, this._timeoutDuration = typeof t?.timeoutDuration == "number" ? t?.timeoutDuration : 5e3, this._cooldownDuration = typeof t?.cooldownDuration == "number" ? t?.cooldownDuration : 3e4, this._cacheMaxAge = typeof t?.cacheMaxAge == "number" ? t?.cacheMaxAge : 6e5, t?.[Bo] !== void 0 && (this._cache = t?.[Bo], Vo(t?.[Bo], this._cacheMaxAge) && (this._jwksTimestamp = this._cache.uat, this._local = Io(this._cache.jwks)));
	}
	coolingDown() {
	...
	async getKey(e, t) {
		...
		try {
			...
			if (n instanceof ga && this.coolingDown() === !1) return await this.reload(), this._local(e, t);
			throw n;
		}
	}
	async reload() {
		this._pendingFetch && Ro() && (this._pendingFetch = void 0);
		let e = new Headers(this._options.headers);
		zo && !e.has("User-Agent") && (e.set("User-Agent", zo), this._options.headers = Object.fromEntries(e.entries())), this._pendingFetch ||= Lo(this._url, this._timeoutDuration, this._options).then((e) => {
			this._local = Io(e), this._cache && (this._cache.uat = Date.now(), this._cache.jwks = e), this._jwksTimestamp = Date.now(), this._pendingFetch = void 0;
		}).catch((e) => {
...
function Uo(e, t) {
	let n = new Ho(e, t), r = async (e, t) => n.getKey(e, t);
...
var Wo = ia;
function Go(e) {
	if (typeof e != "string") throw new pa("JWTs must use Compact JWS serialization, JWT must be a string");
	let { 1: t, length: n } = e.split(".");
	if (n === 5) throw new pa("Only JWTs using Compact JWS serialization can be decoded");
	if (n !== 3) throw new pa("Invalid JWT");
	if (!t) throw new pa("JWTs must contain a payload");
	let r;
	try {
		r = Wo(t);
	} catch {
		throw new pa("Failed to base64url decode the payload");
	}
	let i;
	try {
		i = JSON.parse($i.decode(r));
	} catch {
		throw new pa("Failed to parse the decoded payload as JSON");
	}
	if (!Na(i)) throw new pa("Invalid JWT Claims Set");
	return i;
}
function Ko(e) {
	let t = e?.modulusLength ?? 2048;
	if (typeof t != "number" || t < 2048) throw new la("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
	return t;
}
		...
		case "EdDSA": {
			...
			switch (e) {
				...
				case "Ed448":
					n = { name: e };
					break;
				default: throw new la("Invalid or unsupported crv option provided");
			}
			break;
		}
		case "ECDH-ES":
		...
		case "ECDH-ES+A256KW": {
			...
			switch (e) {
				...
				case "X448":
					n = { name: e };
					break;
				default: throw new la("Invalid or unsupported crv option provided, supported values are P-256, P-384, P-521, X25519, and X448");
			}
			break;
		}
		default: throw new la("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
	}
	return Yi.subtle.generateKey(n, t?.extractable ?? !1, r);
}
...
var Yo = async (e, t) => {
	...
	if (!l) {
		...
		l = (await Yo(e, n ?? { redirect_uris: [i] }).then((e) => {
			if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
			return e.json();
		})).client_id;
	}
	...
	let { pkce_code_verifier: u, pkce_code_challenge: d } = await Zo();
	...
	let c = await Jo("ES256"), l = await $o(r, a, n.toString(), o, s, c).then((e) => {
		if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
		return e.json();
	...
	let { payload: f } = await xo(u, Uo(new URL(d)), {
		issuer: i,
		audience: "solid"
	}), p = await ko(await ro(c.publicKey));
	...
	try {
		...
		let { payload: l } = await xo(o, Uo(new URL(c)), {
			issuer: s,
			audience: "solid"
		}), u = await ko(await ro(r.publicKey));
...
var rs = class extends EventTarget {
	isActive_ = !1;
	exp_;
	webId_ = void 0;
	currentAth_ = void 0;
	...
	rejectRefresh;
	constructor(e, t) {
		super(), this.authFetch = this.authFetch.bind(this), this.information = { clientDetails: e }, this.database = t?.database, t?.onSessionStateChange && this.addEventListener(ns.STATE_CHANGE, (e) => t.onSessionStateChange?.(e)), t?.onSessionExpirationWarning && this.addEventListener(ns.EXPIRATION_WARNING, (e) => t?.onSessionExpirationWarning?.(e)), t?.onSessionExpiration && this.addEventListener(ns.EXPIRATION, (e) => t?.onSessionExpiration?.(e));
	}
	async login(e, t) {
		await Xo(e, t, this.information.clientDetails);
	}
	async handleRedirectFromLogin() {
		let e = await Qo(this.information.clientDetails, this.database);
	...
	async restore() {
		...
		let e = this.isActive;
		return es(this.database).then((e) => this.setTokenDetails(e)).then(() => this.resolveRefresh()).catch((e) => {
	...
	async _createSignedDPoPToken(e) {
		...
		let t = await ro(this.information.tokenDetails.dpop_key_pair.publicKey);
		return new Do(e).setIssuedAt().setJti(window.crypto.randomUUID()).setProtectedHeader({
			alg: "ES256",
			typ: "dpop+jwt",
			jwk: t
...
var os = class {
	...
	constructor(e, t) {
		...
		this.worker = new SharedWorker(i, { type: "module" }), this.worker.port.onmessage = (e) => {
			...
			this.worker.port.postMessage({ type: as.DISCONNECT });
		});
	}
	async handleWorkerMessage(e) {
		let { type: t, payload: n, error: r } = e;
		switch (t) {
			case as.TOKEN_DETAILS:
				let e = this.isActive;
			...
			case as.ERROR_ON_REFRESH:
				...
				break;
			case as.EXPIRED: this.isActive && (this.dispatchExpirationEvent(), await this.logout()), this.refreshPromise && this.rejectRefresh && (this.rejectRefresh(Error(r || "Token refresh failed")), this.clearRefreshPromise());
		}
	}
	async handleRedirectFromLogin() {
	...
	async restore() {
		return this.refreshPromise ? this.refreshPromise : (this.refreshPromise = new Promise((e, t) => {
			this.resolveRefresh = e, this.rejectRefresh = t;
		}), this.worker.port.postMessage({ type: as.REFRESH }), this.refreshPromise);
	}
	async logout() {
		this.worker.port.postMessage({ type: as.STOP }), await super.logout();
	}
}, cs = /* @__PURE__ */ c({
	SessionCore: () => gl,
	SessionEvents: () => hl
}), ls = crypto, us = (e) => e instanceof CryptoKey, ds = async (e, t) => {
	let n = `SHA-${e.slice(-3)}`;
	return new Uint8Array(await ls.subtle.digest(n, t));
}, fs = new TextEncoder(), ps = new TextDecoder();
function ms(...e) {
	let t = e.reduce((e, { length: t }) => e + t, 0), n = new Uint8Array(t), r = 0;
	for (let t of e) n.set(t, r), r += t.length;
	return n;
...
var hs = (e) => {
	let t = e;
	typeof t == "string" && (t = fs.encode(t));
	let n = 32768, r = [];
	for (let e = 0; e < t.length; e += n) r.push(String.fromCharCode.apply(null, t.subarray(e, e + n)));
	return btoa(r.join(""));
}, gs = (e) => hs(e).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_"), _s = (e) => {
	let t = atob(e), n = new Uint8Array(t.length);
	for (let e = 0; e < t.length; e++) n[e] = t.charCodeAt(e);
	return n;
}, vs = (e) => {
	let t = e;
	t instanceof Uint8Array && (t = ps.decode(t)), t = t.replace(/-/g, "+").replace(/_/g, "/").replace(/\s/g, "");
	try {
		return _s(t);
	} catch {
		throw TypeError("The input to be decoded is not correctly encoded.");
...
bs.code = "ERR_JWT_CLAIM_VALIDATION_FAILED";
...
xs.code = "ERR_JWT_EXPIRED";
var Ss = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JOSE_ALG_NOT_ALLOWED";
	}
};
Ss.code = "ERR_JOSE_ALG_NOT_ALLOWED";
var Cs = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JOSE_NOT_SUPPORTED";
	}
};
Cs.code = "ERR_JOSE_NOT_SUPPORTED";
var ws = class extends ys {
	constructor(e = "decryption operation failed", t) {
		super(e, t), this.code = "ERR_JWE_DECRYPTION_FAILED";
	}
};
ws.code = "ERR_JWE_DECRYPTION_FAILED";
...
var Es = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JWS_INVALID";
	}
};
Es.code = "ERR_JWS_INVALID";
var Ds = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JWT_INVALID";
	}
};
Ds.code = "ERR_JWT_INVALID";
var Os = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JWK_INVALID";
	}
};
Os.code = "ERR_JWK_INVALID";
var ks = class extends ys {
	constructor() {
		super(...arguments), this.code = "ERR_JWKS_INVALID";
	}
};
ks.code = "ERR_JWKS_INVALID";
var As = class extends ys {
	constructor(e = "no applicable key found in the JSON Web Key Set", t) {
		super(e, t), this.code = "ERR_JWKS_NO_MATCHING_KEY";
	}
};
As.code = "ERR_JWKS_NO_MATCHING_KEY";
var js = class extends ys {
	constructor(e = "multiple matching keys found in the JSON Web Key Set", t) {
		super(e, t), this.code = "ERR_JWKS_MULTIPLE_MATCHING_KEYS";
	}
};
js.code = "ERR_JWKS_MULTIPLE_MATCHING_KEYS";
var Ms = class extends ys {
	constructor(e = "request timed out", t) {
		super(e, t), this.code = "ERR_JWKS_TIMEOUT";
	}
};
Ms.code = "ERR_JWKS_TIMEOUT";
var Ns = class extends ys {
	constructor(e = "signature verification failed", t) {
		super(e, t), this.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
	}
};
Ns.code = "ERR_JWS_SIGNATURE_VERIFICATION_FAILED";
function Ps(e, t = "algorithm.name") {
	return /* @__PURE__ */ TypeError(`CryptoKey does not support this operation, its ${t} must be ${e}`);
}
function Fs(e, t) {
	return e.name === t;
...
function zs(e, t, ...n) {
	switch (t) {
		...
		case "HS384":
		case "HS512": {
			if (!Fs(e.algorithm, "HMAC")) throw Ps("HMAC");
			let n = parseInt(t.slice(2), 10);
			if (Is(e.algorithm.hash) !== n) throw Ps(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "RS256":
		case "RS384":
		case "RS512": {
			if (!Fs(e.algorithm, "RSASSA-PKCS1-v1_5")) throw Ps("RSASSA-PKCS1-v1_5");
			let n = parseInt(t.slice(2), 10);
			if (Is(e.algorithm.hash) !== n) throw Ps(`SHA-${n}`, "algorithm.hash");
			break;
		}
		...
		case "PS384":
		case "PS512": {
			if (!Fs(e.algorithm, "RSA-PSS")) throw Ps("RSA-PSS");
			let n = parseInt(t.slice(2), 10);
			if (Is(e.algorithm.hash) !== n) throw Ps(`SHA-${n}`, "algorithm.hash");
			break;
		}
		case "EdDSA":
			if (e.algorithm.name !== "Ed25519" && e.algorithm.name !== "Ed448") throw Ps("Ed25519 or Ed448");
			break;
		case "Ed25519":
			if (!Fs(e.algorithm, "Ed25519")) throw Ps("Ed25519");
			break;
		case "ES256":
		case "ES384":
		case "ES512": {
			if (!Fs(e.algorithm, "ECDSA")) throw Ps("ECDSA");
			let n = Ls(t);
			if (e.algorithm.namedCurve !== n) throw Ps(n, "algorithm.namedCurve");
			break;
		}
		default: throw TypeError("CryptoKey does not support this operation");
	}
...
var Vs = (e, ...t) => Bs("Key must be ", e, ...t);
function Hs(e, t, ...n) {
	return Bs(`Key for the ${e} algorithm must be `, t, ...n);
}
var Us = (e) => us(e) ? !0 : e?.[Symbol.toStringTag] === "KeyObject", Ws = ["CryptoKey"], Gs = (...e) => {
	let t = e.filter(Boolean);
	if (t.length === 0 || t.length === 1) return !0;
	let n;
	for (let e of t) {
...
function qs(e) {
	if (!Ks(e) || Object.prototype.toString.call(e) !== "[object Object]") return !1;
	if (Object.getPrototypeOf(e) === null) return !0;
	let t = e;
	for (; Object.getPrototypeOf(t) !== null;) t = Object.getPrototypeOf(t);
	return Object.getPrototypeOf(e) === t;
...
function Ys(e) {
	return qs(e) && typeof e.kty == "string";
}
function Xs(e) {
	return e.kty !== "oct" && typeof e.d == "string";
}
...
function Qs(e) {
	return Ys(e) && e.kty === "oct" && typeof e.k == "string";
}
function $s(e) {
	let t, n;
	switch (e.kty) {
		case "RSA":
			switch (e.alg) {
				...
				case "RSA-OAEP-512":
					...
					break;
				default: throw new Cs("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
			}
			break;
		case "EC":
			switch (e.alg) {
		...
		case "OKP":
			...
			break;
		default: throw new Cs("Invalid or unsupported JWK \"kty\" (Key Type) Parameter value");
	}
	return {
		algorithm: t,
		keyUsages: n
...
var ec = async (e) => {
	if (!e.alg) throw TypeError("\"alg\" argument is required when \"jwk.alg\" is not present");
	let { algorithm: t, keyUsages: n } = $s(e), r = [
		t,
		e.ext ?? !1,
		e.key_ops ?? n
	], i = { ...e };
	return delete i.alg, delete i.use, ls.subtle.importKey("jwk", i, ...r);
}, tc = (e) => vs(e), nc, rc, ic = (e) => e?.[Symbol.toStringTag] === "KeyObject", ac = async (e, t, n, r, i = !1) => {
	let a = e.get(t);
	if (a?.[r]) return a[r];
	let o = await ec({
		...n,
	...
	normalizePublicKey: (e, t) => {
		if (ic(e)) {
			let n = e.export({ format: "jwk" });
			return delete n.d, delete n.dp, delete n.dq, delete n.p, delete n.q, delete n.qi, n.k ? tc(n.k) : (rc ||= /* @__PURE__ */ new WeakMap(), ac(rc, e, n, t));
		}
		return Ys(e) ? e.k ? vs(e.k) : (rc ||= /* @__PURE__ */ new WeakMap(), ac(rc, e, e, t, !0)) : e;
	},
	normalizePrivateKey: (e, t) => {
		if (ic(e)) {
			let n = e.export({ format: "jwk" });
			return n.k ? tc(n.k) : (nc ||= /* @__PURE__ */ new WeakMap(), ac(nc, e, n, t));
		}
		return Ys(e) ? e.k ? vs(e.k) : (nc ||= /* @__PURE__ */ new WeakMap(), ac(nc, e, e, t, !0)) : e;
	}
};
async function sc(e, t) {
	if (!qs(e)) throw TypeError("JWK must be an object");
	switch (t ||= e.alg, e.kty) {
		case "oct":
			if (typeof e.k != "string" || !e.k) throw TypeError("missing \"k\" (Key Value) Parameter value");
			return vs(e.k);
		case "RSA": if ("oth" in e && e.oth !== void 0) throw new Cs("RSA JWK \"oth\" (Other Primes Info) Parameter value is not supported");
		case "EC":
		case "OKP": return ec({
			...e,
			alg: t
		});
		default: throw new Cs("Unsupported \"kty\" (Key Type) Parameter value");
	}
}
var cc = (e) => e?.[Symbol.toStringTag], lc = (e, t, n) => {
	if (t.use !== void 0 && t.use !== "sig") throw TypeError("Invalid key for this operation, when present its use must be sig");
	if (t.key_ops !== void 0 && t.key_ops.includes?.(n) !== !0) throw TypeError(`Invalid key for this operation, when present its key_ops must include ${n}`);
	if (t.alg !== void 0 && t.alg !== e) throw TypeError(`Invalid key for this operation, when present its alg must be ${e}`);
	return !0;
	...
	if (!(t instanceof Uint8Array)) {
		if (r && Ys(t)) {
			if (Qs(t) && lc(e, t, n)) return;
			throw TypeError("JSON Web Key for symmetric algorithms must have JWK \"kty\" (Key Type) equal to \"oct\" and the JWK \"k\" (Key Value) present");
		}
		if (!Us(t)) throw TypeError(Hs(e, t, ...Ws, "Uint8Array", r ? "JSON Web Key" : null));
		if (t.type !== "secret") throw TypeError(`${cc(t)} instances for symmetric algorithms must be of type "secret"`);
	}
}, dc = (e, t, n, r) => {
	if (r && Ys(t)) switch (n) {
		case "sign":
			if (Xs(t) && lc(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a private JWK");
		case "verify":
			if (Zs(t) && lc(e, t, n)) return;
			throw TypeError("JSON Web Key for this operation be a public JWK");
	}
	if (!Us(t)) throw TypeError(Hs(e, t, ...Ws, r ? "JSON Web Key" : null));
	if (t.type === "secret") throw TypeError(`${cc(t)} instances for asymmetric algorithms must not be of type "secret"`);
	if (n === "sign" && t.type === "public") throw TypeError(`${cc(t)} instances for asymmetric algorithm signing must be of type "private"`);
	if (n === "decrypt" && t.type === "public") throw TypeError(`${cc(t)} instances for asymmetric algorithm decryption must be of type "private"`);
	if (t.algorithm && n === "verify" && t.type === "private") throw TypeError(`${cc(t)} instances for asymmetric algorithm verifying must be of type "public"`);
	if (t.algorithm && n === "encrypt" && t.type === "private") throw TypeError(`${cc(t)} instances for asymmetric algorithm encryption must be of type "public"`);
};
function fc(e, t, n, r) {
	t.startsWith("HS") || t === "dir" || t.startsWith("PBES2") || /^A\d{3}(?:GCM)?KW$/.test(t) ? uc(t, n, r, e) : dc(t, n, r, e);
}
fc.bind(void 0, !1);
var pc = fc.bind(void 0, !0);
function mc(e, t, n, r, i) {
	...
	a = n === void 0 ? t : new Map([...Object.entries(n), ...t.entries()]);
	for (let t of r.crit) {
		if (!a.has(t)) throw new Cs(`Extension Header Parameter "${t}" is not recognized`);
		if (i[t] === void 0) throw new e(`Extension Header Parameter "${t}" is missing`);
		if (a.get(t) && r[t] === void 0) throw new e(`Extension Header Parameter "${t}" MUST be integrity protected`);
	}
	return new Set(r.crit);
...
var hc = (e, t) => {
	...
	if (!us(e)) throw TypeError(Vs(e, ...Ws, "Uint8Array"));
	if (!e.extractable) throw TypeError("non-extractable CryptoKey cannot be exported as a JWK");
	let { ext: t, key_ops: n, alg: r, use: i, ...a } = await ls.subtle.exportKey("jwk", e);
	return a;
};
async function _c(e) {
	return gc(e);
...
function vc(e, t) {
	...
	switch (e) {
		...
		case "Ed25519": return { name: "Ed25519" };
		case "EdDSA": return { name: t.name };
		default: throw new Cs(`alg ${e} is not supported either by JOSE or your javascript runtime`);
	}
}
async function yc(e, t, n) {
	if (n === "sign" && (t = await oc.normalizePrivateKey(t, e)), n === "verify" && (t = await oc.normalizePublicKey(t, e)), us(t)) return zs(t, e, n), t;
	if (t instanceof Uint8Array) {
		if (!e.startsWith("HS")) throw TypeError(Vs(t, ...Ws));
		return ls.subtle.importKey("raw", t, {
			hash: `SHA-${e.slice(-3)}`,
			name: "HMAC"
		}, !1, [n]);
	}
	throw TypeError(Vs(t, ...Ws, "Uint8Array", "JSON Web Key"));
}
var bc = async (e, t, n, r) => {
	let i = await yc(e, t, "verify");
	Js(e, i);
	let a = vc(e, i.algorithm);
	try {
		return await ls.subtle.verify(a, i, n, r);
	} catch {
		return !1;
	}
};
async function xc(e, t, n) {
	if (!qs(e)) throw new Es("Flattened JWS must be an object");
	if (e.protected === void 0 && e.header === void 0) throw new Es("Flattened JWS must have either of the \"protected\" or \"header\" members");
	if (e.protected !== void 0 && typeof e.protected != "string") throw new Es("JWS Protected Header incorrect type");
	if (e.payload === void 0) throw new Es("JWS Payload missing");
	if (typeof e.signature != "string") throw new Es("JWS Signature missing or incorrect type");
	if (e.header !== void 0 && !qs(e.header)) throw new Es("JWS Unprotected Header incorrect type");
	let r = {};
	if (e.protected) try {
		let t = vs(e.protected);
		r = JSON.parse(ps.decode(t));
	} catch {
		throw new Es("JWS Protected Header is invalid");
	}
	if (!Gs(r, e.header)) throw new Es("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
	let i = {
		...r,
		...e.header
	}, a = mc(Es, /* @__PURE__ */ new Map([["b64", !0]]), n?.crit, r, i), o = !0;
	if (a.has("b64") && (o = r.b64, typeof o != "boolean")) throw new Es("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
	let { alg: s } = i;
	if (typeof s != "string" || !s) throw new Es("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
	let c = n && hc("algorithms", n.algorithms);
	if (c && !c.has(s)) throw new Ss("\"alg\" (Algorithm) Header Parameter value not allowed");
	if (o) {
		if (typeof e.payload != "string") throw new Es("JWS Payload must be a string");
	} else if (typeof e.payload != "string" && !(e.payload instanceof Uint8Array)) throw new Es("JWS Payload must be a string or an Uint8Array instance");
	let l = !1;
	typeof t == "function" ? (t = await t(r, e), l = !0, pc(s, t, "verify"), Ys(t) && (t = await sc(t, s))) : pc(s, t, "verify");
	let u = ms(fs.encode(e.protected ?? ""), fs.encode("."), typeof e.payload == "string" ? fs.encode(e.payload) : e.payload), d;
	try {
		d = vs(e.signature);
	} catch {
		throw new Es("Failed to base64url decode the signature");
	}
	if (!await bc(s, t, d, u)) throw new Ns();
	let f;
	if (o) try {
		f = vs(e.payload);
	} catch {
		throw new Es("Failed to base64url decode the payload");
	}
	else f = typeof e.payload == "string" ? fs.encode(e.payload) : e.payload;
	let p = { payload: f };
	return e.protected !== void 0 && (p.protectedHeader = r), e.header !== void 0 && (p.unprotectedHeader = e.header), l ? {
		...p,
		key: t
...
async function Sc(e, t, n) {
	if (e instanceof Uint8Array && (e = ps.decode(e)), typeof e != "string") throw new Es("Compact JWS must be a string or Uint8Array");
	let { 0: r, 1: i, 2: a, length: o } = e.split(".");
	if (o !== 3) throw new Es("Invalid Compact JWS");
	let s = await xc({
		payload: i,
		protected: r,
		signature: a
...
var Cc = (e) => Math.floor(e.getTime() / 1e3), wc = 60, Tc = 3600, Ec = Tc * 24, Dc = Ec * 7, Oc = Ec * 365.25, kc = /^(\+|\-)? ?(\d+|\d+\.\d+) ?(seconds?|secs?|s|minutes?|mins?|m|hours?|hrs?|h|days?|d|weeks?|w|years?|yrs?|y)(?: (ago|from now))?$/i, Ac = (e) => {
	let t = kc.exec(e);
	if (!t || t[4] && t[1]) throw TypeError("Invalid time period format");
	let n = parseFloat(t[2]), r = t[3].toLowerCase(), i;
	switch (r) {
		...
		case "w":
			i = Math.round(n * Dc);
			break;
		default: i = Math.round(n * Oc);
	}
	return t[1] === "-" || t[4] === "ago" ? -i : i;
}, jc = (e) => e.toLowerCase().replace(/^application\//, ""), Mc = (e, t) => typeof e == "string" ? t.includes(e) : Array.isArray(e) ? t.some(Set.prototype.has.bind(new Set(e))) : !1, Nc = (e, t, n = {}) => {
	let r;
	try {
		r = JSON.parse(ps.decode(t));
	} catch {}
	if (!qs(r)) throw new Ds("JWT Claims Set must be a top-level JSON object");
	let { typ: i } = n;
	if (i && (typeof e.typ != "string" || jc(e.typ) !== jc(i))) throw new bs("unexpected \"typ\" JWT header value", r, "typ", "check_failed");
	let { requiredClaims: a = [], issuer: o, subject: s, audience: c, maxTokenAge: l } = n, u = [...a];
	l !== void 0 && u.push("iat"), c !== void 0 && u.push("aud"), s !== void 0 && u.push("sub"), o !== void 0 && u.push("iss");
	for (let e of new Set(u.reverse())) if (!(e in r)) throw new bs(`missing required "${e}" claim`, r, e, "missing");
	if (o && !(Array.isArray(o) ? o : [o]).includes(r.iss)) throw new bs("unexpected \"iss\" claim value", r, "iss", "check_failed");
	if (s && r.sub !== s) throw new bs("unexpected \"sub\" claim value", r, "sub", "check_failed");
	if (c && !Mc(r.aud, typeof c == "string" ? [c] : c)) throw new bs("unexpected \"aud\" claim value", r, "aud", "check_failed");
	let d;
	switch (typeof n.clockTolerance) {
		case "string":
			d = Ac(n.clockTolerance);
			break;
		case "number":
			d = n.clockTolerance;
			break;
	...
	let { currentDate: f } = n, p = Cc(f || /* @__PURE__ */ new Date());
	if ((r.iat !== void 0 || l) && typeof r.iat != "number") throw new bs("\"iat\" claim must be a number", r, "iat", "invalid");
	if (r.nbf !== void 0) {
		if (typeof r.nbf != "number") throw new bs("\"nbf\" claim must be a number", r, "nbf", "invalid");
		if (r.nbf > p + d) throw new bs("\"nbf\" claim timestamp check failed", r, "nbf", "check_failed");
	}
	if (r.exp !== void 0) {
		if (typeof r.exp != "number") throw new bs("\"exp\" claim must be a number", r, "exp", "invalid");
		if (r.exp <= p - d) throw new xs("\"exp\" claim timestamp check failed", r, "exp", "check_failed");
	}
	if (l) {
		let e = p - r.iat, t = typeof l == "number" ? l : Ac(l);
		if (e - d > t) throw new xs("\"iat\" claim timestamp check failed (too far in the past)", r, "iat", "check_failed");
		if (e < 0 - d) throw new bs("\"iat\" claim timestamp check failed (it should be in the past)", r, "iat", "check_failed");
	}
	return r;
};
async function Pc(e, t, n) {
	let r = await Sc(e, t, n);
	if (r.protectedHeader.crit?.includes("b64") && r.protectedHeader.b64 === !1) throw new Ds("JWTs MUST NOT use unencoded payload");
	let i = {
		payload: Nc(r.protectedHeader, r.payload, n),
		protectedHeader: r.protectedHeader
	};
	return typeof t == "function" ? {
		...i,
...
var Fc = async (e, t, n) => {
	let r = await yc(e, t, "sign");
	Js(e, r);
	let i = await ls.subtle.sign(vc(e, r.algorithm), r, n);
	return new Uint8Array(i);
}, Ic = class {
	constructor(e) {
		if (!(e instanceof Uint8Array)) throw TypeError("payload must be an instance of Uint8Array");
	...
	async sign(e, t) {
		if (!this._protectedHeader && !this._unprotectedHeader) throw new Es("either setProtectedHeader or setUnprotectedHeader must be called before #sign()");
		if (!Gs(this._protectedHeader, this._unprotectedHeader)) throw new Es("JWS Protected and JWS Unprotected Header Parameter names must be disjoint");
		let n = {
			...this._protectedHeader,
			...this._unprotectedHeader
		}, r = mc(Es, /* @__PURE__ */ new Map([["b64", !0]]), t?.crit, this._protectedHeader, n), i = !0;
		if (r.has("b64") && (i = this._protectedHeader.b64, typeof i != "boolean")) throw new Es("The \"b64\" (base64url-encode payload) Header Parameter must be a boolean");
		let { alg: a } = n;
		if (typeof a != "string" || !a) throw new Es("JWS \"alg\" (Algorithm) Header Parameter missing or invalid");
		pc(a, e, "sign");
		let o = this._payload;
		i && (o = fs.encode(gs(o)));
		let s;
		s = this._protectedHeader ? fs.encode(gs(JSON.stringify(this._protectedHeader))) : fs.encode("");
		let c = {
			signature: gs(await Fc(a, e, ms(s, fs.encode("."), o))),
			payload: ""
		};
		return i && (c.payload = ps.decode(o)), this._unprotectedHeader && (c.header = this._unprotectedHeader), this._protectedHeader && (c.protected = ps.decode(s)), c;
	}
}, Lc = class {
	constructor(e) {
		this._flattened = new Ic(e);
	}
	setProtectedHeader(e) {
		return this._flattened.setProtectedHeader(e), this;
	}
...
var zc = class {
	constructor(e = {}) {
		if (!qs(e)) throw TypeError("JWT Claims Set MUST be an object");
		this._payload = e;
	}
	setIssuer(e) {
		return this._payload = {
	...
	setNotBefore(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			nbf: Rc("setNotBefore", e)
		} : e instanceof Date ? {
			...this._payload,
			nbf: Rc("setNotBefore", Cc(e))
		} : {
			...this._payload,
			nbf: Cc(/* @__PURE__ */ new Date()) + Ac(e)
		}, this;
	}
	setExpirationTime(e) {
		return this._payload = typeof e == "number" ? {
			...this._payload,
			exp: Rc("setExpirationTime", e)
		} : e instanceof Date ? {
			...this._payload,
			exp: Rc("setExpirationTime", Cc(e))
		} : {
			...this._payload,
			exp: Cc(/* @__PURE__ */ new Date()) + Ac(e)
		}, this;
	}
	setIssuedAt(e) {
		return this._payload = e === void 0 ? {
			...this._payload,
			iat: Cc(/* @__PURE__ */ new Date())
		} : e instanceof Date ? {
			...this._payload,
			iat: Rc("setIssuedAt", Cc(e))
		} : typeof e == "string" ? {
			...this._payload,
			iat: Rc("setIssuedAt", Cc(/* @__PURE__ */ new Date()) + Ac(e))
		} : {
			...this._payload,
			iat: Rc("setIssuedAt", e)
		}, this;
	}
}, Bc = class extends zc {
	setProtectedHeader(e) {
	...
	async sign(e, t) {
		let n = new Lc(fs.encode(JSON.stringify(this._payload)));
		if (n.setProtectedHeader(this._protectedHeader), Array.isArray(this._protectedHeader?.crit) && this._protectedHeader.crit.includes("b64") && this._protectedHeader.b64 === !1) throw new Ds("JWTs MUST NOT use unencoded payload");
		return n.sign(e, t);
	}
}, Vc = (e, t) => {
	if (typeof e != "string" || !e) throw new Os(`${t} missing or invalid`);
};
async function Hc(e, t) {
	...
	switch (e.kty) {
		case "EC":
			Vc(e.crv, "\"crv\" (Curve) Parameter"), Vc(e.x, "\"x\" (X Coordinate) Parameter"), Vc(e.y, "\"y\" (Y Coordinate) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x,
				y: e.y
			...
			break;
		case "OKP":
			Vc(e.crv, "\"crv\" (Subtype of Key Pair) Parameter"), Vc(e.x, "\"x\" (Public Key) Parameter"), n = {
				crv: e.crv,
				kty: e.kty,
				x: e.x
			};
			break;
		case "RSA":
			Vc(e.e, "\"e\" (Exponent) Parameter"), Vc(e.n, "\"n\" (Modulus) Parameter"), n = {
				e: e.e,
				kty: e.kty,
				n: e.n
			};
			break;
		case "oct":
			Vc(e.k, "\"k\" (Key Value) Parameter"), n = {
				k: e.k,
				kty: e.kty
			};
			break;
		default: throw new Cs("\"kty\" (Key Type) Parameter missing or unsupported");
	}
	let r = fs.encode(JSON.stringify(n));
	return gs(await ds(t, r));
}
function Uc(e) {
	switch (typeof e == "string" && e.slice(0, 2)) {
		case "RS":
		...
		case "ES": return "EC";
		case "Ed": return "OKP";
		default: throw new Cs("Unsupported \"alg\" value for a JSON Web Key Set");
	}
}
function Wc(e) {
	return e && typeof e == "object" && Array.isArray(e.keys) && e.keys.every(Gc);
}
function Gc(e) {
	return qs(e);
}
...
var qc = class {
	constructor(e) {
		if (this._cached = /* @__PURE__ */ new WeakMap(), !Wc(e)) throw new ks("JSON Web Key Set malformed");
		this._jwks = Kc(e);
	}
	async getKey(e, t) {
		let { alg: n, kid: r } = {
			...e,
			...t?.header
		}, i = Uc(n), a = this._jwks.keys.filter((e) => {
			let t = i === e.kty;
			if (t && typeof r == "string" && (t = r === e.kid), t && typeof e.alg == "string" && (t = n === e.alg), t && typeof e.use == "string" && (t = e.use === "sig"), t && Array.isArray(e.key_ops) && (t = e.key_ops.includes("verify")), t) switch (n) {
				case "ES256":
					t = e.crv === "P-256";
		...
		if (s === 0) throw new As();
		if (s !== 1) {
			let e = new js(), { _cached: t } = this;
			throw e[Symbol.asyncIterator] = async function* () {
				for (let e of a) try {
					yield await Jc(t, e, n);
				} catch {}
			}, e;
		}
		return Jc(this._cached, o, n);
	}
};
async function Jc(e, t, n) {
	...
	if (r[n] === void 0) {
		...
		if (e instanceof Uint8Array || e.type !== "public") throw new ks("JSON Web Key Set members must be public keys");
		r[n] = e;
	}
	return r[n];
}
function Yc(e) {
	let t = new qc(e), n = async (e, n) => t.getKey(e, n);
	return Object.defineProperties(n, { jwks: {
		value: () => Kc(t._jwks),
		enumerable: !0,
		configurable: !1,
...
var Xc = async (e, t, n) => {
	...
	if (i !== void 0 && clearTimeout(i), o.status !== 200) throw new ys("Expected 200 OK from the JSON Web Key Set HTTP response");
	try {
		return await o.json();
	} catch {
		throw new ys("Failed to parse the JSON Web Key Set HTTP response as JSON");
	}
};
function Zc() {
	return typeof WebSocketPair < "u" || typeof navigator < "u" && navigator.userAgent === "Cloudflare-Workers" || typeof EdgeRuntime < "u" && EdgeRuntime === "vercel";
...
var Qc;
(typeof navigator > "u" || !navigator.userAgent?.startsWith?.("Mozilla/5.0 ")) && (Qc = "jose/v5.10.0");
var $c = Symbol();
function el(e, t) {
	return !(typeof e != "object" || !e || !("uat" in e) || typeof e.uat != "number" || Date.now() - e.uat >= t || !("jwks" in e) || !qs(e.jwks) || !Array.isArray(e.jwks.keys) || !Array.prototype.every.call(e.jwks.keys, qs));
}
var tl = class {
	constructor(e, t) {
		if (!(e instanceof URL)) throw TypeError("url must be an instance of URL");
		this._url = new URL(e.href), this._options = {
			agent: t?.agent,
			headers: t?.headers
		}, this._timeoutDuration = typeof t?.timeoutDuration == "number" ? t?.timeoutDuration : 5e3, this._cooldownDuration = typeof t?.cooldownDuration == "number" ? t?.cooldownDuration : 3e4, this._cacheMaxAge = typeof t?.cacheMaxAge == "number" ? t?.cacheMaxAge : 6e5, t?.[$c] !== void 0 && (this._cache = t?.[$c], el(t?.[$c], this._cacheMaxAge) && (this._jwksTimestamp = this._cache.uat, this._local = Yc(this._cache.jwks)));
	}
	coolingDown() {
		return typeof this._jwksTimestamp == "number" && Date.now() < this._jwksTimestamp + this._cooldownDuration;
	}
	...
	async getKey(e, t) {
		...
		try {
			...
			if (n instanceof As && this.coolingDown() === !1) return await this.reload(), this._local(e, t);
			throw n;
		}
	}
	async reload() {
		this._pendingFetch && Zc() && (this._pendingFetch = void 0);
		let e = new Headers(this._options.headers);
		Qc && !e.has("User-Agent") && (e.set("User-Agent", Qc), this._options.headers = Object.fromEntries(e.entries())), this._pendingFetch ||= Xc(this._url, this._timeoutDuration, this._options).then((e) => {
			this._local = Yc(e), this._cache && (this._cache.uat = Date.now(), this._cache.jwks = e), this._jwksTimestamp = Date.now(), this._pendingFetch = void 0;
		}).catch((e) => {
			throw this._pendingFetch = void 0, e;
		}), await this._pendingFetch;
	}
...
function nl(e, t) {
	let n = new tl(e, t), r = async (e, t) => n.getKey(e, t);
	return Object.defineProperties(r, {
		coolingDown: {
			get: () => n.coolingDown(),
			enumerable: !0,
...
var rl = vs;
function il(e) {
	if (typeof e != "string") throw new Ds("JWTs must use Compact JWS serialization, JWT must be a string");
	let { 1: t, length: n } = e.split(".");
	if (n === 5) throw new Ds("Only JWTs using Compact JWS serialization can be decoded");
	if (n !== 3) throw new Ds("Invalid JWT");
	if (!t) throw new Ds("JWTs must contain a payload");
	let r;
	try {
		r = rl(t);
	} catch {
		throw new Ds("Failed to base64url decode the payload");
	}
	let i;
	try {
		i = JSON.parse(ps.decode(r));
	} catch {
		throw new Ds("Failed to parse the decoded payload as JSON");
	}
	if (!qs(i)) throw new Ds("Invalid JWT Claims Set");
	return i;
}
function al(e) {
	let t = e?.modulusLength ?? 2048;
	if (typeof t != "number" || t < 2048) throw new Cs("Invalid or unsupported modulusLength option provided, 2048 bits or larger keys must be used");
	return t;
}
		...
		case "EdDSA": {
			...
			switch (e) {
				...
				case "Ed448":
					n = { name: e };
					break;
				default: throw new Cs("Invalid or unsupported crv option provided");
			}
			break;
		}
		case "ECDH-ES":
		...
		case "ECDH-ES+A256KW": {
			...
			switch (e) {
				...
				case "X448":
					n = { name: e };
					break;
				default: throw new Cs("Invalid or unsupported crv option provided, supported values are P-256, P-384, P-521, X25519, and X448");
			}
			break;
		}
		default: throw new Cs("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
	}
	return ls.subtle.generateKey(n, t?.extractable ?? !1, r);
}
...
var cl = async (e, t) => {
	...
	if (!l) {
		let e = o.registration_endpoint;
		l = (await cl(e, n ?? { redirect_uris: [i] }).then((e) => {
			if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
			return e.json();
		})).client_id;
	}
	...
	let { pkce_code_verifier: u, pkce_code_challenge: d } = await ul();
	sessionStorage.setItem("pkce_code_verifier", u);
	let f = window.crypto.randomUUID();
	sessionStorage.setItem("csrf_token", f);
	let p = o.authorization_endpoint + `?response_type=code&redirect_uri=${encodeURIComponent(i)}&scope=openid offline_access webid&client_id=${encodeURIComponent(l)}&code_challenge_method=S256&code_challenge=${d}&state=${f}&prompt=consent`;
	...
	let s = sessionStorage.getItem("token_endpoint");
	if (s === null) throw Error("Access Token Request preparation - Could not find in sessionStorage: token_endpoint");
	let c = await sl("ES256"), l = await fl(r, a, n.toString(), o, s, c).then((e) => {
		if (!e.ok) throw Error(`HTTP error! Status: ${e.status}`);
		return e.json();
	}), u = l.access_token, d = sessionStorage.getItem("jwks_uri");
	if (d === null) throw Error("Access Token validation preparation - Could not find in sessionStorage: jwks_uri");
	let { payload: f } = await Pc(u, nl(new URL(d)), {
		issuer: i,
		audience: "solid"
	}), p = await Hc(await _c(c.publicKey));
	if (f.cnf.jkt !== p) throw Error("Access Token validation failed on `jkt`: jkt !== DPoP thumbprint - " + f.cnf.jkt + " !== " + p);
	if (f.client_id !== o) throw Error("Access Token validation failed on `client_id`: JWT payload !== client_id - " + f.client_id + " !== " + o);
	let m = {
		...l,
...
}, fl = async (e, t, n, r, i, a) => {
	let o = await _c(a.publicKey);
	o.alg = "ES256";
	let s = await new Bc({
		htu: i,
		htm: "POST"
	...
	try {
		...
		let c = await e.getItem("jwks_uri");
		if (c === null) throw Error("Access Token validation preparation - Could not find in sessionDatabase: jwks_uri");
		let { payload: l } = await Pc(o, nl(new URL(c)), {
			issuer: s,
			audience: "solid"
		}), u = await Hc(await _c(r.publicKey));
		if (l.cnf.jkt !== u) throw Error("Access Token validation failed on `jkt`: jkt !== DPoP thumbprint - " + l.cnf.jkt + " !== " + u);
		if (l.client_id !== t) throw Error("Access Token validation failed on `client_id`: JWT payload !== client_id - " + l.client_id + " !== " + t);
		return await e.setItem("refresh_token", a.refresh_token), {
			...a,
...
var gl = class extends EventTarget {
	isActive_ = !1;
	exp_;
	webId_ = void 0;
	currentAth_ = void 0;
	...
	rejectRefresh;
	constructor(e, t) {
		super(), this.authFetch = this.authFetch.bind(this), this.information = { clientDetails: e }, this.database = t?.database, t?.onSessionStateChange && this.addEventListener(hl.STATE_CHANGE, (e) => t.onSessionStateChange?.(e)), t?.onSessionExpirationWarning && this.addEventListener(hl.EXPIRATION_WARNING, (e) => t?.onSessionExpirationWarning?.(e)), t?.onSessionExpiration && this.addEventListener(hl.EXPIRATION, (e) => t?.onSessionExpiration?.(e));
	}
	async login(e, t) {
		await ll(e, t, this.information.clientDetails);
	}
	async handleRedirectFromLogin() {
	...
	async restore() {
		...
		let e = this.isActive;
		return pl(this.database).then((e) => this.setTokenDetails(e)).then(() => this.resolveRefresh()).catch((e) => {
			this.isActive ? (this.rejectRefresh(Error(e || "Token refresh failed")), this.isExpired() ? this.dispatchExpirationEvent() : this.dispatchExpirationWarningEvent()) : this.rejectRefresh(/* @__PURE__ */ Error("No session to restore."));
		}).finally(() => {
			this.clearRefreshPromise(), e !== this.isActive && this.dispatchStateChangeEvent();
		}), this.refreshPromise;
	...
	async _createSignedDPoPToken(e) {
		if (!this.information.tokenDetails || !this.currentAth_) throw Error("Session not established.");
		e.ath = this.currentAth_;
		let t = await _c(this.information.tokenDetails.dpop_key_pair.publicKey);
		return new Bc(e).setIssuedAt().setJti(window.crypto.randomUUID()).setProtectedHeader({
			alg: "ES256",
			typ: "dpop+jwt",
			jwk: t
		}).sign(this.information.tokenDetails.dpop_key_pair.privateKey);
	...
	dispatchStateChangeEvent() {
		this.dispatchEvent(new CustomEvent(hl.STATE_CHANGE, { detail: {
			isActive: this.isActive,
			webId: this.webId
		} }));
	}
	dispatchExpirationWarningEvent() {
		this.dispatchEvent(new CustomEvent(hl.EXPIRATION_WARNING, { detail: { expires_in: this.getExpiresIn() } }));
	}
	dispatchExpirationEvent() {
		this.dispatchEvent(new CustomEvent(hl.EXPIRATION));
	}
}, _l = class {
	constructor() {
...
function yl() {
	let e = cs, t = e.SessionCore ?? e.default?.SessionCore ?? e.default;
...
function xl() {
	...
	})()) return bl ? new bl(void 0, { database: new vl() }) : new ss();
	try {
		return new ss();
	} catch (e) {
		...
		try {
			...
			return console.warn("solid-logic: IndexedDB unavailable, using in-memory session database:", e), bl ? new bl(void 0, { database: new _l() }) : new ss();
		}
	}
}
var Sl = xl();
...
}, El = Sl, Dl = typeof El.login == "function" ? El.login.bind(Sl) : void 0;
Dl && (El.login = async (e, t) => {
	if (e && typeof e == "object" && !Array.isArray(e)) {
		let t = e.oidcIssuer ?? e.idp ?? e.issuer, n = e.redirectUrl ?? e.redirect_uri ?? e.redirectUri;
		if (typeof t == "string" && typeof n == "string") return Dl(await wl(t), n);
	}
	return Dl(typeof e == "string" ? await wl(e) : e, t);
});
var Ol = new Tl();
wi(Sl, {
	onEvent: (e) => Ol.emit(e),
...
var kl = Object.assign(Sl, { events: Ol });
Object.defineProperty(kl, "info", {
	enumerable: !0,
	configurable: !0,
	get() {
		return hi(Sl);
...
var Ml = class {
	constructor(e) {
		this.checkUserInFlight = null, this.sessionRestoreHookAttached = !1, this.session = e, this.identity = wi(e, { onRefocus: () => this.refreshCookieBackedFallback() });
	}
	dispose() {
		this.identity.unsubscribe();
	}
	async refreshCookieBackedFallback() {
		fi(this.session) || this.identity.reportCookieIdentity(await this.probeNssCookieBackedWebId());
	}
	get authSession() {
		return this.session;
	}
	currentUser() {
		let e = Mi();
		if (e.viewingNoAuthPage) return Wr(e.webId);
		let { webId: t } = mi(this.session);
		return t ? Wr(t) : Ni();
	}
	async checkUser(e) {
		...
		!this.sessionRestoreHookAttached && typeof n?.events?.on == "function" && (n.events.on("sessionRestore", (e) => {
			Ai(`Session restored to ${e}`), document.location.toString() !== e && history.replaceState(null, "", e);
	...
	async resolveCurrentUser() {
		...
		if (t.hash = "", typeof e?.handleIncomingRedirect == "function") await e.handleIncomingRedirect({
			...
			let t = e?.isActive ?? !!e?.webId, n = gi(e);
			if (n) {
				try {
					await jl(n);
				} catch (t) {
					...
					Ai(`Session restore failed, continuing logged-out: ${n}`);
				}
		...
		return i ||= (this.identity.reportCookieIdentity(await this.probeNssCookieBackedWebId()), mi(e).webId ?? null), i && (r = this.saveUser(i)), r && Ai(`(Logged in as ${r} by authentication)`), r;
	}
	...
	webIdFromSession(e, t) {
		...
		return ui(t) || r === !1 || i === !1 || a === !1 ? null : n;
	}
};
//#endregion
...
function Nl(e) {
	try {
		...
		return ji(`Could not flag authorization metadata: ${String(e)}`), !1;
	}
}
function Pl(e, t) {
	let n = wi(t, { onTransition: () => {
		let t = Ll(e);
		t.generation += 1, t.invalidationFailed = !Nl(e);
	} });
	return () => n.unsubscribe();
}
var Fl = /* @__PURE__ */ new WeakMap(), Il = {
	generation: 0,
	invalidationFailed: !1
};
function Ll(e) {
	if (typeof e != "object" || !e) return Il;
	let t = Fl.get(e);
	return t || (t = {
		generation: 0,
		invalidationFailed: !1
...
async function zl(e, t) {
	let n = Ll(e), r = e.fetcher?.load;
	if (typeof r == "function") for (let i = 0; i < Rl; i++) {
		let i = n.generation;
		if (!Nl(e)) return;
		...
		try {
			...
			ji(`Could not reload ${String(t)}: ${String(e)}`);
			return;
		}
...
async function Bl(e, t) {
	return !Ll(e).invalidationFailed && e.updater?.editable?.(t) !== void 0 || await zl(e, t) !== void 0;
}
async function Vl(e, t) {
	let n = Ll(e), r = n.generation, i = e.fetcher?.load;
	if (typeof i != "function") throw Error("fetcher.load is unavailable");
	return await i.call(e.fetcher, t), r === n.generation ? Bl(e, t) : await zl(e, t) !== void 0;
}
//#endregion
//#region node_modules/solid-logic/dist/chat/chatLogic.esm.js
var Hl = "index.ttl#this";
function Ul(e, t) {
	let n = Di;
	async function r(t, n, r) {
		await e.fetcher.load(t);
		let i = e.any(t, new H("http://www.iana.org/assignments/link-relations/acl"));
	...
	async function i(t, r) {
		...
		let a = Vi(i), o = [
			Ur(a, n.rdf("type"), n.solid("TypeRegistration"), i.doc()),
			Ur(a, n.solid("forClass"), n.meeting("LongChat"), i.doc()),
			Ur(a, n.solid("instance"), t, i.doc())
		];
	...
	async function a(n) {
		let r = await t.loadMe(), i = Gi(n, await t.getPodRoot(r)), a = !0;
		try {
			await e.fetcher.load(new H(i.value + "index.ttl#this"));
		} catch {
			a = !1;
		}
		return {
	...
	function s(t) {
		...
		let a = t.newInstance = t.newInstance || r.sym(t.newBase + Hl), o = a.doc();
		return r.add(a, n.rdf("type"), n.meeting("LongChat"), o), r.add(a, n.dc("title"), "Chat channel", o), r.add(a, n.dc("created"), $r(new Date(Date.now())), o), t.me && r.add(a, n.dc("author"), t.me, o), new Promise(function(e, n) {
...
function ql(e, t, n = {}) {
	if (e.ok || n.allowNotFound && Kl(e.status)) return;
...
function Xl(e) {
	...
	let t = Yl(e), n = t.get("user") ?? /* @__PURE__ */ new Set(), r = t.get("public") ?? /* @__PURE__ */ new Set();
	return {
		canEdit: n.has("write"),
...
function Zl(e, t, n, r) {
	...
	function s(t, n) {
		...
		if (n.headers) {
			...
			let c = Xl(n.headers.get("wac-allow"));
			i = c.canEdit, a = c.isPublic, o = n.headers.get("etag") ?? void 0, s = e.anyValue(t, Di.dct("modified")) || e.anyValue(t, Di.dc("modified")) || void 0;
		}
		(!n.headers || !n.headers.get("content-type")) && (!n.headers || !n.headers.get("wac-allow") || !n.headers.get("etag")) && e.each(null, e.sym("http://www.w3.org/2007/ont/link#requestedURI"), t).map((n) => {
			...
			if (c && c.termType === "NamedNode") {
				let n = e.anyValue(c, Di.httph("content-type")) || void 0;
				r === void 0 && (r = n);
				let l = Xl(e.anyValue(c, Di.httph("wac-allow")) || e.anyValue(c, Di.httph("WAC-Allow")));
				i ||= l.canEdit, a ||= l.isPublic;
				let u = e.anyValue(c, Di.httph("etag")) || void 0;
				o === void 0 && (o = u), s = e.anyValue(t, Di.dct("modified")) || e.anyValue(t, Di.dc("modified")) || void 0;
			}
		});
		let c = e.any(t, Oi)?.value || void 0;
		return {
			contentType: r,
			access: {
				canEdit: i,
	...
	async function c(t) {
		...
		return ql(n, "HEAD"), s(t, n);
	}
	async function l(t) {
		let n = e.any(t, Di.ldp("contains")) || t.dir();
		if (!n || n.termType !== "NamedNode") return !1;
		try {
			return (await c(n)).access.canEdit;
		} catch {
			return !1;
		}
	}
	...
	async function m(t, r = {}) {
		...
		if (a(t)) {
			...
			await Promise.all(e.map((e) => m(Wr(e), r)));
		}
		let o;
		try {
			o = await e.fetcher._fetch(t.value, { method: "DELETE" }), ql(o, "DELETE", { allowNotFound: !0 });
		} catch (e) {
			if (!Jl(e)) throw e;
		}
		return r.deleteTypeIndexes && await p(t, r.user), i && e.removeMatches(i, Di.ldp("contains"), t, i.doc()), e.removeDocument(t), e.fetcher.unload(t.doc()), o;
	}
	...
	return {
		recursiveDelete: m,
		deleteResourceAndTypeIndexIfExists: h,
		fetchMetadata: d,
		fetchMetadataWithDelete: f,
		createContainer: i,
		isContainer: a,
...
function Ql(e) {
	function t(t) {
		return e.statementsMatching(t, Wr("http://www.w3.org/ns/ldp#contains"), void 0).map((e) => e.object);
	}
	function n(t) {
		let n = e.findTypeURIs(t);
		return !!(t.value.charAt(t.value.length - 1) === "/" || n[Di.ldp("Container").uri] || n[Di.ldp("BasicContainer").uri]);
	}
	function r(e) {
		return t(e).length;
	}
	async function i(t) {
		if (!n(Wr(t))) throw Error(`Not a container URL ${t}`);
		let r = await e.fetcher._fetch(t, {
			method: "PUT",
			headers: {
...
function nu(e, t, n) {
	let r = Di, i = Ql(e), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
	function s(e) {
		return !!e && (e.startsWith("https://") || e.startsWith("http://"));
	}
	function c(e) {
	...
	async function f(t, n) {
		...
		let i = Wr(r), a;
		try {
			await e.fetcher.load(i), a = e.any(i, Oi)?.value;
		} catch (e) {
			if (!u(e)) throw e;
		}
		a ||= `${r}.acl`;
	...
	async function p(t, r, i = !1) {
		if (!await n.loadOrCreateWithContentOnCreate(r, Ki()) && !i) return;
		let a;
		try {
			await e.fetcher.load(r), a = e.any(r, Oi)?.value;
		} catch (e) {
			if (!u(e)) throw e;
		}
		a ||= `${r.uri}.acl`;
	...
	async function m(e) {
		await n.loadOrCreateWithContentOnCreate(e, qi());
	}
	async function h(t, i) {
		...
		f && await n.followOrCreateLinkWithContentOnCreate(t, r.solid("publicTypeIndex"), u, o, Ki());
		let h = [];
		e.holds(a, r.rdf("type"), r.space("ConfigurationFile"), a) || h.push(Ur(a, r.rdf("type"), r.space("ConfigurationFile"), a)), e.holds(a, r.dct("title"), void 0, a) || h.push(Ur(a, r.dct("title"), Jr("Preferences file"), a)), e.holds(t, r.solid("publicTypeIndex"), u, a) || h.push(Ur(t, r.solid("publicTypeIndex"), u, a)), e.holds(t, r.solid("privateTypeIndex"), d, a) || h.push(Ur(t, r.solid("privateTypeIndex"), d, a)), h.length > 0 && (await e.updater.update([], h), await e.fetcher.load(a)), await p(t, u, f), await m(d);
	}
	async function g(e) {
		try {
			return !!await n.loadOrCreateWithContentOnCreate(e, eu());
		} catch (t) {
			throw t.response?.status === 401 ? new Fi() : t.response?.status === 403 ? Ui(e) ? new Ii() : new Li() : t;
		}
	}
	async function _(e) {
		try {
	...
	async function v(t) {
		...
		let c = (async () => {
			...
			try {
				...
				throw ji(`User ${t} has no pointer in profile to preferences file.`), e instanceof Ri || e instanceof zi || e instanceof Fi || e instanceof Ii || e instanceof Li || e instanceof Bi, e;
			}
			try {
				await e.fetcher.load(a);
			} catch (n) {
				...
				throw ji(r), n.response.status === 401 ? new Fi() : n.response.status === 403 ? Ui(a) ? new Ii() : new Li() : Error(r);
			}
...
function ru(e, t, n) {
		...
		try {
			...
			if (n?.response?.status === 404) {
				try {
					...
					if ((e?.response?.status ?? e?.status) !== 412) throw new zi(`createIfNotExists: PUT FAILED: ${t}: ${e}`);
				}
				return await e.fetcher.load(t);
			}
			if (n?.response?.status === 401) throw new Fi();
			if (n?.response?.status === 403) throw Ui(t) ? new Ii() : new Li();
			let r = `createIfNotExists doc load error: ${t}: ${n}`;
			throw new Bi(n?.status, `${n?.message || ""}${r}`);
		}
	}
	...
	async function a(t, n, i, a) {
		...
		try {
			await e.updater.update([], [Ur(t, n, i, a)]);
		} catch (e) {
			throw ji(`followOrCreateLink: Error making link in ${a} to ${i}: ${e}`), new zi(e);
		}
		try {
			await r(i);
		} catch (e) {
			throw ji(`followOrCreateLink: Error loading or saving new linked document: ${i}: ${e}`), e;
		}
		return i;
	}
	async function o(t, n, r, a, o) {
		...
		try {
			await e.updater.update([], [Ur(t, n, r, a)]);
		} catch (e) {
		...
		try {
			...
			throw ji(`followOrCreateLinkWithContentOnCreate: Error loading or saving new linked document: ${r}: ${e}`), e;
		}
		return r;
	}
	async function s(n) {
		...
		let i = await t.findAclDocUrl(Wr(n.target));
...
function iu(e, t) {
	Ai("SolidLogic: Unique instance created.  There should only be one of these.");
	let n = Vr();
	Q(n, { fetch: e.fetch }), n.updater = new Fr(n), n.features = [];
	let r = Pl(n, t), i = new Ml(t), a = i.dispose?.bind(i);
	i.dispose = () => {
		r(), a?.();
	};
	let o = ki(n), s = Ql(n), c = ru(n, o, s), l = nu(n, i, c), u = Ul(n, l), d = Wl(n, l, c, s, o), f = Ji(n, i, l, c), p = Zl(n, o, s, f);
	Ai("SolidAuthnLogic initialized");
	function m(e) {
...
var au = async (e, t) => {
	let n = t && t.credentials && t.credentials == "omit", r = kl;
	if (!di(r) && (r?.info?.webId || r?.webId) && !n) {
...
}, ou = Symbol.for("solid-logic-singleton"), su = typeof window < "u" ? window : global;
function cu() {
	return su[ou] ? Ai("SolidLogic: Using existing global singleton instance.") : (Ai("SolidLogic: Creating new global singleton instance."), su[ou] = iu({ fetch: au }, kl), Ai("Unique quadstore initialized.")), su[ou];
}
var lu = cu(), uu = lu.authn, du = lu.authn.authSession, fu = lu.store;
//#endregion
export { St as A, s as B, Ur as C, Mr as D, Fr as E, Ce as F, c as H, _e as I, he as L, Xe as M, Ie as N, mr as O, ke as P, H as R, Wr as S, Gr as T, d as U, o as V, u as W, Q as _, Ji as a, Hr as b, zi as c, Fi as d, Ni as f, zr as g, ni as h, lu as i, gt as j, wt as k, Li as l, Ei as m, du as n, Ri as o, Oi as p, uu as r, Ii as s, fu as t, Bi as u, Qr as v, $r as w, Jr as x, Vr as y, N as z };

//# sourceMappingURL=index.esm-AZPmKqjU.js.map