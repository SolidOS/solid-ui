...
var De = r`wa-dropdown::part(menu){gap:2px;min-width:300px;box-shadow:0 4px 16px #00000059}wa-dropdown-item{border-radius:5px;padding:0;&:hover{background-color:var(--solid-ui-color-primary-hover)}}`, W, G, K, q, J, Y, Oe, ke, Ae, je, Me, Ne, Pe, Fe, Ie, Le, Re, ze, Be;
function X(e, t, n) {
	Ve(e, t), t.set(e, n);
}
function Ve(e, t) {
...
new (ze = (K = /*#__PURE__*/ new WeakMap(), q = /*#__PURE__*/ new WeakMap(), J = /*#__PURE__*/ new WeakMap(), Y = /*#__PURE__*/ new WeakMap(), Be = (je = m({
	...
	type: Number,
	reflect: !0
}), Fe = g("wa-dropdown"), Le = h(), "placement"), G = class extends t {
	constructor(...e) {
...
], Ae, 0, void 0, t), G), W = class extends Ye {
	constructor() {
...
//# sourceMappingURL=menu-D9tKJQwm.js.map