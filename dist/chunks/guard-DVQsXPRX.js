...
d = [n("solid-ui-guard")];
var O;
new (m = (c = /*#__PURE__*/ new WeakMap(), h = (f = i({
	context: e,
	subscribe: !0
}), "auth"), s = class extends r {
	constructor(...e) {
		super(...e), g(this, c, (l(this), p(this, t))), x(this, "unsubscribeSessionUpdated", void 0);
	}
	get [h]() {
		return y(c, this);
	}
	...
	1,
	"auth"
]], d, 0, void 0, r), s), o = class extends D {
	constructor() {
...
//# sourceMappingURL=guard-DVQsXPRX.js.map