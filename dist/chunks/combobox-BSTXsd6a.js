import { c as e, f as t, g as n, i as r, p as i, r as a, t as o, u as s } from "./components-BHoVP7zE.js";
import "./chunk.64OG2H45-BjTEA4fC.js";
...
var l = Symbol(), u = class {
	get taskComplete() {
		return this.t ||= this.i === 1 ? new Promise(((e, t) => {
			this.o = e, this.h = t;
		})) : this.i === 3 ? Promise.reject(this.l) : Promise.resolve(this.u), this.t;
	}
	constructor(e, t, n) {
...
}, d = (e, n) => e === n || e.length === n.length && e.every(((e, r) => !t(e, n[r])));
//#endregion
...
var m = i`:host{flex-direction:column;align-items:flex-start;gap:5px;display:inline-flex;& label{color:var(--solid-ui-color-gray-600);font-size:var(--solid-ui-font-size-sm);font-weight:400}& wa-popup{width:100%;display:block}& wa-popup::part(popup){border:1px solid var(--solid-ui-color-gray-100);background:#fff;border-radius:5px;padding:4px;overflow:hidden;box-shadow:0 4px 16px #00000059}& .input-wrapper{width:100%;position:relative;& input{border:1px solid var(--solid-ui-color-gray-400);border-radius:5px;width:100%;padding:10px 40px 10px 10px}& icon-lucide-chevron-down{color:var(--solid-ui-color-gray-500);width:var(--solid-ui-font-size-lg);height:var(--solid-ui-font-size-lg);pointer-events:none;position:absolute;top:50%;right:15px;transform:translateY(-50%)}}& .listbox{max-height:min(28rem, calc(100dvh - 6rem), var(--auto-size-available-height,28rem));overscroll-behavior:contain;scrollbar-width:thin;flex-direction:column;gap:2px;display:flex;overflow:hidden auto;&::-webkit-scrollbar{width:4px}& [role=option],& .non-selectable-option{color:var(--solid-ui-color-gray-700);border-radius:5px;padding:12px 8px}& [role=option]{cursor:pointer;&:hover,&[data-active]{background:var(--solid-ui-color-primary-hover)}&[aria-selected=true]{background:var(--solid-ui-color-primary-selected)}}& .non-selectable-option{justify-content:center;align-items:center;display:flex;& icon-svg-spinners-3-dots-fade{width:2rem}& .message--error{color:var(--solid-ui-color-error)}}}}`, h, g, _, v, y, b, x, S, C, w, T, E, D, O, k, A, j, ee, te, ne, re, ie, ae, oe, se, M, N, P, F, I, L, R, z, B, V, H, U, W, G, K, ce, le, ue, de, fe, pe;
function q(e, t, n) {
	me(e, t), t.set(e, n);
}
function me(e, t) {
	...
	var f = Object.create(d ?? null), p = function(e, t, n, r) {
		...
		for (var f = 0; f < t.length; f++) {
			...
			if (Array.isArray(p)) {
				...
				l(v ? e : e.prototype, p, _, g ? "#" + h : _e(h), m, r, v ? a ||= [] : i ||= [], o, v, g, y, m === 1, v && g ? c : n);
			}
		}
		return d(i), d(a), o;
	}(e, t, i, f);
...
ee = [n("solid-ui-combobox")];
var $;
new (fe = (_ = /*#__PURE__*/ new WeakMap(), v = /*#__PURE__*/ new WeakMap(), y = /*#__PURE__*/ new WeakMap(), b = /*#__PURE__*/ new WeakMap(), x = /*#__PURE__*/ new WeakMap(), S = /*#__PURE__*/ new WeakMap(), C = /*#__PURE__*/ new WeakMap(), w = /*#__PURE__*/ new WeakMap(), T = /*#__PURE__*/ new WeakMap(), E = /*#__PURE__*/ new WeakMap(), D = /*#__PURE__*/ new WeakMap(), O = /*#__PURE__*/ new WeakMap(), k = /*#__PURE__*/ new WeakMap(), pe = (te = r({
	type: Boolean,
	reflect: !0,
...
}), F = r({ type: Function }), L = r({ type: Array }), z = c("input"), V = r({
	type: Boolean,
	reflect: !0
}), U = a(), G = a(), ce = a(), ue = a(), "selectOnly"), g = class extends o {
	get [pe]() {
		return Y(_, this);
	}
	set selectOnly(e) {
	...
	constructor() {
		super(), q(this, _, (A(this), ne(this, !1))), q(this, v, ie(this, "")), q(this, y, oe(this, "")), q(this, b, M(this, "")), q(this, x, P(this, "")), q(this, S, I(this, null)), q(this, C, R(this, null)), q(this, w, B(this, null)), q(this, T, H(this, !1)), q(this, E, W(this, "")), q(this, D, K(this, "")), q(this, O, le(this, !1)), q(this, k, de(this, -1)), X(this, "openListenersAttached", !1), X(this, "updateDebouncedFilter", f(300, (e) => this.filter = e)), X(this, "asyncOptionsTask", void 0), X(this, "_selectedOption", void 0), X(this, "listboxId", void 0), X(this, "handleDocumentFocusIn", (e) => {
	...
	render() {
		let t = this.getFilteredOptions(), n = (this.open && this.activeIndex >= 0 ? t[this.activeIndex] : void 0) === void 0 ? void 0 : this.getOptionId(this.activeIndex), r = this.placeholder || "Combobox";
		return s`
      ...
      >
        <div class="input-wrapper" slot="anchor" @mousedown=${this.onAnchorMouseDown}>
          <input
            ...
            aria-labelledby=${this.label ? this.controlTrait.labelId : e}
            aria-label=${this.label ? e : r}
        ...
        >
          ${t.map((t, n) => t.selectable === !1 ? s`<div class="non-selectable-option">${t.template ?? t.label}</div>` : s`<div
                  id=${this.getOptionId(n)}
                  role="option"
                  aria-selected=${t.value === this.value ? "true" : "false"}
                  data-active=${n === this.activeIndex || e}
                  @mousemove=${() => this.setActiveIndex(n)}
                >
                  ${t.template ?? t.label}
                </div>`)}
        </div>
	...
	getFilteredOptions() {
		return this.asyncOptionsTask ? this.asyncOptionsTask.render({
			...
			pending: () => [{
				value: "",
				label: "Loading...",
				template: s`<icon-svg-spinners-3-dots-fade></icon-svg-spinners-3-dots-fade>`,
				selectable: !1
			}],
			error: (e) => {
				...
				return [{
					value: "",
					label: n,
					template: s`<span class="message message--${t ? "error" : "info"}">${n}</span>`,
					selectable: !1
				}];
			}
...
}, {e: [ne, ie, oe, M, P, I, R, B, H, W, K, le, de, A], c: [$, j]} = ge(g, [
	[
		te,
		1,
		"selectOnly"
...
], ee, 0, void 0, o), g), h = class extends be {
	constructor() {
		super($), X(this, "styles", m), j();
	}
}, X(h, fe, void 0), h)();
//#endregion
...
var Se = $;
//#endregion
export { $ as n, xe as r, Se as t };

//# sourceMappingURL=combobox-BSTXsd6a.js.map