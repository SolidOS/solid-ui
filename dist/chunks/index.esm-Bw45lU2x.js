...
async function Sn(e, t, n) {
	let r = n && Object.prototype.hasOwnProperty.call(n, "termType") ? n.value : n, i = await import("./jsonld-Tix-kz1U.js").then((e) => /* @__PURE__ */ u(e.default));
	...
	_tokenizeToEnd(e, t) {
		...
		for (;;) {
			...
			switch (c) {
				...
				case "h":
				case "o":
					this._n3Mode && (f = this._matchN3Verb(n, t)) ? l = f[0] : m = !0;
					break;
				case "i":
					this._n3Mode && (f = this._n3Id.exec(n)) ? l = "id" : this._n3Mode && (f = this._matchN3Verb(n, t)) ? l = f[0] : m = !0;
					break;
				case "=":
...
//# sourceMappingURL=index.esm-Bw45lU2x.js.map