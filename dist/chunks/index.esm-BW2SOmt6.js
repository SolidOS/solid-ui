	...
	(function(e, n) {
		...
		function n(e, n) {
				...
				if (n !== r) {
					if (T.test(e.charAt(K)) ? (i = e.charAt(K), K++) : (i = r, J === 0 && Z(E)), i !== r) {
						if (D.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(O)), a !== r) {
							if (k.test(e.charAt(K)) ? (o = e.charAt(K), K++) : (o = r, J === 0 && Z(ee)), o !== r) {
								if (A.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(j)), s !== r) {
			...
			function cr() {
				...
				if (n !== r) {
					if (te.test(e.charAt(K)) ? (i = e.charAt(K), K++) : (i = r, J === 0 && Z(ne)), i !== r) {
						if (re.test(e.charAt(K)) ? (a = e.charAt(K), K++) : (a = r, J === 0 && Z(ie)), a !== r) {
							if (A.test(e.charAt(K)) ? (o = e.charAt(K), K++) : (o = r, J === 0 && Z(j)), o !== r) {
								if (M.test(e.charAt(K)) ? (s = e.charAt(K), K++) : (s = r, J === 0 && Z(N)), s !== r) {
									if (ae.test(e.charAt(K)) ? (c = e.charAt(K), K++) : (c = r, J === 0 && Z(P)), c !== r) {
			...
			function _r() {
				...
				if (n !== r) {
					if (e.charCodeAt(K) === 91 ? (i = ve, K++) : (i = r, J === 0 && Z(ye)), i !== r) {
						if (a = ur(), a !== r) {
			...
			function vr() {
				for (var t = K, n = [], i = Q(), a, o, s; i !== r;) n.push(i), i = Q();
				if (n !== r) {
					if (e.charCodeAt(K) === 40 ? (i = Se, K++) : (i = r, J === 0 && Z(Ce)), i !== r) {
				...
				if (t === r) {
					...
					if (n !== r) {
						if (i = Sr(), i !== r) {
							for (a = [], o = Q(); o !== r;) a.push(o), o = Q();
							if (a !== r) {
								if (e.substr(K, 2) === W ? (o = W, K += 2) : (o = r, J === 0 && Z(De)), o !== r) {
									for (s = [], c = Q(); c !== r;) s.push(c), c = Q();
...
async function fn(t, n, r) {
	let i = r && Object.prototype.hasOwnProperty.call(r, "termType") ? r.value : r, a = await import("./jsonld-PfYSYrj9.js").then((t) => /* @__PURE__ */ e(t.default));
	...
	_unescape(e) {
		let t = !1, n = e.replace(wn, (e, n, r, i) => {
			if (typeof n == "string") {
				...
				return Dn(e) ? String.fromCharCode(e) : (t = !0, "");
			}
			if (typeof r == "string") {
				let e = Number.parseInt(r, 16);
				return Dn(e) ? e <= 65535 ? String.fromCharCode(Number.parseInt(r, 16)) : String.fromCharCode(55296 + ((e -= 65536) >> 10), 56320 + (e & 1023)) : (t = !0, "");
			}
...
var Kc = Object.assign(Rc, { events: Wc }), qc = 5e3;
async function Jc(e) {
	if (e === null) return;
	let t, n = new Promise((e) => {
		t = setTimeout(() => e(void 0), qc);
	});
	try {
...
function Zc(e, t) {
	...
	function s(t) {
		...
		let a = t.newInstance = t.newInstance || r.sym(t.newBase + Xc), o = a.doc();
...
function rl(e, t, n) {
	let r = Wr, i = $c(e), a = /* @__PURE__ */ new Map(), o = /* @__PURE__ */ new Map();
	function s(e) {
		return !!e && (e.startsWith("https://") || e.startsWith("http://"));
	}
	function c(e) {
	...
	async function g(e) {
		try {
			return !!await n.loadOrCreateWithContentOnCreate(e, tl());
		} catch (t) {
...
function al(e, t) {
	...
	let r = new Yc(t), i = Kr(n), a = $c(n), o = il(n, i, a), s = rl(n, r, o), c = Zc(n, s), l = Qc(n, s, o, a, i), u = ui(n, r, s, o);
...
}, sl = Symbol.for("solid-logic-singleton"), cl = typeof window < "u" ? window : global;
function ll() {
	return cl[sl] ? qr("SolidLogic: Using existing global singleton instance.") : (qr("SolidLogic: Creating new global singleton instance."), cl[sl] = al({ fetch: ol }, Kc), qr("Unique quadstore initialized.")), cl[sl];
}
var ul = ll(), dl = ul.authn, fl = ul.authn.authSession, pl = ul.store;
//#endregion
export { ot as A, zr as C, $n as D, gr as E, le as F, V as I, z as L, W as M, be as N, mt as O, me as P, k as R, kr as S, br as T, Rr as _, ui as a, Pr as b, ti as c, Qr as d, Xr as f, Er as g, wr as h, ul as i, Be as j, ft as k, ei as l, Ur as m, fl as n, $ as o, Gr as p, dl as r, $r as s, pl as t, ni as u, Dr as v, jr as w, Ar as x, Or as y };

//# sourceMappingURL=index.esm-BW2SOmt6.js.map