import { m as e, x as t } from "./index.esm-C63HBmfn.js";
import { b as n, g as r, i, o as a, r as o, u as s } from "./components-BHoVP7zE.js";
import { a as c, i as l, o as u, r as d, s as f } from "./rdf-input-CiQNdkKK.js";
...
j = (_ = n({
	context: l,
	subscribe: !0
}), y = i({ attribute: !1 }), x = o(), C = o(), T = o(), D = i({ converter: H }), k = i({ converter: H }), "storeContext"), p = class extends a {
	constructor(...e) {
		super(...e), M(this, G, (m(this), v(this, d))), M(this, K, b(this, null)), M(this, q, S(this, !0)), M(this, J, w(this, 0)), M(this, Y, E(this, !1)), M(this, X, O(this, null)), M(this, Z, A(this, null));
	}
	get [j]() {
		return F(G, this);
	}
	...
	render() {
		if (!this._documentsLoaded) return s``;
		let n = this.currentStore, r = U(this.subjectUrl);
		r && n.updater?.editable(r) !== void 0 && n.updater?.editable(r) !== !1 && (this.entireDataIsReadonly = !1);
		let i = u(this.currentStore, U(this.formUrl));
		if (!i) throw Error("No ui:Form found in " + U(this.formUrl));
		let a = t(U(this.formUrl)), o = n.each(i, e.ui("parts"), null, a), c = (f(n, o) || []).flatMap((e) => e && typeof e == "object" && "elements" in e && Array.isArray(e.elements) ? e.elements : [e]).map((t) => {
			let r = n.each(t, e.rdf("type"), null, a)[0], i = r ? r.value || String(r) : t.value || String(t), o = i.lastIndexOf("#");
			return {
				value: t,
				fieldValue: o >= 0 ? i.slice(o + 1) : i
			};
		});
		return s`
      <form>
        ${c.map((e) => {
			switch (e.fieldValue) {
				...
				case "NamedNodeURIField": return s` <solid-ui-rdf-input 
                  .formSubject=${t(e.value)} 
                  .dataSubject=${t(r)}
                  .storeVersion=${this._loadVersion}
                  .readonly=${this.entireDataIsReadonly}
                ></solid-ui-rdf-input>
                <br>`;
				case "MultiLineTextField": return s`<input .rdf=${e}></input>`;
				case "BooleanField": return s`<input .rdf=${e}></input>`;
				case "TristateField": return s`<input .rdf=${e}></input>`;
				case "Classifier": return s`<input .rdf=${e}></input>`;
				case "Choice": return s`<input .rdf=${e}></input>`;
				case "Multiple": return s`<input .rdf=${e}></input>`;
				case "Options": return s`<input .rdf=${e}></input>`;
				case "AutocompleteField": return s`<input .rdf=${e}></input>`;
				case "Comment":
				case "Heading": return s`<input .rdf=${e}></input>`;
				default: return s`<div>Unknown part type: ${e}</div>`;
			}
		})}
      </form>
    `;
	...
	async loadDocumentsIfNeeded() {
		...
		if (!(!t || !n)) try {
			await c(e, t), await c(e, n), this._loadVersion += 1, this._documentsLoaded = !0;
		} catch (e) {
...
//#endregion
//#region src/components/rdf-form/index.ts
var Q = W;
//#endregion
export { W as n, Q as t };

//# sourceMappingURL=rdf-form-C2zcf1F0.js.map