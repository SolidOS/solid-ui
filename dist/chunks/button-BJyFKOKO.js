import { c as e, g as t, i as n, o as r, p as i, u as a } from "./components-DrP7BOrs.js";
...
g = [t("solid-ui-button")];
var B;
new (T = (u = /*#__PURE__*/ new WeakMap(), d = /*#__PURE__*/ new WeakMap(), f = /*#__PURE__*/ new WeakMap(), p = /*#__PURE__*/ new WeakMap(), E = (_ = n({
	type: String,
	reflect: !0
}), y = n({
	type: String,
	reflect: !0
}), x = n({ type: Boolean }), C = n({ type: Boolean }), "variant"), l = class extends r {
	constructor(...e) {
	...
	render() {
		let t = this.disabled ?? this.loading;
		return a`
        <button type=${this.type} ?disabled=${t} @click=${this.onClick}>
            ${this.loading ? a`<icon-svg-spinners-180-ring></icon-svg-spinners-180-ring>` : e}
...
], g, 0, void 0, r), l), c = class extends R {
	constructor() {
...
//# sourceMappingURL=button-BJyFKOKO.js.map