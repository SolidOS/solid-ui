import { a as e, i as t, l as n, r } from "./components-BD458q30.js";
import { c as i, i as a, n as o } from "./lit-C4H1jI4q.js";
import "./dialog-DZgm_Tph.js";
import "./button-Dvkek1tx.js";
import "./dialog-content-DY-ROHyi.js";
import "./dialog-footer-BAZTjZ8J.js";
...
new (he = (u = /*#__PURE__*/ new WeakMap(), d = /*#__PURE__*/ new WeakMap(), f = /*#__PURE__*/ new WeakMap(), p = /*#__PURE__*/ new WeakMap(), m = /*#__PURE__*/ new WeakMap(), h = /*#__PURE__*/ new WeakMap(), g = /*#__PURE__*/ new WeakMap(), _ = /*#__PURE__*/ new WeakMap(), v = /*#__PURE__*/ new WeakMap(), y = /*#__PURE__*/ new WeakMap(), b = /*#__PURE__*/ new WeakMap(), x = /*#__PURE__*/ new WeakMap(), S = /*#__PURE__*/ new WeakMap(), C = /*#__PURE__*/ new WeakMap(), w = /*#__PURE__*/ new WeakMap(), T = /*#__PURE__*/ new WeakMap(), E = /*#__PURE__*/ new WeakMap(), ge = (A = t({
	...
	reflect: !0
}), se = r(), le = r(), de = r(), pe = r(), "name"), l = class extends e {
	constructor(...e) {
	...
	render() {
        ...
        <solid-ui-dialog title=${this.heading}>
            ...
            <solid-ui-dialog-footer>
                ${this.showCancelButton ? a`<solid-ui-button variant="secondary" @click=${() => this.close()}>${this.cancelLabel}</solid-ui-button>` : o}
	...
	renderViewport() {
		return a`<div class="viewport">${this.previewUrl ? a`<img src="${this.previewUrl}" alt="Captured photo preview" />` : a`<video autoplay playsinline muted></video>`}</div>`;
	}
	renderStatus() {
		return this.errorMessage ? a`<div class="status error">${this.errorMessage}</div>` : this.startingPreview ? a`<div class="status">Opening camera…</div>` : this.value ? a`<div class="status">Review the photo before confirming it.</div>` : a`<div class="status">Preview the camera and take a photo when ready.</div>`;
	}
	onRetake() {
...
//# sourceMappingURL=photo-capture-modal-BLZtHDj1.js.map